...
public class RequestMappingHandlerAdapterTests {
    ...
    /**
     * This class additionally implements {@link RequestBodyAdvice} solely for the purpose of verifying that controller
     * advice implementing both {@link ResponseBodyAdvice} and {@link RequestBodyAdvice} does not get registered twice.
     *
