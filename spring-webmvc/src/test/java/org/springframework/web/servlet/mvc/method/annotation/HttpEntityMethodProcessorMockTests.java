...
/**
 * Test fixture for {@link HttpEntityMethodProcessor} delegating to a mock {@link HttpMessageConverter}.
 *
 * <p>
...
public class HttpEntityMethodProcessorMockTests {
    ...
    public void setup() throws Exception {
        ...
        Method handle1 =
            getClass().getMethod("handle1", HttpEntity.class, ResponseEntity.class, Integer.TYPE, RequestEntity.class);
    ...
    public void shouldHandleNotModifiedResponse() throws Exception {
        ...
        String etagValue = "\"deadb33f8badf00d\"";
        ResponseEntity<String> returnValue =
            ResponseEntity.status(HttpStatus.NOT_MODIFIED).eTag(etagValue).lastModified(oneMinuteAgo).body("body");
    ...
    public void disableRangeSupportIfContentRangePresent() throws Exception {
        ResponseEntity<Resource> returnValue =
            ResponseEntity.status(HttpStatus.PARTIAL_CONTENT).header(HttpHeaders.RANGE, "bytes=0-5")
