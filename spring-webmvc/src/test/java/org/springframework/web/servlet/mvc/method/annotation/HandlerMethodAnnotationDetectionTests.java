...
/**
 * Test various scenarios for detecting method-level and method parameter annotations depending on where they are
 * located -- on interfaces, parent classes, in parameterized methods, or in combination with proxies.
 *
...
class HandlerMethodAnnotationDetectionTests {
    ...
    static Object[][] handlerTypes() {
        return new Object[][] {{SimpleController.class, true}, // CGLIB proxy
            ...
            // { ParameterizedSubclassDoesNotOverrideConcreteImplementationsFromGenericAbstractSuperclass.class, true },
            // // CGLIB proxy
