...
/**
 * Test fixture for a {@link RequestResponseBodyMethodProcessor} with actual delegation to {@link HttpMessageConverter}
 * instances. Also see {@link RequestResponseBodyMethodProcessorMockTests}.
 *
...
public class RequestResponseBodyMethodProcessorTests {
    ...
    public void resolveArgumentRawTypeFromParameterizedType() throws Exception {
        ...
        MultiValueMap<String, String> result =
            (MultiValueMap<String, String>)processor.resolveArgument(paramMultiValueMap, container, request, factory);
    ...
    public void resolveParameterizedWithTypeVariableArgument() throws Exception {
        ...
        @SuppressWarnings("unchecked")
        List<SimpleBean> result = (List<SimpleBean>)processor.resolveArgument(methodParam, container, request, factory);
    ...
    public void resolveArgumentWithJacksonJsonView() throws Exception {
        ...
        JacksonViewBean result =
            (JacksonViewBean)processor.resolveArgument(methodParameter, this.container, this.request, this.factory);
    ...
    public void resolveHttpEntityArgumentWithJacksonJsonView() throws Exception {
        ...
        HttpEntityMethodProcessor processor =
            new HttpEntityMethodProcessor(converters, null, Collections.singletonList(new JsonViewRequestBodyAdvice()));
