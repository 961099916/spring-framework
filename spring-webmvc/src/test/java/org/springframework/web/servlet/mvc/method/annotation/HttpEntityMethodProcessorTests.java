...
/**
 * Test fixture with {@link HttpEntityMethodProcessor} delegating to actual {@link HttpMessageConverter} instances.
 *
 * <p>
...
public class HttpEntityMethodProcessorTests {
    ...
    public void resolveArgument() throws Exception {
        ...
        HttpEntity<SimpleBean> result =
            (HttpEntity<SimpleBean>)processor.resolveArgument(paramSimpleBean, mavContainer, webRequest, binderFactory);
    ...
    public void resolveGenericArgument() throws Exception {
        ...
        HttpEntity<List<SimpleBean>> result =
            (HttpEntity<List<SimpleBean>>)processor.resolveArgument(paramList, mavContainer, webRequest, binderFactory);
    ...
    public void resolveArgumentTypeVariable() throws Exception {
        ...
        @SuppressWarnings("unchecked")
        HttpEntity<SimpleBean> result =
            (HttpEntity<SimpleBean>)processor.resolveArgument(methodParam, mavContainer, webRequest, binderFactory);
