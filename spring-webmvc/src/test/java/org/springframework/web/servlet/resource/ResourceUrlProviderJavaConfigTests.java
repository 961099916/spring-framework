...
/**
 * Integration tests using {@link ResourceUrlEncodingFilter} and {@link ResourceUrlProvider} with the latter configured
 * in Spring MVC Java config.
 *
...
public class ResourceUrlProviderJavaConfigTests {
    ...
    public void setup() throws Exception {
        ...
        this.filterChain =
            new MockFilterChain(this.servlet, new ResourceUrlEncodingFilter(), (request, response, chain) -> {
    ...
    static class WebConfig extends WebMvcConfigurationSupport {
        ...
        public void addResourceHandlers(ResourceHandlerRegistry registry) {
            registry.addResourceHandler("/resources/**")
                .addResourceLocations("classpath:org/springframework/web/servlet/resource/test/").resourceChain(true)
