...
/**
 * A test fixture with a controller with all supported method signature styles and arguments. A convenient place to test
 * or confirm a problem with a specific argument or return value type.
 *
...
public class RequestMappingHandlerAdapterIntegrationTests {
    ...
    private interface HandlerIfc {
        ...
        String handleInInterface(@CookieValue("cookie") int cookieV, @PathVariable("pathvar") String pathvarV,
            ...
            @RequestAttribute TestBean requestAttribute, User user, @ModelAttribute OtherUser otherUser, Model model,
    ...
    private static class Handler implements HandlerIfc {
        ...
        public String handle(@CookieValue("cookie") int cookieV, @PathVariable("pathvar") String pathvarV,
            ...
            model.addAttribute("cookie", cookieV).addAttribute("pathvar", pathvarV).addAttribute("header", headerV)
                ...
                .addAttribute("sessionAttribute", sessionAttribute).addAttribute("requestAttribute", requestAttribute)
