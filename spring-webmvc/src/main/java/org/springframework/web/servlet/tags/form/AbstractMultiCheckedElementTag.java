...
/**
 * Abstract base class to provide common methods for implementing databinding-aware JSP tags for rendering
 * <i>multiple</i> HTML '{@code input}' elements with a '{@code type}' of '{@code checkbox}' or '{@code radio}'.
 *
...
public abstract class AbstractMultiCheckedElementTag extends AbstractCheckedElementTag {
    ...
    /**
     * The {@link java.util.Collection}, {@link java.util.Map} or array of objects used to generate the
     * '{@code input type="checkbox/radio"}' tags.
     */
    @Nullable
    private Object items;

    /**
     * The name of the property mapped to the '{@code value}' attribute of the '{@code input type="checkbox/radio"}'
     * tag.
     */
    @Nullable
    ...
    /**
     * Get the {@link java.util.Collection}, {@link java.util.Map} or array of objects used to generate the
     * '{@code input type="checkbox/radio"}' tags.
     */
    @Nullable
    ...
    /**
     * Set the {@link java.util.Collection}, {@link java.util.Map} or array of objects used to generate the
     * '{@code input type="checkbox/radio"}' tags.
     * <p>
    ...
    /**
     * Get the name of the property mapped to the '{@code value}' attribute of the '{@code input type="checkbox/radio"}'
     * tag.
     */
    @Nullable
    ...
    /**
     * Set the name of the property mapped to the '{@code value}' attribute of the '{@code input type="checkbox/radio"}'
     * tag.
     * <p>
    ...
    /**
     * Renders the '{@code input type="radio"}' element with the configured {@link #setItems(Object)} values. Marks the
     * element as checked if the value matches the bound value.
     */
    @Override
