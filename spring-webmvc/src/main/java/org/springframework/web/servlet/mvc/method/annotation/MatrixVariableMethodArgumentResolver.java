 ...
 *
 * <p>
 * If the method parameter is of type {@link Map} it will by resolved by {@link MatrixVariableMapMethodArgumentResolver}
 * instead unless the annotation specifies a name in which case it is considered to be a single attribute of type map
 * (vs multiple attributes collected in a map).
 *
