...
/**
 * The {@code <button>} tag renders a form field label in an HTML 'button' tag. It is provided for completeness if the
 * application relies on a {@link RequestDataValueProcessor}.
 *
 * <p>
 * <table>
...
public class ButtonTag extends AbstractHtmlElementTag {
    ...
    /**
     * Writes the '{@code value}' attribute to the supplied {@link TagWriter}. Subclasses may choose to override this
     * implementation to control exactly when the value is written.
     */
    ...
    /**
     * Get the value of the '{@code type}' attribute. Subclasses can override this to change the type of '{@code input}'
     * element rendered. Default value is '{@code submit}'.
     */
