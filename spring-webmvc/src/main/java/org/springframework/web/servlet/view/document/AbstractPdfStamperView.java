...
/**
 * Abstract superclass for PDF views that operate on an existing document with an AcroForm. Application-specific view
 * classes will extend this class to merge the PDF form with model data.
 *
 * <p>
...
public abstract class AbstractPdfStamperView extends AbstractUrlBasedView {
     ...
     *            the model Map
     * @param stamper
     *            the PdfStamper instance that will contain the AcroFields. You may also customize this PdfStamper
     *            instance according to your needs, e.g. setting the "formFlattening" property.
     * @param request
