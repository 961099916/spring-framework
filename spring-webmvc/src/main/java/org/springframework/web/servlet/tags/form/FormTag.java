...
/**
 * The {@code <form>} tag renders an HTML 'form' tag and exposes a binding path to inner tags for binding.
 *
 * <p>
 * Users should place the form object into the {@link org.springframework.web.servlet.ModelAndView ModelAndView} when
 * populating the data for their view. The name of this form object can be configured using the
 ...
 * <td>
 * <p>
 * Specifies the list of character encodings for input data that is accepted by the server processing this form. The
 * value is a space- and/or comma-delimited list of charset values. The client must interpret this list as an
...
public class FormTag extends AbstractHtmlElementTag {
    ...
    /**
     * The name of the {@link javax.servlet.jsp.PageContext} attribute under which the form object name is exposed.
     */
    ...
    /**
     * Set the value of the '{@code action}' attribute through a value that is to be appended to the current servlet
     * path.
     * <p>
     * May be a runtime expression.
     *
     ...
     * 
     * @param tagWriter
     *            the {@link TagWriter} to which the form content is to be written
     ...
     *             if the form object resolves to {@code null}
     */
     ...
     * <p>
     * If the user configured an '{@code action}' value then the result of evaluating this value is used. If the user
     * configured an '{@code servletRelativeAction}' value then the value is prepended with the context and servlet
     * paths, and the result is used. Otherwise, the
     * {@link org.springframework.web.servlet.support.RequestContext#getRequestUri() originating URI} is used.
     * 
    ...
    /**
     * Process the action through a {@link RequestDataValueProcessor} instance if one is configured or otherwise returns
