...
/**
 * Spring MVC {@link View} that renders XML content by serializing the model for the current request using
 * <a href="https://github.com/FasterXML/jackson">Jackson 2's</a> {@link XmlMapper}.
 *
 * <p>
 * The Object to be serialized is supplied as a parameter in the model. The first serializable entry is used. Users can
 * either specify a specific entry in the model via the {@link #setModelKey(String) sourceKey} property.
 *
 * <p>
...
public class MappingJackson2XmlView extends AbstractJackson2View {
    ...
    /**
     * Construct a new {@code MappingJackson2XmlView} using default configuration provided by
     * {@link Jackson2ObjectMapperBuilder} and setting the content type to {@code application/xml}.
     */
    ...
    /**
     * Construct a new {@code MappingJackson2XmlView} using the provided {@link XmlMapper} and setting the content type
