...
public class InterceptorRegistry {
     ...
     * @return an {@link InterceptorRegistration} that allows you optionally configure the registered interceptor
     *         further for example adding URL patterns it should apply to.
     */
