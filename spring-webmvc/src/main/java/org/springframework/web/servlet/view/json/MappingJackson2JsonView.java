...
/**
 * Spring MVC {@link View} that renders JSON content by serializing the model for the current request using
 * <a href="https://github.com/FasterXML/jackson">Jackson 2's</a> {@link ObjectMapper}.
 *
 * <p>
 * By default, the entire contents of the model map (with the exception of framework-specific classes) will be encoded
 * as JSON. If the model contains only one key, you can have it extracted encoded as JSON alone via
...
public class MappingJackson2JsonView extends AbstractJackson2View {
    ...
    /**
     * Construct a new {@code MappingJackson2JsonView} using the provided {@link ObjectMapper} and setting the content
    ...
    /**
     * Indicates whether the JSON output by this view should be prefixed with <tt>")]}', "</tt>. Default is
     * {@code false}.
     * <p>
     ...
     * <p>
     * The effect of setting this flag is similar to using {@code MappingJackson2HttpMessageConverter} with an
     * {@code @ResponseBody} request-handling method.
     * <p>
    ...
    /**
     * Filter out undesired attributes from the given model. The return value can be either another {@link Map} or a
     * single value object.
     * <p>
     * The default implementation removes {@link BindingResult} instances and entries not included in the
     * {@link #setModelKeys modelKeys} property.
     * 
     * @param model
