 ...
 * {@link org.springframework.web.context.WebApplicationContext}, the {@link java.util.Locale}, the
 * {@link org.springframework.ui.context.Theme}, etc.
 *
 * <p>
 * Mainly intended for {@link org.springframework.web.servlet.DispatcherServlet} requests; will use fallbacks when used
 * outside {@code DispatcherServlet}.
 *
 * @author Rod Johnson
...
public abstract class RequestContextAwareTag extends TagSupport implements TryCatchFinally {
    ...
    /**
     * Create and expose the current RequestContext. Delegates to {@link #doStartTagInternal()} for actual work.
     * 
     ...
     * @throws Exception
     *             any exception, any checked one other than a JspException gets wrapped in a JspException by doStartTag
