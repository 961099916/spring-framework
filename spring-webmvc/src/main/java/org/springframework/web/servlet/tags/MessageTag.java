...
/**
 * The {@code <message>} tag looks up a message in the scope of this page. Messages are resolved using the
 * ApplicationContext and thus support internationalization.
 *
 * <p>
 ...
 * <td>false</td>
 * <td>true</td>
 * <td>Set optional message arguments for this tag, as a (comma-)delimited String (each String argument can contain JSP
 * EL), an Object array (used as argument array), or a single Object (used as single argument).</td>
 * </tr>
 * <tr>
 * <td>argumentSeparator</td>
 * <td>false</td>
 * <td>true</td>
 * <td>The separator character to be used for splitting the arguments string value; defaults to a 'comma' (',').</td>
 * </tr>
 * <tr>
 * <td>code</td>
 * <td>false</td>
 * <td>true</td>
 * <td>The code (key) to use when looking up the message. If code is not provided, the text attribute will be used.</td>
 * </tr>
 * <tr>
 * <td>htmlEscape</td>
 * <td>false</td>
 * <td>true</td>
 * <td>Set HTML escaping for this tag, as boolean value. Overrides the default HTML escaping setting for the current
 * page.</td>
 * </tr>
 * <tr>
 ...
 * <td>false</td>
 * <td>true</td>
 * <td>A MessageSourceResolvable argument (direct or through JSP EL). Fits nicely when used in conjunction with Spring’s
 * own validation error classes which all implement the MessageSourceResolvable interface. For example, this allows you
 * to iterate over all of the errors in a form, passing each error (using a runtime expression) as the value of this
 * 'message' attribute, thus effecting the easy display of such error messages.</td>
 * </tr>
 * <tr>
 * <td>scope</td>
 * <td>false</td>
 * <td>true</td>
 * <td>The scope to use when exporting the result to a variable. This attribute is only used when var is also set.
 * Possible values are page, request, session and application.</td>
 * </tr>
 * <tr>
 * <td>text</td>
 * <td>false</td>
 * <td>true</td>
 * <td>Default text to output when a message for the given code could not be found. If both text and code are not set,
 * the tag will output null.</td>
 * </tr>
 * <tr>
 * <td>var</td>
 * <td>false</td>
 * <td>true</td>
 * <td>The string to use when binding the result to the page, request, session or application scope. If not specified,
 * the result gets outputted to the writer (i.e. typically directly to the JSP).</td>
 * </tr>
 * </tbody>
 * </table>
 *
...
public class MessageTag extends HtmlEscapingAwareTag implements ArgumentAware {
     ...
     * <p>
     * If a MessageSourceResolvable is specified, it effectively overrides any code, arguments or text specified on this
     * tag.
     */
    ...
    protected String resolveMessage() throws JspException, NoSuchMessageException {
        ...
        if (this.code != null || this.text != null) {
            ...
            if (this.text != null) {
                ...
                String msg =
                    messageSource.getMessage(this.code, argumentsArray, this.text, getRequestContext().getLocale());
                return (msg != null ? msg : "");
            } else {
