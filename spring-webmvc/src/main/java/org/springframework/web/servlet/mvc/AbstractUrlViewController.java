 ...
 *
 * <p>
 * Provides infrastructure for determining view names from URLs and configurable URL lookup. For information on the
 * latter, see {@code alwaysUseFullPath} and {@code urlDecode} properties.
 *
...
public abstract class AbstractUrlViewController extends AbstractController {
    ...
    /**
     * Set if context path and request URI should be URL-decoded. Both are returned <i>undecoded</i> by the Servlet API,
    ...
    /**
     * Retrieves the URL path to use for lookup and delegates to {@link #getViewNameForRequest}. Also adds the content
     * of {@link RequestContextUtils#getInputFlashMap} to the model.
     */
    @Override
    ...
    /**
     * Return the name of the view to render for this request, based on the given lookup path. Called by
     * {@link #handleRequestInternal}.
     * 
     * @param request
