...
public interface RenderingResponse extends ServerResponse {
     ...
     *
     * @param other
     *            the response to copy the values from
    ...
    interface Builder {
         ...
         * cannot correctly determine the true convention name. View code should check for {@code null} rather than for
         * empty collections.</em>
         * 
         * @param attribute
        ...
        /**
         * Copy all attributes in the supplied {@code Collection} into the model, using attribute name generation for
         * each element.
         * 
         * @see #modelAttribute(Object)
         */
