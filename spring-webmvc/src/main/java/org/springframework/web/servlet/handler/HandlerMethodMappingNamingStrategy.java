 ...
 *
 * <p>
 * The strategy can be configured on {@link org.springframework.web.servlet.handler.AbstractHandlerMethodMapping
 * AbstractHandlerMethodMapping}. It is used to assign a name to the mapping of every registered handler method. The
 * names can then be queried via
 ...
 * MvcUriComponentsBuilder#fromMappingName} or in JSPs through the "mvcUrl" function registered by the Spring tag
 * library.
 *
