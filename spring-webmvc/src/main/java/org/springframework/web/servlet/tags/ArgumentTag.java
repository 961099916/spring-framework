...
/**
 * The {@code <argument>} tag is based on the JSTL {@code fmt:param} tag. The purpose is to support arguments inside the
 * message and theme tags.
 *
 * <p>
...
public class ArgumentTag extends BodyTagSupport {
    ...
    /**
     * Set the value of the argument (optional). If not set, the tag's body content will get evaluated.
     * 
     * @param value
     *            the parameter value
     */
