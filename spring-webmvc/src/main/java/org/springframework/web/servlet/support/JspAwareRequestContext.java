 ...
 * {@code javax.servlet.jsp.PageContext}.
 *
 * <p>
 * This context will detect a JSTL locale attribute in page/request/session/application scope, in addition to the
 * fallback locale strategy provided by the base class.
 *
...
public class JspAwareRequestContext extends RequestContext {
    ...
    /**
     * Create a new JspAwareRequestContext for the given page context, using the request attributes for Errors
     * retrieval.
     * 
     * @param pageContext
    ...
    /**
     * Create a new JspAwareRequestContext for the given page context, using the given model attributes for Errors
     * retrieval.
     * 
     * @param pageContext
     *            current JSP page context
    ...
    /**
     * This implementation checks for a JSTL locale attribute in page, request, session or application scope; if not
    ...
    /**
     * This implementation checks for a JSTL time zone attribute in page, request, session or application scope; if not
