...
/**
 * Handler for return values of type {@link ResponseBodyEmitter} and sub-classes such as {@link SseEmitter} including
 * the same types wrapped with {@link ResponseEntity}.
 *
 * <p>
 * As of 5.0 also supports reactive return value types for any reactive library with registered adapters in
...
public class ResponseBodyEmitterReturnValueHandler implements HandlerMethodReturnValueHandler {
    ...
    /**
     * Simple constructor with reactive type support based on a default instance of {@link ReactiveAdapterRegistry},
     * {@link org.springframework.core.task.SyncTaskExecutor}, and {@link ContentNegotiationManager} with an Accept
     * header strategy.
     */
     ...
     *            converters to write emitted objects with
     * @param registry
     *            for reactive return value type support
     * @param executor
     *            for blocking I/O writes of items emitted from reactive types
     * @param manager
     *            for detecting streaming media types
     * @since 5.0
     */
    public ResponseBodyEmitterReturnValueHandler(List<HttpMessageConverter<?>> messageConverters,
    ...
    public boolean supportsReturnType(MethodParameter returnType) {
        ...
        return (bodyType != null
            && (ResponseBodyEmitter.class.isAssignableFrom(bodyType) || this.reactiveHandler.isReactiveType(bodyType)));
    }
    ...
    /**
     * Wrap to silently ignore header changes HttpMessageConverter's that would otherwise cause HttpHeaders to raise
     * exceptions.
     */
