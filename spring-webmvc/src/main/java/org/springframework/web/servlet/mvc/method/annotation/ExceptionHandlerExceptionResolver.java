...
/**
 * An {@link AbstractHandlerMethodExceptionResolver} that resolves exceptions through {@code @ExceptionHandler} methods.
 *
 * <p>
...
public class ExceptionHandlerExceptionResolver extends AbstractHandlerMethodExceptionResolver
     ...
     * {@code @ResponseBody} or returning {@code ResponseEntity} but before the body is written to the response with the
     * selected {@code HttpMessageConverter}.
     */
    ...
    /**
     * Return an unmodifiable Map with the {@link ControllerAdvice @ControllerAdvice} beans discovered in the
     * ApplicationContext. The returned map will be empty if the method is invoked before the bean has been initialized
    ...
    /**
     * Find an {@code @ExceptionHandler} method for the given exception. The default implementation searches methods in
     * the class hierarchy of the controller first and if not found, it continues searching for additional
     * {@code @ExceptionHandler} methods assuming some {@linkplain ControllerAdvice @ControllerAdvice} Spring-managed
     * beans were detected.
     * 
     * @param handlerMethod
     *            the method where the exception was raised (may be {@code null})
     * @param exception
