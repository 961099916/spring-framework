...
/**
 * The {@code <select>} tag renders an HTML 'select' element. Supports data binding to the selected option.
 *
 * <p>
...
public class SelectTag extends AbstractHtmlInputElementTag {
    ...
    /**
     * The {@link Collection}, {@link Map} or array of objects used to generate the inner '{@code option}' tags.
     */
    @Nullable
    ...
    /**
     * Set the {@link Collection}, {@link Map} or array of objects used to generate the inner '{@code option}' tags.
     * <p>
     * Required when wishing to render '{@code option}' tags from an array, {@link Collection} or {@link Map}.
     * <p>
     ...
     * <p>
     * Renders nested '{@code option}' tags if the {@link #setItems items} property is set, otherwise exposes the bound
     * value for the nested {@link OptionTag OptionTags}.
     */
    @Override
     ...
     * server-side in response to a {@code null} post.
     */
