 ...
 *
 * <p>
 * <strong>Note:</strong> As of 5.1, methods in this class do not extract {@code "Forwarded"} and
 * {@code "X-Forwarded-*"} headers that specify the client-originated address. Please, use
 * {@link org.springframework.web.filter.ForwardedHeaderFilter ForwardedHeaderFilter}, or similar from the underlying
 * server, to extract and use such headers, or to discard them.
 *
...
public class ServletUriComponentsBuilder extends UriComponentsBuilder {
     ...
     * <p>
     * If the servlet is mapped by name, e.g. {@code "/main/*"}, the path will end with "/main". If the servlet is
     * mapped otherwise, e.g. {@code "/"} or {@code "*.do"}, the result will be the same as if calling
    ...
    /**
     * Remove any path extension from the {@link HttpServletRequest#getRequestURI() requestURI}. This method must be
     * invoked before any calls to {@link #path(String)} or {@link #pathSegment(String...)}.
     * 
     * <pre>
