...
public interface ServerResponse {
    ...
    /**
     * Create a builder with a {@linkplain HttpStatus#CREATED 201 Created} status and a location header set to the given
     * URI.
     *
     * @param location
     *            the location URI
    ...
    /**
     * Create a builder with a {@linkplain HttpStatus#UNPROCESSABLE_ENTITY 422 Unprocessable Entity} status.
     *
     * @return the created builder
     */
    ...
    interface HeadersBuilder<B extends HeadersBuilder<B>> {
         ...
         * 
         * @param writeFunction
         *            the function used to write to the {@link HttpServletResponse}
         */
    ...
    interface BodyBuilder extends HeadersBuilder<BodyBuilder> {
         ...
         *
         * <p>
         * Asynchronous response bodies are supported by providing a {@link CompletionStage} or {@link Publisher} as
         * body.
         * 
         * @param body
        ...
        /**
         * Set the body of the response to the given {@code Object} and return it. The parameter {@code bodyType} is
         * used to capture the generic type.
         *
         * @param body
         *            the body of the response
         * @param bodyType
         *            the type of the body, used to capture the generic type
         * @return the built response
         */
