 ...
 * <li>{@link #getServletConfigClasses()} -- for {@code DispatcherServlet} application context (Spring MVC
 * infrastructure) configuration.
 * </ul>
 *
 * <p>
 * If an application context hierarchy is not required, applications may return all configuration via
 * {@link #getRootConfigClasses()} and return {@code null} from {@link #getServletConfigClasses()}.
 *
