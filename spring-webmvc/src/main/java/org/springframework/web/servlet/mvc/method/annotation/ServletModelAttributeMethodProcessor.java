...
/**
 * A Servlet-specific {@link ModelAttributeMethodProcessor} that applies data binding through a WebDataBinder of type
 * {@link ServletRequestDataBinder}.
 *
 * <p>
 * Also adds a fall-back strategy to instantiate the model attribute from a URI template variable or from a request
...
public class ServletModelAttributeMethodProcessor extends ModelAttributeMethodProcessor {
    ...
    /**
     * Instantiate the model attribute from a URI template variable or from a request parameter if the name matches to
     * the model attribute name and if there is an appropriate type conversion strategy. If none of these are true
    ...
    /**
     * This implementation downcasts {@link WebDataBinder} to {@link ServletRequestDataBinder} before binding.
     * 
