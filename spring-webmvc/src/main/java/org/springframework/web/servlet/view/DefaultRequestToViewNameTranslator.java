 ...
 * {@link org.springframework.web.servlet.DispatcherServlet} context. Otherwise, a plain default instance will be used.
 *
 * <p>
 * The default transformation simply strips leading and trailing slashes as well as the file extension of the URI, and
 * returns the result as the view name with the configured {@link #setPrefix prefix} and a {@link #setSuffix suffix}
 * added as appropriate.
 *
 * <p>
 * The stripping of the leading slash and file extension can be disabled using the {@link #setStripLeadingSlash
 * stripLeadingSlash} and {@link #setStripExtension stripExtension} properties, respectively.
 *
 * <p>
...
public class DefaultRequestToViewNameTranslator implements RequestToViewNameTranslator {
    ...
    /**
     * Set the value that will replace '{@code /}' as the separator in the view name. The default behavior simply leaves
     ...
     * 
     * @param lookupPath
     *            the lookup path for the current request, as determined by the UrlPathHelper
