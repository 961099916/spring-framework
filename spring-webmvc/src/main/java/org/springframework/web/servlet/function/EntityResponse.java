...
public interface EntityResponse<T> extends ServerResponse {
     ...
     *
     * @param t
     *            the object that represents the body of the response
     * @param <T>
     *            the type of element contained in the publisher
     ...
     *            the object that represents the body of the response
     * @param entityType
     *            the type of the entity, used to capture the generic type
     * @param <T>
     *            the type of element contained in the publisher
     * @return the created builder
     */
