...
/**
 * Simple {@code Controller} implementation that transforms the virtual path of a URL into a view name and returns that
 * view.
 *
 * <p>
 * Can optionally prepend a {@link #setPrefix prefix} and/or append a {@link #setSuffix suffix} to build the viewname
...
public class UrlFilenameViewController extends AbstractUrlViewController {
     ...
     * 
     * @param uri
     *            the request URI; for example {@code "/index.html"}
     ...
     * <p>
     * The default implementation simply applies prefix and suffix. This can be overridden, for example, to manipulate
