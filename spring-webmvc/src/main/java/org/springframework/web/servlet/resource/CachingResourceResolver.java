...
/**
 * A {@link org.springframework.web.servlet.resource.ResourceResolver} that resolves resources from a
 * {@link org.springframework.cache.Cache} or otherwise delegates to the resolver chain and saves the result in the
 * cache.
 *
...
public class CachingResourceResolver extends AbstractResourceResolver {
    ...
    /**
     * Configure the supported content codings from the {@literal "Accept-Encoding"} header for which to cache resource
     * variations.
     * <p>
