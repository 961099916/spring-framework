...
/**
 * Extends {@link InvocableHandlerMethod} with the ability to handle return values through a registered
 * {@link HandlerMethodReturnValueHandler} and also supports setting the response status based on a method-level
 * {@code @ResponseStatus} annotation.
 *
 * <p>
 * A {@code null} return value (including void) may be interpreted as the end of request processing in combination with
 * a {@code @ResponseStatus} annotation, a not-modified check condition (see
 * {@link ServletWebRequest#checkNotModified(long)}), or a method argument that provides access to the response stream.
 *
...
public class ServletInvocableHandlerMethod extends InvocableHandlerMethod {
    ...
    /**
     * Create a nested ServletInvocableHandlerMethod subclass that returns the the given value (or raises an Exception
    ...
    /**
     * A nested subclass of {@code ServletInvocableHandlerMethod} that uses a simple {@link Callable} instead of the
