...
/**
 * A {@link org.springframework.web.servlet.ViewResolver} implementation that uses bean definitions in a dedicated XML
 * file for view definitions, specified by resource location. The file will typically be located in the WEB-INF
 * directory; the default is "/WEB-INF/views.xml".
 *
 * <p>
 * This {@code ViewResolver} does not support internationalization at the level of its definition resources. Consider
