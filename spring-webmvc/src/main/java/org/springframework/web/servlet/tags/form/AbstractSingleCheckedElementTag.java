...
/**
 * Abstract base class to provide common methods for implementing databinding-aware JSP tags for rendering a
 * <i>single</i> HTML '{@code input}' element with a '{@code type}' of '{@code checkbox}' or '{@code radio}'.
 *
...
public abstract class AbstractSingleCheckedElementTag extends AbstractCheckedElementTag {
    ...
    /**
     * Renders the '{@code input(radio)}' element with the configured {@link #setValue(Object) value}. Marks the element
     * as checked if the value matches the {@link #getValue bound value}.
     */
    @Override
