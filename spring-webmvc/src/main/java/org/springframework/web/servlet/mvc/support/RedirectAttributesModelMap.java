...
/**
 * A {@link ModelMap} implementation of {@link RedirectAttributes} that formats values as Strings using a
 * {@link DataBinder}. Also provides a place to store flash attributes so they can survive a redirect without the need
 * to be embedded in the redirect URL.
 *
