 ...
 *
 * <p>
 * This base class provides an {@code @ExceptionHandler} method for handling internal Spring MVC exceptions. This method
 * returns a {@code ResponseEntity} for writing to the response with a {@link HttpMessageConverter message converter},
 * in contrast to {@link org.springframework.web.servlet.mvc.support.DefaultHandlerExceptionResolver
 * DefaultHandlerExceptionResolver} which returns a {@link org.springframework.web.servlet.ModelAndView ModelAndView}.
 *
 * <p>
 * If there is no need to write error content to the response body, or when using view resolution (e.g., via
 * {@code ContentNegotiatingViewResolver}), then {@code DefaultHandlerExceptionResolver} is good enough.
 *
 * <p>
