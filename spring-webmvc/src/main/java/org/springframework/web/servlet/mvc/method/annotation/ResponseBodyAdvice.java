 ...
 *
 * <p>
 * Implementations may be registered directly with {@code RequestMappingHandlerAdapter} and
 * {@code ExceptionHandlerExceptionResolver} or more likely annotated with {@code @ControllerAdvice} in which case they
...
public interface ResponseBodyAdvice<T> {
     ...
     *            the content type selected through content negotiation
     * @param selectedConverterType
     *            the converter type selected to write to the response
     * @param request
     *            the current request
     * @param response
