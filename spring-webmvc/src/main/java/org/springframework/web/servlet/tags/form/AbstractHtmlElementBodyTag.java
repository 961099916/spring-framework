...
/**
 * Convenient super class for many html tags that render content using the databinding features of the
 * {@link AbstractHtmlElementTag AbstractHtmlElementTag}. The only thing sub-tags need to do is override
 * {@link #renderDefaultContent(TagWriter)}.
 *
 * @author Rob Harrop
...
public abstract class AbstractHtmlElementBodyTag extends AbstractHtmlElementTag implements BodyTag {
    ...
    /**
     * If {@link #shouldRender rendering}, flush any buffered {@link BodyContent} or, if no {@link BodyContent} is
     * supplied, {@link #renderDefaultContent render the default content}.
     * 
     ...
     * <p>
     * The default implementation simply {@link #flushBufferedBodyContent flushes} the {@link BodyContent} directly to
     * the output. Subclasses may choose to override this to add additional content to the output.
     */
    ...
    /**
     * Called at the start of {@link #writeTagContent} allowing subclasses to perform any precondition checks or setup
     * tasks that might be necessary.
     */
    protected void onWriteTagContent() {}

    /**
     * Should rendering of this tag proceed at all. Returns '{@code true}' by default causing rendering to occur always,
     * Subclasses can override this if they provide conditional rendering.
     */
