...
/**
 * The {@code <eval>} tag evaluates a Spring expression (SpEL) and either prints the result or assigns it to a variable.
 ...
 * <td>false</td>
 * <td>true</td>
 * <td>The name of the variable to export the evaluation result to. If not specified the evaluation result is converted
 * to a String and written as output.</td>
 * </tr>
 * </tbody>
 * </table>
 *
...
public class EvalTag extends HtmlEscapingAwareTag {
    ...
    /**
     * {@link javax.servlet.jsp.PageContext} attribute for the page-level {@link EvaluationContext} instance.
     */
    ...
    /**
     * Set the variable name to expose the evaluation result under. Defaults to rendering the result to the current
     * JspWriter.
     */
    ...
    public int doEndTag() throws JspException {
        ...
        if (this.var != null) {
            ...
            try {
                String result =
                    (this.expression != null ? this.expression.getValue(evaluationContext, String.class) : null);
