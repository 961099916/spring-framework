...
/**
 * Trivial controller that always returns a pre-configured view and optionally sets the response status code. The view
 * and status can be configured using the provided configuration properties.
 *
 * @author Rod Johnson
...
public class ParameterizableViewController extends AbstractController {
    ...
    /**
     * Set a view name for the ModelAndView to return, to be resolved by the DispatcherServlet via a ViewResolver. Will
     ...
     * <p>
     * When a "redirect:" prefixed view name is configured, there is no need to set this property since RedirectView
     * will do that. However this property may still be used to override the 3xx status code of {@code RedirectView}.
    ...
    /**
     * The property can be used to indicate the request is considered fully handled within the controller and that no
     * view should be used for rendering. Useful in combination with {@link #setStatusCode}.
     * <p>
     ...
     * <p>
     * The content of the {@link RequestContextUtils#getInputFlashMap "input" FlashMap} is also added to the model.
     * 
     * @see #getViewName()
     */
    @Override
