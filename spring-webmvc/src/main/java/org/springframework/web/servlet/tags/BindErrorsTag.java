...
/**
 * This {@code <hasBindErrors>} tag provides an {@link Errors} instance in case of bind errors. The HTML escaping flag
 * participates in a page-wide or application-wide setting (i.e. by HtmlEscapeTag or a "defaultHtmlEscape" context-param
 * in web.xml).
 *
 * <table>
 ...
 * <td>true</td>
 * <td>true</td>
 * <td>The name of the bean in the request that needs to be inspected for errors. If errors are available for this bean,
 * they will be bound under the 'errors' key.</td>
 * </tr>
 * </tbody>
 * </table>
 *
