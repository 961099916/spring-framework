...
public abstract class AbstractJackson2View extends AbstractView {
     ...
     * ObjectMapper} will be used.
     * <p>
     * Setting a custom-configured {@code ObjectMapper} is one way to take further control of the JSON serialization
     * process. The other option is to use Jackson's provided annotations on the types to be serialized, in which case a
    ...
    /**
     * Whether to use the default pretty printer when writing the output. This is a shortcut for setting up an
    ...
    /**
     * Set the attribute in the model that should be rendered by this view. When set, all other model attributes will be
     * ignored.
     */
