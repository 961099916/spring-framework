 ...
 * "default" Servlet. This is intended to be used when the Spring MVC {@link DispatcherServlet} is mapped to "/" thus
 * overriding the Servlet container's default handling of static resources.
 *
 * <p>
 * Since this handler is configured at the lowest precedence, effectively it allows all other handler mappings to handle
 * the request, and if none of them do, this handler can forward it to the "default" Servlet.
 *
...
public class DefaultServletHandlerConfigurer {
     ...
     * <p>
     * When this method is used the {@link DefaultServletHttpRequestHandler} will try to autodetect the "default"
     * Servlet name. Alternatively, you can specify the name of the default Servlet via {@link #enable(String)}.
     * 
     * @see DefaultServletHttpRequestHandler
     */
    public void enable() {
     ...
     * {@link DefaultServletHttpRequestHandler} instance mapped to {@code "/**"}; or {@code null} if default servlet
     * handling was not been enabled.
     * 
     * @since 4.3.12
     */
    @Nullable
