...
/**
 * Interceptor that checks the authorization of the current user via the user's roles, as evaluated by
 * HttpServletRequest's isUserInRole method.
 *
...
public class UserRoleAuthorizationInterceptor extends HandlerInterceptorAdapter {
    ...
    /**
     * Handle a request that is not authorized according to this interceptor. Default implementation sends HTTP status
     * code 403 ("forbidden").
     * <p>
