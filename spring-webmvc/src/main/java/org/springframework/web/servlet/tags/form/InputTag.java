...
public class InputTag extends AbstractHtmlInputElementTag {
    ...
    /**
     * Writes the '{@code input}' tag to the supplied {@link TagWriter}. Uses the value returned by {@link #getType()}
     * to determine which type of '{@code input}' element to render.
     */
    @Override
     ...
     * element rendered. Default value is '{@code text}'.
     */
