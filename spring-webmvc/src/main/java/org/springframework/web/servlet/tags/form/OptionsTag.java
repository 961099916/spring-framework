...
/**
 * The {@code <options>} tag renders a list of HTML 'option' tags. Sets 'selected' as appropriate based on bound value.
 *
 * <p>
...
public class OptionsTag extends AbstractHtmlElementTag {
    ...
    /**
     * Get the {@link java.util.Collection}, {@link java.util.Map} or array of objects used to generate the inner
     * '{@code option}' tags.
     * <p>
    ...
    /**
     * Set the {@link java.util.Collection}, {@link java.util.Map} or array of objects used to generate the inner
     * '{@code option}' tags.
     * <p>
     * Required when wishing to render '{@code option}' tags from an array, {@link java.util.Collection} or
     * {@link java.util.Map}.
     * <p>
     * Typically a runtime expression.
     */
