 ...
 *
 * <p>
 * See the "formTags" showcase application that ships with the full Spring distribution for an example of this class in
 * action.
 *
 * <p>
 * <table>
...
public class LabelTag extends AbstractHtmlElementTag {
    ...
    /**
     * Overrides {@code #getName()} to always return {@code null}, because the '{@code name}' attribute is not supported
