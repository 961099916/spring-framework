 ...
 *
 * <p>
 * For working with the workbook in the subclass, see <a href="https://poi.apache.org">Apache's POI site</a>
 *
...
public abstract class AbstractXlsView extends AbstractView {
     ...
     * <p>
     * The default implementation creates a traditional {@link HSSFWorkbook}. Spring-provided subclasses are overriding
     * this for the OOXML-based variants; custom subclasses may override this for reading a workbook from a file.
     * 
     * @param model
     *            the model Map
     * @param request
