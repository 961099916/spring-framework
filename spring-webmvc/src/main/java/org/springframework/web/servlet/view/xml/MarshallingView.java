...
/**
 * Spring-MVC {@link View} that allows for response context to be rendered as the result of marshalling by a
 * {@link Marshaller}.
 *
 * <p>
 ...
 * {@link #setModelKey(String) sourceKey} property or have Spring locate the Source object.
 *
...
public class MarshallingView extends AbstractView {
    ...
    /**
     * Construct a new {@code MarshallingView} with no {@link Marshaller} set. The marshaller must be set after
     * construction by invoking {@link #setMarshaller}.
     */
     ...
     * <p>
     * The default implementation first attempts to look under the configured {@linkplain #setModelKey(String) model
     * key}, if any, before attempting to locate an object of {@linkplain Marshaller#supports(Class) supported type}.
     * 
     * @param model
     *            the model Map
     * @return the Object to be marshalled (or {@code null} if none found)
     * @throws IllegalStateException
     *             if the model object specified by the {@linkplain #setModelKey(String) model key} is not supported by
     *             the marshaller
     ...
     * {@link Marshaller}.
     * <p>
     * The default implementation calls {@link Marshaller#supports(Class)}, unwrapping a given {@link JAXBElement} first
     * if applicable.
     * 
     * @param modelKey
     *            the value's key in the model (never {@code null})
     * @param value
     *            the value to check (never {@code null})
