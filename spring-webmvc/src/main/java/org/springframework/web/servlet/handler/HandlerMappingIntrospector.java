 ...
 * <ul>
 * <li>{@link #getMatchableHandlerMapping} &mdash; obtain a {@code HandlerMapping} to check request-matching criteria
 * against.
...
public class HandlerMappingIntrospector implements CorsConfigurationSource, ApplicationContextAware, InitializingBean {
    ...
    /**
     * Constructor that detects the configured {@code HandlerMapping}s in the given {@code ApplicationContext} or falls
     * back on "DispatcherServlet.properties" like the {@code DispatcherServlet}.
     * 
    ...
    /**
     * Find the {@link HandlerMapping} that would handle the given request and return it as a
     * {@link MatchableHandlerMapping} that can be used to test request-matching criteria.
     * <p>
     * If the matching HandlerMapping is not an instance of {@link MatchableHandlerMapping}, an IllegalStateException is
     * raised.
     *
     * @param request
     *            the current request
