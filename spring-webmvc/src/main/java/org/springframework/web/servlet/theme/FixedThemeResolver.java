...
/**
 * {@link org.springframework.web.servlet.ThemeResolver} implementation that simply uses a fixed theme. The fixed name
 * can be defined via the "defaultThemeName" property; out of the box, it is "theme".
 *
 * <p>
