...
/**
 * A {@link BeanDefinitionParser} that provides the configuration for the {@code <annotation-driven/>} MVC namespace
 * element.
 *
 * <p>
 ...
 *
 * <p>
 * <strong>Note:</strong> Additional HandlerMappings may be registered as a result of using the
 ...
 * <li>A {@link org.springframework.validation.beanvalidation.LocalValidatorFactoryBean} if a JSR-303 implementation is
 * available on the classpath
 * <li>A range of {@link HttpMessageConverter HttpMessageConverters} depending on which third-party libraries are
 * available on the classpath.
 * </ul>
 *
 * @author Keith Donald
...
class AnnotationDrivenBeanDefinitionParser implements BeanDefinitionParser {
    ...
    private RuntimeBeanReference getValidator(Element element, @Nullable Object source, ParserContext context) {
        if (element.hasAttribute("validator")) {
            ...
            RootBeanDefinition validatorDef =
                new RootBeanDefinition("org.springframework.validation.beanvalidation.OptionalValidatorFactoryBean");
    ...
    /**
     * A FactoryBean for a CompositeUriComponentsContributor that obtains the HandlerMethodArgumentResolver's configured
     * in RequestMappingHandlerAdapter after it is fully initialized.
     */
