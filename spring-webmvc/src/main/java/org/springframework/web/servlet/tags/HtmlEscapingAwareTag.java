...
public abstract class HtmlEscapingAwareTag extends RequestContextAwareTag {
    ...
    /**
     * Set HTML escaping for this tag, as boolean value. Overrides the default HTML escaping setting for the current
     * page.
     *
     ...
     * <p>
     * The default implementation checks the RequestContext's setting, falling back to {@code false} in case of no
