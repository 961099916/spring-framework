...
public abstract class RequestPredicates {
    ...
    /**
     * Return a {@code RequestPredicate} that matches if the request's HTTP method is equal to the given method.
     * 
     * @param httpMethod
    ...
    /**
     * Return a {@code RequestPredicate} that matches if the request's HTTP method is equal to one the of the given
     * methods.
     * 
     * @param httpMethods
    ...
    /**
     * Return a function that creates new path-matching {@code RequestPredicates} from pattern Strings using the given
     * {@link PathPatternParser}.
     * <p>
     * This method can be used to specify a non-default, customized {@code PathPatternParser} when resolving path
     * patterns.
     * 
     * @param patternParser
     *            the parser used to parse patterns given to the returned function
     * @return a function that resolves a pattern String into a path-matching {@code RequestPredicates} instance
     */
    ...
    /**
     * Return a {@code RequestPredicate} that tests if the request's {@linkplain ServerRequest.Headers#contentType()
     * content type} is {@linkplain MediaType#includes(MediaType) included} by any of the given media types.
     * 
     * @param mediaTypes
    ...
    /**
     * Return a {@code RequestPredicate} that tests if the request's {@linkplain ServerRequest.Headers#accept() accept}
     * header is {@linkplain MediaType#isCompatibleWith(MediaType) compatible} with any of the given media types.
     * 
     * @param mediaTypes
     ...
     * 
     * @param extensionPredicate
     *            the predicate to test against the request path extension
     * @return a predicate that matches if the given predicate matches against the request's path file extension
     */
    ...
    /**
     * Return a {@code RequestPredicate} that matches if the request's parameter of the given name has the given value.
     * 
     * @param name
     *            the name of the parameter to test against
     * @param value
    ...
    /**
     * Return a {@code RequestPredicate} that tests the request's parameter of the given name against the given
     * predicate.
     * 
     * @param name
     *            the name of the parameter to test against
     * @param predicate
     *            the predicate to test against the parameter value
    ...
    public interface Visitor {
         ...
         * 
         * @param methods
         *            the HTTP methods that make up the predicate
         ...
         * 
         * @param pattern
         *            the path pattern that makes up the predicate
         ...
         * 
         * @param extension
         *            the path extension that makes up the predicate
         ...
         * @param value
         *            the desired value of the HTTP header
        ...
        /**
         * Receive first notification of a logical AND predicate. The first subsequent notification will contain the
         * left-hand side of the AND-predicate; followed by {@link #and()}, followed by the right-hand side, followed by
         * {@link #endAnd()}.
         * 
        ...
        /**
         * Receive "middle" notification of a logical AND predicate. The following notification contains the right-hand
         * side, followed by {@link #endAnd()}.
         * 
         * @see RequestPredicate#and(RequestPredicate)
         */
        void and();
        ...
        /**
         * Receive first notification of a logical OR predicate. The first subsequent notification will contain the
         * left-hand side of the OR-predicate; the second notification contains the right-hand side, followed by
         * {@link #endOr()}.
         * 
        ...
        /**
         * Receive "middle" notification of a logical OR predicate. The following notification contains the right-hand
         * side, followed by {@link #endOr()}.
         * 
         * @see RequestPredicate#or(RequestPredicate)
         */
        void or();
        ...
        /**
         * Receive first notification of a negated predicate. The first subsequent notification will contain the negated
         * predicated, followed by {@link #endNegate()}.
         * 
        ...
        private AcceptPredicate(Set<MediaType> mediaTypes) {
            super(headers -> {
                ...
                boolean match = acceptedMediaTypes.stream()
                    .anyMatch(acceptedMediaType -> mediaTypes.stream().anyMatch(acceptedMediaType::isCompatibleWith));
