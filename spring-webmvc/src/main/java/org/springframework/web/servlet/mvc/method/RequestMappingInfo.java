...
public final class RequestMappingInfo implements RequestCondition<RequestMappingInfo> {
    ...
    /**
     * Return the HTTP request methods of this {@link RequestMappingInfo}; or instance with 0 request methods (never
     * {@code null}).
     */
    ...
    /**
     * Return the "parameters" condition of this {@link RequestMappingInfo}; or instance with 0 parameter expressions
     * (never {@code null}).
     */
    ...
    /**
     * Return the "headers" condition of this {@link RequestMappingInfo}; or instance with 0 header expressions (never
     * {@code null}).
     */
    ...
    /**
     * Return the "consumes" condition of this {@link RequestMappingInfo}; or instance with 0 consumes expressions
     * (never {@code null}).
     */
    ...
    /**
     * Return the "produces" condition of this {@link RequestMappingInfo}; or instance with 0 produces expressions
     * (never {@code null}).
     */
    ...
    /**
     * Checks if all conditions in this request mapping info match the provided request and returns a potentially new
     * request mapping info with conditions tailored to the current request.
     * <p>
     * For example the returned instance may contain the subset of URL patterns that match to the current request,
     * sorted with best matching patterns on top.
     *
     ...
     * <p>
     * Note: It is assumed both instances have been obtained via {@link #getMatchingCondition(HttpServletRequest)} to
     * ensure they have conditions with content relevant to current request.
     */
    @Override
    ...
    private static class DefaultBuilder implements Builder {
        ...
        public DefaultBuilder headers(String... headers) {
            for (String header : headers) {
                this.hasContentType =
                    this.hasContentType || header.contains("Content-Type") || header.contains("content-type");
    ...
    /**
     * Container for configuration options used for request mapping purposes. Such configuration is required to create
     * RequestMappingInfo instances but is typically used across all RequestMappingInfo instances.
     * 
     * @since 4.2
     * @see Builder#options
     */
    public static class BuilderConfiguration {
         ...
         * @deprecated as of 5.2.4. See class-level note in {@link RequestMappingHandlerMapping} on the deprecation of
        ...
        /**
         * Set whether suffix pattern matching should be restricted to registered file extensions only. Setting this
         * property also sets {@code suffixPatternMatch=true} and requires that a {@link #setContentNegotiationManager}
         * is also configured in order to obtain the registered file extensions.
         * 
         * @deprecated as of 5.2.4. See class-level note in {@link RequestMappingHandlerMapping} on the deprecation of
         *             path extension config options; note also that in 5.3 the default for this property switches from
        ...
        /**
         * Return the file extensions to use for suffix pattern matching. If {@code registeredSuffixPatternMatch=true},
         * the extensions are obtained from the configured {@code contentNegotiationManager}.
         * 
         * @deprecated as of 5.2.4. See class-level note in {@link RequestMappingHandlerMapping} on the deprecation of
         *             path extension config options.
         */
