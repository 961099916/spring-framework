...
/**
 * Simple implementation of the {@link org.springframework.web.servlet.ViewResolver} interface, allowing for direct
 * resolution of symbolic view names to URLs, without explicit mapping definitions. This is useful if your symbolic
 * names match the names of your view resources in a straightforward manner (i.e. the symbolic name is the unique part
 ...
 * {@link org.springframework.web.servlet.view.freemarker.FreeMarkerView}. The view class for all views generated by
 * this resolver can be specified via the "viewClass" property.
 *
 * <p>
 ...
 *
 * <p>
 * As a special feature, redirect URLs can be specified via the "redirect:" prefix. E.g.: "redirect:myAction" will
 * trigger a redirect to the given URL, rather than resolution as standard view name. This is typically used for
 * redirecting to a controller URL after finishing a form workflow.
 *
 * <p>
 * Furthermore, forward URLs can be specified via the "forward:" prefix. E.g.: "forward:myAction" will trigger a forward
 * to the given URL, rather than resolution as standard view name. This is typically used for controller URLs; it is not
 * supposed to be used for JSP URLs - use logical view names there.
 *
 * <p>
 * Note: This class does not support localized resolution, i.e. resolving a symbolic view name to different resources
 ...
 * {@link InternalResourceView}, it is not generally possible to determine the existence of the target resource upfront.
 * In such a scenario, a UrlBasedViewResolver will always return a View for any given view name; as a consequence, it
 * should be configured as the last ViewResolver in the chain.
 *
...
public class UrlBasedViewResolver extends AbstractCachingViewResolver implements Ordered {
     ...
     *
     * @param viewClass
     *            class that is assignable to the required view class (by default, AbstractUrlBasedView)
     * @see AbstractUrlBasedView
     */
     ...
     * <p>
     * <b>Redirect URLs can be specified via the "redirect:" prefix.</b> E.g.: "redirect:myAction"
     *
     ...
     * {@link HttpServletResponse#encodeRedirectURL} for URLs that have a host and that host is not listed as a known
     * host.
     * <p>
    ...
    /**
     * Set static attributes from a {@code java.util.Properties} object, for all views returned by this resolver.
     * <p>
    ...
    /**
     * Allow Map access to the static attributes for views returned by this resolver, with the option to add or override
     * specific entries.
     * <p>
    ...
    /**
     * Set static attributes from a Map, for all views returned by this resolver. This allows to set any kind of
     ...
     * <p>
     * >The default setting is to let each View decide (see {@link AbstractView#setExposePathVariables}. However, you
     ...
     * {@link org.springframework.web.servlet.ViewResolver}. View names can contain simple wildcards such that 'my*',
     ...
     * <p>
     * Not possible in {@code loadView}, since overridden {@code loadView} versions in subclasses might rely on the
    ...
    /**
     * Indicates whether or not this {@link org.springframework.web.servlet.ViewResolver} can handle the supplied view
     * name. If not, {@link #createView(String, java.util.Locale)} will return {@code null}. The default implementation
    ...
    /**
     * Creates a new View instance of the specified view class and configures it. Does <i>not</i> perform any lookup for
     * pre-defined View instances.
     * <p>
     * Spring lifecycle methods as defined by the bean container do not have to be called here; those will be applied by
     * the {@code loadView} method after this method returns.
     * <p>
     * Subclasses will typically call {@code super.buildView(viewName)} first, before setting further properties
     * themselves. {@code loadView} will then apply Spring lifecycle methods at the end of this process.
     * 
     * @param viewName
    ...
    /**
     * Apply the containing {@link ApplicationContext}'s lifecycle methods to the given {@link View} instance, if such a
     * context is available.
     * 
     * @param viewName
     *            the name of the view
     * @param view
     *            the freshly created View instance, pre-configured with {@link AbstractUrlBasedView}'s properties
