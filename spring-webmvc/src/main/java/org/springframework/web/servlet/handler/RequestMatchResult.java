...
/**
 * Container for the result from request pattern matching via {@link MatchableHandlerMapping} with a method to further
 * extract URI template variables from the pattern.
 *
...
public class RequestMatchResult {
     ...
     *            the matching pattern, possibly not the same as the input pattern, e.g. inputPattern="/foo" and
     *            matchingPattern="/foo/".
     * @param lookupPath
     *            the lookup path extracted from the request
     * @param pathMatcher
