...
/**
 * Default implementation of the {@link Errors} and {@link BindingResult} interfaces, for the registration and
 * evaluation of binding errors on JavaBean objects.
 *
 * <p>
 * Performs standard JavaBean property access, also supporting nested properties. Normally, application code will work
 * with the {@code Errors} interface or the {@code BindingResult} interface. A {@link DataBinder} returns its
 * {@code BindingResult} via {@link DataBinder#getBindingResult()}.
 *
...
public class BeanPropertyBindingResult extends AbstractPropertyBindingResult implements Serializable {
     ...
     *            the limit for array and collection auto-growing
     */
    ...
    /**
     * Returns the {@link BeanWrapper} that this instance uses. Creates a new one if none existed before.
     * 
