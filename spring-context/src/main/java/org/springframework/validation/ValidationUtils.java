...
/**
 * Utility class offering convenient methods for invoking a {@link Validator} and for rejecting empty fields.
 *
 * <p>
 * Checks for an empty field in {@code Validator} implementations can become one-liners when using
 * {@link #rejectIfEmpty} or {@link #rejectIfEmptyOrWhitespace}.
 *
...
public abstract class ValidationUtils {
     ...
     * 
     * @param validator
     *            the {@code Validator} to be invoked
     * @param target
     *            the object to bind the parameters to
     * @param errors
     *            the {@link Errors} instance that should store the errors
     * @throws IllegalArgumentException
     *             if either of the {@code Validator} or {@code Errors} arguments is {@code null}, or if the supplied
     *             {@code Validator} does not {@link Validator#supports(Class) support} the validation of the supplied
     *             object's type
     */
     ...
     *            one or more hint objects to be passed to the validation engine
     * @throws IllegalArgumentException
     *             if either of the {@code Validator} or {@code Errors} arguments is {@code null}, or if the supplied
     *             {@code Validator} does not {@link Validator#supports(Class) support} the validation of the supplied
     *             object's type
     ...
     * <p>
     * The object whose field is being validated does not need to be passed in because the {@link Errors} instance can
     * resolve field values by itself (it will usually hold an internal reference to the target object).
     * 
     * @param errors
     *            the {@code Errors} instance to register errors on
     * @param field
     ...
     *            the error code, interpretable as message key
     * @param errorArgs
     *            the error arguments, for argument binding via MessageFormat (can be {@code null})
     */
     ...
     * <p>
     * An 'empty' value in this context means either {@code null}, the empty string "", or consisting wholly of
     * whitespace.
     * <p>
     * The object whose field is being validated does not need to be passed in because the {@link Errors} instance can
     * resolve field values by itself (it will usually hold an internal reference to the target object).
    ...
    /**
     * Reject the given field with the given error code and default message if the value is empty or just contains
     * whitespace.
     * <p>
     * An 'empty' value in this context means either {@code null}, the empty string "", or consisting wholly of
     * whitespace.
    ...
    /**
     * Reject the given field with the given error code and error arguments if the value is empty or just contains
     * whitespace.
     * <p>
     * An 'empty' value in this context means either {@code null}, the empty string "", or consisting wholly of
     * whitespace.
    ...
    /**
     * Reject the given field with the given error code, error arguments and default message if the value is empty or
