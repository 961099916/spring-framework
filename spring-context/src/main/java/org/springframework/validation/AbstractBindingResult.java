...
/**
 * Abstract implementation of the {@link BindingResult} interface and its super-interface {@link Errors}. Encapsulates
 * common management of {@link ObjectError ObjectErrors} and {@link FieldError FieldErrors}.
 *
...
public abstract class AbstractBindingResult extends AbstractErrors implements BindingResult, Serializable {
    ...
    /**
     * This default implementation determines the type based on the actual field value, if any. Subclasses should
     * override this to determine the type from a descriptor, even for {@code null} values.
     * 
    ...
    /**
     * Return a model Map for the obtained state, exposing an Errors instance as '{@link #MODEL_KEY_PREFIX
     * MODEL_KEY_PREFIX} + objectName' and the object itself.
     * <p>
     ...
     * <p>
     * The attributes in the model Map returned by this method are usually included in the ModelAndView for a form view
     * that uses Spring's bind tag, which needs access to the Errors instance.
     * 
     * @see #getObjectName
    ...
    /**
     * This implementation delegates to the {@link #getPropertyEditorRegistry() PropertyEditorRegistry}'s editor lookup
     ...
     *            the field to check
     * @param value
     *            the value of the field (either a rejected value other than from a binding error, or an actual field
     *            value)
