 ...
 *
 * <p>
 * See the {@link DefaultMessageCodesResolver} javadoc for details on how a message code list is built for a
 * {@code FieldError}.
 *
 * @author Rod Johnson
...
public class FieldError extends ObjectError {
     ...
     *            whether this error represents a binding failure (like a type mismatch); else, it is a validation
     *            failure
     * @param codes
    ...
    /**
     * Return whether this error represents a binding failure (like a type mismatch); otherwise it is a validation
     * failure.
     */
