 ...
 *
 * <p>
 * See the {@link DefaultMessageCodesResolver} javadoc for details on how a message code list is built for an
 * {@code ObjectError}.
 *
...
public class ObjectError extends DefaultMessageSourceResolvable {
     ...
     * <p>
     * Note that any such source object is being stored as transient: that is, it won't be part of a serialized error
     * representation.
     * 
     * @param source
     *            the source object
     ...
     * {@link javax.validation.ConstraintViolation}.
     * <p>
     * The cause of the outermost exception will be introspected as well, e.g. the underlying conversion exception or
     * exception thrown from a setter (instead of having to unwrap the {@code PropertyAccessException} in turn).
     * 
     * @return the source object of the given type
     * @throws IllegalArgumentException
     *             if no such source object is available (i.e. none specified or not available anymore after
     *             deserialization)
     * @since 5.0.4
     */
