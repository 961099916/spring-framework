...
/**
 * Abstract implementation of the {@link Errors} interface. Provides common access to evaluated errors; however, does
 * not define concrete management of {@link ObjectError ObjectErrors} and {@link FieldError FieldErrors}.
 *
...
public abstract class AbstractErrors implements Errors, Serializable {
     ...
     * 
     * @param field
     *            the field that we are looking up FieldErrors for
     * @param fieldError
