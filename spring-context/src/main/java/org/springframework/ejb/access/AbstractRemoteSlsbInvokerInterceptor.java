...
/**
 * Base class for interceptors proxying remote Stateless Session Beans. Designed for EJB 2.x, but works for EJB 3
...
public abstract class AbstractRemoteSlsbInvokerInterceptor extends AbstractSlsbInvokerInterceptor {
     ...
     * <p>
     * Can be turned on to allow for hot restart of the EJB server. If a cached EJB home throws an RMI exception that
     * indicates a remote connect failure, a fresh home will be fetched and the invocation will be retried.
     * 
     ...
     * <p>
     * If configured to refresh on connect failure, it will call {@link #refreshAndRetry} on corresponding RMI
     * exceptions.
     * 
     * @see #getHome
     * @see #doInvoke
