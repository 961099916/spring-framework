 ...
 * package (JSR-223): {@link org.springframework.scripting.support.StandardScriptEvaluator}.
 *
...
public interface ScriptEvaluator {
     ...
     * 
     * @param script
     *            the ScriptSource for the script to evaluate
     * @return the return value of the script, if any
     * @throws ScriptCompilationException
     *             if the evaluator failed to read, compile or evaluate the script
     */
    @Nullable
     ...
     *            the ScriptSource for the script to evaluate
     * @param arguments
     *            the key-value pairs to expose to the script, typically as script variables (may be {@code null} or
     *            empty)
     * @return the return value of the script, if any
     * @throws ScriptCompilationException
     *             if the evaluator failed to read, compile or evaluate the script
