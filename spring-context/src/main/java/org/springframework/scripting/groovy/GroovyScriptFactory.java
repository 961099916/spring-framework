 ...
 *
 * <p>
 * Typically used in combination with a {@link org.springframework.scripting.support.ScriptFactoryPostProcessor}; see
...
public class GroovyScriptFactory implements ScriptFactory, BeanFactoryAware, BeanClassLoaderAware {
     ...
     *            a locator that points to the source of the script. Interpreted by the post-processor that actually
     *            creates the script.
     */
    ...
    /**
     * Create a new GroovyScriptFactory for the given script source, specifying a strategy interface that can create a
     * custom MetaClass to supply missing methods and otherwise change the behavior of the object.
     * 
     * @param scriptSourceLocator
     *            a locator that points to the source of the script. Interpreted by the post-processor that actually
     *            creates the script.
     * @param groovyObjectCustomizer
     *            a customizer that can set a custom metaclass or make other changes to the GroovyObject created by this
     *            factory (may be {@code null})
     ...
     *            a custom compiler configuration to be applied to the GroovyClassLoader (may be {@code null})
     * @since 4.3.3
    ...
    /**
     * Create a new GroovyScriptFactory for the given script source, specifying a strategy interface that can customize
     * Groovy's compilation process within the underlying GroovyClassLoader.
     * 
     * @param scriptSourceLocator
     *            a locator that points to the source of the script. Interpreted by the post-processor that actually
     *            creates the script.
     * @param compilationCustomizers
     *            one or more customizers to be applied to the GroovyClassLoader compiler configuration
     * @since 4.3.3
     ...
     * 
     * @param classLoader
     *            the ClassLoader to build a GroovyClassLoader for
     * @since 4.3.3
     */
     ...
     * 
     * @param scriptSource
     *            the source for the underlying script
     * @param scriptClass
