...
public interface ScriptSource {
    ...
    /**
     * Indicate whether the underlying script data has been modified since the last time {@link #getScriptAsString()}
     * was called. Returns {@code true} if the script has not been read yet.
     * 
