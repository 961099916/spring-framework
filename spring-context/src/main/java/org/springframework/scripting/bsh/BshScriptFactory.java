...
public class BshScriptFactory implements ScriptFactory, BeanClassLoaderAware {
     ...
     * <p>
     * With this {@code BshScriptFactory} variant, the script needs to declare a full class or return an actual instance
     ...
     *            the Java interfaces that the scripted object is supposed to implement (may be {@code null})
     */
        ...
        synchronized (this.scriptClassMonitor) {
            try {
                if (scriptSource.isModified()) {
                    ...
                    this.scriptClass =
                        BshScriptUtils.determineBshObjectType(scriptSource.getScriptAsString(), this.beanClassLoader);
                }
