...
/**
 * Subclass of {@link BeanFactoryRefreshableTargetSource} that determines whether a refresh is required through the
 * given {@link ScriptFactory}.
 *
 * @author Rob Harrop
...
public class RefreshableScriptTargetSource extends BeanFactoryRefreshableTargetSource {
     ...
     * 
     * @param beanFactory
     *            the BeanFactory to fetch the scripted bean from
     * @param beanName
     *            the name of the target bean
     * @param scriptFactory
     *            the ScriptFactory to delegate to for determining whether a refresh is required
     * @param scriptSource
     *            the ScriptSource for the script definition
     * @param isFactoryBean
    ...
    /**
     * Determine whether a refresh is required through calling ScriptFactory's {@code requiresScriptedObjectRefresh}
     * method.
     * 
