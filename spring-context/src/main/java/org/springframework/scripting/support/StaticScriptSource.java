...
/**
 * Static implementation of the {@link org.springframework.scripting.ScriptSource} interface, encapsulating a given
 * String that contains the script source text. Supports programmatic updates of the script String.
 *
 * @author Rob Harrop
...
public class StaticScriptSource implements ScriptSource {
     ...
     *            the script String
     * @param className
     *            the suggested class name for the script (may be {@code null})
     */
