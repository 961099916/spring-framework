...
/**
 * Exception decorating a {@link javax.script.ScriptException} coming out of JSR-223 script evaluation, i.e. a
 * {@link javax.script.ScriptEngine#eval} call or {@link javax.script.Invocable#invokeMethod} /
 * {@link javax.script.Invocable#invokeFunction} call.
 *
 * <p>
 * This exception does not print the Java stacktrace, since the JSR-223 {@link ScriptException} results in a rather
 * convoluted text output. From that perspective, this exception is primarily a decorator for a {@link ScriptException}
