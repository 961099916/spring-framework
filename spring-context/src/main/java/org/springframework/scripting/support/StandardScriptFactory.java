...
/**
 * {@link org.springframework.scripting.ScriptFactory} implementation based on the JSR-223 script engine abstraction (as
 * included in Java 6+). Supports JavaScript, Groovy, JRuby, and other JSR-223 compliant engines.
 *
 * <p>
...
public class StandardScriptFactory implements ScriptFactory, BeanClassLoaderAware {
     ...
     *            the name of the JSR-223 ScriptEngine to use (explicitly given instead of inferred from the script
     *            source)
     * @param scriptSourceLocator
     *            a locator that points to the source of the script. Interpreted by the post-processor that actually
     *            creates the script.
