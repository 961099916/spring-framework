 ...
 * {@link org.springframework.core.io.Resource} abstraction. Loads the script text from the underlying Resource's
 * {@link org.springframework.core.io.Resource#getFile() File} or
 * {@link org.springframework.core.io.Resource#getInputStream() InputStream}, and tracks the last-modified timestamp of
...
public class ResourceScriptSource implements ScriptSource {
     ...
     * 
     * @param resource
     *            the EncodedResource to load the script from
     */
     ...
     * 
     * @param resource
     *            the Resource to load the script from (using UTF-8 encoding)
     */
     ...
     * <p>
     * The default value for regular Resources is "UTF-8". A {@code null} value implies the platform default.
     */
