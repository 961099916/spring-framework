...
/**
 * {@link FactoryBean} that obtains a WebSphere {@link javax.management.MBeanServer} reference through WebSphere's
 * proprietary {@code AdminServiceFactory} API, available on WebSphere 5.1 and higher.
 *
 * <p>
 * Exposes the {@code MBeanServer} for bean references.
 *
 * <p>
 * This {@code FactoryBean} is a direct alternative to {@link MBeanServerFactoryBean}, which uses standard JMX 1.2 API
 * to access the platform's {@link MBeanServer}.
 *
 * <p>
