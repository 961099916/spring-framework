...
/**
 * {@link FactoryBean} that creates a JMX 1.2 {@code MBeanServerConnection} to a remote {@code MBeanServer} exposed via
 * a {@code JMXServerConnector}. Exposes the {@code MBeanServer} for bean references.
 *
 * @author Rob Harrop
...
public class MBeanServerConnectionFactoryBean
    ...
    /**
     * Set the environment properties used to construct the {@code JMXConnector} as {@code java.util.Properties} (String
     * key/value pairs).
     */
     ...
     * <p>
     * Can be turned off to allow for late start of the JMX server. In this case, the JMX connector will be fetched on
     * first access.
     */
    ...
    /**
     * Lazily creates a {@code JMXConnector} using the configured service URL and environment properties.
     * 
