...
public final class ObjectNameManager {
     ...
     * 
     * @param objectName
     *            the {@code ObjectName} in {@code ObjectName} or {@code String} format
     ...
     * 
     * @param objectName
     *            the {@code ObjectName} in {@code String} format
     * @return the {@code ObjectName} instance
     * @throws MalformedObjectNameException
     *             in case of an invalid object name specification
     * @see ObjectName#ObjectName(String)
    ...
    /**
     * Retrieve an {@code ObjectName} instance for the specified domain and a single property with the supplied key and
     * value.
     * 
     * @param domainName
     *            the domain name for the {@code ObjectName}
     * @param key
     *            the key for the single property in the {@code ObjectName}
     * @param value
     *            the value for the single property in the {@code ObjectName}
     * @return the {@code ObjectName} instance
     * @throws MalformedObjectNameException
     *             in case of an invalid object name specification
     ...
     *            the domain name for the {@code ObjectName}
     * @param properties
     *            the properties for the {@code ObjectName}
     * @return the {@code ObjectName} instance
     * @throws MalformedObjectNameException
     *             in case of an invalid object name specification
