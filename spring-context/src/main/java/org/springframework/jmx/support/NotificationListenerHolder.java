 ...
 * {@link javax.management.NotificationFilter}, and an arbitrary handback object, as well as the names of MBeans from
 * which the listener wishes to receive {@link javax.management.Notification Notifications}.
 *
...
public class NotificationListenerHolder {
    ...
    /**
     * Set the {@link javax.management.NotificationFilter} associated with the encapsulated
     * {@link #getNotificationFilter() NotificationFilter}.
     * <p>
     * May be {@code null}.
     */
     ...
     *
     * @param handback
     *            the handback object (can be {@code null})
     * @see javax.management.NotificationListener#handleNotification(javax.management.Notification, Object)
     */
    ...
    /**
     * Set the {@link javax.management.ObjectName}-style name of the single MBean that the encapsulated
     * {@link #getNotificationFilter() NotificationFilter} will be registered with to listen for
     * {@link javax.management.Notification Notifications}. Can be specified as {@code ObjectName} instance or as
     * {@code String}.
     * 
    ...
    public void setMappedObjectName(@Nullable Object mappedObjectName) {
        this.mappedObjectNames =
            (mappedObjectName != null ? new LinkedHashSet<>(Collections.singleton(mappedObjectName)) : null);
    }

    /**
     * Set an array of {@link javax.management.ObjectName}-style names of the MBeans that the encapsulated
     * {@link #getNotificationFilter() NotificationFilter} will be registered with to listen for
     * {@link javax.management.Notification Notifications}. Can be specified as {@code ObjectName} instances or as
     * {@code String}s.
     * 
    ...
    /**
     * Return the list of {@link javax.management.ObjectName} String representations for which the encapsulated
     * {@link #getNotificationFilter() NotificationFilter} will be registered as a listener for
     * {@link javax.management.Notification Notifications}.
     * 
     * @throws MalformedObjectNameException
     *             if an {@code ObjectName} is malformed
     */
    @Nullable
