...
/**
 * {@link FactoryBean} that creates a JSR-160 {@link JMXConnectorServer}, optionally registers it with the
 * {@link MBeanServer}, and then starts it.
 *
 * <p>
 * The {@code JMXConnectorServer} can be started in a separate thread by setting the {@code threaded} property to
 * {@code true}. You can configure this thread to be a daemon thread by setting the {@code daemon} property to
 * {@code true}.
 *
 * <p>
 * The {@code JMXConnectorServer} is correctly shut down when an instance of this class is destroyed on shutdown of the
 * containing {@code ApplicationContext}.
 *
 * @author Rob Harrop
...
public class ConnectorServerFactoryBean extends MBeanRegistrationSupport
    ...
    /**
     * Set the environment properties used to construct the {@code JMXConnectorServer} as {@code java.util.Properties}
    ...
    /**
     * Set the environment properties used to construct the {@code JMXConnector} as a {@code Map} of String keys and
    ...
    /**
     * Set the {@code ObjectName} used to register the {@code JMXConnectorServer} itself with the {@code MBeanServer},
     * as {@code ObjectName} instance or as {@code String}.
     * 
     * @throws MalformedObjectNameException
     *             if the {@code ObjectName} is malformed
     */
    ...
    /**
     * Start the connector server. If the {@code threaded} flag is set to {@code true}, the {@code JMXConnectorServer}
     * will be started in a separate thread. If the {@code daemon} flag is set to {@code true}, that thread will be
     * started as a daemon thread.
     * 
     * @throws JMException
     *             if a problem occurred when registering the connector server with the {@code MBeanServer}
     * @throws IOException
    ...
    /**
     * Stop the {@code JMXConnectorServer} managed by an instance of this class. Automatically called on
     * {@code ApplicationContext} shutdown.
     * 
     * @throws IOException
