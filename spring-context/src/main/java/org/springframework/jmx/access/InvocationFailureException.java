...
/**
 * Thrown when an invocation on an MBean resource failed with an exception (either a reflection exception or an
 * exception thrown by the target method itself).
 *
