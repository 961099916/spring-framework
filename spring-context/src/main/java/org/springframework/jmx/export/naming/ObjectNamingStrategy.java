...
public interface ObjectNamingStrategy {
     ...
     * 
     * @param managedBean
     *            the bean that will be exposed under the returned {@code ObjectName}
     * @param beanKey
     *            the key associated with this bean in the beans map passed to the {@code MBeanExporter}
     * @return the {@code ObjectName} instance
     * @throws MalformedObjectNameException
     *             if the resulting {@code ObjectName} is invalid
     */
