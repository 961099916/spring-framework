...
/**
 * Implementation of the {@code JmxAttributeSource} interface that reads annotations and exposes the corresponding
 * attributes.
 *
 * @author Rob Harrop
...
public class AnnotationJmxAttributeSource implements JmxAttributeSource, BeanFactoryAware {
    ...
    public org.springframework.jmx.export.metadata.ManagedOperationParameter[]
        ...
        List<MergedAnnotation<? extends Annotation>> anns =
            getRepeatableAnnotations(method, ManagedOperationParameter.class, ManagedOperationParameters.class);
