 ...
 * context ClassLoader} is switched for the managed resource's {@link ClassLoader} before any invocations occur.
 *
 * @author Rob Harrop
 * @since 2.0
...
public class SpringModelMBean extends RequiredModelMBean {
    ...
    /**
     * Switches the {@link Thread#getContextClassLoader() context ClassLoader} for the managed resources
     * {@link ClassLoader} before allowing the invocation to occur.
     * 
