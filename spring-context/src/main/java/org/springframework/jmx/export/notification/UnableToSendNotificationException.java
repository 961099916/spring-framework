 ...
 *
 * <p>
 * The root cause of just why a particular notification could not be sent will <i>typically</i> be available via the
 * {@link #getCause()} property.
 *
 * @author Rob Harrop
 * @since 2.0
...
public class UnableToSendNotificationException extends JmxException {
    ...
    /**
     * Create a new instance of the {@link UnableToSendNotificationException} with the specified error message and root
     * cause.
     * 
     * @param msg
     *            the detail message
