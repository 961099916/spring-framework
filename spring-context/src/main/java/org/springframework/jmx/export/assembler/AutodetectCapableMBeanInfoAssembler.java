...
/**
 * Extends the {@code MBeanInfoAssembler} to add autodetection logic. Implementations of this interface are given the
 * opportunity by the {@code MBeanExporter} to include additional beans in the registration process.
 *
 * <p>
...
public interface AutodetectCapableMBeanInfoAssembler extends MBeanInfoAssembler {
     ...
     * {@code beans} map of the {@code MBeanExporter}.
     * 
     * @param beanClass
     *            the class of the bean (might be a proxy class)
     * @param beanName
