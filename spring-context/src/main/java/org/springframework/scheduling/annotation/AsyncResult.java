...
/**
 * A pass-through {@code Future} handle that can be used for method signatures which are declared with a {@code Future}
 * return type for asynchronous execution.
 *
 * <p>
 * As of Spring 4.1, this class implements {@link ListenableFuture}, not just plain {@link java.util.concurrent.Future},
 * along with the corresponding support in {@code @Async} processing.
 *
 * <p>
...
public class AsyncResult<V> implements ListenableFuture<V> {
    ...
    /**
     * Create a new async result which exposes the given exception as an {@link ExecutionException} from
     * {@link Future#get()}.
     *
     * @param ex
     *            the exception to expose (either an pre-built {@link ExecutionException} or a cause to be wrapped in an
    ...
    /**
     * Determine the exposed exception: either the cause of a given {@link ExecutionException}, or the original
     * exception as-is.
     *
     * @param original
     *            the original as given to {@link #forExecutionException}
