 ...
 *
 * <p>
 * As of Spring 3.1, {@code ScheduledTaskRegistrar} has a more prominent user-facing role when used in conjunction with
 * the {@link org.springframework.scheduling.annotation.EnableAsync @EnableAsync} annotation and its
 * {@link org.springframework.scheduling.annotation.SchedulingConfigurer SchedulingConfigurer} callback interface.
 *
...
public class ScheduledTaskRegistrar implements ScheduledTaskHolder, InitializingBean, DisposableBean {
     ...
     * <p>
     * This is primarily meant for use with {@link #addCronTask(Runnable, String)} when the value for the supplied
     * {@code expression} is retrieved from an external source &mdash; for example, from a property in the
     ...
     * {@link java.util.concurrent.ScheduledExecutorService} to be wrapped as a {@code TaskScheduler}.
     */
    ...
    /**
     * Specify triggered tasks as a Map of Runnables (the tasks) and Trigger objects (typically custom implementations
     * of the {@link Trigger} interface).
     */
    ...
    /**
     * Specify triggered tasks as a list of {@link TriggerTask} objects. Primarily used by {@code <task:*>} namespace
     * parsing.
     * 
     * @since 3.2
    ...
    /**
     * Specify triggered tasks as a list of {@link CronTask} objects. Primarily used by {@code <task:*>} namespace
     * parsing.
     * 
     * @since 3.2
     * @see ScheduledTasksBeanDefinitionParser
    ...
    /**
     * Specify fixed-rate tasks as a list of {@link IntervalTask} objects. Primarily used by {@code <task:*>} namespace
     * parsing.
     * 
     * @since 3.2
     * @see ScheduledTasksBeanDefinitionParser
    ...
    /**
     * Specify fixed-delay tasks as a list of {@link IntervalTask} objects. Primarily used by {@code <task:*>} namespace
     * parsing.
     * 
     * @since 3.2
     * @see ScheduledTasksBeanDefinitionParser
     ...
     * <p>
     * As of Spring Framework 5.2, this method will not register the task if the {@code expression} is equal to
     * {@link #CRON_DISABLED}.
     */
    ...
    /**
     * Schedule all registered tasks against the underlying {@linkplain #setTaskScheduler(TaskScheduler) task
     * scheduler}.
     */
     ...
     * 
     * @return a handle to the scheduled task, allowing to cancel it (or {@code null} if processing a previously
     *         registered task)
     * @since 4.3
     */
    @Nullable
