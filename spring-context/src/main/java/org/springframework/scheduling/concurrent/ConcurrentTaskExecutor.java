 ...
 * {@code java.util.concurrent.ExecutorService}, adapting the {@link org.springframework.core.task.AsyncTaskExecutor}
 * interface accordingly.
 *
 * <p>
 * Autodetects a JSR-236 {@link javax.enterprise.concurrent.ManagedExecutorService} in order to expose
 * {@link javax.enterprise.concurrent.ManagedTask} adapters for it, exposing a long-running hint based on
 * {@link SchedulingAwareRunnable} and an identity name based on the given Runnable/Callable's {@code toString()}. For
 * JSR-236 style lookup in a Java EE 7 environment, consider using {@link DefaultManagedTaskExecutor}.
 *
 * <p>
 * Note that there is a pre-built {@link ThreadPoolTaskExecutor} that allows for defining a
 * {@link java.util.concurrent.ThreadPoolExecutor} in bean style, exposing it as a Spring
 * {@link org.springframework.core.task.TaskExecutor} directly. This is a convenient alternative to a raw
...
public class ConcurrentTaskExecutor implements AsyncListenableTaskExecutor, SchedulingTaskExecutor {
     ...
     * <p>
     * Autodetects a JSR-236 {@link javax.enterprise.concurrent.ManagedExecutorService} in order to expose
     * {@link javax.enterprise.concurrent.ManagedTask} adapters for it.
     * 
     * @param executor
    ...
    /**
     * TaskExecutorAdapter subclass that wraps all provided Runnables and Callables with a JSR-236 ManagedTask, exposing
     * a long-running hint based on {@link SchedulingAwareRunnable} and an identity name based on the task's
     ...
     * {@link SchedulingAwareRunnable} and a given identity name.
     */
