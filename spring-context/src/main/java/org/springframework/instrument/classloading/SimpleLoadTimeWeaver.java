 ...
 *
 * <p>
 * Mainly intended for testing environments, where it is sufficient to perform all class transformation on a newly
 * created {@code ClassLoader} instance.
 *
 * @author Rod Johnson
...
public class SimpleLoadTimeWeaver implements LoadTimeWeaver {
     ...
     * 
     * @param classLoader
     *            the {@code ClassLoader} to build a simple instrumentable {@code ClassLoader} on top of
     */
