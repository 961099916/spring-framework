...
/**
 * ClassLoader decorator that shadows an enclosing ClassLoader, applying registered transformers to all affected
 * classes.
 *
 * @author Rob Harrop
...
public class ShadowingClassLoader extends DecoratingClassLoader {
    ...
    /**
     * Create a new ShadowingClassLoader, decorating the given ClassLoader, applying {@link #DEFAULT_EXCLUDED_PACKAGES}.
     * 
     * @param enclosingClassLoader
