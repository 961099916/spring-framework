...
/**
 * ClassLoader that can be used to load classes without bringing them into the parent loader. Intended to support JPA
 * "temp class loader" requirement, but not JPA-specific.
 *
 * @author Rod Johnson
 * @since 2.0
 */
