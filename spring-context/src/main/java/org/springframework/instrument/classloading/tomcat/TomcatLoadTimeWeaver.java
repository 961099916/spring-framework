...
/**
 * {@link org.springframework.instrument.classloading.LoadTimeWeaver} implementation for Tomcat's new
 * {@code org.apache.tomcat.InstrumentableClassLoader}. Also capable of handling Spring's
...
public class TomcatLoadTimeWeaver implements LoadTimeWeaver {
    ...
    /**
     * Create a new instance of the {@link TomcatLoadTimeWeaver} class using the default {@link ClassLoader class
     * loader}.
     * 
    ...
    /**
     * Create a new instance of the {@link TomcatLoadTimeWeaver} class using the supplied {@link ClassLoader}.
     * 
     * @param classLoader
