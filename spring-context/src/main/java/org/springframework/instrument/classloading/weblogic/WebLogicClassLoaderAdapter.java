...
/**
 * Reflective wrapper around a WebLogic 10 class loader. Used to encapsulate the classloader-specific methods
    ...
    public WebLogicClassLoaderAdapter(ClassLoader classLoader) {
        ...
        try {
            ...
            this.wlGenericClassLoaderConstructor =
                wlGenericClassLoaderClass.getConstructor(this.getClassFinderMethod.getReturnType(), ClassLoader.class);
        } catch (Throwable ex) {
