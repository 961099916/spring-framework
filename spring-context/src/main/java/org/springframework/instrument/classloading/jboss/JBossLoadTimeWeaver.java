...
/**
 * {@link LoadTimeWeaver} implementation for JBoss's instrumentable ClassLoader. Thanks to Ales Justin and Marius
 * Bogoevici for the initial prototype.
 *
 * <p>
 * As of Spring Framework 5.0, this weaver supports WildFly 8+. As of Spring Framework 5.1.5, it also supports WildFly
 * 13+.
 *
 * @author Costin Leau
...
public class JBossLoadTimeWeaver implements LoadTimeWeaver {
    ...
    /**
     * Create a new instance of the {@link JBossLoadTimeWeaver} class using the default {@link ClassLoader class
     * loader}.
     * 
    ...
    /**
     * Create a new instance of the {@link JBossLoadTimeWeaver} class using the supplied {@link ClassLoader}.
     * 
     * @param classLoader
     *            the {@code ClassLoader} to delegate to for weaving
     */
