...
/**
 * Helper class that simplifies JNDI operations. It provides methods to lookup and bind objects, and allows
 * implementations of the {@link JndiCallback} interface to perform any operation they like with a JNDI naming context
 * provided.
 *
 * @author Rod Johnson
...
public class JndiTemplate {
     ...
     *            the JndiCallback implementation to use
    ...
    /**
     * Obtain a JNDI context corresponding to this template's configuration. Called by {@link #execute}; may also be
     * called directly.
     * <p>
     ...
     * 
     * @param ctx
     *            the JNDI context to release (may be {@code null})
     * @see #getContext
     */
     ...
     * <p>
     * The default implementation use this template's environment settings. Can be subclassed for custom contexts, e.g.
     * for testing.
     * 
     ...
     * @return object found (cannot be {@code null}; if a not so well-behaved JNDI implementations returns null, a
     *         NamingException gets thrown)
     * @throws NamingException
     ...
     *            the JNDI name of the object
     * @param requiredType
     *            type the JNDI object must match. Can be an interface or superclass of the actual class, or
     *            {@code null} for any match. For example, if the value is {@code Object.class}, this method will
