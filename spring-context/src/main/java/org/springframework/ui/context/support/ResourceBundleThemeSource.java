...
/**
 * {@link ThemeSource} implementation that looks up an individual {@link java.util.ResourceBundle} per theme. The theme
 * name gets interpreted as ResourceBundle basename, supporting a common basename prefix for all themes.
 *
...
public class ResourceBundleThemeSource implements HierarchicalThemeSource, BeanClassLoaderAware {
     ...
     * <p>
     * {@link ResourceBundleMessageSource}'s default is the {@code java.util.ResourceBundle} default encoding:
     * ISO-8859-1.
     * 
     * @since 4.2
     ...
     * corresponds to the given theme name (prefixed by the configured "basenamePrefix").
     * <p>
     * SimpleTheme instances are cached per theme name. Use a reloadable MessageSource if themes should reflect changes
     ...
     * <p>
     * Default implementation creates a ResourceBundleMessageSource. for the given basename. A subclass could create a
     * specifically configured ReloadableResourceBundleMessageSource, for example.
     * 
     * @param basename
