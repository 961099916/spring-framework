 ...
 * {@link org.springframework.remoting.support.RemoteInvocationResult} objects, for example Spring's HTTP invoker.
 *
 * <p>
 * Provides template methods for {@code ObjectInputStream} and {@code ObjectOutputStream} handling.
 *
...
public abstract class RemoteInvocationSerializingExporter extends RemoteInvocationBasedExporter
     ...
     * <p>
     * The default implementation simply calls {@link java.io.ObjectInputStream#readObject()}. Can be overridden for
     * deserialization of a custom wrapper object rather than the plain invocation, for example an encryption-aware
     * holder.
     * 
     * @param ois
     ...
     * <p>
     * The default implementation simply calls {@link java.io.ObjectOutputStream#writeObject}. Can be overridden for
     * serialization of a custom wrapper object rather than the plain invocation, for example an encryption-aware
     * holder.
     * 
     * @param result
