 ...
 *
 * <p>
 * Exports services via the {@link javax.rmi.PortableRemoteObject} class. You need to run "rmic" with the "-iiop" option
 * to generate corresponding stubs and skeletons for each exported service.
 *
 * <p>
 * Also supports exposing any non-RMI service via RMI invokers, to be accessed via {@link JndiRmiClientInterceptor} /
 * {@link JndiRmiProxyFactoryBean}'s automatic detection of such invokers.
 *
 * <p>
 ...
 *
 * <p>
 * The JNDI environment can be specified as "jndiEnvironment" bean property, or be configured in a
...
public class JndiRmiServiceExporter extends RmiBasedExporter implements InitializingBean, DisposableBean {
    ...
    /**
     * Set the JNDI template to use for JNDI lookups. You can also specify JNDI environment settings via
     * "jndiEnvironment".
     * 
     * @see #setJndiEnvironment
     */
