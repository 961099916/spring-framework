...
public interface HierarchicalMessageSource extends MessageSource {
     ...
     *
     * @param parent
     *            the parent MessageSource that will be used to resolve messages that this object can't resolve. May be
     *            {@code null}, in which case no further resolution is possible.
     */
