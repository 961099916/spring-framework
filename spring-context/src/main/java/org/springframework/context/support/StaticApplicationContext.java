...
/**
 * {@link org.springframework.context.ApplicationContext} implementation which supports programmatic registration of
 * beans and messages, rather than reading bean definitions from external configuration sources. Mainly useful for
 * testing.
 *
 * @author Rod Johnson
...
public class StaticApplicationContext extends GenericApplicationContext {
     ...
     *            lookup code
     * @param locale
     *            the locale message should be found within
