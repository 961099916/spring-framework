...
/**
 * {@link AbstractRefreshableApplicationContext} subclass that adds common handling of specified config locations.
 * Serves as base class for XML-based application context implementations such as {@link ClassPathXmlApplicationContext}
 * and {@link FileSystemXmlApplicationContext}, as well as
...
public abstract class AbstractRefreshableConfigApplicationContext extends AbstractRefreshableApplicationContext
     ...
     * built with. Can also include location patterns, which will get resolved via a ResourcePatternResolver.
     * <p>
    ...
    /**
     * Sets the id of this context to the bean name by default, for cases where the context instance is itself defined
     * as a bean.
     */
    @Override
