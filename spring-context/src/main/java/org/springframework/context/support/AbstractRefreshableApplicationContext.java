 ...
 * multiple calls to {@link #refresh()}, creating a new internal bean factory instance every time. Typically (but not
 * necessarily), such a context will be driven by a set of config locations to load bean definitions from.
 *
 * <p>
 ...
 * {@link org.springframework.context.annotation.AnnotationConfigApplicationContext} supports
...
public abstract class AbstractRefreshableApplicationContext extends AbstractApplicationContext {
     ...
     * previous bean factory (if any) and initializing a fresh bean factory for the next phase of the context's
     * lifecycle.
     */
    @Override
    ...
    /**
     * Overridden to turn it into a no-op: With AbstractRefreshableApplicationContext, {@link #getBeanFactory()} serves
     * a strong assertion for an active context anyway.
     */
    @Override
     ...
     * with the {@linkplain #getInternalParentBeanFactory() internal bean factory} of this context's parent as parent
     * bean factory. Can be overridden in subclasses, for example to customize DefaultListableBeanFactory's settings.
     * 
     ...
     * <p>
     * The default implementation applies this context's {@linkplain #setAllowBeanDefinitionOverriding
     * "allowBeanDefinitionOverriding"} and {@linkplain #setAllowCircularReferences "allowCircularReferences"} settings,
     * if specified. Can be overridden in subclasses to customize any of {@link DefaultListableBeanFactory}'s settings.
     * 
     * @param beanFactory
