...
/**
 * Helper class that allows for accessing a Spring {@link org.springframework.context.MessageSource} as a
 * {@link java.util.ResourceBundle}. Used for example to expose a Spring MessageSource to JSTL web views.
 *
...
public class MessageSourceResourceBundle extends ResourceBundle {
    ...
    /**
     * This implementation resolves the code in the MessageSource. Returns {@code null} if the message could not be
     * resolved.
     */
    @Override
    @Nullable
     ...
     * {@code NoSuchMessageException} accordingly. In contrast to ResourceBundle's default implementation in JDK 1.6,
     * this does not rely on the capability to enumerate message keys.
     */
    @Override
    ...
    /**
     * This implementation throws {@code UnsupportedOperationException}, as a MessageSource does not allow for
     * enumerating the defined message codes.
     */
    @Override
