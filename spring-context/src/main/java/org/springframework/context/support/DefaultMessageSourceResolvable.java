...
/**
 * Spring's default implementation of the {@link MessageSourceResolvable} interface. Offers an easy way to store all the
 * necessary values needed to resolve a message via a {@link org.springframework.context.MessageSource}.
 *
...
public class DefaultMessageSourceResolvable implements MessageSourceResolvable, Serializable {
     ...
     * {@link java.text.MessageFormat} escaping.
     * 
     * @return {@code true} if the default message may contain argument placeholders; {@code false} if it definitely
     *         does not contain placeholders or custom escaping and can therefore be simply exposed as-is
     * @since 5.1.7
    ...
    /**
     * Build a default String representation for this MessageSourceResolvable: including codes, arguments, and default
     * message.
     */
