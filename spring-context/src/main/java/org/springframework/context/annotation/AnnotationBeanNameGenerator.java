 ...
 * {@link org.springframework.stereotype.Component @Component} annotation or with another annotation that is itself
 * annotated with {@code @Component} as a meta-annotation. For example, Spring's stereotype annotations (such as
 * {@link org.springframework.stereotype.Repository @Repository}) are themselves annotated with {@code @Component}.
 *
 * <p>
 ...
 *
 * <p>
 * If the annotation's value doesn't indicate a bean name, an appropriate name will be built based on the short name of
 * the class (with the first letter lower-cased). For example:
 *
 * <pre class="code">
...
public class AnnotationBeanNameGenerator implements BeanNameGenerator {
     ...
     * Derive a default bean name from the given bean definition.
     * <p>
     * The default implementation simply builds a decapitalized version of the short class name: e.g.
     * "mypackage.MyJdbcDao" -> "myJdbcDao".
     * <p>
     * Note that inner classes will thus have names of the form "outerClassName.InnerClassName", which because of the
     * period in the name may be an issue if you are autowiring by name.
     * 
     * @param definition
     *            the bean definition to build a bean name for
     * @return the default bean name (never {@code null})
