...
/**
 * Common delegate code for the handling of parser strategies, e.g. {@code TypeFilter}, {@code ImportSelector},
...
abstract class ParserStrategyUtils {
    ...
    /**
     * Instantiate a class using an appropriate constructor and return the new instance as the specified assignable
     * type. The returned instance will have {@link BeanClassLoaderAware}, {@link BeanFactoryAware},
     * {@link EnvironmentAware}, and {@link ResourceLoaderAware} contracts invoked if they are implemented by the given
     * object.
     * 
     * @since 5.2
     */
    ...
    private static Object createInstance(Class<?> clazz, Environment environment, ResourceLoader resourceLoader,
        ...
        if (constructors.length == 1 && constructors[0].getParameterCount() > 0) {
            try {
                ...
                Object[] args =
                    resolveArgs(constructor.getParameterTypes(), environment, resourceLoader, registry, classLoader);
