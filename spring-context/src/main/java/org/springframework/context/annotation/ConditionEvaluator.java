...
class ConditionEvaluator {
    ...
    /**
     * Determine if an item should be skipped based on {@code @Conditional} annotations. The {@link ConfigurationPhase}
     * will be deduced from the type of item (i.e. a {@code @Configuration} class will be
