...
/**
 * Simple {@link ScopeMetadataResolver} implementation that follows JSR-330 scoping rules: defaulting to prototype scope
 * unless {@link javax.inject.Singleton} is present.
 *
 * <p>
 * This scope resolver can be used with {@link ClassPathBeanDefinitionScanner} and {@link AnnotatedBeanDefinitionReader}
 * for standard JSR-330 compliance. However, in practice, you will typically use Spring's rich default scoping instead -
 * or extend this resolver with custom scoping annotations that point to extended Spring scopes.
 *
...
public class Jsr330ScopeMetadataResolver implements ScopeMetadataResolver {
     ...
     *            the JSR-330 annotation type as a Class
     * @param scopeName
     ...
     * <p>
     * The default implementation simply checks against registered scopes. Can be overridden for custom mapping rules,
