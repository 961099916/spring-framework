 ...
 *
 * <p>
 * This class was modeled after the {@link BeanDefinitionReader} hierarchy, but does not implement/extend any of its
 * artifacts as a set of configuration classes is not a {@link Resource}.
 *
 * @author Chris Beams
...
class ConfigurationClassBeanDefinitionReader {
    ...
    /**
     * Read a particular {@link ConfigurationClass}, registering bean definitions for the class itself and all of its
     * {@link Bean} methods.
     */
    ...
    /**
     * Read the given {@link BeanMethod}, registering bean definitions with the BeanDefinitionRegistry based on its
     * contents.
     */
    ...
    private void
        loadBeanDefinitionsFromImportedResources(Map<String, Class<? extends BeanDefinitionReader>> importedResources) {
    ...
    /**
     * {@link RootBeanDefinition} marker subclass used to signify that a bean definition was created from a
     * configuration class as opposed to any other configuration source. Used in bean overriding cases where it's
     * necessary to determine whether the bean definition was created externally.
     */
