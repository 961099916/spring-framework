...
/**
 * Configures component scanning directives for use with @{@link Configuration} classes. Provides support parallel with
 * Spring XML's {@code <context:component-scan>} element.
 *
 * <p>
 ...
 *
 * <p>
 * Note that the {@code <context:component-scan>} element has an {@code annotation-config} attribute; however, this
 * annotation does not. This is because in almost all cases when using {@code @ComponentScan}, default annotation config
 * processing (e.g. processing {@code @Autowired} and friends) is assumed. Furthermore, when using
 * {@link AnnotationConfigApplicationContext}, annotation config processors are always registered, meaning that any
 * attempt to disable them at the {@code @ComponentScan} level would be ignored.
 *
 * <p>
...
public @interface ComponentScan {
    ...
    /**
     * Declares the type filter to be used as an {@linkplain ComponentScan#includeFilters include filter} or
     * {@linkplain ComponentScan#excludeFilters exclude filter}.
     */
    @Retention(RetentionPolicy.RUNTIME)
    @Target({})
    @interface Filter {
         ...
         * <p>
         * The following table explains how the classes will be interpreted based on the configured value of the
         * {@link #type} attribute.
         * <table border="1">
         * <tr>
         ...
         * </table>
         * <p>
         * When multiple classes are specified, <em>OR</em> logic is applied &mdash; for example, "include types
         * annotated with {@code @Foo} OR {@code @Bar}".
         * <p>
         * Custom {@link TypeFilter TypeFilters} may optionally implement any of the following
         * {@link org.springframework.beans.factory.Aware Aware} interfaces, and their respective methods will be called
         * prior to {@link TypeFilter#match match}:
         * <ul>
         ...
         * <p>
         * If {@link #type} is set to {@link FilterType#ASPECTJ ASPECTJ}, this is an AspectJ type pattern expression. If
         * {@link #type} is set to {@link FilterType#REGEX REGEX}, this is a regex pattern for the fully-qualified class
         * names to match.
         * 
         * @see #type
         * @see #classes
