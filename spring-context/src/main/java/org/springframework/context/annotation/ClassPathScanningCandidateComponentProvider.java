...
/**
 * A component provider that provides candidate components from a base package. Can use {@link CandidateComponentsIndex
 * the index} if it is available of scans the classpath otherwise. Candidate components are identified by applying
 * exclude and include filters. {@link AnnotationTypeFilter}, {@link AssignableTypeFilter} include filters on an
 * annotation/superclass that are annotated with {@link Indexed} are supported: if any other include filter is
 * specified, the index is ignored and classpath scanning is used instead.
 *
 * <p>
...
public class ClassPathScanningCandidateComponentProvider implements EnvironmentCapable, ResourceLoaderAware {
     ...
     *            whether to register the default filters for the {@link Component @Component},
     *            {@link Repository @Repository}, {@link Service @Service}, and {@link Controller @Controller}
     ...
     * 
     * @param useDefaultFilters
     *            whether to re-register the default filters for the {@link Component @Component},
     *            {@link Repository @Repository}, {@link Service @Service}, and {@link Controller @Controller}
     *            stereotype annotations
     * @see #registerDefaultFilters()
     */
    ...
    /**
     * Set the Environment to use when resolving placeholders and evaluating {@link Conditional @Conditional}-annotated
     * component classes.
     * <p>
    ...
    /**
     * Set the {@link ResourceLoader} to use for resource locations. This will typically be a
     * {@link ResourcePatternResolver} implementation.
     * <p>
     * Default is a {@code PathMatchingResourcePatternResolver}, also capable of resource pattern resolving through the
     * {@code ResourcePatternResolver} interface.
     *
     ...
     * <p>
     * Default is a {@link CachingMetadataReaderFactory} for the specified {@linkplain #setResourceLoader resource
     * loader}.
     * <p>
     * Call this setter method <i>after</i> {@link #setResourceLoader} in order for the given MetadataReaderFactory to
     ...
     * 
     * @return {@code true} if the index is available and the configuration of this instance is supported by it,
