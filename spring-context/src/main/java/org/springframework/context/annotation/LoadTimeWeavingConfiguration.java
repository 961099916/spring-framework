 ...
 *
 * <p>
 * This configuration class is automatically imported when using the {@link EnableLoadTimeWeaving} annotation. See
 * {@code @EnableLoadTimeWeaving} javadoc for complete usage details.
 *
 * @author Chris Beams
 * @since 3.1
