...
/**
 * {@link org.springframework.context.ApplicationListener} decorator that filters events from a specified event source,
 * invoking its delegate listener for matching {@link org.springframework.context.ApplicationEvent} objects only.
 *
 * <p>
 * Can also be used as base class, overriding the {@link #onApplicationEventInternal} method instead of specifying a
 * delegate listener.
 *
...
public class SourceFilteringListener implements GenericApplicationListener, SmartApplicationListener {
     ...
     * {@link #onApplicationEventInternal} method (instead of specifying a delegate listener).
     * 
     * @param source
     *            the event source that this listener filters for, only processing events from this source
     */
