 ...
 *
 * <p>
 * Note that this interceptor is only capable of publishing <i>stateless</i> events configured via the
...
public class EventPublicationInterceptor
     ...
     * <p>
     * The event class <b>must</b> have a constructor with a single {@code Object} argument for the event source. The
     * interceptor will pass in the invoked object.
     * 
     * @throws IllegalArgumentException
     *             if the supplied {@code Class} is {@code null} or if it is not an {@code ApplicationEvent} subclass or
