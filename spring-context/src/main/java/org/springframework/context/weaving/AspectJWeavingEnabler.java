...
/**
 * Post-processor that registers AspectJ's {@link org.aspectj.weaver.loadtime.ClassPreProcessorAgentAdapter} with the
 * Spring application context's default {@link org.springframework.instrument.classloading.LoadTimeWeaver}.
 *
...
public class AspectJWeavingEnabler
     ...
     *
     * @param weaverToUse
     *            the LoadTimeWeaver to apply to (or {@code null} for a default weaver)
    ...
    /**
     * ClassFileTransformer decorator that suppresses processing of AspectJ classes in order to avoid potential
     * LinkageErrors.
     * 
