 ...
 *
 * <p>
 * Delegates to {@link java.text.NumberFormat#getInstance(Locale)}. Configures BigDecimal parsing so there is no loss in
 * precision. Allows configuration over the decimal number pattern. The {@link #parse(String, Locale)} routine always
