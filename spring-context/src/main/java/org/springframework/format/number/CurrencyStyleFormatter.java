 ...
 *
 * <p>
 * Delegates to {@link java.text.NumberFormat#getCurrencyInstance(Locale)}. Configures BigDecimal parsing so there is no
 * loss of precision. Can apply a specified {@link java.math.RoundingMode} to parsed values.
 *
 * @author Keith Donald
