...
/**
 * A context that holds user-specific <code>java.time</code> (JSR-310) settings such as the user's Chronology (calendar
...
public class DateTimeContext {
     ...
     * <p>
     * Alternatively, set a {@link TimeZoneAwareLocaleContext} on {@link LocaleContextHolder}. This context class will
     * fall back to checking the locale context if no setting has been provided here.
     *
    ...
    /**
     * Get the DateTimeFormatter with the this context's settings applied to the base {@code formatter}.
     * 
     * @param formatter
