...
/**
 * A formatter for {@link java.util.Date} types. Allows the configuration of an explicit date pattern and locale.
 *
 * @author Keith Donald
...
public class DateFormatter implements Formatter<Date> {
    ...
    /**
     * Set the two character to use to format date values. The first character used for the date style, the second is
     * for the time style. Supported characters are
     * <ul>
     * <li>'S' = Small</li>
     * <li>'M' = Medium</li>
     * <li>'L' = Long</li>
     ...
     * <p>
     * With lenient parsing, the parser may allow inputs that do not precisely match the format. With strict parsing,
     * inputs must match the format exactly.
     */
