 ...
 *
 * <p>
 * Formatters will be created using the defined {@link #setPattern pattern}, {@link #setIso ISO}, and {@link #setStyle
 * style} methods (considered in that order).
 *
 * @author Phillip Webb
 * @author Sam Brannen
 * @since 3.2
...
public class DateTimeFormatterFactory {
     ...
     * <p>
     * If no specific pattern or style has been defined, {@link DateTimeFormat#mediumDateTime() medium date time format}
     * will be used.
     * 
     ...
     * Create a new {@code DateTimeFormatter} using this factory.
     * <p>
     * If no specific pattern or style has been defined, the supplied {@code fallbackFormatter} will be used.
     * 
     * @param fallbackFormatter
     *            the fall-back formatter to use when no specific factory properties have been set
     * @return a new date time formatter
     */
