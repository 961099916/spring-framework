 ...
 *
 * <p>
 * Note: {@link JodaTimeFormatterRegistrar} installs these converters and relies on several of them for its formatters.
 * Some additional converters are just being registered for custom conversion scenarios.
 *
 * @author Keith Donald
 * @author Phillip Webb
