...
public class JodaTimeFormatterRegistrar implements FormatterRegistrar {
    ...
    /**
     * Set the default format style of Joda {@link LocalDateTime} and {@link DateTime} objects, as well as JDK
     * {@link Date} and {@link Calendar} objects. Default is {@link DateTimeFormat#shortDateTime()}.
     */
     ...
     * <p>
     * This formatter will be used for the {@link LocalDate} type. When specified the {@link #setDateStyle(String)
     * dateStyle} and {@link #setUseIsoFormat(boolean) useIsoFormat} properties will be ignored.
     *
     * @param formatter
     ...
     * <p>
     * This formatter will be used for the {@link LocalTime} type. When specified the {@link #setTimeStyle(String)
     * timeStyle} and {@link #setUseIsoFormat(boolean) useIsoFormat} properties will be ignored.
     *
     * @param formatter
     *            the formatter to use
     * @since 3.2
     ...
     * <p>
     * This formatter will be used for {@link LocalDateTime}, {@link ReadableInstant}, {@link Date} and {@link Calendar}
     * types. When specified the {@link #setDateTimeStyle(String) dateTimeStyle} and {@link #setUseIsoFormat(boolean)
