...
public final class JodaTimeContextHolder {
     ...
     *
     * @param jodaTimeContext
     *            the current JodaTimeContext, or {@code null} to reset the thread-bound context
     */
     ...
     * 
     * @param formatter
     *            the base formatter that establishes default formatting rules (generally user independent)
     * @param locale
     *            the current user locale (may be {@code null} if not known)
