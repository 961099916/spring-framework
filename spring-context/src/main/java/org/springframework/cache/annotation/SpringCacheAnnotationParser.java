...
/**
 * Strategy implementation for parsing Spring's {@link Caching}, {@link Cacheable}, {@link CacheEvict}, and
 * {@link CachePut} annotations.
 *
 * @author Costin Leau
...
public class SpringCacheAnnotationParser implements CacheAnnotationParser, Serializable {
     ...
     * <p>
     * Throws an {@link IllegalStateException} if the state of the operation is invalid. As there might be multiple
     * sources for default values, this ensure that the operation is in a proper state before being returned.
     * 
     * @param ae
