...
/**
 * A strategy for handling cache-related errors. In most cases, any exception thrown by the provider should simply be
 * thrown back at the client but, in some circumstances, the infrastructure may need to handle cache-provider exceptions
 * in a different way.
 *
 * <p>
 * Typically, failing to retrieve an object from the cache with a given id can be transparently managed as a cache miss
 * by not throwing back such exception.
 *
...
public interface CacheErrorHandler {
     ...
     * {@code key}, possibly rethrowing it as a fatal exception.
     * 
     * @param exception
     ...
     * {@code key} and {@code value}, possibly rethrowing it as a fatal exception.
     * 
     * @param exception
     *            the exception thrown by the cache provider
     * @param cache
