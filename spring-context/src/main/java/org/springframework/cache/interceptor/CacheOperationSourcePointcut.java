...
/**
 * A Pointcut that matches if the underlying {@link CacheOperationSource} has an attribute for a given method.
 *
 * @author Costin Leau
...
abstract class CacheOperationSourcePointcut extends StaticMethodMatcherPointcut implements Serializable {
    ...
    /**
     * {@link ClassFilter} that delegates to {@link CacheOperationSource#isCandidateClass} for filtering classes whose
