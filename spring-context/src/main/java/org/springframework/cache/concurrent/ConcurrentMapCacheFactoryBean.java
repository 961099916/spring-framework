...
/**
 * {@link FactoryBean} for easy configuration of a {@link ConcurrentMapCache} when used within a Spring container. Can
 * be configured through bean properties; uses the assigned Spring bean name as the default cache name.
 *
 * <p>
