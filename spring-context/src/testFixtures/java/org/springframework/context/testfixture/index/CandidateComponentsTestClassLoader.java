...
/**
 * A test {@link ClassLoader} that can be used in a testing context to control the {@code spring.components} resource
 * that should be loaded. Can also simulate a failure by throwing a configurable {@link IOException}.
 *
...
public class CandidateComponentsTestClassLoader extends ClassLoader {
    ...
    /**
     * Create a test {@link ClassLoader} that disable the use of the index, even if resources are present at the
     * standard location.
     *
     * @param classLoader
     *            the classloader to use for all other operations
