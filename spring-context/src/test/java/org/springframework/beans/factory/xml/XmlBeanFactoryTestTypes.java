...
/**
 * Bean testing the ability to use both lookup method overrides and constructor injection. There is also a property
 * ("setterString") to be set via Setter Injection.
 *
 * @author Rod Johnson
 */
...
abstract class OverrideOneMethod extends MethodReplaceCandidate implements OverrideInterface {
    ...
    /**
     * Another overloaded form of replaceMe, not getting replaced. Must not cause errors when the other replaceMe
     * methods get replaced.
     */
