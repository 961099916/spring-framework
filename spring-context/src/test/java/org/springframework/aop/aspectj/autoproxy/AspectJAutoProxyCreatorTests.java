...
/**
 * Integration tests for AspectJ auto-proxying. Includes mixing with Spring AOP Advisors to demonstrate that existing
 * autoproxying contract is honoured.
 *
 * @author Rod Johnson
...
public class AspectJAutoProxyCreatorTests {
    ...
    /**
     * Returns the relatively qualified name for <var>fileSuffix</var>. e.g. for a fileSuffix='foo.xml', this method
     * will return 'AspectJAutoProxyCreatorTests-foo.xml'
     */
