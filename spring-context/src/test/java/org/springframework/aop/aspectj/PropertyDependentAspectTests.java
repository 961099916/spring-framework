...
/**
 * Check that an aspect that depends on another bean, where the referenced bean itself is advised by the same aspect,
 * works correctly.
 *
...
class JoinPointMonitorAspect {
    ...
    /**
     * The counter property is purposefully not used in the aspect to avoid distraction from the main bug -- merely
     * needing a dependency on an advised bean is sufficient to reproduce the bug.
     */
