...
public class ProxyFactoryBeanTests {
    ...
    /**
     * The instances are equal, but do not have object identity. Interceptors and interfaces and the target are the
     * same.
     */
    @Test
     ...
     * 
     * @param beanName
     *            name of the ProxyFactoryBean definition that should be a prototype
     */
    ...
    /**
     * Test that inner bean for target means that we can use autowire without ambiguity from target and proxy
     */
    @Test
    ...
    /**
     * Try adding and removing interfaces and interceptors on prototype. Changes will only affect future references
     * obtained from the factory. Each instance will be independent.
     */
    @Test
    ...
    */
    ...
    /**
     * Checks that globals get invoked, and that they can add aspect interfaces unavailable to other beans. These
     * interfaces don't need to be included in proxiedInterface [].
     */
    @Test
     ...
     * use of getType() by bean factory.
     */
    @Test
    ...
    /**
     * Use as a global interceptor. Checks that global interceptors can add aspect interfaces. NB: Add only via global
     * interceptors in XML file.
     */
