...
class SimpleThreadScopeTests {
    ...
    void getMultipleInstances() throws Exception {
        ...
        Thread thread1 =
            new Thread(() -> beans[0] = applicationContext.getBean("removeNodeStatusScreen", TestBean.class));
        Thread thread2 =
            new Thread(() -> beans[1] = applicationContext.getBean("removeNodeStatusScreen", TestBean.class));
        // Act
        thread1.start();
        thread2.start();
        // Assert
