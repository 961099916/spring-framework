 ...
 * {@link BeanFactoryPostProcessor} implementations. Specifically {@link StaticApplicationContext} is used for the
 * tests, but what's represented here is any {@link AbstractApplicationContext} implementation.
 *
...
public class BeanFactoryPostProcessorTests {
    ...
    public void testBeanFactoryPostProcessorAsApplicationListener() {
        ...
        ac.refresh();
        boolean condition =
            ac.getBean(ListeningBeanFactoryPostProcessor.class).received instanceof ContextRefreshedEvent;
