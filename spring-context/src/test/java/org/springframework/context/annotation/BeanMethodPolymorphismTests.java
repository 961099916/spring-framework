...
public class BeanMethodPolymorphismTests {
    ...
    /**
     * When inheritance is not involved, it is still possible to override a bean method from the container's point of
     * view. This is not strictly 'overloading' of a method per se, so it's referred to here as 'shadowing' to
