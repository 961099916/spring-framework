...
/**
 * <p>
 * JUnit-3.8-based unit test which verifies expected <em>init</em> and <em>destroy</em> bean lifecycle behavior as
 * requested in <a href="https://opensource.atlassian.com/projects/spring/browse/SPR-3775" target="_blank">SPR-3775</a>.
 * </p>
 * <p>
 ...
 * <li>Custom {@link RootBeanDefinition#getInitMethodName() init} &amp; {@link RootBeanDefinition#getDestroyMethodName()
 * destroy} methods</li>
