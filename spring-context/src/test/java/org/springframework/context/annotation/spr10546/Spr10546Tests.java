...
public class Spr10546Tests {
    ...
    /**
     * Prior to fixing SPR-10546 this might have succeeded depending on the ordering the classes were picked up. If they
     * are picked up in the same order as {@link #enclosingConfigFirstParentDefinesBean()} then it would fail. This test
     ...
     * {@link AEnclosingConfig.ChildConfig} which encourages this to occur with the classpath scanning implementation
     * being used by the author of this test.
     */
    @Test
