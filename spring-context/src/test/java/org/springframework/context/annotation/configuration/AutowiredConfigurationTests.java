...
/**
 * System tests covering use of {@link Autowired} and {@link Value} within {@link Configuration} classes.
 *
 * @author Chris Beams
...
public class AutowiredConfigurationTests {
    ...
    public void testObjectFactoryConstructorWithTypeVariable() {
        DefaultListableBeanFactory factory = new DefaultListableBeanFactory();
        new XmlBeanDefinitionReader(factory)
            .loadBeanDefinitions(new ClassPathResource("annotation-config.xml", ObjectFactoryConstructorConfig.class));
        GenericApplicationContext ctx = new GenericApplicationContext(factory);
