...
/**
 * Tests ensuring that nested static @Configuration classes are automatically detected and registered without the need
 * for explicit registration or @Import. See SPR-8186.
 *
 * @author Chris Beams
