...
/**
 * {@code @Configuration} class that registers an {@code AnnotationBeanConfigurerAspect} capable of performing
 * dependency injection services for non-Spring managed objects annotated
 ...
 * {@link EnableSpringConfigured @EnableSpringConfigured} annotation. See {@code @EnableSpringConfigured}'s javadoc for
