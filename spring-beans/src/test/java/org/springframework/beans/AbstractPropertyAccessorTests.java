...
public abstract class AbstractPropertyAccessorTests {
    ...
    public void setIntArrayProperty() {
        ...
        assertThat(
            target.intArray[0] == 4 && target.intArray[1] == 5 && target.intArray[2] == 2 && target.intArray[3] == 3)
    ...
    public void setMapPropertyWithTypeConversion() {
        ...
        assertThatExceptionOfType(PropertyBatchUpdateException.class)
            .isThrownBy(() -> accessor.setPropertyValues(badValues)).satisfies(
                ex -> assertThat(ex.getPropertyAccessException("map[key2]")).isInstanceOf(TypeMismatchException.class));
    }
