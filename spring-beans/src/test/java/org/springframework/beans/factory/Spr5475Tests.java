...
/**
 * SPR-5475 exposed the fact that the error message displayed when incorrectly invoking a factory method is not
 * instructive to the user and rather misleading.
 *
 * @author Chris Beams
