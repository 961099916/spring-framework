...
/**
 * {@link ConfigurablePropertyAccessor} implementation that directly accesses instance fields. Allows for direct binding
 * to fields instead of going through JavaBean setters.
 *
 * <p>
 * As of Spring 4.2, the vast majority of the {@link BeanWrapper} features have been merged to
 * {@link AbstractPropertyAccessor}, which means that property traversal as well as collections and map access is now
 * supported here as well.
 *
 * <p>
 * A DirectFieldAccessor's default for the "extractOldValueForEditor" setting is "true", since a field can always be
...
public class DirectFieldAccessor extends AbstractNestablePropertyAccessor {
     ...
     * @param parent
     *            the containing DirectFieldAccessor (must not be {@code null})
     */
