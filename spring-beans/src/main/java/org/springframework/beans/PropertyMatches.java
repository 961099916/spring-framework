...
/**
 * Helper class for calculating property matches, according to a configurable distance. Provide the list of potential
 * matches and an easy way to generate an error message. Works for both java bean properties and fields.
 *
 * <p>
...
public abstract class PropertyMatches {
     ...
     *
     * @param propertyName
     *            the name of the field to find possible matches for
     * @param beanClass
     *            the bean class to search for matches
     */
    ...
    private static class BeanPropertyMatches extends PropertyMatches {
         ...
         * {@code getStringDistance} method, which in turn uses the Levenshtein algorithm to determine the distance
         * between two Strings.
         * 
         * @param descriptors
