...
/**
 * Subclass of {@link MethodInvoker} that tries to convert the given arguments for the actual target method via a
 * {@link TypeConverter}.
 *
 * <p>
...
public class ArgumentConvertingMethodInvoker extends MethodInvoker {
     ...
     * <p>
     * Can be cast to {@link org.springframework.beans.PropertyEditorRegistry} if direct access to the underlying
     * PropertyEditors is desired (provided that the present TypeConverter actually implements the
     ...
     * implementation, typically a pre-configured SimpleTypeConverter or a BeanWrapperImpl instance.
     *
     ...
     * <p>
     * Called if no explicit TypeConverter has been specified. The default implementation builds a
     ...
     * <p>
     * Typically used in conjunction with the default {@link org.springframework.beans.SimpleTypeConverter}; will work
     * with any TypeConverter that implements the PropertyEditorRegistry interface as well.
     * 
     * @param requiredType
    ...
    /**
     * Actually find a method with matching parameter type, i.e. where each argument value is assignable to the
     * corresponding parameter type.
     * 
     * @param arguments
     *            the argument values to match against method parameters
