...
public class PropertyValue extends BeanMetadataAttributeAccessor implements Serializable {
    ...
    /**
     * Constructor that exposes a new value for an original value holder. The original holder will be exposed as source
     * of the new holder.
     * 
     * @param original
    ...
    /**
     * Return whether this is an optional value, that is, to be ignored when no corresponding property exists on the
     * target class.
     *
     * @since 3.0
     */
    ...
    /**
     * Set whether this is an optional value, that is, to be ignored when no corresponding property exists on the target
     * class.
     *
     * @since 3.0
     */
    ...
    /**
     * Return whether this holder contains a converted value already ({@code true}), or whether the value still needs to
     * be converted ({@code false}).
     */
