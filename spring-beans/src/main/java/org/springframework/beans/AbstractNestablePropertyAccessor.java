 ...
 *
 * <p>
 * This accessor will convert collection and array values to the corresponding target collections or arrays, if
 * necessary. Custom property editors that deal with collections or arrays can either be written via PropertyEditor's
 * {@code setValue}, or against a comma-delimited String via {@code setAsText}, as String arrays are converted in such a
...
public abstract class AbstractNestablePropertyAccessor extends AbstractPropertyAccessor {
     ...
     *            whether to register default editors (can be suppressed if the accessor won't need any type conversion)
     * @see #setWrappedInstance
     */
    ...
    /**
     * Return the {@link PropertyHandler} for the specified {@code propertyName}, navigating if necessary. Return
     * {@code null} if not found rather than throwing an exception.
     * 
     * @param propertyName
    ...
    /**
     * Return a {@link PropertyHandler} for the specified local {@code propertyName}. Only used to reach a property
     * available in the current context.
     * 
     * @param propertyName
     *            the name of a local property
    ...
    /**
     * Create a new nested property accessor instance. Can be overridden in subclasses to create a PropertyAccessor
     * subclass.
     * 
     * @param object
     *            the object wrapped by this PropertyAccessor
     * @param nestedPath
     *            the nested path of the object
     ...
     * 
     * @param propertyPath
     *            property path, which may be nested
