...
public interface Mergeable {
     ...
     * <p>
     * The supplied object is considered the parent, and values in the callee's value set must override those of the
     * supplied object.
     * 
     * @param parent
     ...
     *             if merging is not enabled for this instance (i.e. {@code mergeEnabled} equals {@code false}).
     */
