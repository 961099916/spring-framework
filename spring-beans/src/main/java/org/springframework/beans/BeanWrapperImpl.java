...
/**
 * Default {@link BeanWrapper} implementation that should be sufficient for all typical use cases. Caches introspection
 ...
 * which apply in addition to the JDK's standard PropertyEditors. Applications can call the
 * {@link #registerCustomEditor(Class, java.beans.PropertyEditor)} method to register an editor for a particular
 * instance (i.e. they are not shared across the application). See the base class {@link PropertyEditorRegistrySupport}
 * for details.
 *
 * <p>
 * <b>NOTE: As of Spring 2.5, this is - for almost all purposes - an internal class.</b> It is just public in order to
 * allow for access from other framework packages. For standard application access purposes, use the
...
public class BeanWrapperImpl extends AbstractNestablePropertyAccessor implements BeanWrapper {
     ...
     *            whether to register default editors (can be suppressed if the BeanWrapper won't need any type
     *            conversion)
     * @see #setWrappedInstance
     */
     ...
     *            the nested path of the object
     * @param parent
     *            the containing BeanWrapper (must not be {@code null})
     */
     ...
     * <p>
     * This method is only intended for optimizations in a BeanFactory. Use the {@code convertIfNecessary} methods for
            ...
            if (System.getSecurityManager() != null) {
                ...
                try {
                    return AccessController.doPrivileged((PrivilegedExceptionAction<
                        Object>)() -> readMethod.invoke(getWrappedInstance(), (Object[])null), acc);
            ...
            if (System.getSecurityManager() != null) {
                ...
                try {
                    AccessController.doPrivileged(
                        (PrivilegedExceptionAction<Object>)() -> writeMethod.invoke(getWrappedInstance(), value), acc);
