...
/**
 * The default implementation of the {@link PropertyValues} interface. Allows simple manipulation of properties, and
...
public class MutablePropertyValues implements PropertyValues, Serializable {
     ...
     * 
     * @param original
     *            a Map with property values keyed by property name Strings
    ...
    public MutablePropertyValues(@Nullable Map<?, ?> original) {
        ...
        if (original != null) {
            ...
            original.forEach(
                (attrName, attrValue) -> this.propertyValueList.add(new PropertyValue(attrName.toString(), attrValue)));
        } else {
            this.propertyValueList = new ArrayList<>(0);
        }
    }
    ...
    /**
     * Return the underlying List of PropertyValue objects in its raw form. The returned List can be modified directly,
     * although this is not recommended.
     * <p>
     * This is an accessor for optimized access to all PropertyValue objects. It is not intended for typical
     * programmatic use.
     */
    ...
    /**
     * Copy all given PropertyValues into this object. Guarantees PropertyValue references are independent, although it
     * can't deep copy objects currently referenced by individual PropertyValue objects.
     * 
     * @param other
     *            the PropertyValues to copy
     ...
     * 
     * @param other
     *            a Map with property values keyed by property name, which must be a String
     * @return this in order to allow for adding multiple property values in a chain
     */
    ...
    /**
     * Add a PropertyValue object, replacing any existing one for the corresponding property or getting merged with it
     * (if applicable).
     * 
     * @param pv
     *            the PropertyValue object to add
     * @return this in order to allow for adding multiple property values in a chain
     */
    ...
    /**
     * Merges the value of the supplied 'new' {@link PropertyValue} with that of the current {@link PropertyValue} if
     * merging is supported and enabled.
     * 
     * @see Mergeable
     */
    ...
    /**
     * Register the specified property as "processed" in the sense of some processor calling the corresponding setter
     * method outside of the PropertyValue(s) mechanism.
     * <p>
    ...
    /**
     * Return whether this holder contains converted values only ({@code true}), or whether the values still need to be
