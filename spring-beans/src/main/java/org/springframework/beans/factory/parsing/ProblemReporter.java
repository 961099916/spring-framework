...
/**
 * SPI interface allowing tools and other external processes to handle errors and warnings reported during bean
 * definition parsing.
 *
 * @author Rob Harrop
...
public interface ProblemReporter {
     ...
     * 
     * @param problem
     *            the source of the error (never {@code null})
     */
     ...
     * 
     * @param problem
     *            the source of the warning (never {@code null})
     */
