...
/**
 * Exception thrown when a {@code BeanFactory} is asked for a bean instance for which multiple matching candidates have
 * been found when only one matching bean was expected.
 *
...
public class NoUniqueBeanDefinitionException extends NoSuchBeanDefinitionException {
    ...
    /**
     * Return the number of beans found when only one matching bean was expected. For a NoUniqueBeanDefinitionException,
     * this will usually be higher than 1.
     * 
     * @see #getBeanType()
     */
    @Override
    ...
    /**
     * Return the names of all beans found when only one matching bean was expected. Note that this may be {@code null}
     * if not specified at construction time.
     * 
     * @since 4.3
     * @see #getBeanType()
     */
