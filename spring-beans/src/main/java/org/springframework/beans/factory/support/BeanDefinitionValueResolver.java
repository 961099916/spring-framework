...
/**
 * Helper class for use in bean factory implementations, resolving values contained in bean definition objects into the
 * actual values applied to the target bean instance.
 *
 * <p>
...
class BeanDefinitionValueResolver {
    ...
    /**
     * Given a PropertyValue, return a value, resolving any references to other beans in the factory if necessary. The
     * value could be:
     * <li>A BeanDefinition, which leads to the creation of a corresponding new bean instance. Singleton flags and names
     * of such "inner beans" are always ignored: Inner beans are anonymous prototypes.
     * <li>A RuntimeBeanReference, which must be resolved.
     * <li>A ManagedList. This is a special collection that may contain RuntimeBeanReferences or Collections that will
     * need to be resolved.
     * <li>A ManagedSet. May also contain RuntimeBeanReferences or Collections that will need to be resolved.
     * <li>A ManagedMap. In this case the value may be a RuntimeBeanReference or Collection that will need to be
     * resolved.
    ...
    /**
     * Checks the given bean name whether it is unique. If not already unique, a counter is added, increasing the
     * counter until the name is unique.
     * 
     * @param innerBeanName
