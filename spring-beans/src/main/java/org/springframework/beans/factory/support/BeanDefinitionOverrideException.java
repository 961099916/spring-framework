...
/**
 * Subclass of {@link BeanDefinitionStoreException} indicating an invalid override attempt: typically registering a new
 * definition for the same bean name while {@link DefaultListableBeanFactory#isAllowBeanDefinitionOverriding()} is
 * {@code false}.
 *
