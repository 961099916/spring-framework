...
/**
 * Interface that receives callbacks for component, alias and import registrations during a bean definition reading
 * process.
 *
 * @author Rob Harrop
...
public interface ReaderEventListener extends EventListener {
     ...
     *            a descriptor for the new component
