...
/**
 * Simple factory for shared List instances. Allows for central setup of Lists via the "list" element in XML bean
 * definitions.
 *
...
public class ListFactoryBean extends AbstractFactoryBean<List<Object>> {
    ...
    /**
     * Set the class to use for the target List. Can be populated with a fully qualified class name when defined in a
