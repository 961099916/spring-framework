...
/**
 * Bean definition for beans which inherit settings from their parent. Child bean definitions have a fixed dependency on
 ...
 * parent, with the option to add new values. If init method, destroy method and/or static factory method are specified,
 * they will override the corresponding parent settings. The remaining settings will <i>always</i> be taken from the
 * child definition: depends on, autowire mode, dependency check, singleton, lazy init.
 *
 * <p>
 * <b>NOTE:</b> Since Spring 2.5, the preferred way to register bean definitions programmatically is the
 * {@link GenericBeanDefinition} class, which allows to dynamically define parent dependencies through the
 * {@link GenericBeanDefinition#setParentName} method. This effectively supersedes the ChildBeanDefinition class for
 * most use cases.
 *
 * @author Rod Johnson
...
public class ChildBeanDefinition extends AbstractBeanDefinition {
    ...
    /**
     * Create a new ChildBeanDefinition for the given parent, to be configured through its bean properties and
    ...
    /**
     * Create a new ChildBeanDefinition for the given parent, providing constructor arguments and property values. Takes
     * a bean class name to avoid eager loading of the bean class.
     * 
     * @param parentName
     *            the name of the parent bean
     * @param beanClassName
