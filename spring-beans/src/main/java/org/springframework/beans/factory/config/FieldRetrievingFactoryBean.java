...
public class FieldRetrievingFactoryBean
    ...
    /**
     * Set the target class on which the field is defined. Only necessary when the target field is static; else, a
    ...
    /**
     * Set the target object on which the field is defined. Only necessary when the target field is not static; else, a
     * target class is sufficient.
     *
     * @see #setTargetClass
     * @see #setTargetField
     */
    ...
    /**
     * Set the name of the field to be retrieved. Refers to either a static field or a non-static field, depending on a
    ...
    /**
     * Set a fully qualified static field name to retrieve, e.g. "example.MyExampleClass.MY_EXAMPLE_FIELD". Convenient
    ...
    /**
     * The bean name of this FieldRetrievingFactoryBean will be interpreted as "staticField" pattern, if neither
     * "targetClass" nor "targetObject" nor "targetField" have been specified. This allows for concise bean definitions
