...
/**
 * Visitor class for traversing {@link BeanDefinition} objects, in particular the property values and constructor
 * argument values contained in them, resolving bean metadata values.
 *
 * <p>
 * Used by {@link PlaceholderConfigurerSupport} to parse all String values contained in a BeanDefinition, resolving any
 * placeholders found.
 *
...
public class BeanDefinitionVisitor {
    ...
    /**
     * Create a new BeanDefinitionVisitor for subclassing. Subclasses need to override the {@link #resolveStringValue}
     * method.
     */
    protected BeanDefinitionVisitor() {}

    /**
     * Traverse the given BeanDefinition object and the MutablePropertyValues and ConstructorArgumentValues contained in
     * them.
     * 
