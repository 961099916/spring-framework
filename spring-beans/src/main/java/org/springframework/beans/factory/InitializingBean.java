 ...
 * {@link BeanFactory}: e.g. to perform custom initialization, or merely to check that all mandatory properties have
 * been set.
 *
 * <p>
 * An alternative to implementing {@code InitializingBean} is specifying a custom init method, for example in an XML
 * bean definition. For a list of all bean lifecycle methods, see the {@link BeanFactory BeanFactory javadocs}.
 *
 * @author Rod Johnson
...
public interface InitializingBean {
     ...
     * {@link BeanFactoryAware}, {@code ApplicationContextAware} etc.
     * <p>
