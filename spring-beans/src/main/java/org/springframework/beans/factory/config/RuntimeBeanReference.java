...
public class RuntimeBeanReference implements BeanReference {
    ...
    /**
     * Create a new RuntimeBeanReference to the given bean name, with the option to mark it as reference to a bean in
     * the parent factory.
     * 
     * @param beanName
     *            name of the target bean
    ...
    /**
     * Create a new RuntimeBeanReference to a bean of the given type, with the option to mark it as reference to a bean
