...
public class BeanDefinitionDefaults {
    ...
    /**
     * Return whether beans should be lazily initialized by default, i.e. not eagerly instantiated on startup. Only
     * applicable to singleton beans.
     *
     ...
     *
     * @param autowireMode
     *            the autowire mode to set. Must be one of the constants defined in {@link AbstractBeanDefinition}.
     ...
     *            the code to set. Must be one of the constants defined in {@link AbstractBeanDefinition}.
     ...
     * <p>
     * Note that this method is not enforced on all affected bean definitions but rather taken as an optional callback,
     * to be invoked if actually present.
     *
