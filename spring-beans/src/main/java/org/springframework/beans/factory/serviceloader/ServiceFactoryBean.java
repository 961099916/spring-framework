...
/**
 * {@link org.springframework.beans.factory.FactoryBean} that exposes the 'primary' service for the configured service
 * class, obtained through the JDK 1.6 {@link java.util.ServiceLoader} facility.
 *
