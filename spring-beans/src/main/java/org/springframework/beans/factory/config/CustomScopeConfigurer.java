...
/**
 * Simple {@link BeanFactoryPostProcessor} implementation that registers custom {@link Scope Scope(s)} with the
 * containing {@link ConfigurableBeanFactory}.
 *
 * <p>
 ...
 *
 * <p>
 * This class allows for <i>declarative</i> registration of custom scopes. Alternatively, consider implementing a custom
 * {@link BeanFactoryPostProcessor} that calls {@link ConfigurableBeanFactory#registerScope} programmatically.
 *
...
public class CustomScopeConfigurer implements BeanFactoryPostProcessor, BeanClassLoaderAware, Ordered {
     ...
     * <p>
     * The keys indicate the scope names (of type String); each value is expected to be the corresponding custom
     * {@link Scope} instance or class name.
     */
