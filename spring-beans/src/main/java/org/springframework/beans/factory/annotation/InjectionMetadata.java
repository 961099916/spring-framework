...
public class InjectionMetadata {
     ...
     * <p>
     * Preferably use {@link #forElements} for reusing the {@link #EMPTY} instance in case of no elements.
     * 
     * @param targetClass
     *            the target class
     * @param elements
     *            the associated elements to inject
     * @see #forElements
     */
     ...
     *
     * @param elements
     *            the elements to inject (possibly empty)
     * @param clazz
     *            the target class
     ...
     *
     * @param metadata
     *            the existing metadata instance
     * @param clazz
    ...
    public abstract static class InjectedElement {
        ...
        /**
         * Check whether this injector's property needs to be skipped due to an explicit property value having been
