...
public abstract class YamlProcessor {
     ...
     * YAML documents are separated by {@code ---} lines, and each document is converted to properties before the match
     * is made. E.g.
     * 
     * <pre class="code">
     * environment: dev
     ...
     * matchers} abstain will nevertheless match. Default is {@code true}.
     */
     ...
     * decide which map entries to keep in the final output from this factory. Default is
     ...
     * <p>
     * If no supported types are configured, all types encountered in YAML documents will be supported. If an
     * unsupported type is encountered, an {@link IllegalStateException} will be thrown when the corresponding YAML node
     * is processed.
     * 
     * @param supportedTypes
     *            the supported types, or an empty array to clear the supported types
     * @since 5.1.16
     * @see #createYaml()
     */
     ...
     * <p>
     * The default implementation sets the "allowDuplicateKeys" flag to {@code false}, enabling built-in duplicate key
     * handling in SnakeYAML 1.18+.
     * <p>
     * As of Spring Framework 5.1.16, if custom {@linkplain #setSupportedTypes supported types} have been configured,
     * the default implementation creates a {@code Yaml} instance that filters out unsupported types encountered in YAML
     * documents. If an unsupported type is encountered, an {@link IllegalStateException} will be thrown when the node
     * is processed.
     * 
    ...
    public interface MatchCallback {
         ...
         *
         * @param properties
         *            the properties to process (as a flattened representation with indexed keys in case of a collection
         *            or map)
         * @param map
         *            the result map (preserving the original value structure in the YAML document)
         */
     ...
     * <p>
     * If an unsupported type is encountered in a YAML document, an {@link IllegalStateException} will be thrown from
