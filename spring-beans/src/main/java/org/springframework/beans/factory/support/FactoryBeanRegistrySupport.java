...
public abstract class FactoryBeanRegistrySupport extends DefaultSingletonBeanRegistry {
    ...
    /**
     * Obtain an object to expose from the given FactoryBean, if available in cached form. Quick check for minimal
     * synchronization.
     * 
     * @param beanName
     ...
     *            whether the bean is subject to post-processing
    ...
    /**
     * Post-process the given object that has been obtained from the FactoryBean. The resulting object will get exposed
     * for bean references.
     * <p>
     * The default implementation simply returns the given object as-is. Subclasses may override this, for example, to
    ...
    /**
     * Return the security context for this bean factory. If a security manager is set, interaction with the user code
     * will be executed using the privileged of the security context returned by this method.
     * 
