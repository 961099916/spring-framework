...
/**
 * A {@link org.springframework.beans.factory.config.BeanFactoryPostProcessor} implementation that allows for convenient
...
public class CustomAutowireConfigurer implements BeanFactoryPostProcessor, BeanClassLoaderAware, Ordered {
    ...
    /**
     * Register custom qualifier annotation types to be considered when autowiring beans. Each element of the provided
     * set may be either a Class instance or a String representation of the fully-qualified class name of the custom
     * annotation.
     * <p>
     * Note that any annotation that is itself annotated with Spring's
     * {@link org.springframework.beans.factory.annotation.Qualifier} does not require explicit registration.
     * 
     * @param customQualifierTypes
