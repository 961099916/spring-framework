 ...
 * {@link Qualifier @Qualifier} annotation.
 *
...
public abstract class BeanFactoryAnnotationUtils {
    ...
    /**
     * Retrieve all bean of type {@code T} from the given {@code BeanFactory} declaring a qualifier (e.g. via
     * {@code <qualifier>} or {@code @Qualifier}) matching the given qualifier, or having a bean name matching the given
     * qualifier.
     * 
     * @param beanFactory
     *            the factory to get the target beans from (also searching ancestors)
     * @param beanType
     *            the type of beans to retrieve
     * @param qualifier
     *            the qualifier for selecting among all type matches
     * @return the matching beans of type {@code T}
     * @throws BeansException
     *             if any of the matching beans could not be created
     * @since 5.1.1
    ...
    /**
     * Obtain a bean of type {@code T} from the given {@code BeanFactory} declaring a qualifier (e.g. via
     * {@code <qualifier>} or {@code @Qualifier}) matching the given qualifier, or having a bean name matching the given
     * qualifier.
     * 
     * @param beanFactory
     *            the factory to get the target bean from (also searching ancestors)
     * @param beanType
     ...
     *             if multiple matching beans of type {@code T} found
     ...
     * 
     * @param bf
     *            the factory to get the target bean from
     * @param beanType
     *            the type of bean to retrieve
     * @param qualifier
     *            the qualifier for selecting between multiple bean matches
     ...
     * @param beanFactory
     *            the factory from which to retrieve the named bean
     * @return {@code true} if either the bean definition (in the XML case) or the bean's factory method (in the
     *         {@code @Bean} case) defines a matching qualifier value (through {@code <qualifier>} or
     *         {@code @Qualifier})
     * @since 5.0
     */
