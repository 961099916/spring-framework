...
/**
 * Tag collection class used to hold managed array elements, which may include runtime bean references (to be resolved
 * into bean objects).
 *
...
public class ManagedArray extends ManagedList<Object> {
     ...
     *            the target element type as a class name
     * @param size
