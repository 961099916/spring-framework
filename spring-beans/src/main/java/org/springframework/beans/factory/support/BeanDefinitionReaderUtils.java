...
public abstract class BeanDefinitionReaderUtils {
    ...
    /**
     * Create a new GenericBeanDefinition for the given parent name and class name, eagerly loading the bean class if a
     * ClassLoader has been specified.
     * 
     * @param parentName
     *            the name of the parent bean, if any
     * @param className
     *            the name of the bean class, if any
     * @param classLoader
     *            the ClassLoader to use for loading bean classes (can be {@code null} to just register bean classes by
     *            name)
     ...
     * @param registry
     *            the bean factory that the definition is going to be registered with (to check for existing bean names)
     ...
     *            the bean factory that the definition is going to be registered with (to check for existing bean names)
     * @param isInnerBean
     *            whether the given bean definition will be registered as inner bean or as top-level bean (allowing for
     *            special name generation for inner beans versus top-level beans)
     * @return the generated bean name
     * @throws BeanDefinitionStoreException
     *             if no unique name can be generated for the given bean definition
     */
    ...
    /**
     * Turn the given bean name into a unique bean name for the given bean factory, appending a unique counter as suffix
     * if necessary.
     * 
     * @param beanName
     ...
     *            the bean definition including name and aliases
     * @param registry
     ...
     * @return the generated bean name
     * @throws BeanDefinitionStoreException
     *             if no unique name can be generated for the given bean definition or the definition cannot be
     *             registered
     */
