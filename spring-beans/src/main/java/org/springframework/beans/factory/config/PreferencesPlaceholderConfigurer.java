 ...
 *
 * <p>
 * Tries to resolve placeholders as keys first in the user preferences, then in the system preferences, then in this
 * configurer's properties. Thus, behaves like PropertyPlaceholderConfigurer if no corresponding preferences defined.
 *
 * <p>
 * Supports custom paths for the system and user preferences trees. Also supports custom paths specified in placeholders
 * ("myPath/myPlaceholderKey"). Uses the respective root node if not specified.
 *
...
public class PreferencesPlaceholderConfigurer extends PropertyPlaceholderConfigurer implements InitializingBean {
    ...
    /**
     * This implementation tries to resolve placeholders as keys first in the user preferences, then in the system
     * preferences, then in the passed-in properties.
     */
    @Override
     ...
     * 
     * @param path
     *            the preferences path (placeholder part before '/')
     * @param key
     *            the preferences key (placeholder part after '/')
     * @param preferences
     *            the Preferences to resolve against
