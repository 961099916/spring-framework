 ...
 *
 * <p>
 * Configuration parsers <strong>may</strong> provide the ability to attach source metadata during the parse phase. They
 * will offer this metadata in a generic format which can be further modified by a {@link SourceExtractor} before being
...
public interface SourceExtractor {
     ...
     *            the original source metadata (never {@code null})
     * @param definingResource
     *            the resource that defines the given source object (may be {@code null})
