 ...
 *
 * <p>
 * This is pulled out into a strategy as various approaches are possible, including using CGLIB to create subclasses on
 * the fly to support Method Injection.
 *
 * @author Rod Johnson
...
public interface InstantiationStrategy {
     ...
     *            the bean definition
     * @param beanName
     *            the name of the bean when it is created in this context. The name can be {@code null} if we are
     *            autowiring a bean which doesn't belong to the factory.
     * @param owner
     ...
     *            the owning BeanFactory
     * @param factoryBean
     *            the factory bean instance to call the factory method on, or {@code null} in case of a static factory
     *            method
     * @param factoryMethod
     *            the factory method to use
     * @param args
