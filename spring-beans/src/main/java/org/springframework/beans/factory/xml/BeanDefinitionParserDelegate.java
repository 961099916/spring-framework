...
public class BeanDefinitionParserDelegate {
     ...
     * 
     * @param defaults
     *            the defaults to populate
     * @param parentDefaults
     *            the parent BeanDefinitionParserDelegate (if any) defaults to fall back to
     * @param root
     ...
     *            the default type (class name) for any {@code <value>} tag that might be created
     */
    @Nullable
     ...
     *            the element to parse
     * @param containingBd
     *            the containing bean definition (if any)
     * @return the resulting bean definition
     */
    @Nullable
    ...
    private BeanDefinitionHolder parseNestedCustomElement(Element ele, @Nullable BeanDefinition containingBd) {
        ...
        if (logger.isTraceEnabled()) {
            logger
                .trace("Using generated bean name [" + id + "] for nested custom element '" + ele.getNodeName() + "'");
        }
     ...
     * <p>
     * The default implementation uses {@link Node#getNamespaceURI}. Subclasses may override the default implementation
     * to provide a different namespace identification mechanism.
     * 
     * @param node
     *            the node
     */
     ...
     * <p>
     * The default implementation calls {@link Node#getLocalName}. Subclasses may override the default implementation to
     ...
     * <p>
     * The default implementation checks the supplied desired name against both {@link Node#getNodeName()} and
