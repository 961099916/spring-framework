 ...
 *
 * <p>
 * Provides bean definition registration methods for Map/Properties and ResourceBundle. Typically applied to a
...
public class PropertiesBeanDefinitionReader extends AbstractBeanDefinitionReader {
    ...
    /**
     * Set the default parent bean for this bean factory. If a child bean definition handled by this factory provides
     * neither a parent nor a class attribute, this default value gets used.
     * <p>
     * Can be used e.g. for view definition files, to define a parent with a default view class and common attributes
     * for all views. View definitions that define their own parent or carry their own class can still override this.
     * <p>
     * Strictly speaking, the rule that a default parent setting does not apply to a bean definition that carries a
     * class is there for backwards compatibility reasons. It still matches the typical use case.
     */
     ...
     *            the resource descriptor for the properties file
     * @param prefix
     *            a filter within the keys in the map: e.g. 'beans.' (can be empty or {@code null})
     * @return the number of bean definitions found
     * @throws BeanDefinitionStoreException
     *             in case of loading or parsing errors
     */
     ...
     *            the resource descriptor for the properties file, allowing to specify an encoding to use for parsing
     *            the file
     * @return the number of bean definitions found
     * @throws BeanDefinitionStoreException
     *             in case of loading or parsing errors
     ...
     * 
     * @param map
     *            a map of {@code name} to {@code property} (String or Object). Property values will be strings if
     *            coming from a Properties file etc. Property names (keys) <b>must</b> be Strings. Class keys must be
     *            Strings.
     * @return the number of bean definitions found
     ...
     *            description of the resource that the Map came from (for logging purposes)
     * @return the number of bean definitions found
     * @throws BeansException
     *             in case of loading or parsing errors
    ...
    /**
     * Get all property values, given a prefix (which will be stripped) and add the bean they define to the factory with
     * the given name.
     * 
     * @param beanName
     *            name of the bean to define
     * @param map
     *            a Map containing string pairs
     * @param prefix
     *            prefix of each entry, which will be stripped
     * @param resourceDescription
     *            description of the resource that the Map came from (for logging purposes)
     * @throws BeansException
