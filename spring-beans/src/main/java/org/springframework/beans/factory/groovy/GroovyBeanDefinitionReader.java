 ...
 *
 * <p>
 * This bean definition reader also understands XML bean definition files, allowing for seamless mixing and matching
 * with Groovy bean definition files.
 *
 * <p>
 * Typically applied to a {@link org.springframework.beans.factory.support.DefaultListableBeanFactory} or a
 * {@link org.springframework.context.support.GenericApplicationContext}, but can be used against any
 ...
 * {@link #loadBeanDefinitions(Resource...)} or {@link #loadBeanDefinitions(String...)} method, with a script looking
...
public class GroovyBeanDefinitionReader extends AbstractBeanDefinitionReader implements GroovyObject {
    ...
    /**
     * Standard {@code XmlBeanDefinitionReader} created with default settings for loading bean definitions from XML
     * files.
     */
    private final XmlBeanDefinitionReader standardXmlBeanDefinitionReader;

    /**
     * Groovy DSL {@code XmlBeanDefinitionReader} for loading bean definitions via the Groovy DSL, typically configured
     ...
     * 
     * @param registry
     *            the {@code BeanDefinitionRegistry} to load bean definitions into
     */
    ...
    /**
     * Create a new {@code GroovyBeanDefinitionReader} based on the given {@link XmlBeanDefinitionReader}, loading bean
     * definitions into its {@code BeanDefinitionRegistry} and delegating Groovy DSL loading to it.
     * <p>
     * The supplied {@code XmlBeanDefinitionReader} should typically be pre-configured with XML validation disabled.
     * 
     * @param xmlBeanDefinitionReader
     *            the {@code XmlBeanDefinitionReader} to derive the registry from and to delegate Groovy DSL loading to
     */
    ...
    /**
     * Set the binding, i.e. the Groovy variables available in the scope of a {@code GroovyBeanDefinitionReader}
     * closure.
     */
     ...
     * <p>
     * Note that {@code ".xml"} files will be parsed as XML content; all other kinds of resources will be parsed as
     * Groovy scripts.
     * 
     * @param resource
     ...
     *            the resource descriptor for the Groovy script or XML file, allowing specification of an encoding to
     ...
     *            the bean type
     * @param args
     *            the constructors arguments and closure configurer
     * @return the bean definition
     */
     ...
     * @param args
     *            the arguments to the bean. The first argument is the class name, the last argument is sometimes a
     *            closure. All the arguments in between are constructor arguments.
    ...
    /**
     * Checks whether there are any {@link RuntimeBeanReference RuntimeBeanReferences} inside the {@link Map} and
     * converts it to a {@link ManagedMap} if necessary.
     * 
     * @param map
     *            the original Map
    ...
    /**
     * Checks whether there are any {@link RuntimeBeanReference RuntimeBeanReferences} inside the {@link List} and
     * converts it to a {@link ManagedList} if necessary.
     * 
     * @param list
     *            the original List
    ...
    /**
     * This method overrides property setting in the scope of the {@code GroovyBeanDefinitionReader} to set properties
     * on the current bean definition.
     */
    @Override
    ...
    /**
     * This method overrides property retrieval in the scope of the {@code GroovyBeanDefinitionReader}. A property
    ...
    private GroovyDynamicElementReader createDynamicElementReader(String namespace) {
        XmlReaderContext readerContext =
            this.groovyDslXmlBeanDefinitionReader.createReaderContext(new DescriptiveResource("Groovy"));
    ...
    /**
     * This class is used to defer the adding of a property to a bean definition until later. This is for a case where
     * you assign a property to a list that may not contain bean references at that point of assignment, but may later;
    ...
    private class GroovyRuntimeBeanReference extends RuntimeBeanReference implements GroovyObject {
        ...
        /**
         * Wraps a bean definition property and ensures that any RuntimeBeanReference additions to it are deferred for
         * resolution later.
         */
