...
/**
 * Represents a problem with a bean definition configuration. Mainly serves as common argument passed into a
...
public class Problem {
     ...
     *            a message detailing the problem
     * @param parseState
     *            the {@link ParseState} at the time of the error
     * @param location
     *            the location within a bean configuration source that triggered the error
     */
     ...
     *            a message detailing the problem
     * @param rootCause
     *            the underlying exception that caused the error (may be {@code null})
     * @param parseState
     *            the {@link ParseState} at the time of the error
     * @param location
     *            the location within a bean configuration source that triggered the error
    ...
    /**
     * Get the description of the bean configuration source that triggered the error, as contained within this Problem's
     * Location object.
     * 
     * @see #getLocation()
     */
