...
/**
 * XML-specific BeanDefinitionStoreException subclass that wraps a {@link org.xml.sax.SAXException}, typically a
 * {@link org.xml.sax.SAXParseException} which contains information about the error location.
 *
...
public class XmlBeanDefinitionStoreException extends BeanDefinitionStoreException {
     ...
     * @param cause
     *            the SAXException (typically a SAXParseException) root cause
     * @see org.xml.sax.SAXParseException
     */
