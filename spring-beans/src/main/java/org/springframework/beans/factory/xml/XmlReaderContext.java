...
/**
 * Extension of {@link org.springframework.beans.factory.parsing.ReaderContext}, specific to use with an
 * {@link XmlBeanDefinitionReader}. Provides access to the {@link NamespaceHandlerResolver} configured in the
...
public class XmlReaderContext extends ReaderContext {
     ...
     * 
     * @param resource
     *            the XML bean definition resource
     * @param problemReporter
     *            the problem reporter in use
     * @param eventListener
     *            the event listener in use
     * @param sourceExtractor
     *            the source extractor in use
     * @param reader
     *            the XML bean definition reader in use
    ...
    /**
     * Call the bean name generator for the given bean definition and register the bean definition under the generated
     * name.
     * 
     * @see XmlBeanDefinitionReader#getBeanNameGenerator()
     * @see org.springframework.beans.factory.support.BeanNameGenerator#generateBeanName
