...
/**
 * Exception thrown when a {@code BeanFactory} is asked for a bean instance for which it cannot find a definition. This
 * may point to a non-existing bean, a non-unique bean, or a manually registered singleton instance without an
...
public class NoSuchBeanDefinitionException extends BeansException {
     ...
     * 
     * @param type
     *            full type declaration of the missing bean
     * @since 4.3.4
     */
