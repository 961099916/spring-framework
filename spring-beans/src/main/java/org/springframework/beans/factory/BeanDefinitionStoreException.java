...
/**
 * Exception thrown when a BeanFactory encounters an invalid bean definition: e.g. in case of incomplete or
...
public class BeanDefinitionStoreException extends FatalBeanException {
     ...
     * @param msg
     *            the detail message (appended to an introductory message that indicates the resource and the name of
     *            the bean)
     */
