...
abstract class AutowireUtils {
     ...
     * The result will contain public constructors first, with decreasing number of arguments, then non-public
    ...
    /**
     * Sort the given factory methods, preferring public methods and "greedy" ones with a maximum of arguments. The
     * result will contain public methods first, with decreasing number of arguments, then non-public methods, again
     * with decreasing number of arguments.
     * 
     * @param factoryMethods
     *            the factory method array to sort
     */
     ...
     * @param requiredType
     *            the type to assign the result to
    ...
    /**
     * Determine the target type for the generic return type of the given <em>generic factory method</em>, where formal
     * type variables are declared on the given method itself.
     * <p>
     * For example, given a factory method with the following signature, if {@code resolveReturnTypeForFactoryMethod()}
     * is invoked with the reflected method for {@code createProxy()} and an {@code Object[]} array containing
     * {@code MyService.class}, {@code resolveReturnTypeForFactoryMethod()} will infer that the target return type is
     * {@code MyService}.
     * 
     * <pre class="code">
     ...
     * <li>the {@linkplain Method#getReturnType() standard return type}, if the given {@code method} does not declare
     * any {@linkplain Method#getTypeParameters() formal type variables}</li>
     * <li>the {@linkplain Method#getReturnType() standard return type}, if the target return type cannot be inferred
     * (e.g., due to type erasure)</li>
     * <li>{@code null}, if the length of the given arguments array is shorter than the length of the
     * {@linkplain Method#getGenericParameterTypes() formal argument list} for the given method</li>
     * </ul>
     * 
     * @param method
     *            the method to introspect (never {@code null})
     * @param args
     *            the arguments that will be supplied to the method when it is invoked (never {@code null})
     * @param classLoader
     *            the ClassLoader to resolve class names against, if necessary (never {@code null})
