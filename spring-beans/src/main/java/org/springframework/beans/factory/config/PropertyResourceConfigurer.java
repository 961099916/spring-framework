...
/**
 * Allows for configuration of individual bean property values from a property resource, i.e. a properties file. Useful
 * for custom config files targeted at system administrators that override bean properties configured in the application
 * context.
 *
 * <p>
 * Two concrete implementations are provided in the distribution:
 * <ul>
 * <li>{@link PropertyOverrideConfigurer} for "beanName.property=value" style overriding (<i>pushing</i> values from a
 * properties file into bean definitions)
 * <li>{@link PropertyPlaceholderConfigurer} for replacing "${...}" placeholders (<i>pulling</i> values from a
 * properties file into bean definitions)
 * </ul>
 *
 * <p>
...
public abstract class PropertyResourceConfigurer extends PropertiesLoaderSupport
    ...
    /**
     * {@linkplain #mergeProperties Merge}, {@linkplain #convertProperties convert} and {@linkplain #processProperties
     * process} properties against the given bean factory.
     * 
     * @throws BeanInitializationException
     *             if any properties cannot be loaded
     */
    @Override
     ...
     * <p>
     * The default implementation will invoke {@link #convertPropertyValue} for each property value, replacing the
     * original with the converted value.
     * 
     * @param props
     ...
     * 
     * @param originalValue
     *            the original value from the properties source (properties file or local "properties")
     * @return the converted value, to be used for processing
     * @see #setProperties
     * @see #setLocations
     * @see #setLocation
