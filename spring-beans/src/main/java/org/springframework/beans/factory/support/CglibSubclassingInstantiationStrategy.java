 ...
 *
 * <p>
 * Uses CGLIB to generate subclasses dynamically if methods need to be overridden by the container to implement
 * <em>Method Injection</em>.
 *
 * @author Rod Johnson
...
public class CglibSubclassingInstantiationStrategy extends SimpleInstantiationStrategy {
    ...
    /**
     * Index in the CGLIB callback array for a method that should be overridden to provide <em>method lookup</em>.
     */
    private static final int LOOKUP_OVERRIDE = 1;

    /**
     * Index in the CGLIB callback array for a method that should be overridden using generic <em>method replacer</em>
     * functionality.
     */
    ...
    /**
     * An inner class created for historical reasons to avoid external CGLIB dependency in Spring versions earlier than
     * 3.2.
     */
    private static class CglibSubclassCreator {
         ...
         * 
         * @param ctor
         *            constructor to use. If this is {@code null}, use the no-arg constructor (no parameterization, or
         *            Setter Injection)
         * @param args
         *            arguments to use for the constructor. Ignored if the {@code ctor} parameter is {@code null}.
