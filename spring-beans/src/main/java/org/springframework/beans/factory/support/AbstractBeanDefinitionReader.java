...
public abstract class AbstractBeanDefinitionReader implements BeanDefinitionReader, EnvironmentCapable {
    ...
    /**
     * Set the ResourceLoader to use for resource locations. If specifying a ResourcePatternResolver, the bean
     * definition reader will be capable of resolving resource patterns to Resource arrays.
     * <p>
     ...
     * <p>
     * Setting this to {@code null} suggests that absolute resource loading is not available for this bean definition
     * reader.
     *
     ...
     * <p>
     * Default is {@code null}, which suggests to not load bean classes eagerly but rather to just register bean
    ...
    /**
     * Set the Environment to use when reading bean definitions. Most often used for evaluating profile information to
     * determine which bean definitions should be read and which should be omitted.
     */
     ...
     *            a Set to be filled with the actual Resource objects that have been resolved during the loading
     *            process. May be {@code null} to indicate that the caller is not interested in those Resource objects.
