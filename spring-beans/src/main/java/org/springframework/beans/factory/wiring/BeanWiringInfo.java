...
/**
 * Holder for bean wiring metadata information about a particular class. Used in conjunction with the
 * {@link org.springframework.beans.factory.annotation.Configurable} annotation and the AspectJ
...
public class BeanWiringInfo {
    ...
    /**
     * Create a default BeanWiringInfo that suggests plain initialization of factory and post-processor callbacks that
     * the bean class may expect.
     */
     ...
     *             if the supplied beanName is {@code null}, is empty, or consists wholly of whitespace
     */
     ...
     * @param beanName
     *            the name of the bean definition to take the property values from
     * @param isDefaultBeanName
     *            whether the given bean name is a suggested default bean name, not necessarily matching an actual bean
     *            definition
     * @throws IllegalArgumentException
     *             if the supplied beanName is {@code null}, is empty, or consists wholly of whitespace
     */
     ...
     * 
     * @param autowireMode
     *            one of the constants {@link #AUTOWIRE_BY_NAME} / {@link #AUTOWIRE_BY_TYPE}
     * @param dependencyCheck
     *            whether to perform a dependency check for object references in the bean instance (after autowiring)
     * @throws IllegalArgumentException
     *             if the supplied {@code autowireMode} is not one of the allowed values
    ...
    /**
     * Return whether the specific bean name is a suggested default bean name, not necessarily matching an actual bean
    ...
    /**
     * Return one of the constants {@link #AUTOWIRE_BY_NAME} / {@link #AUTOWIRE_BY_TYPE}, if autowiring is indicated.
     */
