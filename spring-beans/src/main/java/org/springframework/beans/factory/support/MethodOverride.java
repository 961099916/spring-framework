 ...
 *
 * <p>
 * Note that the override mechanism is <em>not</em> intended as a generic means of inserting crosscutting code: use AOP
 * for that.
 *
 * @author Rod Johnson
...
public abstract class MethodOverride implements BeanMetadataElement {
    ...
    /**
     * Return whether the overridden method is <em>overloaded</em> (i.e., whether argument type matching needs to occur
     * to disambiguate methods of the same name).
     */
    ...
    /**
     * Set whether the overridden method is <em>overloaded</em> (i.e., whether argument type matching needs to occur to
     * disambiguate methods of the same name).
     * <p>
    ...
    /**
     * Subclasses must override this to indicate whether they <em>match</em> the given method. This allows for argument
     * list checking as well as method name checking.
     * 
     * @param method
     *            the method to check
