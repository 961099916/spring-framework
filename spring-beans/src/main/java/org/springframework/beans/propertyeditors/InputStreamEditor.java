...
/**
 * One-way PropertyEditor which can convert from a text String to a {@code java.io.InputStream}, interpreting the given
 * String as a Spring resource location (e.g. a URL String).
 *
 * <p>
