 ...
 *
 * <p>
 * Strings must be in CSV format, with a customizable separator. By default values in the result are trimmed of
 * whitespace.
 *
 * @author Rod Johnson
...
public class StringArrayPropertyEditor extends PropertyEditorSupport {
     ...
     *            {@code true} if an empty String array is to be transformed into {@code null}
     */
