 ...
 *
 * <p>
 * Optionally allows transforming an empty string into a {@code null} value. Needs to be explicitly registered, e.g. for
 * command binding.
 *
...
public class StringTrimmerEditor extends PropertyEditorSupport {
     ...
     * 
     * @param emptyAsNull
     *            {@code true} if an empty String is to be transformed into {@code null}
     */
