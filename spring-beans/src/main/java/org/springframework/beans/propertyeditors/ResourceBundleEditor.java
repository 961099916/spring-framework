...
/**
 * {@link java.beans.PropertyEditor} implementation for standard JDK {@link java.util.ResourceBundle ResourceBundles}.
 *
 * <p>
 * Only supports conversion <i>from</i> a String, but not <i>to</i> a String.
 *
 * Find below some examples of using this class in a (properly configured) Spring container using XML-based metadata:
 *
 * <pre class="code">
 ...
 *
 * <p>
 * A 'properly configured' Spring {@link org.springframework.context.ApplicationContext container} might contain a
 * {@link org.springframework.beans.factory.config.CustomEditorConfigurer} definition such that the conversion can be
 * effected transparently:
 *
 * <pre class="code">
 ...
 *
 * <p>
 * Please note that this {@link java.beans.PropertyEditor} is <b>not</b> registered by default with any of the Spring
 * infrastructure.
 *
 * <p>
...
public class ResourceBundleEditor extends PropertyEditorSupport {
    ...
    /**
     * The separator used to distinguish between the base name and the locale (if any) when {@link #setAsText(String)
