 ...
 *
 * <p>
 * By default registered for Set, SortedSet and List, to automatically convert any given Collection to one of those
...
public class CustomCollectionEditor extends PropertyEditorSupport {
     ...
     * <p>
     * If the incoming value is of the given type, it will be used as-is. If it is a different Collection type or an
     * array, it will be converted to a default implementation of the given Collection type. If the value is anything
     * else, a target Collection with that single value will be created.
     * <p>
     ...
     *            whether to convert an incoming {@code null} value to an empty Collection (of the appropriate type)
     * @see java.util.Collection
     * @see java.util.ArrayList
     * @see java.util.TreeSet
     * @see java.util.LinkedHashSet
     ...
     * <p>
     * Default is "false"; can be overridden to enforce creation of a new Collection, for example to convert elements in
     * any case.
     *
     * @see #convertElement
     */
    ...
    /**
     * Hook to convert each encountered Collection/array element. The default implementation simply returns the
     * passed-in element as-is.
     * <p>
     * Can be overridden to perform conversion of certain elements, for example String to Integer if a String array
     * comes in and should be converted to a Set of Integer objects.
     * <p>
     * Only called if actually creating a new Collection! This is by default not the case if the type of the passed-in
     * Collection already matches. Override {@link #alwaysCreateNewCollection()} to enforce creating a new Collection in
     * every case.
     *
     * @param element
     *            the source element
