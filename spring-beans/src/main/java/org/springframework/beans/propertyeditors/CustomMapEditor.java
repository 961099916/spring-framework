...
public class CustomMapEditor extends PropertyEditorSupport {
     ...
     * 
     * @param mapType
     *            the target type, which needs to be a sub-interface of Map or a concrete Map class
     * @see java.util.Map
     ...
     * <p>
     * If the incoming value is of the given type, it will be used as-is. If it is a different Map type or an array, it
     * will be converted to a default implementation of the given Map type. If the value is anything else, a target Map
     * with that single value will be created.
     * <p>
     ...
     *            ap whether to convert an incoming {@code null} value to an empty Map (of the appropriate type)
     * @see java.util.Map
     * @see java.util.TreeMap
     * @see java.util.LinkedHashMap
     */
     ...
     * <p>
     * Default is "false"; can be overridden to enforce creation of a new Map, for example to convert elements in any
     * case.
     *
     * @see #convertKey
     * @see #convertValue
     ...
     * <p>
     * Only called if actually creating a new Map! This is by default not the case if the type of the passed-in Map
     * already matches. Override {@link #alwaysCreateNewMap()} to enforce creating a new Map in every case.
     *
     * @param key
     *            the source key
