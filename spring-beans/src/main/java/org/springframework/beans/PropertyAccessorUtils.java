...
/**
 * Utility methods for classes that perform bean property access according to the {@link PropertyAccessor} interface.
 *
...
public abstract class PropertyAccessorUtils {
     ...
     * 
     * @param propertyPath
     *            the property path to determine the property name for (can include property keys, for example for
     *            specifying a map entry)
    ...
    /**
     * Determine whether the given registered path matches the given property path, either indicating the property
     * itself or an indexed element of the property.
     * 
     * @param propertyPath
