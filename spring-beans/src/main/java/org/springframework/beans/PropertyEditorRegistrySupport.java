...
/**
 * Base implementation of the {@link PropertyEditorRegistry} interface. Provides management of default editors and
 * custom editors. Mainly serves as base class for {@link BeanWrapperImpl}.
 *
...
public class PropertyEditorRegistrySupport implements PropertyEditorRegistry {
    ...
    /**
     * Activate the default editors for this registry instance, allowing for lazily registering default editors when
     * needed.
     */
     ...
     * <p>
     * Note that this is different from registering a custom editor in that the editor semantically still is a default
     * editor. A ConversionService will override such a default editor, whereas custom editors usually override the
     * ConversionService.
     * 
     * @param requiredType
     ...
     * 
     * @param elementType
     *            the target type of the element (can be {@code null} if not known)
     * @param propertyPath
     *            the property path (typically of the array/collection; can be {@code null} if not known)
     ...
     * <p>
     * Called by {@link #findCustomEditor} if no required type has been specified, to be able to find a type-specific
     * editor even if just given a property path.
     * <p>
     * The default implementation always returns {@code null}. BeanWrapperImpl overrides this with the standard
     * {@code getPropertyType} method as defined by the BeanWrapper interface.
     * 
     * @param propertyPath
     ...
     * any case be able to render a value as String via {@code getAsText}).
     * 
     * @param requiredType
     *            the type to look for
     ...
     *            the nested property path of the target registry, if any. If this is non-null, only editors registered
