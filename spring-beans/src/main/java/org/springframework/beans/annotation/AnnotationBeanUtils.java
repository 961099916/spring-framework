...
public abstract class AnnotationBeanUtils {
    ...
    /**
     * Copy the properties of the supplied {@link Annotation} to the supplied target bean. Any properties defined in
     * {@code excludedProperties} will not be copied.
     * 
     * @param ann
     *            the annotation to copy from
     * @param bean
     *            the bean instance to copy to
     * @param excludedProperties
     *            the names of excluded properties, if any
     ...
     *            the bean instance to copy to
     * @param valueResolver
     *            a resolve to post-process String property values (may be {@code null})
     * @param excludedProperties
     *            the names of excluded properties, if any
     * @see org.springframework.beans.BeanWrapper
     */
