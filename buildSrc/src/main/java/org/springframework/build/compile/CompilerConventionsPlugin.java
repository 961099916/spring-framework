 ...
 * <p>
 * One can override the default Java source compatibility version with a dedicated property on the CLI:
 * {@code "./gradlew test -PjavaSourceVersion=11"}.
 *
 * @author Brian Clozel
 * @author Sam Brannen
 */
public class CompilerConventionsPlugin implements Plugin<Project> {
    ...
    /**
     * The project property that can be used to switch the Java source compatibility version for building source and
     * test classes.
     */
    ...
    static {
        List<String> commonCompilerArgs = Arrays.asList("-Xlint:serial", "-Xlint:cast", "-Xlint:classfile",
            "-Xlint:dep-ann", "-Xlint:divzero", "-Xlint:empty", "-Xlint:finally", "-Xlint:overrides", "-Xlint:path",
            "-Xlint:processing", "-Xlint:static", "-Xlint:try", "-Xlint:-options");
        COMPILER_ARGS = new ArrayList<>();
        COMPILER_ARGS.addAll(commonCompilerArgs);
        COMPILER_ARGS.addAll(Arrays.asList("-Xlint:varargs", "-Xlint:fallthrough", "-Xlint:rawtypes",
