...
public class MockClientHttpRequest extends MockHttpOutputMessage implements ClientHttpRequest {
    ...
    /**
     * Set the {@link #isExecuted() executed} flag to {@code true} and return the configured
    ...
    /**
     * The default implementation returns the configured {@link #setResponse(ClientHttpResponse) response}.
     * <p>
     * Override this method to execute the request and provide a response, potentially different than the configured
     * response.
     */
