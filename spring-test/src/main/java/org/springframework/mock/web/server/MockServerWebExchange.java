...
/**
 * Extension of {@link DefaultServerWebExchange} for use in tests, along with {@link MockServerHttpRequest} and
 * {@link MockServerHttpResponse}.
 *
 * <p>
...
public final class MockServerWebExchange extends DefaultServerWebExchange {
    ...
    private MockServerWebExchange(MockServerHttpRequest request, WebSessionManager sessionManager) {
        super(request, new MockServerHttpResponse(), sessionManager, ServerCodecConfigurer.create(),
    ...
    public static class Builder {
         ...
         * <p>
         * This method is mutually exclusive with {@link #sessionManager(WebSessionManager)}.
         * 
         * @param session
         *            the session to use
         * @see MockWebSession
