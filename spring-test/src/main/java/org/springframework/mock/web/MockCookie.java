...
/**
 * Extension of {@code Cookie} with extra attributes, as defined in <a href="https://tools.ietf.org/html/rfc6265">RFC
 * 6265</a>.
 *
 * @author Vedran Pavic
...
public class MockCookie extends Cookie {
     ...
     * <p>
     * This limits the scope of the cookie such that it will only be attached to same-site requests if the supplied
     * value is {@code "Strict"} or cross-site requests if the supplied value is {@code "Lax"}.
     *
    ...
    public String toString() {
        return new ToStringCreator(this).append("name", getName()).append("value", getValue()).append("Path", getPath())
            .append("Domain", getDomain()).append("Version", getVersion()).append("Comment", getComment())
            .append("Secure", getSecure()).append("HttpOnly", isHttpOnly()).append("SameSite", this.sameSite)
            .append("Max-Age", getMaxAge()).append("Expires",
