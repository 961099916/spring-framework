...
public class MockHttpSession implements HttpSession {
    ...
    /**
     * Serialize the attributes of this session into an object that can be turned into a byte array with standard Java
     * serialization.
     * 
    ...
    /**
     * Deserialize the attributes of this session from a state object created by {@link #serializeState()}.
     * 
     * @param state
