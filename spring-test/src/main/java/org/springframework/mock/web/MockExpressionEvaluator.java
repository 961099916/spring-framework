...
/**
 * Mock implementation of the JSP 2.0 {@link javax.servlet.jsp.el.ExpressionEvaluator} interface, delegating to the
 * Apache JSTL {@link ExpressionEvaluatorManager}. Only necessary for testing applications when testing custom JSP tags.
 *
 * <p>
 * Note that the Apache JSTL implementation (jstl.jar, standard.jar) has to be available on the classpath to use this
