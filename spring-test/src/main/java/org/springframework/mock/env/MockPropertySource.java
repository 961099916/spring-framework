...
/**
 * Simple {@link PropertySource} implementation for use in testing. Accepts a user-provided {@link Properties} object,
 * or if omitted during construction, the implementation will initialize its own.
 *
...
public class MockPropertySource extends PropertiesPropertySource {
    ...
    /**
     * Create a new {@code MockPropertySource} named {@value #MOCK_PROPERTIES_PROPERTY_SOURCE_NAME} that will maintain
     * its own internal {@link Properties} instance.
     */
    ...
    /**
     * Create a new {@code MockPropertySource} named {@value #MOCK_PROPERTIES_PROPERTY_SOURCE_NAME} and backed by the
    ...
    /**
     * Convenient synonym for {@link #setProperty} that returns the current instance. Useful for method chaining and
     * fluent-style use.
     * 
