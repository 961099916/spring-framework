 ...
 * binding a JDBC DataSource to a well-known JNDI location, to be able to use traditional Java EE data access code
...
public class SimpleNamingContextBuilder implements InitialContextFactoryBuilder {
     ...
     * existing activated SimpleNamingContextBuilder, clear it and return it.
     * <p>
     ...
     *             if there's already a naming context builder registered with the JNDI NamingManager
     */
     ...
     * 
     * @param name
     *            the JNDI name of the object (e.g. "java:comp/env/jdbc/myds")
     * @param obj
