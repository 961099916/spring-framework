...
/**
 * Concrete implementation of {@link AbstractGenericContextLoader} that reads bean definitions from XML resources.
 *
 * <p>
    ...
    protected void validateMergedContextConfiguration(MergedContextConfiguration mergedConfig) {
        if (mergedConfig.hasClasses()) {
            String msg = String.format(
                ...
                mergedConfig.getTestClass().getName(), ObjectUtils.nullSafeToString(mergedConfig.getClasses()),
