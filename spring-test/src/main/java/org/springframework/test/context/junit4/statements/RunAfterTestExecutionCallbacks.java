...
/**
 * {@code RunAfterTestExecutionCallbacks} is a custom JUnit {@link Statement} which allows the <em>Spring TestContext
 * Framework</em> to be plugged into the JUnit 4 execution chain by calling {@link TestContextManager#afterTestExecution
...
public class RunAfterTestExecutionCallbacks extends Statement {
     ...
     *            the TestContextManager upon which to call {@code afterTestExecution()}
     */
     ...
     * {@link RunBeforeTestExecutionCallbacks}), catching any exceptions thrown, and then invoke
     * {@link TestContextManager#afterTestExecution} supplying the first caught exception (if any).
     * <p>
     * If the invocation of {@code afterTestExecution()} throws an exception, that exception will also be tracked.
