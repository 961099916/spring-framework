...
/**
 * {@link ContextCustomizerFactory} which creates a {@link MockServerContainerContextCustomizer} if WebSocket support is
 * present in the classpath and the test class is annotated with {@code @WebAppConfiguration}.
 *
 * @author Sam Brannen
 * @since 4.3.1
 */
