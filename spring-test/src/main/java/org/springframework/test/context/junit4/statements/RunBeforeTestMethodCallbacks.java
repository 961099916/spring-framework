...
/**
 * {@code RunBeforeTestMethodCallbacks} is a custom JUnit {@link Statement} which allows the <em>Spring TestContext
...
public class RunBeforeTestMethodCallbacks extends Statement {
    ...
    /**
     * Invoke {@link TestContextManager#beforeTestMethod(Object, Method)} and then evaluate the next {@link Statement}
     * in the execution chain (typically an instance of {@link org.junit.internal.runners.statements.RunBefores
     * RunBefores}).
     */
    @Override
