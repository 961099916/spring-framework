...
/**
 * {@code MergedTestPropertySources} encapsulates the <em>merged</em> property sources declared on a test class and all
 * of its superclasses via {@link TestPropertySource @TestPropertySource}.
 *
 * @author Sam Brannen
 * @since 4.1
...
class MergedTestPropertySources {
    ...
    /**
     * Create a {@code MergedTestPropertySources} instance with the supplied {@code locations} and {@code properties}.
     *
     * @param locations
     *            the resource locations of properties files; may be empty but never {@code null}
     * @param properties
     *            the properties in the form of {@code key=value} pairs; may be empty but never {@code null}
     */
