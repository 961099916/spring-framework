...
public abstract class TestConstructorUtils {
     ...
     *
     * <p>
     * This method delegates to {@link #isAutowirableConstructor(Constructor, Class)} if the executable is a
     * constructor.
     *
     * @param executable
     *            an executable for the test class
     * @param testClass
     *            the test class
    ...
    public static boolean isAutowirableConstructor(Executable executable, Class<?> testClass) {
        return (executable instanceof Constructor && isAutowirableConstructor((Constructor<?>)executable, testClass));
    }
     ...
     * <li>{@link TestConstructor @TestConstructor} is <em>present</em> or <em>meta-present</em> on the test class with
     * {@link TestConstructor#autowireMode() autowireMode} set to {@link AutowireMode#ALL ALL}.</li>
