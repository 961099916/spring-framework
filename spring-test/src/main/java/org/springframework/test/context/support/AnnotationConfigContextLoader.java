...
/**
 * Concrete implementation of {@link AbstractGenericContextLoader} that loads bean definitions from component classes.
 *
 * <p>
 * See the Javadoc for {@link org.springframework.test.context.ContextConfiguration @ContextConfiguration} for a
 * definition of <em>component class</em>.
 *
 * <p>
 * Note: {@code AnnotationConfigContextLoader} supports <em>component classes</em> rather than the String-based resource
 * locations defined by the legacy {@link org.springframework.test.context.ContextLoader ContextLoader} API. Thus,
 * although {@code AnnotationConfigContextLoader} extends {@code AbstractGenericContextLoader},
 * {@code AnnotationConfigContextLoader} does <em>not</em> support any String-based methods defined by
 * {@code AbstractContextLoader} or {@code AbstractGenericContextLoader}. Consequently,
 * {@code AnnotationConfigContextLoader} should chiefly be considered a
 * {@link org.springframework.test.context.SmartContextLoader SmartContextLoader} rather than a
 * {@link org.springframework.test.context.ContextLoader ContextLoader}.
 *
 * @author Sam Brannen
 * @since 3.1
...
public class AnnotationConfigContextLoader extends AbstractGenericContextLoader {
     ...
     * <p>
     * If the <em>component classes</em> are {@code null} or empty and {@link #isGenerateDefaultLocations()} returns
     * {@code true}, this {@code SmartContextLoader} will attempt to {@link #detectDefaultConfigurationClasses detect
     * default configuration classes}. If defaults are detected they will be
     * {@link ContextConfigurationAttributes#setClasses(Class[]) set} in the supplied configuration attributes.
     * Otherwise, properties in the supplied configuration attributes will not be modified.
     * 
    ...
    /**
     * Ensure that the supplied {@link MergedContextConfiguration} does not contain
     * {@link MergedContextConfiguration#getLocations() locations}.
     * 
     * @since 4.0.4
    ...
    /**
     * Register classes in the supplied {@link GenericApplicationContext context} from the classes in the supplied
     * {@link MergedContextConfiguration}.
     * <p>
     * Each class must represent a <em>component class</em>. An {@link AnnotatedBeanDefinitionReader} is used to
     * register the appropriate bean definitions.
     * <p>
     * Note that this method does not call {@link #createBeanDefinitionReader} since
     * {@code AnnotatedBeanDefinitionReader} is not an instance of {@link BeanDefinitionReader}.
     * 
     * @param context
     *            the context in which the component classes should be registered
     * @param mergedConfig
