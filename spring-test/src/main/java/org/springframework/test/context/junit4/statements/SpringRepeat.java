...
/**
 * {@code SpringRepeat} is a custom JUnit {@link Statement} which adds support for Spring's
 * {@link org.springframework.test.annotation.Repeat @Repeat} annotation by repeating the test the specified number of
 * times.
 *
 * @author Sam Brannen
 * @since 3.0
...
public class SpringRepeat extends Statement {
    ...
    /**
     * Construct a new {@code SpringRepeat} statement for the supplied {@code testMethod}, retrieving the configured
     * repeat count from the {@code @Repeat} annotation on the supplied method.
     * 
     * @param next
    ...
    /**
     * Evaluate the next {@link Statement statement} in the execution chain repeatedly, using the specified repeat
     * count.
     */
    @Override
