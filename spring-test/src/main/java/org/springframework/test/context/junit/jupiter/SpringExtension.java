...
/**
 * {@code SpringExtension} integrates the <em>Spring TestContext Framework</em> into JUnit 5's <em>Jupiter</em>
 * programming model.
 *
 * <p>
 * To use this extension, simply annotate a JUnit Jupiter based test class with
 * {@code @ExtendWith(SpringExtension.class)}, {@code @SpringJUnitConfig}, or {@code @SpringJUnitWebConfig}.
 *
 * @author Sam Brannen
 * @since 5.0
...
public class SpringExtension implements BeforeAllCallback, AfterAllCallback, TestInstancePostProcessor,
     ...
     *
     * @param context
     *            the current {@code ExtensionContext} (never {@code null})
    ...
    /**
     * Determine if the value for the {@link Parameter} in the supplied {@link ParameterContext} should be autowired
     ...
     * <ol>
     * <li>The {@linkplain ParameterContext#getDeclaringExecutable() declaring executable} is a {@link Constructor} and
     * {@link TestConstructorUtils#isAutowirableConstructor(Constructor, Class)} returns {@code true}.</li>
     * <li>The parameter is of type {@link ApplicationContext} or a sub-type thereof.</li>
     * <li>{@link ParameterResolutionDelegate#isAutowirable} returns {@code true}.</li>
     * </ol>
     * <p>
     * <strong>WARNING</strong>: If a test class {@code Constructor} is annotated with {@code @Autowired} or
     * automatically autowirable (see {@link TestConstructor}), Spring will assume the responsibility for resolving all
     * parameters in the constructor. Consequently, no other registered {@link ParameterResolver} will be able to
     * resolve parameters.
     *
    ...
    /**
     * Resolve a value for the {@link Parameter} in the supplied {@link ParameterContext} by retrieving the
