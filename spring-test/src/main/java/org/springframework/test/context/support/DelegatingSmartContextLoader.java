...
/**
 * {@code DelegatingSmartContextLoader} is a concrete implementation of {@link AbstractDelegatingSmartContextLoader}
 * that delegates to a {@link GenericXmlContextLoader} (or a {@link GenericGroovyXmlContextLoader} if Groovy is present
 * in the classpath) and an {@link AnnotationConfigContextLoader}.
 *
 * @author Sam Brannen
 * @since 3.1
...
public class DelegatingSmartContextLoader extends AbstractDelegatingSmartContextLoader {
    ...
    private static final boolean groovyPresent =
        ClassUtils.isPresent("groovy.lang.Closure", DelegatingSmartContextLoader.class.getClassLoader()) && ClassUtils
            .isPresent(GROOVY_XML_CONTEXT_LOADER_CLASS_NAME, DelegatingSmartContextLoader.class.getClassLoader());
