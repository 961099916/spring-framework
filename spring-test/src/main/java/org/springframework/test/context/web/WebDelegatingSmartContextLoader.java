...
/**
 * {@code WebDelegatingSmartContextLoader} is a concrete implementation of {@link AbstractDelegatingSmartContextLoader}
 * that delegates to a {@link GenericXmlWebContextLoader} (or a {@link GenericGroovyXmlWebContextLoader} if Groovy is
 * present on the classpath) and an {@link AnnotationConfigWebContextLoader}.
 *
 * @author Sam Brannen
 * @since 3.2
...
public class WebDelegatingSmartContextLoader extends AbstractDelegatingSmartContextLoader {
    ...
    private static final boolean groovyPresent =
        ClassUtils.isPresent("groovy.lang.Closure", WebDelegatingSmartContextLoader.class.getClassLoader())
