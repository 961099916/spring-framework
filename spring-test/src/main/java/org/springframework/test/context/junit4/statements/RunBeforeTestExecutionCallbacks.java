...
/**
 * {@code RunBeforeTestExecutionCallbacks} is a custom JUnit {@link Statement} which allows the <em>Spring TestContext
 * Framework</em> to be plugged into the JUnit 4 execution chain by calling
 * {@link TestContextManager#beforeTestExecution beforeTestExecution()} on the supplied {@link TestContextManager}.
 *
 * @author Sam Brannen
 * @since 5.0
 * @see #evaluate()
...
public class RunBeforeTestExecutionCallbacks extends Statement {
     ...
     *            the TestContextManager upon which to call {@code beforeTestExecution()}
     */
    ...
    /**
     * Invoke {@link TestContextManager#beforeTestExecution(Object, Method)} and then evaluate the next
