...
public class DefaultBootstrapContext implements BootstrapContext {
     ...
     * 
     * @param testClass
     *            the test class for this bootstrap context; never {@code null}
     * @param cacheAwareContextLoaderDelegate
     *            the context loader delegate to use for transparent interaction with the {@code ContextCache}; never
     *            {@code null}
     */
    public DefaultBootstrapContext(Class<?> testClass,
