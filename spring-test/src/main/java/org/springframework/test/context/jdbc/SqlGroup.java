 ...
 *
 * <p>
 * Can be used natively, declaring several nested {@code @Sql} annotations. Can also be used in conjunction with Java
 * 8's support for repeatable annotations, where {@code @Sql} can simply be declared several times on the same class or
