 ...
 *
 * <p>
 * To use a static {@link DefaultContextCache}, invoke the {@link #DefaultCacheAwareContextLoaderDelegate()}
 * constructor; otherwise, invoke the {@link #DefaultCacheAwareContextLoaderDelegate(ContextCache)} and provide a custom
 * {@link ContextCache} implementation.
 *
 * @author Sam Brannen
 * @since 4.1
 */
public class DefaultCacheAwareContextLoaderDelegate implements CacheAwareContextLoaderDelegate {
    ...
    /**
     * Construct a new {@code DefaultCacheAwareContextLoaderDelegate} using a static {@link DefaultContextCache}.
     * <p>
     * This default cache is static so that each context can be cached and reused for all subsequent tests that declare
     * the same unique context configuration within the same JVM process.
     * 
