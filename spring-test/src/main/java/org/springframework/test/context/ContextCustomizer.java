...
/**
 * Strategy interface for customizing {@link ConfigurableApplicationContext application contexts} that are created and
 * managed by the <em>Spring TestContext Framework</em>.
 *
 * <p>
 * Customizers are created by {@link ContextCustomizerFactory} implementations.
 *
 * <p>
 * Implementations must implement correct {@code equals} and {@code hashCode} methods since customizers form part of the
...
public interface ContextCustomizer {
    ...
    /**
     * Customize the supplied {@code ConfigurableApplicationContext} <em>after</em> bean definitions have been loaded
