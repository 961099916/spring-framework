...
public abstract class AbstractTestExecutionListener implements TestExecutionListener, Ordered {
    ...
    /**
     * The default implementation returns {@link Ordered#LOWEST_PRECEDENCE}, thereby ensuring that custom listeners are
     * ordered after default listeners supplied by the framework. Can be overridden by subclasses as necessary.
     * 
     * @since 4.1
     */
    @Override
