...
/**
 * Abstract {@linkplain Transactional transactional} extension of {@link AbstractJUnit4SpringContextTests} which adds
 * convenience functionality for JDBC access. Expects a {@link DataSource} bean and a {@link PlatformTransactionManager}
 * bean to be defined in the Spring {@linkplain ApplicationContext application context}.
 *
 * <p>
 * This class exposes a {@link JdbcTemplate} and provides an easy way to {@linkplain #countRowsInTable count the number
 * of rows in a table} (potentially {@linkplain #countRowsInTableWhere with a WHERE clause}),
 * {@linkplain #deleteFromTables delete from tables}, {@linkplain #dropTables drop tables}, and
 ...
 *
 * <p>
 * The following {@link org.springframework.test.context.TestExecutionListener TestExecutionListeners} are configured by
 * default:
 *
 * <ul>
 ...
 * <ul>
 * <li>If you do not wish for your test classes to be tied to a Spring-specific class hierarchy, you may configure your
 * own custom test classes by using {@link SpringRunner}, {@link ContextConfiguration @ContextConfiguration},
 * {@link TestExecutionListeners @TestExecutionListeners}, etc.</li>
 * <li>If you wish to extend this class and use a runner other than the {@link SpringRunner}, as of Spring Framework 4.2
 * you can use {@link org.springframework.test.context.junit4.rules.SpringClassRule SpringClassRule} and
 * {@link org.springframework.test.context.junit4.rules.SpringMethodRule SpringMethodRule} and specify your runner of
 * choice via {@link org.junit.runner.RunWith @RunWith(...)}.</li>
 * </ul>
 *
 * <p>
...
public abstract class AbstractTransactionalJUnit4SpringContextTests extends AbstractJUnit4SpringContextTests {
     ...
     * @param whereClause
     *            the {@code WHERE} clause to append to the query
     ...
     *            the {@code WHERE} clause to append to the query
     * @param args
     *            arguments to bind to the query (leaving it to the {@code
     * PreparedStatement} to guess the corresponding SQL type); may also contain
     *            {@link org.springframework.jdbc.core.SqlParameterValue SqlParameterValue} objects which indicate not
