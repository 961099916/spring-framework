...
/**
 * {@code ContextConfigurationAttributes} encapsulates the context configuration attributes declared via
...
public class ContextConfigurationAttributes {
     ...
     *            the test class that declared {@code @ContextConfiguration}, either explicitly or implicitly
     * @since 4.3
     */
    ...
    /**
     * Construct a new {@link ContextConfigurationAttributes} instance for the supplied
     * {@link ContextConfiguration @ContextConfiguration} annotation and the {@linkplain Class test class} that declared
     * it.
     * 
     * @param declaringClass
    ...
    /**
     * Construct a new {@link ContextConfigurationAttributes} instance for the supplied {@link AnnotationAttributes}
     * (parsed from a {@link ContextConfiguration @ContextConfiguration} annotation) and the {@linkplain Class test
    ...
    /**
     * Construct a new {@link ContextConfigurationAttributes} instance for the {@linkplain Class test class} that
     * declared the {@link ContextConfiguration @ContextConfiguration} annotation and its corresponding attributes.
     * 
     * @param declaringClass
     *            the test class that declared {@code @ContextConfiguration}
     * @param locations
     *            the resource locations declared via {@code @ContextConfiguration}
     * @param classes
     *            the annotated classes declared via {@code @ContextConfiguration}
     * @param inheritLocations
     *            the {@code inheritLocations} flag declared via {@code @ContextConfiguration}
     * @param initializers
     *            the context initializers declared via {@code @ContextConfiguration}
     * @param inheritInitializers
     *            the {@code inheritInitializers} flag declared via {@code @ContextConfiguration}
     * @param contextLoaderClass
     *            the {@code ContextLoader} class declared via {@code @ContextConfiguration}
     * @throws IllegalArgumentException
     *             if the {@code declaringClass} or {@code contextLoaderClass} is {@code null}
     */
     ...
     *            the {@code inheritInitializers} flag declared via {@code @ContextConfiguration}
     * @param name
     *            the name of level in the context hierarchy, or {@code null} if not applicable
     * @param contextLoaderClass
     *            the {@code ContextLoader} class declared via {@code @ContextConfiguration}
     * @throws IllegalArgumentException
     *             if the {@code declaringClass} or {@code contextLoaderClass} is {@code null}
    ...
    /**
     * Get the {@linkplain Class class} that declared the {@link ContextConfiguration @ContextConfiguration} annotation,
    ...
    /**
     * Get the annotated classes that were declared via {@link ContextConfiguration @ContextConfiguration}.
     * <p>
     * Note: this is a mutable property. The returned value may therefore represent a <em>processed</em> value that does
     * not match the original value declared via {@link ContextConfiguration @ContextConfiguration}.
     *
    ...
    /**
     * Set the <em>processed</em> annotated classes, effectively overriding the original value declared via
     * {@link ContextConfiguration @ContextConfiguration}.
     *
     * @see #getClasses()
     */
    ...
    /**
     * Get the resource locations that were declared via {@link ContextConfiguration @ContextConfiguration}.
     * <p>
     * Note: this is a mutable property. The returned value may therefore represent a <em>processed</em> value that does
     * not match the original value declared via {@link ContextConfiguration @ContextConfiguration}.
     *
    ...
    /**
     * Set the <em>processed</em> resource locations, effectively overriding the original value declared via
     * {@link ContextConfiguration @ContextConfiguration}.
     *
     * @see #getLocations()
     */
    ...
    /**
     * Determine if this {@code ContextConfigurationAttributes} instance has either path-based resource locations or
    ...
    /**
     * Determine if the supplied object is equal to this {@code ContextConfigurationAttributes} instance by comparing
     * both object's {@linkplain #getDeclaringClass() declaring class}, {@linkplain #getLocations() locations},
     * {@linkplain #getClasses() annotated classes}, {@linkplain #isInheritLocations() inheritLocations flag},
     * {@linkplain #getInitializers() context initializer classes}, {@linkplain #isInheritInitializers()
     * inheritInitializers flag}, and the {@link #getContextLoaderClass() ContextLoader class}.
     */
    @Override
    public boolean equals(@Nullable Object other) {
        ...
        return (ObjectUtils.nullSafeEquals(this.declaringClass, otherAttr.declaringClass)
            && Arrays.equals(this.classes, otherAttr.classes)) && Arrays.equals(this.locations, otherAttr.locations)
    ...
    /**
     * Generate a unique hash code for all properties of this {@code ContextConfigurationAttributes} instance excluding
     * the {@linkplain #getName() name}.
     */
    @Override
    public int hashCode() {
