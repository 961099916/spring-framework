...
public class DefaultTestContext implements TestContext {
    ...
    /**
     * <em>Copy constructor</em> for creating a new {@code DefaultTestContext} based on the <em>attributes</em> and
     * immutable state of the supplied context.
     * <p>
     * <em>Immutable state</em> includes all arguments supplied to the
     * {@linkplain #DefaultTestContext(Class, MergedContextConfiguration, CacheAwareContextLoaderDelegate) standard
     * constructor}.
     * 
     * @throws NullPointerException
     *             if the supplied {@code DefaultTestContext} is {@code null}
     */
     ...
     * 
     * @param testClass
     *            the test class for this test context
     * @param mergedContextConfiguration
     *            the merged application context configuration for this test context
    ...
    /**
     * Determine if the {@linkplain ApplicationContext application context} for this test context is present in the
     * context cache.
     * 
     * @return {@code true} if the application context has already been loaded and stored in the context cache
     * @since 5.2
     ...
     * <p>
     * The default implementation delegates to the {@link CacheAwareContextLoaderDelegate} that was supplied when this
     * {@code TestContext} was constructed.
     * 
     * @throws IllegalStateException
     *             if the context returned by the context loader delegate is not <em>active</em> (i.e., has been closed)
    ...
    /**
     * Mark the {@linkplain ApplicationContext application context} associated with this test context as <em>dirty</em>
    ...
    @Override
    public void updateState(@Nullable Object testInstance, @Nullable Method testMethod,
    ...
    public String toString() {
        return new ToStringCreator(this).append("testClass", this.testClass).append("testInstance", this.testInstance)
            .append("testMethod", this.testMethod).append("testException", this.testException)
            .append("mergedContextConfiguration", this.mergedContextConfiguration).append("attributes", this.attributes)
            .toString();
    }
