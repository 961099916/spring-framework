 ...
 *
 * <p>
 * An instance of this class is typically accessed via {@link MockMvcResultMatchers#model}.
 *
...
public class ModelResultMatchers {
    ...
    public ResultMatcher attributeErrorCount(String name, int expectedCount) {
        return result -> {
            ...
            assertEquals("Binding/validation error count for attribute '" + name + "',", expectedCount,
