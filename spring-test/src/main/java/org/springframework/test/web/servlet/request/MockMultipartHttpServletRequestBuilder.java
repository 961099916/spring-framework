...
public class MockMultipartHttpServletRequestBuilder extends MockHttpServletRequestBuilder {
     ...
     * <p>
     * For other ways to initialize a {@code MockMultipartHttpServletRequest}, see {@link #with(RequestPostProcessor)}
     * and the {@link RequestPostProcessor} extension point.
     * 
     * @param urlTemplate
    ...
    /**
     * Create a new {@link MockMultipartHttpServletRequest} based on the supplied {@code ServletContext} and the
     * {@code MockMultipartFiles} added to this builder.
     */
    @Override
    protected final MockHttpServletRequest createServletRequest(ServletContext servletContext) {
        ...
        if (!this.parts.isEmpty()) {
            new StandardMultipartHttpServletRequest(request).getMultiFileMap().values().stream()
                .flatMap(Collection::stream).forEach(request::addFile);
        }
