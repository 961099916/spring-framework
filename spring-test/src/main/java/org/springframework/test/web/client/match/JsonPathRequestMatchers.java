...
/**
 * Factory for assertions on the request content using <a href="https://github.com/jayway/JsonPath">JsonPath</a>
 * expressions.
 *
 * <p>
 * An instance of this class is typically accessed via {@link MockRestRequestMatchers#jsonPath(String, Matcher)} or
...
public class JsonPathRequestMatchers {
     ...
     * <p>
     * Use {@link MockRestRequestMatchers#jsonPath(String, Matcher)} or
     * {@link MockRestRequestMatchers#jsonPath(String, Object...)}.
     * 
     * @param expression
    ...
    /**
     * Evaluate the JSON path expression against the request content and assert the resulting value with the given
    ...
    /**
     * Evaluate the JSON path expression against the request content and assert that the result is equal to the supplied
     * value.
     */
    ...
    /**
     * Evaluate the JSON path expression against the request content and assert that a non-null value exists at the
     * given path.
     * <p>
    ...
    /**
     * Evaluate the JSON path expression against the request content and assert that a value does not exist at the given
     * path.
     * <p>
     * If the JSON path expression is not {@linkplain JsonPath#isDefinite definite}, this method asserts that the value
    ...
    /**
     * Evaluate the JSON path expression against the request content and assert that an empty value exists at the given
     * path.
     * <p>
    ...
    /**
     * Evaluate the JSON path expression against the request content and assert that a non-empty value exists at the
     * given path.
     * <p>
     * For the semantics of <em>empty</em>, consult the Javadoc for
     * {@link org.springframework.util.ObjectUtils#isEmpty(Object)}.
