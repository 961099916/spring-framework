 ...
 * lifecycle events, as well as no pre-processing and post-processing hooks typically associated with beans managed by
 * an {@link ApplicationContext}. Just a simple lookup into a {@link StaticListableBeanFactory}.
 *
...
class StubWebApplicationContext implements WebApplicationContext {
    ...
    /**
     * An extension of StaticListableBeanFactory that implements AutowireCapableBeanFactory in order to allow bean
     * initialization of {@link ApplicationContextAware} singletons.
     */
