...
class DefaultWebTestClient implements WebTestClient {
    ...
    private static class DefaultResponseSpec implements ResponseSpec {
        ...
        DefaultResponseSpec(WiretapConnector.Info wiretapInfo, ClientResponse response, @Nullable String uriTemplate,
            Duration timeout) {
    ...
    private class DefaultRequestBodyUriSpec implements RequestBodyUriSpec {
        ...
        @Override
        public <T, S extends Publisher<T>> RequestHeadersSpec<?> body(S publisher,
