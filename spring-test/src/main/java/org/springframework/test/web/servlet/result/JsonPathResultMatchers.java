...
/**
 * Factory for assertions on the response content using <a href="https://github.com/jayway/JsonPath">JsonPath</a>
 * expressions.
 *
 * <p>
 * An instance of this class is typically accessed via {@link MockMvcResultMatchers#jsonPath(String, Object...)}.
 *
...
public class JsonPathResultMatchers {
    ...
    /**
     * Configures the current {@code JsonPathResultMatchers} instance to verify that the JSON payload is prepended with
     * the given prefix.
     * <p>
    ...
    /**
     * Evaluate the JSON path expression against the response content and assert the resulting value with the given
    ...
    /**
     * An overloaded variant of {@link #value(Matcher)} that also accepts a target type for the resulting value that the
     * matcher can work reliably against.
     * <p>
    ...
    /**
     * Evaluate the JSON path expression against the response content and assert that the result is equal to the
     * supplied value.
     * 
     * @see #value(Matcher)
     * @see #value(Matcher, Class)
    ...
    /**
     * Evaluate the JSON path expression against the response content and assert that a non-null value, possibly an
     * empty array or map, exists at the given path.
     * <p>
     * If the JSON path expression is not {@linkplain JsonPath#isDefinite definite}, this method asserts that the value
    ...
    /**
     * Evaluate the JSON path expression against the response content and assert that a non-null value does not exist at
     * the given path.
     * <p>
     * If the JSON path expression is not {@linkplain JsonPath#isDefinite definite}, this method asserts that the value
     * at the given path is <em>empty</em>.
     */
    ...
    /**
     * Evaluate the JSON path expression against the response content and assert that an empty value exists at the given
     * path.
     * <p>
    ...
    /**
     * Evaluate the JSON path expression against the response content and assert that a non-empty value exists at the
     * given path.
     * <p>
     * For the semantics of <em>empty</em>, consult the Javadoc for
     * {@link org.springframework.util.ObjectUtils#isEmpty(Object)}.
    ...
    /**
     * Evaluate the JSON path expression against the response content and assert that a value, possibly {@code null},
     * exists.
     * <p>
