...
/**
 * Default implementation of {@code RequestExpectation} that simply delegates to the request matchers and the response
 * creator it contains.
 *
...
public class DefaultRequestExpectation implements RequestExpectation {
    ...
    /**
     * Note that as of 5.0.3, the creation of the response, which may block intentionally, is separated from request
     * count tracking, and this method no longer increments the count transparently. Instead
