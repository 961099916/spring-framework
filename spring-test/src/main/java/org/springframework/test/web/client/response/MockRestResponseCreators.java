 ...
 *
 * <p>
 * <strong>Eclipse users:</strong> consider adding this class as a Java editor favorite. To navigate, open the
...
public abstract class MockRestResponseCreators {
     ...
     * 
     * @param body
     *            the response body, a "UTF-8" string
     * @param contentType
     *            the type of the content (may be {@code null})
     */
     ...
     * 
     * @param location
     *            the value for the {@code Location} header
     */
     ...
     * <p>
     * For example, one could use this to simulate a {@code SocketTimeoutException}.
     * 
     * @param ex
     *            the {@code Exception} to be thrown at HTTP call time
     * @since 5.2.2
     */
