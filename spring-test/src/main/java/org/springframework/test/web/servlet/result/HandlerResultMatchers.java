 ...
 *
 * <p>
 * <strong>Note:</strong> Expectations that assert the controller method used to process the request work only for
 * requests processed with {@link RequestMappingHandlerMapping} and {@link RequestMappingHandlerAdapter} which is used
 * by default with the Spring MVC Java config and XML namespace.
 *
...
public class HandlerResultMatchers {
     ...
     * <p>
     * The expected method is specified through a "mock" controller method invocation similar to
