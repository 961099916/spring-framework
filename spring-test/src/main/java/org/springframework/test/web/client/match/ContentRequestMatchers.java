...
/**
 * Factory for request content {@code RequestMatcher}'s. An instance of this class is typically accessed via
 * {@link MockRestRequestMatchers#content()}.
 *
...
public class ContentRequestMatchers {
    ...
    /**
     * Parse the request body and the given String as XML and assert that the two are "similar" - i.e. they contain the
     * same elements and attributes regardless of order.
     * <p>
     * Use of this matcher assumes the <a href="http://xmlunit.sourceforge.net/">XMLUnit</a> library is available.
     * 
     * @param expectedXmlContent
    ...
    /**
     * Parse the request body and the given string as JSON and assert the two are "similar" - i.e. they contain the same
     * attribute-value pairs regardless of formatting.
     * <p>
