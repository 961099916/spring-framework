...
public abstract class MockMvcResultHandlers {
    ...
    /**
     * Log {@link MvcResult} details as a {@code DEBUG} log message via Apache Commons Logging using the log category
    ...
    /**
     * A {@link ResultHandler} that logs {@link MvcResult} details at {@code DEBUG} level via Apache Commons Logging.
     *
     * <p>
     * Delegates to a {@link PrintWriterPrintingResultHandler} for building the log message.
     *
     * @since 4.2
     */
