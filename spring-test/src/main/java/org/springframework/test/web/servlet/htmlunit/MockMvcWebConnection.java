...
public final class MockMvcWebConnection implements WebConnection {
    ...
    /**
     * Create a new instance that assumes the context path of the application is {@code ""} (i.e., the root context).
     * <p>
     * For example, the URL {@code http://localhost/test/this} would use {@code ""} as the context path.
     * 
     * @param mockMvc
     *            the {@code MockMvc} instance to use; never {@code null}
     * @param webClient
     *            the {@link WebClient} to use. never {@code null}
     */
     ...
     * <p>
     * The path may be {@code null} in which case the first path segment of the URL is turned into the contextPath.
     * Otherwise it must conform to {@link javax.servlet.http.HttpServletRequest#getContextPath()} which states that it
     * can be an empty string and otherwise must start with a "/" character and not end with a "/" character.
     * 
     * @param mockMvc
     *            the {@code MockMvc} instance to use (never {@code null})
     * @param webClient
     ...
     * {@link javax.servlet.http.HttpServletRequest#getContextPath()} which states that it can be an empty string and
     * otherwise must start with a "/" character and not end with a "/" character.
     * 
     * @param contextPath
