...
public abstract class MockMvcResultMatchers {
     ...
     * 
     * @param urlTemplate
     *            a URL template; the expanded URL will be encoded
     * @param uriVars
     *            zero or more URI variables to populate the template
     ...
     * Asserts the request was forwarded to the given URL.
     * <p>
     * This method accepts {@link org.springframework.util.AntPathMatcher} patterns.
     * 
     * @param urlPattern
     *            an Ant-style path pattern to match against
     * @since 4.0
     * @see org.springframework.util.AntPathMatcher
     */
    public static ResultMatcher forwardedUrlPattern(String urlPattern) {
        return result -> {
            assertTrue("'" + urlPattern + "' is not an Ant-style path pattern", pathMatcher.isPattern(urlPattern));
    ...
    /**
     * Access to response body assertions using a <a href="https://github.com/jayway/JsonPath">JsonPath</a> expression
     ...
     * 
     * @param expression
     *            the JSON path expression, optionally parameterized with arguments
     * @param args
    ...
    /**
     * Evaluate the given <a href="https://github.com/jayway/JsonPath">JsonPath</a> expression against the response body
     * and assert the resulting value with the given Hamcrest {@link Matcher}.
     * 
     * @param expression
    ...
    /**
     * Evaluate the given <a href="https://github.com/jayway/JsonPath">JsonPath</a> expression against the response body
     * and assert the resulting value with the given Hamcrest {@link Matcher}, coercing the resulting value into the
     ...
     *            a matcher for the value expected at the JSON path
     * @param targetType
     *            the target type to coerce the matching value into
     * @since 5.2
     * @see #jsonPath(String, Object...)
     * @see #jsonPath(String, Matcher)
     */
     ...
     * 
     * @param expression
     *            the XPath expression, optionally parameterized with arguments
     * @param args
