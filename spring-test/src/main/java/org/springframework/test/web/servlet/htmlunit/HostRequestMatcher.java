 ...
 * {@code "code.jquery.com"} or the host {@code "cdn.com"} without regard for the port.
 *
 * <pre class="code">
 ...
 * {@code "code.jquery.com"} with the port of {@code 80}.
 *
 * <pre class="code">
 ...
 *
 * <p>
 * The above {@code cdnMatcher} would match {@code "http://code.jquery.example/jquery.js"} which has a default port of
 * {@code 80} and {@code "http://code.jquery.example:80/jquery.js"}. However, it would not match
 * {@code "https://code.jquery.example/jquery.js"} which has a default port of {@code 443}.
 *
 * @author Rob Winch
 * @author Sam Brannen
 * @since 4.2
...
public final class HostRequestMatcher implements WebRequestMatcher {
    ...
    /**
     * Create a new {@code HostRequestMatcher} for the given hosts &mdash; for example: {@code "localhost"},
     * {@code "example.com:443"}, etc.
     * 
     * @param hosts
