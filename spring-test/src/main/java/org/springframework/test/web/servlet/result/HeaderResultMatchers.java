 ...
 *
 * <p>
 * An instance of this class is available via {@link MockMvcResultMatchers#header}.
 *
...
public class HeaderResultMatchers {
     ...
     * <p>
     * The {@link ResultMatcher} returned by this method throws an {@link AssertionError} if the response does not
     * contain the specified header, or if the supplied {@code value} does not match the primary value.
     */
    ...
    /**
     * Assert the primary value of the named response header parsed into a date using the preferred date format
     * described in RFC 7231.
     * <p>
     * The {@link ResultMatcher} returned by this method throws an {@link AssertionError} if the response does not
     * contain the specified header, or if the supplied {@code value} does not match the primary value.
     * 
    ...
    public ResultMatcher dateValue(String name, long value) {
        return result -> {
            ...
            assertEquals(
                "Response header '" + name + "'='" + headerValue + "' " + "does not match expected value '"
