...
public class XpathExpectationsHelper {
    ...
    private static XPathExpression compileXpathExpression(String expression, @Nullable Map<String, String> namespaces)
        throws XPathExpressionException {
    ...
    /**
     * Parse the content, evaluate the XPath expression as a {@link Node}, and assert it with the given
     * {@code Matcher<Node>}.
     */
    ...
    /**
     * Parse the content, evaluate the XPath expression as a {@link NodeList}, and assert it with the given
     * {@code Matcher<NodeList>}.
     * 
     * @since 5.2.2
     */
     ...
     *             if content parsing or expression evaluation fails
     */
    public void assertNumber(byte[] content, @Nullable String encoding, Matcher<? super Double> matcher)
        throws Exception {
     ...
     * @param encoding
     *            the encoding to use (optionally)
     * @param targetClass
     *            the target class, one of Number, String, Boolean, org.w3c.Node, or NodeList
     * @throws Exception
     *             if content parsing or expression evaluation fails
     * @since 5.1
     */
     ...
     * @param encoding
     *            optional content encoding, if provided as metadata (e.g. in HTTP headers)
