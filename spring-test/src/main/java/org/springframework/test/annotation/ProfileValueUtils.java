...
public abstract class ProfileValueUtils {
    ...
    /**
     * Retrieves the {@link ProfileValueSource} type for the specified {@link Class test class} as configured via the
     * {@link ProfileValueSourceConfiguration &#064;ProfileValueSourceConfiguration} annotation and instantiates a new
     * instance of that type.
     * <p>
     * If {@link ProfileValueSourceConfiguration &#064;ProfileValueSourceConfiguration} is not present on the specified
     * class or if a custom {@link ProfileValueSource} is not declared, the default {@link SystemProfileValueSource}
     * will be returned instead.
     * 
     * @param testClass
     *            the test class for which the ProfileValueSource should be retrieved
    ...
    /**
     * Determine if the supplied {@code testClass} is <em>enabled</em> in the current environment, as specified by the
     * {@link IfProfileValue &#064;IfProfileValue} annotation at the class level.
     * <p>
     * Defaults to {@code true} if no {@link IfProfileValue &#064;IfProfileValue} annotation is declared.
     * 
     * @param testClass
     *            the test class
    ...
    /**
     * Determine if the supplied {@code testMethod} is <em>enabled</em> in the current environment, as specified by the
     * {@link IfProfileValue &#064;IfProfileValue} annotation, which may be declared on the test method itself or at the
     * class level. Class-level usage overrides method-level usage.
     * <p>
     * Defaults to {@code true} if no {@link IfProfileValue &#064;IfProfileValue} annotation is declared.
     * 
     * @param testMethod
     ...
     * Defaults to {@code true} if no {@link IfProfileValue &#064;IfProfileValue} annotation is declared.
     * 
     * @param profileValueSource
     *            the ProfileValueSource to use to determine if the test is enabled
     * @param testMethod
     *            the test method
     * @param testClass
     *            the test class
    ...
    /**
     * Determine if the {@code value} (or one of the {@code values}) in the supplied {@link IfProfileValue
     * &#064;IfProfileValue} annotation is <em>enabled</em> in the current environment.
     * 
     * @param profileValueSource
     *            the ProfileValueSource to use to determine if the test is enabled
     * @param ifProfileValue
     *            the annotation to introspect; may be {@code null}
     * @return {@code true} if the test is <em>enabled</em> in the current environment or if the supplied
     *         {@code ifProfileValue} is {@code null}
     */
