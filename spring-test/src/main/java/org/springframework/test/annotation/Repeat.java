 ...
 *
 * <p>
 * Note that the scope of execution to be repeated includes execution of the test method itself as well as any <em>set
 * up</em> or <em>tear down</em> of the test fixture.
 *
 * <p>
