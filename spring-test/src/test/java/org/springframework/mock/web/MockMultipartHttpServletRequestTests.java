...
class MockMultipartHttpServletRequestTests {
    ...
    void mockMultipartHttpServletRequestWithInputStream() throws IOException {
        ...
        request.addFile(new MockMultipartFile("file2", "myOrigFilename", "text/plain",
    ...
    void mockMultiPartHttpServletRequestWithMixedData() {
        MockMultipartHttpServletRequest request = new MockMultipartHttpServletRequest();
        request.addFile(
            new MockMultipartFile("file", "myOrigFilename", MediaType.TEXT_PLAIN_VALUE, "myContent2".getBytes()));
    ...
    private void doTestMultipartHttpServletRequest(MultipartHttpServletRequest request) throws IOException {
        ...
        assertThat(
            ObjectUtils.nullSafeEquals("myContent1".getBytes(), FileCopyUtils.copyToByteArray(file1.getInputStream())))
                .isTrue();
        ...
        assertThat(
            ObjectUtils.nullSafeEquals("myContent2".getBytes(), FileCopyUtils.copyToByteArray(file2.getInputStream())))
                .isTrue();
    }
