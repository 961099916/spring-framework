...
class MockHttpServletRequestTests {
    ...
    void getContentAsStringWithoutSettingCharacterEncoding() throws IOException {
        assertThatIllegalStateException().isThrownBy(request::getContentAsString)
    ...
    void getReaderAfterGettingInputStream() throws IOException {
        ...
        assertThatIllegalStateException().isThrownBy(request::getReader).withMessageContaining(
    ...
    void getInputStreamAfterGettingReader() throws IOException {
        request.getReader();
        assertThatIllegalStateException().isThrownBy(request::getInputStream).withMessageContaining(
    ...
    void cookies() {
        ...
        assertThat(cookies).describedAs("Raw cookies stored as is").hasSize(2).satisfies(subject -> {
        ...
        assertThat(cookieHeaders).describedAs("Cookies -> Header conversion works as expected per RFC6265")
    ...
    void setPreferredLocalesWithEmptyList() {
        assertThatIllegalArgumentException().isThrownBy(() -> request.setPreferredLocales(new ArrayList<>()));
    }
    ...
    void getServerNameWithInvalidIpv6AddressViaHostHeader() {
        ...
        assertThatIllegalStateException().isThrownBy(() -> request.getServerName())
    ...
    void getServerPortWithInvalidIpv6AddressViaHostHeader() {
        ...
        assertThatIllegalStateException().isThrownBy(() -> request.getServerPort())
            .withMessageStartingWith("Invalid Host header: ");
    }
    ...
    void getServerPortWithIpv6AddressAndInvalidPortViaHostHeader() {
        ...
        assertThatExceptionOfType(NumberFormatException.class).isThrownBy(() -> request.getServerPort())
    ...
    void getRequestURLWithInvalidIpv6AddressViaHostHeader() {
        request.addHeader(HOST, "[::ffff:abcd:abcd"); // missing closing bracket
        assertThatIllegalStateException().isThrownBy(() -> request.getRequestURL())
            .withMessageStartingWith("Invalid Host header: ");
    }
    ...
    void httpHeaderFormattedDateError() {
        ...
        assertThatIllegalArgumentException().isThrownBy(() -> request.getDateHeader(HttpHeaders.IF_MODIFIED_SINCE));
    }
