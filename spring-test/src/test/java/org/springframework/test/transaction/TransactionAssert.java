...
/**
 * Collection of assertions for tests involving transactions. Intended for internal use within the Spring testing suite.
 *
 * @author Sam Brannen
 * @author Phillip Webb
 * @since 5.2
...
public class TransactionAssert {
    ...
    public TransactionAssert isInTransaction(boolean expected) {
        assertThat(TransactionSynchronizationManager.isActualTransactionActive()).as("active transaction")
            .isEqualTo(expected);
        return this;
    }
