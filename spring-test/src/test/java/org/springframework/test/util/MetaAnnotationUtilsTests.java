...
class MetaAnnotationUtilsTests {
    ...
    private void assertAtComponentOnComposedAnnotation(Class<?> startClass, Class<?> rootDeclaringClass,
        ...
        assertThat(descriptor.getComposedAnnotationType()).as("composedAnnotationType")
    ...
    void findAnnotationDescriptorForClassWithLocalMetaAnnotationAndAnnotatedSuperclass() {
        ...
        assertThat(descriptor.getAnnotationAttributes().getClassArray("classes")).as("configured classes")
    ...
    void findAnnotationDescriptorForTypesWithNoAnnotationPresent() {
        assertThat(findAnnotationDescriptorForTypes(NonAnnotatedInterface.class, Transactional.class, Component.class))
            .isNull();
        assertThat(findAnnotationDescriptorForTypes(NonAnnotatedClass.class, Transactional.class, Order.class))
            .isNull();
    }
    ...
    void findAnnotationDescriptorForTypesWithInheritedAnnotationOnClass() {
        // Note: @Transactional is inherited
        assertThat(findAnnotationDescriptorForTypes(InheritedAnnotationClass.class, Transactional.class)
            .getRootDeclaringClass()).isEqualTo(InheritedAnnotationClass.class);
        assertThat(findAnnotationDescriptorForTypes(SubInheritedAnnotationClass.class, Transactional.class)
            .getRootDeclaringClass()).isEqualTo(InheritedAnnotationClass.class);
    }
    ...
    void findAnnotationDescriptorForTypesForClassWithMetaAnnotatedInterface() {
        ...
        UntypedAnnotationDescriptor descriptor = findAnnotationDescriptorForTypes(ClassWithMetaAnnotatedInterface.class,
