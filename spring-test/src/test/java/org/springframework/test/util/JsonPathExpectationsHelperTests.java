...
class JsonPathExpectationsHelperTests {
    ...
    void doesNotExistForIndefinitePathWithResults() throws Exception {
        ...
        assertThatExceptionOfType(AssertionError.class)
            .isThrownBy(() -> new JsonPathExpectationsHelper(expression).doesNotExist(SIMPSONS)).withMessageContaining(
    ...
    void assertValueIsNotEmptyForIndefinitePathWithEmptyResults() throws Exception {
        String expression = "$.familyMembers[?(@.name == 'Dilbert')]";
        assertThatExceptionOfType(AssertionError.class)
            .isThrownBy(() -> new JsonPathExpectationsHelper(expression).assertValueIsNotEmpty(SIMPSONS))
    ...
    void doesNotHaveJsonPathWithNull() {
        assertThatExceptionOfType(AssertionError.class)
            .isThrownBy(() -> new JsonPathExpectationsHelper("$.abc").doesNotHaveJsonPath("{\"abc\": null}"));
    }
    ...
    void doesNotHaveEmptyPathForIndefinitePathWithResults() {
        ...
        assertThatExceptionOfType(AssertionError.class)
            ...
            .withMessageContaining(
                "Expected no values at JSON path \"" + expression + "\" " + "but found: [{\"name\":\"Bart\"}]");
    }
