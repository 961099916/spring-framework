...
public class JsonPathResultMatchersTests {
    ...
    public void doesNotExistForAnEmptyArray() throws Exception {
        assertThatExceptionOfType(AssertionError.class)
            .isThrownBy(() -> new JsonPathResultMatchers("$.emptyArray").doesNotExist().match(stubMvcResult));
    }

    @Test
    public void doesNotExistForAnEmptyMap() throws Exception {
        assertThatExceptionOfType(AssertionError.class)
            .isThrownBy(() -> new JsonPathResultMatchers("$.emptyMap").doesNotExist().match(stubMvcResult));
    }
    ...
    public void isNotEmptyForAnEmptyString() throws Exception {
        assertThatExceptionOfType(AssertionError.class)
            .isThrownBy(() -> new JsonPathResultMatchers("$.emptyString").isNotEmpty().match(stubMvcResult));
    }

    @Test
    public void isNotEmptyForAnEmptyArray() throws Exception {
        assertThatExceptionOfType(AssertionError.class)
            .isThrownBy(() -> new JsonPathResultMatchers("$.emptyArray").isNotEmpty().match(stubMvcResult));
    }

    @Test
    public void isNotEmptyForAnEmptyMap() throws Exception {
        assertThatExceptionOfType(AssertionError.class)
            .isThrownBy(() -> new JsonPathResultMatchers("$.emptyMap").isNotEmpty().match(stubMvcResult));
    }
    ...
    public void valueWithJsonWrongPrefix() throws Exception {
        ...
        StubMvcResult result = createPrefixedStubMvcResult(jsonPrefix);
        assertThatExceptionOfType(AssertionError.class)
            .isThrownBy(() -> new JsonPathResultMatchers("$.str").prefix("wrong").value("foo").match(result));
    }
    ...
    public void prefixWithPayloadNotLongEnough() throws Exception {
        ...
        assertThatExceptionOfType(AssertionError.class)
            .isThrownBy(() -> new JsonPathResultMatchers("$.str").prefix("prefix").value("foo").match(result));
    }
