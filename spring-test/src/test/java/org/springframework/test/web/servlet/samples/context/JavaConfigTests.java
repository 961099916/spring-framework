...
public class JavaConfigTests {
    ...
    /**
     * Verify that the breaking change introduced in <a href="https://jira.spring.io/browse/SPR-12553">SPR-12553</a> has
     * been reverted.
     *
     * <p>
    ...
    private void verifyRootWacSupport() {
        ...
        assertThat(rootServletContext.getAttribute(WebApplicationContext.ROOT_WEB_APPLICATION_CONTEXT_ATTRIBUTE))
            .isSameAs(root);
        assertThat(childServletContext.getAttribute(WebApplicationContext.ROOT_WEB_APPLICATION_CONTEXT_ATTRIBUTE))
            .isSameAs(root);
    }
