...
public class MockServerSpecTests {
    ...
    public void applyFiltersAfterConfigurerAdded() {
        ...
        this.serverSpec.build().get().uri("/").exchange().expectBody(String.class)
            .consumeWith(result -> assertThat(result.getResponseBody()).contains("test-attribute=:A:B"));
    }
    ...
    public void applyFiltersBeforeServerCreated() {
        ...
        this.serverSpec.build().get().uri("/").exchange().expectBody(String.class).consumeWith(
            result -> assertThat(result.getResponseBody()).contains("test-attribute=:Fwk-A:Fwk-B:App-A:App-B"));
    }
