 ...
 *
 * <p>
 * <strong>NOTE</strong>: this <em>smoke test</em> is not intended to be executed with the build. To run this test,
 * comment out the {@code @Disabled} declaration and inspect the output manually.
 *
...
public class PrintingResultHandlerSmokeTests {
    ...
    public void testPrint() throws Exception {
        ...
        standaloneSetup(new SimpleController()).build().perform(get("/").content("Hello Request".getBytes()))
            .andDo(log()).andDo(print()).andDo(print(System.err)).andDo(print(writer));
