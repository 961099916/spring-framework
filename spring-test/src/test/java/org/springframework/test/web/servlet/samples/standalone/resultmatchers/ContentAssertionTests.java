...
/**
 * Examples of defining expectations on the response content, content type, and the character encoding.
 *
...
public class ContentAssertionTests {
    ...
    public void testContentAsString() throws Exception {
        ...
        this.mockMvc.perform(get("/handle").accept(MediaType.TEXT_PLAIN)).andExpect(content().string("Hello world!"));
    ...
    public void testCharacterEncoding() throws Exception {
        ...
        this.mockMvc.perform(get("/handle").accept(MediaType.TEXT_PLAIN)).andExpect(content().encoding("ISO-8859-1"))
            .andExpect(content().string(containsString("world")));
