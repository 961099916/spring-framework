...
public class ContentRequestMatchersTests {
    ...
    public void testContentTypeNoMatch1() throws Exception {
        ...
        assertThatExceptionOfType(AssertionError.class)
            .isThrownBy(() -> MockRestRequestMatchers.content().contentType("application/xml").match(this.request));
    }
    ...
    public void testBytesNoMatch() throws Exception {
        ...
        assertThatExceptionOfType(AssertionError.class)
            .isThrownBy(() -> MockRestRequestMatchers.content().bytes("Test".getBytes()).match(this.request));
    }
    ...
    public void testXmlNoMatch() throws Exception {
        ...
        assertThatExceptionOfType(AssertionError.class)
            .isThrownBy(() -> MockRestRequestMatchers.content().xml("<foo>22</foo>").match(this.request));
    }
    ...
    public void testNodeMatcherNoMatch() throws Exception {
        ...
        this.request.getBody().write(content.getBytes());
        assertThatExceptionOfType(AssertionError.class)
            .isThrownBy(() -> MockRestRequestMatchers.content().node(hasXPath("/foo/bar/bar")).match(this.request));
    }
    ...
    public void testJsonLenientNoMatch() throws Exception {
        ...
        assertThatExceptionOfType(AssertionError.class)
            .isThrownBy(() -> MockRestRequestMatchers.content().json("{\n \"foo\" : \"bar\"  \n}").match(this.request));
        assertThatExceptionOfType(AssertionError.class).isThrownBy(
    ...
    public void testJsonStrictNoMatch() throws Exception {
        ...
        assertThatExceptionOfType(AssertionError.class).isThrownBy(() -> MockRestRequestMatchers.content()
