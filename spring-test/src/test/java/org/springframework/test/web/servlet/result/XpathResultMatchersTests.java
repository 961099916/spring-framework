...
public class XpathResultMatchersTests {
    ...
    public void existsNoMatch() {
        assertThatExceptionOfType(AssertionError.class)
            .isThrownBy(() -> new XpathResultMatchers("/foo/Bar", null).exists().match(getStubMvcResult()));
    }
    ...
    public void doesNotExistNoMatch() {
        assertThatExceptionOfType(AssertionError.class)
            .isThrownBy(() -> new XpathResultMatchers("/foo/bar", null).doesNotExist().match(getStubMvcResult()));
    }
    ...
    public void nodeCountNoMatch() {
        assertThatExceptionOfType(AssertionError.class)
            .isThrownBy(() -> new XpathResultMatchers("/foo/bar", null).nodeCount(1).match(getStubMvcResult()));
    }
    ...
    public void stringNoMatch() {
        assertThatExceptionOfType(AssertionError.class)
            .isThrownBy(() -> new XpathResultMatchers("/foo/bar[1]", null).string("112").match(getStubMvcResult()));
    }
    ...
    public void numberNoMatch() {
        assertThatExceptionOfType(AssertionError.class)
            .isThrownBy(() -> new XpathResultMatchers("/foo/bar[1]", null).number(111.1).match(getStubMvcResult()));
    }
