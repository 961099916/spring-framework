...
public class ExchangeMutatorTests {
    ...
    public void setUp() throws Exception {
        ...
        this.webTestClient = WebTestClient.bindToController(new TestController()).apply(identity("Pablo")).build();
    }

    @Test
    public void useGloballyConfiguredIdentity() throws Exception {
        this.webTestClient.get().uri("/userIdentity").exchange().expectStatus().isOk().expectBody(String.class)
    ...
    public void useLocallyConfiguredIdentity() throws Exception {
        ...
        this.webTestClient.mutateWith(identity("Giovanni")).get().uri("/userIdentity").exchange().expectStatus().isOk()
