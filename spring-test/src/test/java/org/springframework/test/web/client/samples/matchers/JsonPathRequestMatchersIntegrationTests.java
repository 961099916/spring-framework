...
public class JsonPathRequestMatchersIntegrationTests {
    ...
    public void exists() throws Exception {
        this.mockServer.expect(requestTo("/composers")).andExpect(content().contentType("application/json"))
    ...
    public void doesNotExist() throws Exception {
        this.mockServer.expect(requestTo("/composers")).andExpect(content().contentType("application/json"))
            ...
            .andExpect(jsonPath("$.composers[4]").doesNotExist()).andRespond(withSuccess());
    ...
    public void value() throws Exception {
        this.mockServer.expect(requestTo("/composers")).andExpect(content().contentType("application/json"))
            ...
            .andExpect(jsonPath("$.performers[1].name").value("Yehudi Menuhin")).andRespond(withSuccess());
    ...
    public void hamcrestMatchers() throws Exception {
        this.mockServer.expect(requestTo("/composers")).andExpect(content().contentType("application/json"))
            ...
            .andExpect(jsonPath("$.composers[:3].name", hasItem("Johannes Brahms"))).andRespond(withSuccess());
    ...
    public void isArray() throws Exception {
        this.mockServer.expect(requestTo("/composers")).andExpect(content().contentType("application/json"))
            .andExpect(jsonPath("$.composers").isArray()).andRespond(withSuccess());
    ...
    public void isString() throws Exception {
        this.mockServer.expect(requestTo("/composers")).andExpect(content().contentType("application/json"))
            .andExpect(jsonPath("$.composers[0].name").isString()).andRespond(withSuccess());
    ...
    public void isNumber() throws Exception {
        this.mockServer.expect(requestTo("/composers")).andExpect(content().contentType("application/json"))
            .andExpect(jsonPath("$.composers[0].someDouble").isNumber()).andRespond(withSuccess());
    ...
    public void isBoolean() throws Exception {
        this.mockServer.expect(requestTo("/composers")).andExpect(content().contentType("application/json"))
            .andExpect(jsonPath("$.composers[0].someBoolean").isBoolean()).andRespond(withSuccess());
