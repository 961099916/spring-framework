...
public class XpathRequestMatchersTests {
    ...
    public void testDoesNotExistNoMatch() throws Exception {
        assertThatExceptionOfType(AssertionError.class)
            .isThrownBy(() -> new XpathRequestMatchers("/foo/bar", null).doesNotExist().match(this.request));
    }
    ...
    public void testNodeCountNoMatch() throws Exception {
        assertThatExceptionOfType(AssertionError.class)
            .isThrownBy(() -> new XpathRequestMatchers("/foo/bar", null).nodeCount(1).match(this.request));
    }
    ...
    public void testStringNoMatch() throws Exception {
        assertThatExceptionOfType(AssertionError.class)
            .isThrownBy(() -> new XpathRequestMatchers("/foo/bar[1]", null).string("112").match(this.request));
    }
    ...
    public void testNumberNoMatch() throws Exception {
        assertThatExceptionOfType(AssertionError.class)
            .isThrownBy(() -> new XpathRequestMatchers("/foo/bar[1]", null).number(111.1).match(this.request));
    }
    ...
    public void testBooleanNoMatch() throws Exception {
        assertThatExceptionOfType(AssertionError.class)
            .isThrownBy(() -> new XpathRequestMatchers("/foo/bar[2]", null).booleanValue(false).match(this.request));
    }
