...
/**
 * <p>
 * Verifies proper handling of JUnit's {@link org.junit.Ignore &#064;Ignore} and Spring's
 * {@link org.springframework.test.annotation.IfProfileValue &#064;IfProfileValue} and
 * {@link ProfileValueSourceConfiguration &#064;ProfileValueSourceConfiguration} (with an <em>explicit, custom defined
 * {@link ProfileValueSource}</em>) annotations in conjunction with the {@link SpringRunner}.
 * </p>
 *
 * @author Sam Brannen
 * @since 2.5
