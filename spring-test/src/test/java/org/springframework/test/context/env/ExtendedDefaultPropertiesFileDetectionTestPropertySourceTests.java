...
/**
 * Integration tests that verify detection of default properties files when
 * {@link TestPropertySource @TestPropertySource} is <em>empty</em> at multiple levels within a class hierarchy.
 *
 * @author Sam Brannen
 * @since 4.1
 */
