...
/**
 * Abstract base class for all TestNG-based tests involving EJB transaction support in the TestContext framework.
 *
 * @author Sam Brannen
...
public abstract class AbstractEjbTxDaoTestNGTests extends AbstractTransactionalTestNGSpringContextTests {
    ...
    /**
     * The default implementation of this method assumes that the transaction for {@link #test2IncrementCount1()} was
     * committed. Therefore, it is expected that the previous increment has been persisted in the database.
     */
