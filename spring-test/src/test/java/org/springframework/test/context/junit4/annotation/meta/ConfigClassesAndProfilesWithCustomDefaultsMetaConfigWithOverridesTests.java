...
/**
 * Integration tests for meta-annotation attribute override support, overriding default attribute values defined in
 * {@link ConfigClassesAndProfilesWithCustomDefaultsMetaConfig}.
 *
 * @author Sam Brannen
 * @since 4.0
 */
...
@ConfigClassesAndProfilesWithCustomDefaultsMetaConfig(
    classes = {PojoAndStringConfig.class, ConfigClassesAndProfilesWithCustomDefaultsMetaConfig.ProductionConfig.class},
    profiles = "prod")
