...
/**
 * Integration tests that verify support for {@link DirtiesContext.HierarchyMode} in conjunction with context
 * hierarchies configured via {@link ContextHierarchy}.
 *
 * <p>
 * Note that correct method execution order is essential, thus the use of {@link TestMethodOrder @TestMethodOrder}.
 *
 * @author Sam Brannen
 * @since 3.2.2
 */
