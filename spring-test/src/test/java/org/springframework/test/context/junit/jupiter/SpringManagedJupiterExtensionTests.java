...
/**
 * This class demonstrates how to have a JUnit Jupiter extension managed as a Spring bean in order to have dependencies
 * injected into an extension from a Spring {@code ApplicationContext}.
 *
 * @author Sam Brannen
 * @since 5.1
 */
