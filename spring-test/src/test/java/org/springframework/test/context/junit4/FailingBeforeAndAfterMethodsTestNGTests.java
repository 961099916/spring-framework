 ...
 * TestExecutionListeners} as well as {@code @BeforeTransaction} and {@code @AfterTransaction} methods can fail tests in
...
public class FailingBeforeAndAfterMethodsTestNGTests {
    ...
    public static Object[][] testData() {
        return new Object[][] {{AlwaysFailingBeforeTestClassTestCase.class.getSimpleName(), 1, 0, 0, 1},
    ...
    public void runTestAndAssertCounters() throws Exception {
        ...
        assertThat(listener.testStartCount).as("tests started for [" + name + "] ==> ")
            .isEqualTo(this.expectedTestStartCount);
        assertThat(listener.testSuccessCount).as("successful tests for [" + name + "] ==> ")
            .isEqualTo(this.expectedTestSuccessCount);
        assertThat(listener.testFailureCount).as("failed tests for [" + name + "] ==> ")
            .isEqualTo(this.expectedFailureCount);
        assertThat(listener.failedConfigurationsCount).as("failed configurations for [" + name + "] ==> ")
