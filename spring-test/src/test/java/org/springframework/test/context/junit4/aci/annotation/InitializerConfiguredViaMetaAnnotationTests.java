...
/**
 * Integration test that demonstrates how to register one or more {@code @Configuration} classes via an
 * {@link ApplicationContextInitializer} in a composed annotation so that certain {@code @Configuration} classes are
 * always registered whenever the composed annotation is used, even if the composed annotation is used to declare
 * additional {@code @Configuration} classes.
 *
 * <p>
 * This class has been implemented in response to the following Stack Overflow question:
 * <a href="https://stackoverflow.com/questions/35733344/can-contextconfiguration-in-a-custom-annotation-be-merged"> Can
 * {@code @ContextConfiguration} in a custom annotation be merged?</a>
 *
 * @author Sam Brannen
 * @since 4.3
 */
