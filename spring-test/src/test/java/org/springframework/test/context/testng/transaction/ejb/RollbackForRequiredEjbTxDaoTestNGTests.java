...
/**
 * Extension of {@link CommitForRequiredEjbTxDaoTestNGTests} which sets the default rollback semantics for the
 ...
 * the test-managed transaction will be rolled back automatically.
 *
 * @author Sam Brannen
 * @since 4.0.1
 */
...
public class RollbackForRequiredEjbTxDaoTestNGTests extends CommitForRequiredEjbTxDaoTestNGTests {
    ...
    /**
     * Overrides parent implementation in order to change expectations to align with behavior associated with "required"
     * transactions on repositories/DAOs and default rollback semantics for transactions managed by the TestContext
     * framework.
     */
