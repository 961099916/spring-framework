...
/**
 * Unit test which verifies proper {@link ContextLoader#processLocations(Class, String...) processing} of
 * {@code resource locations} by a {@link GenericXmlContextLoader} configured via
 * {@link ContextConfiguration @ContextConfiguration}. Specifically, this test addresses the issues raised in
 * <a href="https://opensource.atlassian.com/projects/spring/browse/SPR-3949" target="_blank">SPR-3949</a>:
...
class GenericXmlContextLoaderResourceLocationsTests {
    ...
    static Stream<Arguments> contextConfigurationLocationsData() {
        return Stream.of(arguments(ClasspathNonExistentDefaultLocationsTestCase.class.getSimpleName(), array()),
    ...
    void assertContextConfigurationLocations(String testClassName, String[] expectedLocations) throws Exception {
        ...
        assertThat(processedLocations).as("Verifying locations for test [" + testClass + "].")
