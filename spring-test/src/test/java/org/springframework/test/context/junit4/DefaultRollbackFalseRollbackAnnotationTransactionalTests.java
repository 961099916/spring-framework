...
/**
 * Integration test which verifies proper transactional behavior when the default rollback flag is set to {@code false}
 * via {@link Rollback @Rollback}.
 *
 * <p>
...
public class DefaultRollbackFalseRollbackAnnotationTransactionalTests extends AbstractTransactionalSpringRunnerTests {
    ...
    public static void verifyFinalTestData() {
        assertThat(countRowsInPersonTable(jdbcTemplate))
            .as("Verifying the final number of rows in the person table after all tests.").isEqualTo(2);
    }
