...
/**
 * Integration tests which demonstrate that the Spring TestContext Framework can be used with JUnit Jupiter's
 * {@link ParameterizedTest @ParameterizedTest} support in conjunction with the {@link SpringExtension}.
 *
 * <p>
