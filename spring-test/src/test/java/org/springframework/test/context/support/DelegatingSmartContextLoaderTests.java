...
class DelegatingSmartContextLoaderTests {
    ...
    void processContextConfigurationWithDefaultXmlConfigAndConfigurationClassGeneration() {
        ContextConfigurationAttributes configAttributes =
            new ContextConfigurationAttributes(ImproperDuplicateDefaultXmlAndConfigClassTestCase.class,
                EMPTY_STRING_ARRAY, EMPTY_CLASS_ARRAY, true, null, true, ContextLoader.class);
        assertThatIllegalStateException().isThrownBy(() -> loader.processContextConfiguration(configAttributes))
    ...
    void loadContextWithoutLocationsAndConfigurationClasses() throws Exception {
        ...
        assertThatIllegalStateException().isThrownBy(() -> loader.loadContext(mergedConfig))
            .withMessageStartingWith("Neither").withMessageContaining("was able to load an ApplicationContext from");
    }
    ...
    void loadContextWithLocationsAndConfigurationClasses() throws Exception {
        MergedContextConfiguration mergedConfig = new MergedContextConfiguration(getClass(), new String[] {"test.xml"},
    ...
    void loadContextWithXmlConfig() throws Exception {
        MergedContextConfiguration mergedConfig = new MergedContextConfiguration(XmlTestCase.class, new String[] {
