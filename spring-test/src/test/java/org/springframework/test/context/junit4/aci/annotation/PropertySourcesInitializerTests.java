...
/**
 * Integration tests that verify that a {@link PropertySource} can be set via a custom
 * {@link ApplicationContextInitializer} in the Spring TestContext Framework.
 *
 * @author Sam Brannen
 * @since 4.1
 */
