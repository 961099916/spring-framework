...
/**
 * JUnit 4 based integration test which verifies support of Spring's {@link Transactional &#64;Transactional},
 * {@link TestExecutionListeners &#64;TestExecutionListeners}, and {@link ContextConfiguration
 * &#64;ContextConfiguration} annotations in conjunction with the {@link SpringRunner} and the following
 ...
 *
 * <p>
 * This class specifically tests usage of {@code @Transactional} defined at the <strong>method level</strong>.
 *
 * @author Sam Brannen
 * @since 2.5
...
public class MethodLevelTransactionalSpringRunnerTests extends AbstractTransactionalSpringRunnerTests {
    ...
    public static void verifyFinalTestData() {
        assertThat(countRowsInPersonTable(jdbcTemplate))
            .as("Verifying the final number of rows in the person table after all tests.").isEqualTo(4);
    }
    ...
    public void verifyInitialTestData() {
        ...
        assertThat(countRowsInPersonTable(jdbcTemplate)).as("Verifying the initial number of rows in the person table.")
            .isEqualTo(1);
    }
    ...
    public void modifyTestDataWithinTransaction() {
        ...
        assertThat(countRowsInPersonTable(jdbcTemplate))
            .as("Verifying the number of rows in the person table within a transaction.").isEqualTo(2);
    }
    ...
    public void modifyTestDataWithoutTransaction() {
        ...
        assertThat(countRowsInPersonTable(jdbcTemplate))
            .as("Verifying the number of rows in the person table without a transaction.").isEqualTo(4);
    }
