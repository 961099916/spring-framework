...
/**
 * Integration tests for hybrid {@link SmartContextLoader} implementations that support path-based and class-based
 * resources simultaneously, as is done in Spring Boot.
 *
 * @author Sam Brannen
 * @since 4.0.4
