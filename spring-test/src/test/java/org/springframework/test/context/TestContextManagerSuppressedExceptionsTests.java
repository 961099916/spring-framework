...
/**
 * JUnit 4 based unit tests for {@link TestContextManager}, which verify proper support for <em>suppressed
 * exceptions</em> thrown by {@link TestExecutionListener TestExecutionListeners}.
 *
 * @author Sam Brannen
 * @since 5.0
...
class TestContextManagerSuppressedExceptionsTests {
    ...
    private void test(String useCase, Class<?> testClass, Callback callback) throws Exception {
        ...
        assertThat(testContextManager.getTestExecutionListeners().size()).as("Registered TestExecutionListeners")
            .isEqualTo(2);
