...
/**
 * Extension of {@link SpringJUnit4ClassRunnerAppCtxTests}, which verifies that we can specify an explicit,
 * <em>classpath</em> location for our application context.
 *
 * @author Sam Brannen
 * @since 2.5
...
public class ClassPathResourceSpringJUnit4ClassRunnerAppCtxTests extends SpringJUnit4ClassRunnerAppCtxTests {
    ...
    /**
     * Classpath-based resource path for the application context configuration for
    ...
    public static final String CLASSPATH_CONTEXT_RESOURCE_PATH =
        ResourceUtils.CLASSPATH_URL_PREFIX + SpringJUnit4ClassRunnerAppCtxTests.DEFAULT_CONTEXT_RESOURCE_PATH;
