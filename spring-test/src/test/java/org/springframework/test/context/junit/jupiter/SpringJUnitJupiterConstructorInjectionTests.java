...
/**
 * Integration tests which demonstrate support for autowiring individual parameters in test class constructors using
 * {@link Autowired @Autowired} and {@link Value @Value} with the Spring TestContext Framework and JUnit Jupiter.
 *
 * <p>
