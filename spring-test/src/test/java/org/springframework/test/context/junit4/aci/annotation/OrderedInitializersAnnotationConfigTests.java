...
/**
 * Integration tests that verify that any {@link ApplicationContextInitializer ApplicationContextInitializers}
 * implementing {@link org.springframework.core.Ordered Ordered} or marked with
 * {@link org.springframework.core.annotation.Order @Order} will be sorted appropriately in conjunction with
 * annotation-driven configuration in the TestContext framework.
 *
 * @author Sam Brannen
 * @since 3.2
 */
...
@ContextConfiguration(classes = {GlobalConfig.class, ConfigTwo.class, ConfigOne.class},
