...
/**
 * Unit tests for {@link ActiveProfilesUtils} involving resolution of active bean definition profiles.
 *
 * @author Sam Brannen
...
class ActiveProfilesUtilsTests extends AbstractContextConfigurationUtilsTests {
    ...
    void resolveActiveProfilesWithResolverWithoutDefaultConstructor() {
        assertThatIllegalStateException()
            .isThrownBy(() -> resolveActiveProfiles(NoDefaultConstructorActiveProfilesResolverTestCase.class));
    }
    ...
    /**
     * This test verifies that the actual test class, not the composed annotation, is passed to the resolver.
     * 
     * @since 4.0.3
     */
    @Test
