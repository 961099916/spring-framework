...
/**
 * Integration tests that verify proper behavior of {@link DirtiesContext @DirtiesContext} in conjunction with context
 * hierarchies configured via {@link ContextHierarchy @ContextHierarchy}.
 *
 * @author Sam Brannen
...
class ContextHierarchyDirtiesContextTests {
    ...
    /**
     * {@link DirtiesContext} is declared at the class level, without specifying the
     * {@link DirtiesContext.HierarchyMode}.
     * <p>
     * After running this test class, the context cache should be <em>exhaustively</em> cleared beginning from the
     * current context hierarchy, upwards to the highest parent context, and then back down through all subhierarchies
     ...
     * <p>
     * After running this test class, the context cache should be cleared beginning from the current context hierarchy
     * and down through all subhierarchies.
     */
    ...
    /**
     * {@link DirtiesContext} is declared at the method level, without specifying the
     * {@link DirtiesContext.HierarchyMode}.
     * <p>
     * After running this test class, the context cache should be <em>exhaustively</em> cleared beginning from the
     * current context hierarchy, upwards to the highest parent context, and then back down through all subhierarchies
