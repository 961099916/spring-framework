...
/**
 * Integration tests which verify that a subclass of {@link DefaultTestContextBootstrapper} can specify a custom
 * <em>default ContextLoader class</em> that overrides the standard default class name.
 *
 * @author Sam Brannen
 * @since 3.0
 */
