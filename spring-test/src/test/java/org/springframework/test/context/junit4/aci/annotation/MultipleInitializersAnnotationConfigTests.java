...
/**
 * Integration tests that verify support for {@link ApplicationContextInitializer ApplicationContextInitializers} in
 * conjunction with annotation-driven configuration in the TestContext framework.
 *
 * @author Sam Brannen
 * @since 3.2
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(classes = {GlobalConfig.class, DevProfileConfig.class},
