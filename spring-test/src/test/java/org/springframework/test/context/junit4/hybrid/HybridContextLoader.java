...
/**
 * Hybrid {@link SmartContextLoader} that supports path-based and class-based resources simultaneously.
 * <p>
...
public class HybridContextLoader extends AbstractGenericContextLoader {
    ...
    protected void validateMergedContextConfiguration(MergedContextConfiguration mergedConfig) {
        Assert.isTrue(mergedConfig.hasClasses() || mergedConfig.hasLocations(),
