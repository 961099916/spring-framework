...
/**
 * Integration tests which verify that the same custom {@link ContextLoader} can be used at all levels within a test
 * class hierarchy when the {@code loader} is explicitly declared via {@link ContextConfiguration
