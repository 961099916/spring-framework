...
/**
 * Simple JUnit 4 based integration test which demonstrates how to use JUnit's {@link Parameterized} Runner in
 * conjunction with {@link ContextConfiguration @ContextConfiguration}, the
 * {@link DependencyInjectionTestExecutionListener}, and a {@link TestContextManager} to provide dependency injection to
 * a <em>parameterized test instance</em>.
 *
 * @author Sam Brannen
 * @since 2.5
...
public class ParameterizedDependencyInjectionTests {
    ...
    public static void verifyNumParameterizedRuns() {
        assertThat(invocationCount.get()).as("Number of times the parameterized test method was executed.")
    ...
    public final void verifyPetAndEmployee() {
        ...
        assertThat(employee.getName()).as("Name of the employee configured as bean [" + this.employeeBeanName + "].")
