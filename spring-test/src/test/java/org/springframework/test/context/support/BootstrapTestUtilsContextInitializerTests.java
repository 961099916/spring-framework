...
class BootstrapTestUtilsContextInitializerTests extends AbstractContextConfigurationUtilsTests {
    ...
    private Set<Class<? extends ApplicationContextInitializer<?>>>
        initializers(Class<? extends ApplicationContextInitializer<?>>... classes) {
    ...
    @ContextConfiguration(classes = BarConfig.class, inheritLocations = false, initializers = BarInitializer.class,
