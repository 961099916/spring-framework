...
/**
 * Integration tests for applications using {@link Async @Async} methods with {@code @DirtiesContext}.
 *
 * <p>
 * Execute this test class with {@code -Xmx8M} to verify that there are no issues with memory leaks as raised in
