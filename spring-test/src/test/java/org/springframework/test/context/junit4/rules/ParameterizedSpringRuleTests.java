...
/**
 * Integration test which demonstrates how to use JUnit's {@link Parameterized} runner in conjunction with
 * {@link SpringClassRule} and {@link SpringMethodRule} to provide dependency injection to a <em>parameterized test
 * instance</em>.
 *
 * @author Sam Brannen
 * @since 4.2
