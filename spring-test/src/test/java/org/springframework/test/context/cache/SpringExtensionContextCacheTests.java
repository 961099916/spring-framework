...
/**
 * Unit tests which verify correct {@link ContextCache application context caching} in conjunction with the
 * {@link SpringExtension} and the {@link DirtiesContext &#064;DirtiesContext} annotation at the method level.
 *
 * @author Sam Brannen
...
class SpringExtensionContextCacheTests {
    ...
    void verifyContextDirty() {
        ...
        assertThat(this.applicationContext).as("The application context should have been autowired.").isNotNull();
        assertThat(this.applicationContext).as("The application context should have been 'dirtied'.")
