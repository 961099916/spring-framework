...
/**
 * Integration tests for meta-annotation attribute override support, demonstrating that the test class is used as the
 * <em>declaring class</em> when detecting default configuration classes for the declaration of
