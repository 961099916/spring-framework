...
/**
 * JUnit-based integration tests that verify support for loading a {@link WebApplicationContext} with a custom
...
class WebAppConfigurationBootstrapWithTests {
    ...
    /**
     * Custom {@link WebTestContextBootstrapper} that requires {@code @WebAppConfiguration} but hard codes the resource
     * base path.
     */
