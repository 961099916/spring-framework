...
/**
 * Integration tests that verify support for configuration classes in the Spring TestContext Framework.
 *
 * <p>
 * Furthermore, by extending {@link SpringJUnit4ClassRunnerAppCtxTests}, this class also verifies support for several
 * basic features of the Spring TestContext Framework. See JavaDoc in {@code SpringJUnit4ClassRunnerAppCtxTests} for
 * details.
 *
 * <p>
