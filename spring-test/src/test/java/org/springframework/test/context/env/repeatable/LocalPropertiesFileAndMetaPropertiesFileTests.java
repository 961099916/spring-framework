 ...
 *
 * <p>
 * Verify a property value is defined both in the properties file which is declared via
 * {@link MetaFileTestProperty @MetaFileTestProperty} and in the properties file which is declared locally via
...
class LocalPropertiesFileAndMetaPropertiesFileTests extends AbstractRepeatableTestPropertySourceTests {
    ...
    /**
     * Composed annotation that declares a properties file via {@link TestPropertySource @TestPropertySource}.
     */
