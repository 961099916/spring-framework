...
/**
 * Extension of {@link SpringJUnit4ClassRunnerAppCtxTests}, which verifies that we can specify an explicit, <em>relative
 * path</em> location for our application context.
 *
 * @author Sam Brannen
 * @since 2.5
