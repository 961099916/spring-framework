...
public class ConcreteTransactionalJUnit4SpringContextTests extends AbstractTransactionalJUnit4SpringContextTests
    ...
    public void setUp() {
        ...
        assertThat(countRowsInPersonTable())
            .as("Verifying the number of rows in the person table before a test method.").isEqualTo(expected);
    }

    @After
    public void tearDown() {
        long expected = (isActualTransactionActive() ? 4 : 1);
        assertThat(countRowsInPersonTable()).as("Verifying the number of rows in the person table after a test method.")
            .isEqualTo(expected);
    }
    ...
    public void beforeTransaction() {
        assertThat(countRowsInPersonTable())
            .as("Verifying the number of rows in the person table before a transactional test method.").isEqualTo(1);
    ...
    public void afterTransaction() {
        ...
        assertThat(countRowsInPersonTable())
            .as("Verifying the number of rows in the person table after a transactional test method.").isEqualTo(1);
    }
    ...
    public void verifyBeanNameSet() {
        ...
        assertThat(this.beanName.startsWith(getClass().getName()))
            .as("The bean name of this test instance should have been set to the fully qualified class name "
    ...
    public void modifyTestDataWithinTransaction() {
        ...
        assertThat(countRowsInPersonTable())
            .as("Verifying the number of rows in the person table in modifyTestDataWithinTransaction().").isEqualTo(4);
    }
