...
/**
 * Integration tests for verifying proper behavior of the {@link ContextCache} in conjunction with cache keys used in
 * {@link TestContext}.
 *
 * @author Sam Brannen
...
class ContextCacheTests {
    ...
    private void loadCtxAndAssertStats(Class<?> testClass, int expectedSize, int expectedHitCount,
    ...
    void removeContextHierarchyCacheLevel1() {
        ...
        TestContext testContext3a =
            TestContextTestUtils.buildTestContext(ClassHierarchyContextHierarchyLevel3aTestCase.class, contextCache);
        ...
        TestContext testContext3b =
            TestContextTestUtils.buildTestContext(ClassHierarchyContextHierarchyLevel3bTestCase.class, contextCache);
