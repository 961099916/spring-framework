...
/**
 * Interface for integration tests that demonstrate support for interface default methods and Java generics in JUnit
 * Jupiter test classes when used with the Spring TestContext Framework and the {@link SpringExtension}.
 *
 * <p>
