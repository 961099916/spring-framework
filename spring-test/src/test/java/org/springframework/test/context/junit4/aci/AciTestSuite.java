...
/**
 * Convenience test suite for integration tests that verify support for {@link ApplicationContextInitializer
 * ApplicationContextInitializers} (ACIs) in the TestContext framework.
 *
 * @author Sam Brannen
 * @since 3.2
 */
