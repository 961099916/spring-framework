...
/**
 * Concrete subclass of {@link AbstractEjbTxDaoTests} which uses the {@link RequiresNewEjbTxTestEntityDao} and sets the
 * default rollback semantics for the {@link TransactionalTestExecutionListener} to {@code false} (i.e.,
 * <em>commit</em>).
 *
 * @author Sam Brannen
 * @since 4.0.1
