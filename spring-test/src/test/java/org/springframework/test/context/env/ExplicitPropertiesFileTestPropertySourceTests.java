...
/**
 * Collection of integration tests that verify proper support for {@link TestPropertySource @TestPropertySource} with
 * explicit properties files declared with absolute paths, relative paths, and placeholders in the classpath and in the
 * file system.
 *
 * @author Sam Brannen
 * @since 5.2
