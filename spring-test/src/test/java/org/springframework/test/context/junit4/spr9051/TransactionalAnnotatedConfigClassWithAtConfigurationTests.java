...
/**
 * Concrete implementation of {@link AbstractTransactionalAnnotatedConfigClassTests} that uses a true
...
public class TransactionalAnnotatedConfigClassWithAtConfigurationTests
     ...
     *
     * <p>
     * Consequently, this class contains standard singleton bean methods instead of <i>annotated factory bean
     * methods</i>.
     */
    @Configuration
    static class Config {
