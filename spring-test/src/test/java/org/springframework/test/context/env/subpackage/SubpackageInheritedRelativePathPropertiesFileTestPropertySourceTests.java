...
/**
 * Integration tests for {@link TestPropertySource @TestPropertySource} support with an inherited explicitly named
 * properties file that is referenced using a relative path within a parent package.
 *
 * @author Sam Brannen
 * @since 4.1
 */
