...
/**
 * Abstract base class for {@link Encoder} unit tests. Subclasses need to implement {@link #canEncode()} and
 * {@link #encode()}, possibly using the wide * variety of helper methods like {@link #testEncodeAll}.
 *
...
public abstract class AbstractEncoderTests<E extends Encoder<?>> extends AbstractLeakCheckingTests {
    ...
    /**
     * Subclasses should implement this method to test {@link Encoder#encode}, possibly using {@link #testEncodeAll} or
     ...
     *
     * @param input
     *            the input to be provided to the encoder
     * @param inputClass
     *            the input class
     * @param stepConsumer
    ...
    /**
     * Test a {@link Encoder#encode encode} scenario where the input stream contains an error. This test method will
     * feed the first element of the {@code input} stream to the encoder, followed by an {@link InputException}. The
    ...
    /**
     * Test a {@link Encoder#encode encode} scenario where the input stream is canceled. This test method will feed the
    ...
    /**
     * Test a {@link Encoder#encode encode} scenario where the input stream is empty. The output is expected to be empty
     * as well.
     *
     * @param inputType
     *            the input type
