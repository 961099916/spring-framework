...
public enum TestGroup {
    ...
    /**
     * Performance-related tests that may fail unpredictably based on CPU profile and load. Any test using
     * {@link Thread#sleep}, {@link Object#wait}, Spring's {@code StopWatch}, etc. should be considered a candidate as
     * their successful execution is likely to be based on events occurring within a given time window.
     */
    PERFORMANCE;
     ...
     *
     * @param value
     *            the comma separated string of groups
     * @return a set of groups
     * @throws IllegalArgumentException
     *             if any specified group name is not a valid {@link TestGroup}
     */
