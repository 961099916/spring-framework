...
/**
 * Abstract base class for {@link Decoder} unit tests. Subclasses need to implement {@link #canDecode()},
 * {@link #decode()} and {@link #decodeToMono()}, possibly using the wide variety of helper methods like
 * {@link #testDecodeAll} or {@link #testDecodeToMonoAll}.
 *
...
public abstract class AbstractDecoderTests<D extends Decoder<?>> extends AbstractLeakCheckingTests {
    ...
    /**
     * Subclasses should implement this method to test {@link Decoder#decode}, possibly using {@link #testDecodeAll} or
    ...
    /**
     * Helper methods that tests for a variety of {@link Flux} decoding scenarios. This methods invokes:
     * <ul>
     ...
     *
     * @param input
     *            the input to be provided to the decoder
     * @param outputClass
     *            the desired output class
     * @param stepConsumer
     *            a consumer to {@linkplain StepVerifier verify} the output
     * @param <T>
     *            the output type
     */
     ...
     *            a consumer to {@linkplain StepVerifier verify} the output
     * @param mimeType
     *            the mime type to use for decoding. May be {@code null}.
     * @param hints
     *            the hints used for decoding. May be {@code null}.
     * @param <T>
     *            the output type
     */
    ...
    /**
     * Test a {@link Decoder#decode decode} scenario where the input stream contains an error. This test method will
     * feed the first element of the {@code input} stream to the decoder, followed by an {@link InputException}. The
     * result is expected to contain one "normal" element, followed by the error.
     *
     * @param input
     *            the input to be provided to the decoder
     * @param outputType
    ...
    /**
     * Test a {@link Decoder#decode decode} scenario where the input stream is canceled. This test method will feed the
     * first element of the {@code input} stream to the decoder, followed by a cancel signal. The result is expected to
     * contain one "normal" element.
     *
     * @param input
     *            the input to be provided to the decoder
     * @param outputType
    ...
    /**
     * Test a {@link Decoder#decode decode} scenario where the input stream is empty. The output is expected to be empty
     * as well.
     *
     * @param outputType
     *            the desired output type
    ...
    /**
     * Helper methods that tests for a variety of {@link Mono} decoding scenarios. This methods invokes:
     * <ul>
    ...
    /**
     * Test a {@link Decoder#decodeToMono decode} scenario where the input stream contains an error. This test method
     * will feed the first element of the {@code input} stream to the decoder, followed by an {@link InputException}.
    ...
    /**
     * Test a {@link Decoder#decodeToMono decode} scenario where the input stream is canceled. This test method will
     * immediately cancel the output stream.
     *
     * @param input
     *            the input to be provided to the decoder
     * @param outputType
    ...
    /**
     * Test a {@link Decoder#decodeToMono decode} scenario where the input stream is empty. The output is expected to be
     * empty as well.
     *
     * @param outputType
     *            the desired output type
     ...
     * 
     * @param bytes
     *            the bytes that are to be stored in the buffer
