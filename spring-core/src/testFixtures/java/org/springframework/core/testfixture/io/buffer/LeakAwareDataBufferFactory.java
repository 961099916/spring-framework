 ...
 * <p>
 * Useful for unit tests that handle data buffers. Simply inherit from {@link AbstractLeakCheckingTests} or call
 * {@link #checkForLeaks()} in a JUnit <em>after</em> method yourself, and any buffers that have not been released will
...
public class LeakAwareDataBufferFactory implements DataBufferFactory {
     ...
     * 
     * @param delegate
     *            the delegate buffer factory to wrap.
     */
    ...
    /**
     * Checks whether all of the data buffers allocated by this factory have also been released. If not, then an
     * {@link AssertionError} is thrown. Typically used from a JUnit <em>after</em> method.
     */
    ...
    public DataBuffer join(List<? extends DataBuffer> dataBuffers) {
        ...
        dataBuffers =
            dataBuffers.stream().map(o -> o instanceof LeakAwareDataBuffer ? ((LeakAwareDataBuffer)o).dataBuffer() : o)
