...
abstract public class AbstractClassGenerator<T> implements ClassGenerator {
    ...
    protected static class ClassLoaderData {
         ...
         * classLoader reference should be weak otherwise it would make classLoader strongly reachable and alive
         * forever. Reference queue is not required since the cleanup is handled by {@link WeakHashMap}.
         */
