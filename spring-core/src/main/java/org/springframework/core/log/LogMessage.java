 ...
 * {@link Supplier} instance (typically bound to a Java 8 lambda expression) or a printf-style format string
...
public abstract class LogMessage implements CharSequence {
     ...
     *
     * @param supplier
     *            the supplier (typically bound to a Java 8 lambda expression)
     * @see #toString()
     */
     ...
     *
     * @param format
     *            the format string (following {@link String#format} rules)
     * @param arg1
     *            the argument
     ...
     *            the format string (following {@link String#format} rules)
     * @param args
     *            the varargs array (costly, prefer individual arguments)
     * @see String#format(String, Object...)
     */
    ...
    /**
     * This will be called by the logging provider, potentially once per log target (therefore locally caching the
     * result here).
     */
    @Override
