...
/**
 * Implementation of {@link Log} that wraps a list of loggers and delegates to the first one for which logging is
 * enabled at the given level.
 *
...
final class CompositeLog implements Log {
    ...
    /**
     * Constructor with list of loggers. For optimal performance, the constructor checks and remembers which logger is
     * on for each log category.
     * 
     * @param loggers
     *            the loggers to use
     */
