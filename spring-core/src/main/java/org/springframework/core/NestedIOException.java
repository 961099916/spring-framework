...
/**
 * Subclass of {@link IOException} that properly handles a root cause, exposing the root cause just like
 * NestedChecked/RuntimeException does.
 *
 * <p>
 * Proper root cause handling has not been added to standard IOException before Java 6, which is why we need to do it
 * ourselves for Java 5 compatibility purposes.
 *
 * <p>
