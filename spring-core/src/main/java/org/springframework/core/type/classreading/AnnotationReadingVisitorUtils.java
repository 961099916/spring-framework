...
abstract class AnnotationReadingVisitorUtils {
     ...
     * 
     * @param attributesMap
     *            the map of annotation attribute lists, keyed by annotation type name
     * @param metaAnnotationMap
     *            the map of meta annotation relationships, keyed by annotation type name
