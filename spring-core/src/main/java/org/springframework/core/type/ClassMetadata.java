...
public interface ClassMetadata {
     ...
     * (static inner class) that can be constructed independently from an enclosing class.
     */
    boolean isIndependent();

    /**
     * Return whether the underlying class is declared within an enclosing class (i.e. the underlying class is an
     * inner/nested class or a local class within a method).
     * <p>
