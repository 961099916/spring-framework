...
/**
 * Defines access to the annotations of a specific type ({@link AnnotationMetadata class} or {@link MethodMetadata
 * method}), in a form that does not necessarily require the class-loading.
 *
...
public interface AnnotatedTypeMetadata {
     ...
     * @param annotationName
     *            the fully qualified class name of the annotation type to look for
     * @return a Map of attributes, with the attribute name as key (e.g. "value") and the defined attribute value as Map
     *         value. This return value will be {@code null} if no matching annotation is defined.
     */
    @Nullable
     ...
     *            whether to convert class references to String class names for exposure as values in the returned Map,
    ...
    /**
     * Retrieve all attributes of all annotations of the given type, if any (i.e. if defined on the underlying element,
     * as direct annotation or meta-annotation). Note that this variant does <i>not</i> take attribute overrides into
     * account.
     * 
     * @param annotationName
     *            the fully qualified class name of the annotation type to look for
     * @return a MultiMap of attributes, with the attribute name as key (e.g. "value") and a list of the defined
     *         attribute values as Map value. This return value will be {@code null} if no matching annotation is
     *         defined.
