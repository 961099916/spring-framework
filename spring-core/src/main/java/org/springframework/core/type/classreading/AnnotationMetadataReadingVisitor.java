 ...
 *             {@link SimpleAnnotationMetadataReadingVisitor} for internal use within the framework, but there is no
 *             public replacement for {@code AnnotationMetadataReadingVisitor}.
 */
@Deprecated
