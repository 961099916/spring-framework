...
final class SimpleAnnotationMetadataReadingVisitor extends ClassVisitor {
    ...
    public void visitEnd() {
        ...
        this.metadata =
            new SimpleAnnotationMetadata(this.className, this.access, this.enclosingClassName, this.superClassName,
                this.independentInnerClass, this.interfaceNames, memberClassNames, annotatedMethods, annotations);
    }
