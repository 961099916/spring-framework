...
public class StandardAnnotationMetadata extends StandardClassMetadata implements AnnotationMetadata {
    ...
    /**
     * Create a new {@link StandardAnnotationMetadata} wrapper for the given Class, providing the option to return any
     * nested annotations or annotation arrays in the form of
     * {@link org.springframework.core.annotation.AnnotationAttributes} instead of actual {@link Annotation} instances.
     * 
     * @param introspectedClass
     *            the Class to introspect
     * @param nestedAnnotationsAsMap
     *            return nested annotations and annotation arrays as
     *            {@link org.springframework.core.annotation.AnnotationAttributes} for compatibility with ASM-based
     *            {@link AnnotationMetadata} implementations
     * @since 3.1.1
     * @deprecated since 5.2 in favor of the factory method {@link AnnotationMetadata#introspect(Class)}. Use
     ...
     *             {@link #getAnnotationAttributes(String)} if {@code nestedAnnotationsAsMap} is {@code false}
     */
    @Deprecated
