...
/**
 * A {@link Converter} that delegates to a {@link org.springframework.core.serializer.Deserializer} to convert data in a
...
public class DeserializingConverter implements Converter<byte[], Object> {
    ...
    /**
     * Create a {@code DeserializingConverter} with default {@link java.io.ObjectInputStream} configuration, using the
    ...
    /**
     * Create a {@code DeserializingConverter} for using an {@link java.io.ObjectInputStream} with the given
     * {@code ClassLoader}.
     * 
     * @since 4.2.1
