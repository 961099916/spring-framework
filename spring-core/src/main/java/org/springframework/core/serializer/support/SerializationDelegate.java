...
/**
 * A convenient delegate with pre-arranged configuration state for common serialization needs. Implements
 * {@link Serializer} and {@link Deserializer} itself, so can also be passed into such more specific callback methods.
 *
...
public class SerializationDelegate implements Serializer<Object>, Deserializer<Object> {
     ...
     * 
     * @param serializer
     *            the {@link Serializer} to use (never {@code null)}
     * @param deserializer
     *            the {@link Deserializer} to use (never {@code null)}
     */
