...
/**
 * A {@link MethodParameter} variant which synthesizes annotations that declare attribute aliases via
...
public class SynthesizingMethodParameter extends MethodParameter {
    ...
    /**
     * Copy constructor, resulting in an independent {@code SynthesizingMethodParameter} based on the same metadata and
     * cache state that the original object was in.
     * 
     * @param original
