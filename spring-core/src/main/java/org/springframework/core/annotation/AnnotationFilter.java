 ...
 *
 * <p>
 * Note that the {@link MergedAnnotations} model (which this interface has been designed for) always ignores lang
 * annotations according to the {@link #PLAIN} filter (for efficiency reasons). Any additional filters and even custom
 * filter implementations apply within this boundary and may only narrow further from here.
 *
 * @author Phillip Webb
