...
interface AnnotationsProcessor<C, R> {
    ...
    /**
     * Called when an aggregate is about to be processed. This method may return a {@code non-null} result to
    ...
    /**
     * Called when an array of annotations can be processed. This method may return a {@code non-null} result to
     * short-circuit any further processing.
     * 
     * @param context
     *            the context information relevant to the processor
     ...
     * @param annotations
     *            the annotations to process (this array may contain {@code null} elements)
     * @return a {@code non-null} result if no further processing is required
     */
    @Nullable
