...
/**
 * General utility for determining the order of an object based on its type declaration. Handles Spring's {@link Order}
 * annotation as well as {@link javax.annotation.Priority}.
 *
...
public abstract class OrderUtils {
    ...
    /**
     * Return the value of the {@code javax.annotation.Priority} annotation declared on the specified type, or
     * {@code null} if none.
     * 
     * @param type
     *            the type to handle
