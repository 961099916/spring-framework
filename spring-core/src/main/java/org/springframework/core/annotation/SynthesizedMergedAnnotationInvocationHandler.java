...
/**
 * {@link InvocationHandler} for an {@link Annotation} that Spring has <em>synthesized</em> (i.e. wrapped in a dynamic
 * proxy) with additional functionality such as attribute alias handling.
 *
 * @author Sam Brannen
 * @author Phillip Webb
 * @since 5.2
