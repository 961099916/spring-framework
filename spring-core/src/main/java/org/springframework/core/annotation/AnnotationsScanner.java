...
abstract class AnnotationsScanner {
     ...
     * 
     * @param context
     *            an optional context object that will be passed back to the processor
     * @param source
        ...
        try {
            ...
            if (includeInterfaces) {
                for (Class<?> interfaceType : sourceClass.getInterfaces()) {
                    R interfacesResult =
                        processMethodHierarchy(context, aggregateIndex, interfaceType, processor, rootMethod, true);
                    if (interfacesResult != null) {
                        return interfacesResult;
                    }
                }
