...
/**
 * Provides a quick way to access the attribute methods of an {@link Annotation} with consistent ordering as well as a
 * few useful utility methods.
 *
 * @author Phillip Webb
 * @since 5.2
 */
final class AttributeMethods {
    ...
    /**
     * Check if values from the given annotation can be safely accessed without causing any
     * {@link TypeNotPresentException TypeNotPresentExceptions}. In particular, this method is designed to cover Google
     * App Engine's late arrival of such exceptions for {@code Class} values (instead of the more typical early
    ...
    /**
     * Determine if the attribute at the specified index could throw a {@link TypeNotPresentException} when accessed.
     *
     * @param index
    ...
    /**
     * Get the index of the specified attribute, or {@code -1} if the attribute is not in this collection.
     *
     * @param attribute
