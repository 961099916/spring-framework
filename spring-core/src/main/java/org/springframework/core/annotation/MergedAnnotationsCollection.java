...
/**
 * {@link MergedAnnotations} implementation backed by a {@link Collection} of {@link MergedAnnotation} instances that
 * represent direct annotations.
 *
 * @author Phillip Webb
 * @since 5.2
        ...
        public boolean tryAdvance(Consumer<? super MergedAnnotation<A>> action) {
            ...
            if (annotationResult != -1) {
                MergedAnnotation<A> mergedAnnotation =
                    createMergedAnnotationIfPossible(annotationResult, this.mappingCursors[annotationResult]);
