...
/**
 * Log facade used to handle annotation introspection failures (in particular {@code TypeNotPresentExceptions}). Allows
 * annotation processing to continue, assuming that when Class attribute values are not resolvable the annotation should
