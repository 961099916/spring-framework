...
/**
 * {@link MergedAnnotation} that adapts attributes from a root annotation by applying the mapping and mirroring rules of
 * an {@link AnnotationTypeMapping}.
 *
 * <p>
 * Root attribute values are extracted from a source object using a supplied {@code BiFunction}. This allows various
 * different annotation models to be supported by the same class. For example, the attributes source might be an actual
 * {@link Annotation} instance where methods on the annotation instance are
 * {@linkplain ReflectionUtils#invokeMethod(Method, Object) invoked} to extract values. Equally, the source could be a
 * simple {@link Map} with values extracted using {@link Map#get(Object)}.
 *
 * <p>
 ...
 * <tr>
 * <td>Annotation[]</td>
 * <td>Annotation[], Map[], or Object[] where elements are compatible with the value extractor</td>
 * </tr>
 * <tr>
 * <td>Other types</td>
...
final class TypeMappedAnnotation<A extends Annotation> extends AbstractMergedAnnotation<A> {
    ...
    public <T extends Map<String, Object>> T asMap(Function<MergedAnnotation<?>, T> factory, Adapt... adaptations) {
        ...
        for (int i = 0; i < attributes.size(); i++) {
            ...
            Object value =
                (isFiltered(attribute.getName()) ? null : getValue(i, getTypeForMapOptions(attribute, adaptations)));
            if (value != null) {
