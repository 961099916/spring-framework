...
/**
 * {@link MergedAnnotations} implementation that searches for and adapts annotations and meta-annotations using
...
final class TypeMappedAnnotations implements MergedAnnotations {
    ...
    static final MergedAnnotations NONE =
        new TypeMappedAnnotations(null, new Annotation[0], RepeatableContainers.none(), AnnotationFilter.ALL);
        ...
        private boolean tryAdvance(Aggregate aggregate, Consumer<? super MergedAnnotation<A>> action) {
            ...
            if (annotationResult != -1) {
                MergedAnnotation<A> mergedAnnotation =
                    aggregate.createMergedAnnotationIfPossible(annotationResult, this.mappingCursors[annotationResult],
