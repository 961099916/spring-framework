...
/**
 * Provides {@link AnnotationTypeMapping} information for a single source annotation type. Performs a recursive breadth
 * first crawl of all meta-annotations to ultimately provide a quick way to map the attributes of a root
 * {@link Annotation}.
 *
 * <p>
 * Supports convention based merging of meta-annotations as well as implicit and explicit {@link AliasFor @AliasFor}
 * aliases. Also provides information about mirrored attributes.
 *
 * <p>
 * This class is designed to be cached so that meta-annotations only need to be searched once, regardless of how many
 * times they are actually used.
 *
 * @author Phillip Webb
 * @since 5.2
...
final class AnnotationTypeMappings {
     ...
     *            the annotation filter used to limit which annotations are considered
     * @return type mappings for the annotation type
     */
    static AnnotationTypeMappings forAnnotationType(Class<? extends Annotation> annotationType,
     ...
     *            the repeatable containers that may be used by the meta-annotations
     * @param annotationFilter
     *            the annotation filter used to limit which annotations are considered
     * @return type mappings for the annotation type
     */
     ...
     * <p>
     * Index {@code 0} will always return the root mapping; higher indexes will return meta-annotation mappings.
     *
     * @param index
     *            the index to return
