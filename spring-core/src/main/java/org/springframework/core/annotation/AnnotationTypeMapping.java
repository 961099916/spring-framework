...
final class AnnotationTypeMapping {
     ...
     * <p>
     * The resulting value is obtained from the closest meta-annotation, taking into consideration both convention and
     * alias based mapping rules. For root mappings, this method will always return {@code null}.
     *
     * @param attributeIndex
     *            the attribute index of the source attribute
     * @param metaAnnotationsOnly
     *            if only meta annotations should be considered. If this parameter is {@code false} then aliases within
     *            the annotation will also be considered.
     ...
     *            the value extractor used to extract values from any nested annotations
     ...
     * <p>
     * Consult the documentation for {@link MergedAnnotation#synthesize()} for an explanation of what is considered
     * synthesizable.
     *
