...
/**
 * {@link MergedAnnotationSelector} implementations that provide various options for {@link MergedAnnotation} instances.
 *
 * @author Phillip Webb
 * @since 5.2
...
public abstract class MergedAnnotationSelectors {
    ...
    /**
     * Select the first directly declared annotation when possible. If no direct annotations are declared then the
     * nearest annotation is selected.
     * 
