...
public class ReactiveAdapter {
    ...
    /**
     * Constructor for an adapter with functions to convert the target reactive or async type to and from a Reactive
     * Streams Publisher.
     * 
     * @param descriptor
     *            the reactive type descriptor
     * @param toPublisherFunction
     *            adapter to a Publisher
     * @param fromPublisherFunction
     ...
     * 
     * @param source
     *            the source object to adapt from; if the given object is {@code null},
