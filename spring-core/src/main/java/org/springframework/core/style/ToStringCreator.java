...
/**
 * Utility class that builds pretty-printing {@code toString()} methods with pluggable styling conventions. By default,
 * ToStringCreator adheres to Spring's {@code toString()} styling conventions.
 *
 * @author Keith Donald
