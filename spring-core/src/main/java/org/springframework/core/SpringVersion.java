 ...
 * Spring version in all environments. Consider using a reflection-based check instead &mdash; for example, checking for
 * the presence of a specific Spring 5.2 method that you intend to call.
 *
