 ...
 * Then copies each element in the source collection to the target collection. Will perform an element conversion from
 * the source collection's parameterized type to the target collection's parameterized type if necessary.
 *
 * @author Keith Donald
