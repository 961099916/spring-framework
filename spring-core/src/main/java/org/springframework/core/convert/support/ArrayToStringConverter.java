...
/**
 * Converts an array to a comma-delimited String. First adapts the source array to a List, then delegates to
 * {@link CollectionToStringConverter} to perform the target String conversion.
 *
 * @author Keith Donald
 * @since 3.0
 */
