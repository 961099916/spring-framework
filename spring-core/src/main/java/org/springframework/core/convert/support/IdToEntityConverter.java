 ...
 *
 * <p>
 * For this converter to match, the finder method must be static, have the signature {@code find[EntityName]([IdType])},
...
final class IdToEntityConverter implements ConditionalGenericConverter {
    ...
    public Object convert(@Nullable Object source, TypeDescriptor sourceType, TypeDescriptor targetType) {
        ...
        Object id =
            this.conversionService.convert(source, sourceType, TypeDescriptor.valueOf(finder.getParameterTypes()[0]));
