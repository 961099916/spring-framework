...
/**
 * A {@link Comparator} that converts values before they are compared. The specified {@link Converter} will be used to
 * convert each value before it passed to the underlying {@code Comparator}.
 *
 * @author Phillip Webb
 * @since 3.2
 * @param <S>
...
public class ConvertingComparator<S, T> implements Comparator<S> {
    ...
    /**
     * Create a new {@link ConvertingComparator} that compares {@link java.util.Map.Entry map * entries} based on their
     * {@link java.util.Map.Entry#getKey() keys}.
     *
     * @param comparator
     *            the underlying comparator used to compare keys
    ...
    /**
     * Create a new {@link ConvertingComparator} that compares {@link java.util.Map.Entry map entries} based on their
     * {@link java.util.Map.Entry#getValue() values}.
     *
     * @param comparator
     *            the underlying comparator used to compare values
     * @return a new {@link ConvertingComparator} instance
     */
