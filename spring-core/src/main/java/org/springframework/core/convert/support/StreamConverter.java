...
/**
 * Converts a {@link Stream} to and from a collection or array, converting the element type if necessary.
 *
...
class StreamConverter implements ConditionalGenericConverter {
    ...
    /**
     * Validate that a {@link Collection} of the elements held within the stream can be converted to the specified
     * {@code targetType}.
     *
     * @param elementType
    ...
    /**
     * Validate that the specified {@code sourceType} can be converted to a {@link Collection} of the type of the stream
     * elements.
     *
     * @param elementType
     *            the type of the stream elements
