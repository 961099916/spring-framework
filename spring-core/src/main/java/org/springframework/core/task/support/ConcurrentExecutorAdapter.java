 ...
 *
 * <p>
 * This is less useful as of Spring 3.0, since TaskExecutor itself extends the Executor interface. The adapter is only
 * relevant for <em>hiding</em> the TaskExecutor nature of a given object now, solely exposing the standard Executor
