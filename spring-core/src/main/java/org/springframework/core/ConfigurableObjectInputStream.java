...
/**
 * Special ObjectInputStream subclass that resolves class names against a specific ClassLoader. Serves as base class for
...
public class ConfigurableObjectInputStream extends ObjectInputStream {
    ...
    /**
     * Return the fallback ClassLoader to use when no ClassLoader was specified and ObjectInputStream's own default
     * class loader failed.
     * <p>
     * The default implementation simply returns {@code null}, indicating that no specific fallback is available.
     */
    @Nullable
