 ...
 * {@link WritableResource} interface for it. This resource variant also caches resolved {@link File} handles from
 * {@link #getFile()}.
 *
 * <p>
 * This is the class resolved by {@link DefaultResourceLoader} for a "file:..." URL location, allowing a downcast to
 * {@link WritableResource} for it.
 *
 * <p>
 * Alternatively, for direct construction from a {@link java.io.File} handle or NIO {@link java.nio.file.Path}, consider
 * using {@link FileSystemResource}.
 *
...
public class FileUrlResource extends UrlResource implements WritableResource {
     ...
     * <p>
     * Note that this does not enforce "file" as URL protocol. If a protocol is known to be resolvable to a file, it is
