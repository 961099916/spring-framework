 ...
 * {@link ByteArrayResource} or any of the file-based {@code Resource} implementations where possible.
 *
 * <p>
 * In contrast to other {@code Resource} implementations, this is a descriptor for an <i>already opened</i> resource -
 * therefore returning {@code true} from {@link #isOpen()}. Do not use an {@code InputStreamResource} if you need to
 * keep the resource descriptor somewhere, or if you need to read from a stream multiple times.
 *
