...
public class UrlResource extends AbstractFileResolvingResource {
     ...
     * 
     * @param protocol
     *            the URL protocol to use (e.g. "jar" or "file" - without colon); also known as "scheme"
     * @param location
     *            the location (e.g. the file path within that protocol); also known as "scheme-specific part"
     * @throws MalformedURLException
     ...
     *            the location (e.g. the file path within that protocol); also known as "scheme-specific part"
     * @param fragment
     *            the fragment within that location (e.g. anchor on an HTML page, as following after a "#" separator)
     * @throws MalformedURLException
     *             if the given URL specification is not valid
     * @see java.net.URI#URI(String, String, String)
     */
    ...
    /**
     * This implementation creates a {@code UrlResource}, delegating to {@link #createRelativeURL(String)} for adapting
     * the relative path.
     * 
    ...
    /**
     * This delegate creates a {@code java.net.URL}, applying the given path relative to the path of the underlying URL
