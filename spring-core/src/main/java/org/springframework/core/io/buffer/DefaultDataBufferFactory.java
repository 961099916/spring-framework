...
/**
 * Default implementation of the {@code DataBufferFactory} interface. Allows for specification of the default initial
 * capacity at construction time, as well as whether heap-based or direct buffers are to be preferred.
 *
...
public class DefaultDataBufferFactory implements DataBufferFactory {
    ...
    /**
     * Creates a new {@code DefaultDataBufferFactory}, indicating whether direct buffers should be created by
     * {@link #allocateBuffer()} and {@link #allocateBuffer(int)}.
     * 
     * @param preferDirect
     *            {@code true} if direct buffers are to be preferred; {@code false} otherwise
     */
    ...
    /**
     * Creates a new {@code DefaultDataBufferFactory}, indicating whether direct buffers should be created by
     * {@link #allocateBuffer()} and {@link #allocateBuffer(int)}, and what the capacity is to be used for
     * {@link #allocateBuffer()}.
     * 
     * @param preferDirect
     *            {@code true} if direct buffers are to be preferred; {@code false} otherwise
    ...
    public DefaultDataBuffer allocateBuffer(int initialCapacity) {
        ByteBuffer byteBuffer =
            (this.preferDirect ? ByteBuffer.allocateDirect(initialCapacity) : ByteBuffer.allocate(initialCapacity));
