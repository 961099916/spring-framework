...
/**
 * Base class for JavaBean-style components that need to load properties from one or more resources. Supports local
 * properties as well, with configurable overriding.
 *
...
public abstract class PropertiesLoaderSupport {
     ...
     * <p>
     * Default is "false": Properties from files override local defaults. Can be switched to "true" to let local
     * properties override defaults from files.
     */
