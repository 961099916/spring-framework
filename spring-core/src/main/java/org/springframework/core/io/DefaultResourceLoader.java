...
/**
 * Default implementation of the {@link ResourceLoader} interface. Used by {@link ResourceEditor}, and serves as base
 * class for {@link org.springframework.context.support.AbstractApplicationContext}. Can also be used standalone.
 *
 * <p>
...
public class DefaultResourceLoader implements ResourceLoader {
    ...
    /**
     * Specify the ClassLoader to load class path resources with, or {@code null} for using the thread context class
     * loader at the time of actual resource access.
     * <p>
    ...
    /**
     * Return the collection of currently registered protocol resolvers, allowing for introspection as well as
     * modification.
     * 
     * @since 4.3
     */
    ...
    /**
     * ClassPathResource that explicitly expresses a context-relative path through implementing the ContextResource
     * interface.
     */
