 ...
 *
 * <p>
 * Callers will usually assume that a location is a relative path if the {@link #isUrl(String)} method returns
 * {@code false}.
 *
...
public abstract class ResourcePatternUtils {
    ...
    /**
     * Return whether the given resource location is a URL: either a special "classpath" or "classpath*" pseudo URL or a
     * standard URL.
     * 
     ...
     * or a default {@link PathMatchingResourcePatternResolver} built on the given {@code ResourceLoader}.
     * 
     * @param resourceLoader
     *            the ResourceLoader to build a pattern resolver for (may be {@code null} to indicate a default
     *            ResourceLoader)
