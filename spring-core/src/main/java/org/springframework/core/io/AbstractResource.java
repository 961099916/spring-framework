...
public abstract class AbstractResource implements Resource {
     ...
     * {@link #getInputStream()}.
     * <p>
     * This is the same as in {@link Resource}'s corresponding default method but mirrored here for efficient JVM-level
     ...
     * <p>
     * For a custom sub-class of {@code InputStreamResource}, we strongly recommend overriding this method with a more
     * optimal implementation, e.g. checking File length, or possibly simply returning -1 if the stream can only be read
     * once.
     * 
     * @see #getInputStream()
     */
     ...
     *             if the resource cannot be resolved as an absolute file path, i.e. is not available in a file system
     * @throws IOException
