...
public class LocalizedResourceHelper {
     ...
     * <p>
     * The file will be searched with locations in the following order, similar to {@code java.util.ResourceBundle}'s
     * search order:
     * <ul>
     ...
     * 
     * @param name
     *            the name of the file, without localization part nor extension
     * @param extension
     *            the file extension (e.g. ".xls")
     * @param locale
     *            the current locale (may be {@code null})
