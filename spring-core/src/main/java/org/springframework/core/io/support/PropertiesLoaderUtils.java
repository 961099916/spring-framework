...
/**
 * Convenient utility methods for loading of {@code java.util.Properties}, performing standard handling of input
 * streams.
 *
 * <p>
 * For more configurable properties loading, including the option of a customized encoding, consider using the
...
public abstract class PropertiesLoaderUtils {
    ...
    /**
     * Fill the given properties from the given EncodedResource, potentially defining a specific encoding for the
     * properties file.
     * 
     * @param props
    ...
    /**
     * Load all properties from the specified class path resource (in ISO-8859-1 encoding), using the default class
     * loader.
     * <p>
    ...
    /**
     * Load all properties from the specified class path resource (in ISO-8859-1 encoding), using the given class
     * loader.
     * <p>
     * Merges properties if more than one resource of the same name found in the class path.
     * 
