...
public interface Resource extends InputStreamSource {
     ...
     * <p>
     * Will be {@code true} for typical resource descriptors that exist since it strictly implies {@link #exists()}
     * semantics as of 5.1. Note that actual content reading may still fail when attempted. However, a value of
     * {@code false} is a definitive indication that the resource content cannot be read.
     * 
     * @see #getInputStream()
     * @see #exists()
     */
    ...
    /**
     * Indicate whether this resource represents a handle with an open stream. If {@code true}, the InputStream cannot
     * be read multiple times, and must be read and closed to avoid resource leaks.
     * <p>
    ...
    /**
     * Determine whether this resource represents a file in a file system. A value of {@code true} strongly suggests
