...
/**
 * Implementation of the {@code DataBuffer} interface that wraps a Netty {@link ByteBuf}. Typically constructed with
 * {@link NettyDataBufferFactory}.
 *
...
public class NettyDataBuffer implements PooledDataBuffer {
    ...
    /**
     * Writes one or more Netty {@link ByteBuf ByteBufs} to this buffer, starting at the current writing position.
     * 
     * @param byteBufs
     *            the buffers to write into this buffer
     * @return this buffer
     */
