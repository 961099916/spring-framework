...
public interface Decoder<T> {
     ...
     * @param mimeType
     *            the mime type associated with the stream to decode (can be {@code null} if not specified)
     ...
     * 
     * @param inputStream
     *            the {@code DataBuffer} input stream to decode
     * @param elementType
     *            the expected type of elements in the output stream; this type must have been previously passed to the
     *            {@link #canDecode} method and it must have returned {@code true}.
     * @param mimeType
    ...
    /**
     * Decode a data buffer to an Object of type T. This is useful for scenarios, that distinct messages (or events) are
     * decoded and handled individually, in fully aggregated form.
     * 
     * @param buffer
     *            the {@code DataBuffer} to decode
     * @param targetType
     *            the expected output type
     * @param mimeType
     *            the MIME type associated with the data
     * @param hints
     *            additional information about how to do encode
