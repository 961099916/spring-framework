...
public abstract class Hints {
    ...
    /**
     * Name of boolean hint whether to avoid logging data either because it's potentially sensitive, or because it has
     * been logged by a composite encoder, e.g. for multipart requests.
     */
     ...
     *            the hints map
     * @param hintName
     *            the required hint name
     * @param <T>
     *            the hint type to cast to
     ...
     * 
     * @param hints
     *            the hints passed to the encode method
    ...
    /**
     * Merge two maps of hints, creating and copying into a new map if both have values, or returning the non-empty map,
     * or an empty map if both are empty.
     * 
     * @param hints1
     *            1st map of hints
     * @param hints2
    ...
    /**
     * Merge a single hint into a map of hints, possibly creating and copying all hints into a new map, or otherwise if
     * the map of hints is empty, creating a new single entry map.
     * 
     * @param hints
     *            a map of hints to be merge
     * @param hintName
     *            the hint name to merge
     * @param hintValue
     *            the hint value to merge
