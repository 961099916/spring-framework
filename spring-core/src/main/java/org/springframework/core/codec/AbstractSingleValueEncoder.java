...
/**
 * Abstract base class for {@link org.springframework.core.codec.Encoder} classes that can only deal with a single
 * value.
 *
...
public abstract class AbstractSingleValueEncoder<T> extends AbstractEncoder<T> {
     ...
     *            a buffer factory used to create the output
     * @param type
     *            the stream element type to process
     * @param mimeType
     *            the mime type to process
     * @param hints
