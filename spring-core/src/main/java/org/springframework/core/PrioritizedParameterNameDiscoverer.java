...
/**
 * {@link ParameterNameDiscoverer} implementation that tries several discoverer delegates in succession. Those added
 * first in the {@code addDiscoverer} method have highest priority. If one returns {@code null}, the next will be tried.
 *
 * <p>
