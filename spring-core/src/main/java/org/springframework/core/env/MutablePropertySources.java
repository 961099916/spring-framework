...
/**
 * The default implementation of the {@link PropertySources} interface. Allows manipulation of contained property
 * sources and provides a constructor for copying an existing {@code PropertySources} instance.
 *
 * <p>
 * Where <em>precedence</em> is mentioned in methods such as {@link #addFirst} and {@link #addLast}, this is with regard
 * to the order in which property sources will be searched when resolving a given property with a
...
public class MutablePropertySources implements PropertySources {
    ...
    /**
     * Create a new {@code MutablePropertySources} from the given propertySources object, preserving the original order
     * of contained {@code PropertySource} objects.
     */
