...
/**
 * {@code ClassLoader} that does <i>not</i> always delegate to the parent loader as normal class loaders do. This
 * enables, for example, instrumentation to be forced in the overriding ClassLoader, or a "throwaway" class loading
 * behavior where selected application classes are temporarily loaded in the overriding {@code ClassLoader} for
 * introspection purposes before eventually loading an instrumented version of the class in the given parent
 * {@code ClassLoader}.
 *
 * @author Rod Johnson
...
public class OverridingClassLoader extends DecoratingClassLoader {
     ...
     * <p>
     * The default implementation delegates to {@link #findLoadedClass}, {@link #loadBytesForClass} and
     * {@link #defineClass}.
     * 
     * @param name
    ...
    /**
     * Load the defining bytes for the given class, to be turned into a Class object through a {@link #defineClass}
     * call.
     * <p>
     ...
     * <p>
     * The default implementation loads a standard class file through the parent ClassLoader's
     ...
     * @return the transformed bytes (never {@code null}; same as the input bytes if the transformation produced no
     *         changes)
     */
