...
public final class GenericTypeResolver {
    ...
    /**
     * Determine the target type for the generic return type of the given method, where formal type variables are
     * declared on the given class.
     * 
     * @param method
     ...
     * @return the resolved parameter type of the method return type, or {@code null} if not resolvable or if the single
     *         argument is of type {@link WildcardType}.
     */
    @Nullable
    ...
    /**
     * Resolve the single type argument of the given generic interface against the given target class which is assumed
     * to implement the generic interface and possibly declare a concrete type for its type variable.
     * 
     * @param clazz
    ...
    /**
     * Build a mapping of {@link TypeVariable#getName TypeVariable names} to {@link Class concrete classes} for the
