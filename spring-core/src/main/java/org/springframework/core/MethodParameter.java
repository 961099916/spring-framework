...
/**
 * Helper class that encapsulates the specification of a method parameter, i.e. a {@link Method} or {@link Constructor}
 * plus a parameter index and a nested type index for a declared generic type. Useful as a specification object to pass
 * along.
 *
 * <p>
 * As of 4.2, there is a {@link org.springframework.core.annotation.SynthesizingMethodParameter} subclass available
 * which synthesizes annotations with attribute aliases. That subclass is used for web and message endpoint processing,
 * in particular.
 *
...
public class MethodParameter {
     ...
     *            the index of the parameter: -1 for the method return type; 0 for the first method parameter; 1 for the
     ...
     *            second method parameter, etc.
     * @param nestingLevel
     *            the nesting level of the target type (typically 1; e.g. in case of a List of Lists, 1 would indicate
    ...
    /**
     * Internal constructor used to create a {@link MethodParameter} with a containing class already set.
     * 
     * @param executable
    ...
    /**
     * Copy constructor, resulting in an independent MethodParameter object based on the same metadata and cache state
     * that the original object was in.
     * 
     * @param original
     ...
     * <p>
     * This is a convenience factory method for scenarios where a Method or Constructor reference is treated in a
     * generic fashion.
     *
     ...
     * <p>
     * This is a convenience factory method for scenarios where a Java 8 {@link Parameter} descriptor is already
     * available.
     *
     * @param parameter
     ...
     * <p>
     * Note: This method exposes the annotations declared on the method/constructor itself (i.e. at the
     * method/constructor level, not at the parameter level).
     *
     ...
     *
     * @see #getNestingLevel()
     * @deprecated since 5.2 in favor of retaining the original MethodParameter and using {@link #nested(Integer)} if
     *             nesting is required
     */
    @Deprecated
    ...
    /**
     * Return the nesting level of the target type (typically 1; e.g. in case of a List of Lists, 1 would indicate the
    ...
    /**
     * Return a variant of this {@code MethodParameter} with the type for the current level set to the specified value.
     *
     * @param typeIndex
     *            the new type index
     * @since 5.2
     ...
     *
     * @param typeIndex
     *            the corresponding type index (or {@code null} for the default type index)
     * @see #getNestingLevel()
     ...
     * {@link java.util.Optional}, any variant of a parameter-level {@code Nullable} annotation (such as from JSR-305 or
     * the FindBugs set of annotations), or a language-level nullable type declaration or {@code Continuation} parameter
     * in Kotlin.
     *
     * @since 4.3
     */
    ...
    /**
     * Check whether this method parameter is annotated with any variant of a {@code Nullable} annotation, e.g.
     * {@code javax.annotation.Nullable} or {@code edu.umd.cs.findbugs.annotations.Nullable}.
     */
     ...
     *
     * @param containingClass
     *            a specific containing class (potentially a subclass of the declaring class, e.g. substituting a type
     *            variable)
     * @since 5.2
     ...
     *
     * @return a specific containing class (potentially a subclass of the declaring class), or otherwise simply the
     ...
     *
     * @return the parameter name (may be {@code null} if no parameter name metadata is contained in the class file or
     *         no {@link #initParameterNameDiscovery ParameterNameDiscoverer} has been set to begin with)
     */
    @Nullable
    ...
    private static class KotlinDelegate {
        ...
        /**
         * Check whether the specified {@link MethodParameter} represents a nullable Kotlin type, an optional parameter
         * (with a default value in the Kotlin declaration) or a {@code Continuation} parameter used in suspending
         * functions.
         */
        public static boolean isOptional(MethodParameter param) {
            ...
            if (method != null) {
                ...
                predicate =
                    p -> (KParameter.Kind.VALUE.equals(p.getKind()) || KParameter.Kind.INSTANCE.equals(p.getKind()));
            }
            if (function != null) {
                int i = 0;
        ...
        /**
         * Return the generic return type of the method, with support of suspending functions via Kotlin reflection.
         */
        ...
        /**
         * Return the return type of the method, with support of suspending functions via Kotlin reflection.
         */
