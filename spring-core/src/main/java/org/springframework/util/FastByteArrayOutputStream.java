 ...
 * {@code ByteArrayOutputStream}, unlike its sibling {@link ResizableByteArrayOutputStream}.
 *
 * <p>
 * Unlike {@link java.io.ByteArrayOutputStream}, this implementation is backed by an {@link java.util.ArrayDeque} of
...
public class FastByteArrayOutputStream extends OutputStream {
     ...
     * {@link #reset()}, {@link #toByteArray()}, and {@link #toByteArrayUnsafe()}) then the
     ...
     *             if the given capacity is smaller than the actual size of the content stored in the buffer already
    ...
    private static final class FastByteArrayInputStream extends UpdateMessageDigestInputStream {
        ...
        /**
         * Update the message digest with the next len bytes in this stream. Avoids creating new byte arrays and use
