...
/**
 * Abstract class that adapts a {@link Future} parameterized over S into a {@code Future} parameterized over T. All
 * methods are delegated to the adaptee, where {@link #get()} and {@link #get(long, TimeUnit)} call
