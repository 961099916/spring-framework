...
/**
 * A {@link ListenableFuture} whose value can be set via {@link #set(Object)} or {@link #setException(Throwable)}. It
 * may also get cancelled.
 *
 * <p>
...
public class SettableListenableFuture<T> implements ListenableFuture<T> {
     ...
     * Retrieve the value.
     * <p>
     * This method returns the value if it has been set via {@link #set(Object)}, throws an
     * {@link java.util.concurrent.ExecutionException} if an exception has been set via
     * {@link #setException(Throwable)}, or throws a {@link java.util.concurrent.CancellationException} if the future
     * has been cancelled.
     * 
