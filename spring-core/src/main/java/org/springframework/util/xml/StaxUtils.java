...
public abstract class StaxUtils {
    ...
    /**
     * Create an {@link XMLInputFactory} with Spring's defensive setup, i.e. no support for the resolution of DTDs and
     * external entities.
     * 
     ...
     *            supplier for the input factory instance
     * @return a new defensively initialized input factory instance to use
     * @since 5.0.12
     */
     ...
     *             if {@code source} isn't a JAXP 1.4 {@link StAXSource} or custom StAX Source
     */
    @Nullable
     ...
     * 
     * @param result
     *            a JAXP 1.4 {@link StAXResult}
     * @return the {@link XMLStreamReader}
     * @throws IllegalArgumentException
     *             if {@code source} isn't a JAXP 1.4 {@link StAXResult} or custom StAX Result
     */
    @Nullable
     ...
     * 
     * @param events
     *            the list of {@link XMLEvent XMLEvents}.
