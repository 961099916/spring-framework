...
abstract class AbstractXMLReader implements XMLReader {
    ...
    /**
     * This implementation throws a {@code SAXNotRecognizedException} exception for any feature outside of the
     * "http://xml.org/sax/features/" namespace and returns {@code false} for any feature within.
     */
    @Override
    ...
    /**
     * This implementation throws a {@code SAXNotRecognizedException} exception for any feature outside of the
     * "http://xml.org/sax/features/" namespace and accepts a {@code false} value for any feature within.
     */
    @Override
