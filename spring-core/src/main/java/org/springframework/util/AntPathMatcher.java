 ...
 * <li>{@code com/{filename:\\w+}.jsp} will match {@code com/test.jsp} and assign the value {@code test} to the
...
public class AntPathMatcher implements PathMatcher {
     ...
     * patterns, the returned comparator will sort this list so that the order will be as indicated.
     * <ol>
