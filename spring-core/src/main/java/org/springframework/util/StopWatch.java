 ...
 *
 * <p>
 * Conceals use of {@link System#nanoTime()}, improving the readability of application code and reducing the likelihood
 ...
 *
 * <p>
 * This class is normally used to verify performance during proof-of-concept work and in development, rather than as
...
public class StopWatch {
     ...
     * <p>
     * Handy when we have output from multiple stop watches and need to distinguish between them in log or console
     * output.
     */
     ...
     * <p>
     * Set this to {@code false} when using a {@code StopWatch} for millions of intervals; otherwise, the
     * {@code TaskInfo} structure will consume excessive memory.
     * <p>
     ...
     * <p>
     * The results are undefined if {@link #stop()} or timing methods are called without invoking this method first.
     *
     * @see #start(String)
     * @see #stop()
     */
     ...
     * <p>
     * The results are undefined if timing methods are called without invoking at least one pair of {@code start()} /
     * {@code stop()} methods.
     *
     * @see #start()
     * @see #start(String)
