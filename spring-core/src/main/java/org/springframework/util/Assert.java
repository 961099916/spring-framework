 ...
 * {@code org.apache.commons.lang3.Validate} from <a href="https://commons.apache.org/proper/commons-lang/">Apache
 * Commons Lang</a>, Google Guava's
 * <a href="https://github.com/google/guava/wiki/PreconditionsExplained">Preconditions</a>, or similar third-party
 * libraries.
 *
 * @author Keith Donald
...
public abstract class Assert {
     ...
     * 
     * <pre class="code">
     * Assert.hasLength(account.getName(), () -&gt; "Name for account '" + account.getId() + "' must not be empty");
     * </pre>
     * 
     * @param text
     *            the String to check
     ...
     *            the object to check
     * @param messageSupplier
     *            a supplier for the exception message to use if the assertion fails. See
     ...
     *            a message which will be prepended to provide further context. If it is empty or ends in ":" or ";" or
     *            "," or ".", a full exception message will be appended. If it ends in a space, the name of the
     *            offending sub type will be appended. In any other case, a ":" with a space and the name of the
