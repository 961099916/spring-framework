...
public abstract class NumberUtils {
    ...
    /**
     * Check for a {@code BigInteger}/{@code BigDecimal} long overflow before returning the given number as a long
     * value.
     * 
     * @param number
     *            the number to convert
     ...
     * <p>
     * Trims all whitespace (leading, trailing, and in between characters) from the input {@code String} before
     ...
     *            the target class to parse into
     * @param numberFormat
     *            the {@code NumberFormat} to use for parsing (if {@code null}, this method falls back to
