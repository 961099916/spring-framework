...
public abstract class StringUtils {
    ...
    /**
     * Check whether the given object (possibly a {@code String}) is empty. This is effectively a shortcut for
     * {@code !hasLength(String)}.
     * <p>
     ...
     * <p>
     * <b>Note: If the object is typed to {@code String} upfront, prefer {@link #hasLength(String)} or
     ...
     * by simple slashes.
     * <p>
     * <strong>NOTE</strong> that {@code cleanPath} should not be depended upon in a security context. Other mechanisms
     * should be used to prevent path-traversal issues.
     * 
     * @param path
     *            the original path
     ...
     * 
     * @param localeValue
     *            the locale value: following either {@code Locale's} {@code toString()} format ("en", "en_UK", etc),
     *            also accepting spaces as separators (as an alternative to underscores), or BCP 47 (e.g. "en-UK") as
     *            specified by {@link Locale#forLanguageTag} on Java 7+
     ...
     * <p>
     * For many parsing scenarios, this is an inverse operation of {@link Locale#toString Locale's toString}, in a
     * lenient sense. This method does not aim for strict {@code Locale} design compliance; it is rather specifically
     * tailored for typical Spring parsing needs.
     * <p>
     * <b>Note: This delegate does not accept the BCP 47 language tag format. Please use {@link #parseLocale} for
     * lenient parsing of both formats.</b>
     * 
     * @param localeString
     *            the locale {@code String}: following {@code Locale's} {@code toString()} format ("en", "en_UK", etc),
     *            also accepting spaces as separators (as an alternative to underscores)
     * @return a corresponding {@code Locale} instance, or {@code null} if none
     * @throws IllegalArgumentException
     *             in case of an invalid locale specification
     */
     ...
     *            the time zone {@code String}, following {@link TimeZone#getTimeZone(String)} but throwing
     ...
     * 
     * @param enumeration
     *            the {@code Enumeration} to copy (potentially {@code null} or empty)
     * @return the resulting {@code String} array
     */
    ...
    /**
     * Trim the elements of the given {@code String} array, calling {@code String.trim()} on each non-null element.
     * 
     * @param array
     ...
     *            the quotation mark symbol), or {@code null} if no removal should occur
     * @return a {@code Properties} instance representing the array contents, or {@code null} if the array to process
     *         was {@code null} or empty
     */
    @Nullable
     ...
     * @param delimiters
     *            the delimiter characters, assembled as a {@code String} (each of the characters is individually
     ...
     * 
     * @param coll
     *            the {@code Collection} to convert (potentially {@code null} or empty)
     * @param delim
