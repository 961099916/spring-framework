 ...
 *
 * <p>
 * The terms and units used in this class are based on <a href="https://en.wikipedia.org/wiki/Binary_prefix">binary
 * prefixes</a> indicating multiplication by powers of 2. Consult the following table and the Javadoc for
...
public final class DataSize implements Comparable<DataSize>, Serializable {
     ...
     * 
     * @param amount
     *            the amount of the size, measured in terms of the unit, positive or negative
    ...
    /**
     * Obtain a {@link DataSize} from a text string such as {@code 12MB} using {@link DataUnit#BYTES} if no unit is
     * specified.
     * <p>
     * Examples:
     * 
    ...
    /**
     * Obtain a {@link DataSize} from a text string such as {@code 12MB} using the specified default {@link DataUnit} if
     * no unit is specified.
     * <p>
     * The string starts with a number followed optionally by a unit matching one of the supported {@linkplain DataUnit
     * suffixes}.
     * <p>
     * Examples:
     * 
