...
public abstract class CollectionUtils {
    ...
    /**
     * Retrieve the first element of the given Set, using {@link SortedSet#first()} or otherwise using the iterator.
     * 
     * @param set
    ...
    /**
     * Retrieve the last element of the given Set, using {@link SortedSet#last()} or otherwise iterating over all
     * elements (assuming a linked set).
     * 
     * @param set
     *            the Set to check (may be {@code null} or empty)
