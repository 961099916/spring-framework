...
public abstract class ObjectUtils {
     ...
     * <p>
     * Builds a String representation of the contents in case of an array. Returns a {@code "null"} String if
     ...
     * Adjacent elements are separated by the characters {@code ", "} (a comma followed by a space). Returns a
