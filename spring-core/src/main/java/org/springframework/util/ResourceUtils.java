 ...
 * uniform manner. {@link org.springframework.core.io.ResourceLoader}'s {@code getResource()} method can resolve any
 * location to a {@link org.springframework.core.io.Resource} object, which in turn allows one to obtain a
