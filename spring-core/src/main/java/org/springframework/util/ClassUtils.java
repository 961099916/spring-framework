...
public abstract class ClassUtils {
     ...
     *             if the class name was not resolvable (that is, the class could not be found or the class file could
     *             not be loaded)
     * @throws IllegalStateException
     *             if the corresponding class is resolvable but there was a readability mismatch in the inheritance
     *             hierarchy of the class (typically a missing dependency declaration in a Jigsaw module definition for
     *             a superclass or interface implemented by the class to be loaded here)
     ...
     *             if the corresponding class is resolvable but there was a readability mismatch in the inheritance
     *             hierarchy of the class (typically a missing dependency declaration in a Jigsaw module definition for
     *             a superclass or interface implemented by the class to be checked here)
     */
     ...
     * @param classLoader
     *            the ClassLoader to check against (may be {@code null} in which case this method will always return
     *            {@code true})
     */
     ...
     * @param classLoader
     *            the ClassLoader to potentially cache metadata in (may be {@code null} which indicates the system class
     *            loader)
     */
     ...
     *            the class to analyze for interfaces
     * @param classLoader
     *            the ClassLoader that the interfaces need to be visible in (may be {@code null} when accepting all
     *            declared interfaces)
     * @return all interfaces that the given object implements as an array
     */
     ...
     * @throws IllegalArgumentException
     *             if the specified interfaces expose conflicting method signatures (or a similar constraint is
     *             violated)
     ...
     *            the method
     * @param clazz
     *            the clazz that the method is being invoked on (may be {@code null} to indicate the method's declaring
     *            class)
     * @return the qualified name of the method
     * @since 4.3.4
     */
     ...
     * <p>
     * This is particularly useful for arriving at a public exported type on Jigsaw which can be reflectively invoked
