...
/**
 * Represents a MIME Type, as originally defined in RFC 2046 and subsequently used in other Internet protocols including
 * HTTP.
 *
 * <p>
 * This class, however, does not contain support for the q-parameters used in HTTP content negotiation. Those can be
 * found in the subclass {@code org.springframework.http.MediaType} in the {@code spring-web} module.
 *
 * <p>
 * Consists of a {@linkplain #getType() type} and a {@linkplain #getSubtype() subtype}. Also has functionality to parse
 * MIME Type values from a {@code String} using {@link #valueOf(String)}. For more parsing options see
 * {@link MimeTypeUtils}.
 *
...
public class MimeType implements Comparable<MimeType>, Serializable {
     ...
     * <p>
     * The {@linkplain #getSubtype() subtype} is set to <code>"&#42;"</code>, and the parameters are empty.
     * 
     * @param type
     *            the primary type
    ...
    /**
     * Copy-constructor that copies the type, subtype, parameters of the given {@code MimeType}, and allows to set the
    ...
    /**
     * Copy-constructor that copies the type and subtype of the given {@code MimeType}, and allows for different
     * parameter.
     * 
     * @param other
     *            the other MimeType
    ...
    /**
     * Parse the given String value into a {@code MimeType} object, with this method name following the 'valueOf' naming
     * convention (as supported by {@link org.springframework.core.convert.ConversionService}.
     *
    ...
    /**
     * Indicates whether this MIME Type is concrete, i.e. whether neither the type nor the subtype is a wildcard
     * character <code>&#42;</code>.
     *
     ...
     * this method is similar to {@link #includes}, except that it <b>is</b> symmetric.
     *
     * @param other
     *            the reference MIME Type with which to compare
     * @return {@code true} if this MIME Type is compatible with the given MIME Type; {@code false} otherwise
     */
    ...
    /**
     * Similar to {@link #equals(Object)} but based on the type and subtype only, i.e. ignoring parameters.
     *
     * @param other
    ...
    /**
     * Unlike {@link Collection#contains(Object)} which relies on {@link MimeType#equals(Object)}, this method only
     * checks the type and the subtype, but otherwise ignores parameters.
     *
     * @param mimeTypes
    ...
    /**
     * Determine if the parameters in this {@code MimeType} and the supplied {@code MimeType} are equal, performing
     * case-insensitive comparisons for {@link Charset Charsets}.
     *
     * @since 4.2
     */
