...
public class LinkedCaseInsensitiveMap<V> implements Map<String, V>, Serializable, Cloneable {
    ...
    /**
     * Create a new LinkedCaseInsensitiveMap that stores case-insensitive keys according to the default Locale (by
    ...
    /**
     * Create a new LinkedCaseInsensitiveMap that stores case-insensitive keys according to the given Locale (by default
     * in lower case).
     * 
     * @param locale
     ...
     * stores case-insensitive keys according to the default Locale (by default in lower case).
     * 
    ...
    /**
     * Create a new LinkedCaseInsensitiveMap that wraps a {@link LinkedHashMap} with the given initial capacity and
     * stores case-insensitive keys according to the given Locale (by default in lower case).
     * 
     * @param initialCapacity
     *            the initial capacity
     * @param locale
