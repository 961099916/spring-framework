...
public abstract class MockitoUtils {
    ...
    /**
     * Verify the same invocations have been applied to two mocks. This is generally not the preferred way test with
     * mockito and should be avoided if possible.
     * 
     * @param expected
     *            the mock containing expected invocations
     * @param actual
     *            the mock containing actual invocations
     * @param argumentAdapters
     *            adapters that can be used to change argument values before they are compared
     */
