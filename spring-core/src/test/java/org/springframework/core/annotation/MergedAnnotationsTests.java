...
/**
 * Tests for {@link MergedAnnotations} and {@link MergedAnnotation}. These tests cover common usage scenarios and were
 * mainly ported from the original {@code AnnotationUtils} and {@code AnnotatedElementUtils} tests.
 *
 * @author Phillip Webb
 * @author Rod Johnson
...
class MergedAnnotationsTests {
    ...
    void streamWhenFromClassWithMetaDepth1() {
        Stream<Class<?>> classes =
            MergedAnnotations.from(TransactionalComponent.class).stream().map(MergedAnnotation::getType);
    ...
    void streamWhenFromClassWithMetaDepth2() {
        Stream<Class<?>> classes =
            MergedAnnotations.from(ComposedTransactionalComponent.class).stream().map(MergedAnnotation::getType);
    ...
    void getMetaTypes() {
        MergedAnnotation<?> annotation =
            MergedAnnotations.from(ComposedTransactionalComponentClass.class).get(TransactionalComponent.class);
    ...
    void collectMultiValueMapFromClassWithLocalComposedAnnotationAndInheritedAnnotation() {
        MultiValueMap<String, Object> map =
            MergedAnnotations.from(SubClassWithInheritedAnnotation.class, SearchStrategy.INHERITED_ANNOTATIONS)
    ...
    void collectMultiValueMapFavorsInheritedAnnotationsOverMoreLocallyDeclaredComposedAnnotations() {
        MultiValueMap<String, Object> map =
            MergedAnnotations.from(SubSubClassWithInheritedAnnotation.class, SearchStrategy.INHERITED_ANNOTATIONS)
                .stream(Transactional.class).collect(MergedAnnotationCollectors.toMultiValueMap());
    ...
    /**
     * If the "value" entry contains both "DerivedTxConfig" AND "TxConfig", then the algorithm is accidentally picking
     * up shadowed annotations of the same type within the class hierarchy. Such undesirable behavior would cause the
     * logic in {@code org.springframework.context.annotation.ProfileCondition} to fail.
     */
    @Test
    ...
    void collectMultiValueMapFromClassWithMultipleComposedAnnotations() {
        MultiValueMap<String, Object> map =
            MergedAnnotations.from(TxFromMultipleComposedAnnotations.class, SearchStrategy.INHERITED_ANNOTATIONS)
                .stream(Transactional.class).collect(MergedAnnotationCollectors.toMultiValueMap());
    ...
    void getWithInheritedAnnotationsFromClassWithLocalAnnotation() {
        MergedAnnotation<?> annotation =
            MergedAnnotations.from(TxConfig.class, SearchStrategy.INHERITED_ANNOTATIONS).get(Transactional.class);
    ...
    void getWithInheritedAnnotationsFavorsLocalComposedAnnotationOverInheritedAnnotation() {
        MergedAnnotation<?> annotation = MergedAnnotations
            .from(SubClassWithInheritedAnnotation.class, SearchStrategy.INHERITED_ANNOTATIONS).get(Transactional.class);
    ...
    void getWithInheritedAnnotationsFromInterfaceImplementedBySuperclass() {
        MergedAnnotation<?> annotation =
            MergedAnnotations.from(ConcreteClassWithInheritedAnnotation.class, SearchStrategy.INHERITED_ANNOTATIONS)
                .get(Transactional.class);
        assertThat(annotation.isPresent()).isFalse();
    }
    ...
    void getWithInheritedAnnotationsFromInheritedAnnotationInterface() {
        MergedAnnotation<?> annotation = MergedAnnotations
            .from(InheritedAnnotationInterface.class, SearchStrategy.INHERITED_ANNOTATIONS).get(Transactional.class);
    ...
    void withInheritedAnnotationsFromAliasedComposedAnnotation() {
        MergedAnnotation<?> annotation =
            MergedAnnotations.from(AliasedComposedContextConfigurationClass.class, SearchStrategy.INHERITED_ANNOTATIONS)
                .get(ContextConfiguration.class);
    ...
    private void testGetWithInherited(Class<?> element, String... expected) {
        MergedAnnotation<?> annotation =
            MergedAnnotations.from(element, SearchStrategy.INHERITED_ANNOTATIONS).get(ContextConfiguration.class);
    ...
    void getWithInheritedAnnotationsFromInvalidConventionBasedComposedAnnotation() {
        assertThatExceptionOfType(AnnotationConfigurationException.class).isThrownBy(() -> MergedAnnotations
            .from(InvalidConventionBasedComposedContextConfigurationClass.class, SearchStrategy.INHERITED_ANNOTATIONS)
            .get(ContextConfiguration.class));
    }
    ...
    void getWithTypeHierarchyFromClassWithAttributeAliasesInTargetAnnotation() {
        MergedAnnotation<AliasedTransactional> mergedAnnotation =
            MergedAnnotations.from(AliasedTransactionalComponentClass.class, SearchStrategy.TYPE_HIERARCHY)
    ...
    void getWithTypeHierarchyFromClassWithMetaMetaAliasedTransactional() {
        MergedAnnotation<AliasedTransactional> mergedAnnotation =
            MergedAnnotations.from(MetaMetaAliasedTransactionalClass.class, SearchStrategy.TYPE_HIERARCHY)
                .get(AliasedTransactional.class);
    ...
    void getWithTypeHierarchyWhenMultipleMetaAnnotationsHaveClashingAttributeNames() {
        MergedAnnotations annotations = MergedAnnotations
            .from(AliasedComposedContextConfigurationAndTestPropertySourceClass.class, SearchStrategy.TYPE_HIERARCHY);
    ...
    void streamTypeHierarchyAndEnclosingClassesFromNonAnnotatedStaticNestedClassWithAnnotatedEnclosingClass() {
        Stream<
            Class<
                ?>> classes =
                    MergedAnnotations
                        .from(AnnotatedClass.NonAnnotatedStaticNestedClass.class,
    ...
    void getDirectFromClassgetDirectFromClassMetaMetaAnnotatedClass() {
        MergedAnnotation<?> annotation =
            MergedAnnotations.from(MetaMetaAnnotatedClass.class, SearchStrategy.TYPE_HIERARCHY).get(Component.class);
        assertThat(annotation.getString("value")).isEqualTo("meta2");
    }
    ...
    void getDirectFromClassWithAnnotatedClassWithMissingTargetMetaAnnotation() {
        ...
        MergedAnnotation<?> annotation =
            MergedAnnotations.from(TransactionalClass.class, SearchStrategy.TYPE_HIERARCHY).get(Component.class);
        assertThat(annotation.isPresent()).isFalse();
    }
    ...
    void getDirectFromClassWithMetaCycleAnnotatedClassWithMissingTargetMetaAnnotation() {
        MergedAnnotation<?> annotation =
            MergedAnnotations.from(MetaCycleAnnotatedClass.class, SearchStrategy.TYPE_HIERARCHY).get(Component.class);
        assertThat(annotation.isPresent()).isFalse();
    }
    ...
    void isDirectlyPresentForAllScenarios() throws Exception {
        ...
        assertThat(MergedAnnotations.from(InheritedAnnotationInterface.class).isDirectlyPresent(Transactional.class))
            .isTrue();
        assertThat(
            MergedAnnotations.from(SubInheritedAnnotationInterface.class).get(Transactional.class).isDirectlyPresent())
                .isFalse();
    ...
    void getRepeatableDeclaredOnClassWithAttributeAliases() {
        ...
        MergedAnnotations annotations =
            MergedAnnotations.from(HierarchyClass.class, SearchStrategy.DIRECT, containers, AnnotationFilter.NONE);
    ...
    private void testJavaRepeatables(SearchStrategy searchStrategy, Class<?> element, String[] expected) {
        MyRepeatable[] annotations =
            searchStrategy == SearchStrategy.DIRECT ? element.getDeclaredAnnotationsByType(MyRepeatable.class)
    ...
    /**
     * If an attempt is made to synthesize an annotation from an annotation instance that has already been synthesized,
     * the original synthesized annotation should ideally be returned as-is without creating a new proxy instance with
     * the same values.
     */
    @Test
    void synthesizeShouldNotResynthesizeAlreadySynthesizedAnnotations() throws Exception {
        ...
        // Synthesizing an annotation from a different MergedAnnotation results in a different synthesized annotation
        // instance.
        assertThat(synthesizedWebMapping1).isNotSameAs(synthesizedWebMapping2);
        // Synthesizing an annotation from the same MergedAnnotation results in the same synthesized annotation
        // instance.
    ...
    void synthesizeWhenAttributeAliasForMetaAnnotationThatIsNotMetaPresent() throws Exception {
        AliasedComposedTestConfigurationNotMetaPresent annotation =
            AliasedComposedTestConfigurationNotMetaPresentClass.class
    ...
    void synthesizeWithTransitiveImplicitAliasesForAliasPair() throws Exception {
        TransitiveImplicitAliasesForAliasPairTestConfiguration config =
            TransitiveImplicitAliasesForAliasPairTestConfigurationClass.class
    ...
    void synthesizeWithImplicitAliasesWithMissingDefaultValues() throws Exception {
        ...
        assertThatExceptionOfType(AnnotationConfigurationException.class)
            .isThrownBy(() -> MergedAnnotation.from(clazz, config)).withMessageStartingWith("Misconfigured aliases:")
    ...
    /**
     * Fully reflection-based test that verifies support for synthesizing annotations across packages with non-public
     * visibility of user types (e.g., a non-public annotation that uses {@code @AliasFor}).
     */
    @Test
    @SuppressWarnings("unchecked")
    ...
    void getValueWhenHasDefaultOverrideWithImplicitAlias() {
        MergedAnnotation<?> annotation1 =
            MergedAnnotations.from(DefaultOverrideImplicitAliasMetaClass1.class).get(DefaultOverrideRoot.class);
        assertThat(annotation1.getString("text")).isEqualTo("alias-meta-1");
        MergedAnnotation<?> annotation2 =
            MergedAnnotations.from(DefaultOverrideImplicitAliasMetaClass2.class).get(DefaultOverrideRoot.class);
    ...
    void asAnnotationAttributesReturnsPopulatedAnnotationAttributes() {
        MergedAnnotation<?> annotation =
            MergedAnnotations.from(SpringApplicationConfigurationClass.class).get(SpringApplicationConfiguration.class);
