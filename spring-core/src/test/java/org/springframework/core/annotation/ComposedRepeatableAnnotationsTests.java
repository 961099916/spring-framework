...
/**
 * Unit tests that verify support for getting and finding all composed, repeatable annotations on a single annotated
 * element.
 *
 * <p>
...
class ComposedRepeatableAnnotationsTests {
    ...
    private void expectContainerMissingValueAttribute(ThrowingCallable throwingCallable) {
        assertThatExceptionOfType(AnnotationConfigurationException.class).isThrownBy(throwingCallable)
            ...
            .withMessageContaining("for repeatable annotation").withMessageContaining(InvalidRepeatable.class.getName())
