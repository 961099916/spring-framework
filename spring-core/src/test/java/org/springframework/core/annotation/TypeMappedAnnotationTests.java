...
/**
 * Tests for {@link TypeMappedAnnotation}. See also {@link MergedAnnotationsTests} for a much more extensive collection
 * of tests.
 *
 * @author Phillip Webb
 */
class TypeMappedAnnotationTests {
    ...
    void adaptFromNestedMergedAnnotation() {
        ...
        MergedAnnotation<?> annotation =
            TypeMappedAnnotation.of(null, null, NestedContainer.class, Collections.singletonMap("value", nested));
