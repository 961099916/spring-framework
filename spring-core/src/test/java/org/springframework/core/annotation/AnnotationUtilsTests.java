...
class AnnotationUtilsTests {
    ...
    void getDeclaredRepeatableAnnotationsDeclaredOnClass() {
        ...
        // Spring
        Set<MyRepeatable> set =
            getDeclaredRepeatableAnnotations(MyRepeatableClass.class, MyRepeatable.class, MyRepeatableContainer.class);
        assertThat(set).isNotNull();
        values = set.stream().map(MyRepeatable::value).collect(toList());
        assertThat(values).isEqualTo(expectedValuesSpring);
    ...
    void findAnnotationFindsRepeatableContainerOnComposedAnnotationMetaAnnotatedWithRepeatableAnnotations()
        ...
        MyRepeatableContainer annotation =
            AnnotationUtils.findAnnotation(MyRepeatableMeta1And2.class, MyRepeatableContainer.class);
    ...
    void findAnnotationFindsRepeatableContainerOnComposedAnnotationMetaAnnotatedWithRepeatableAnnotationsOnMethod()
        throws Exception {
        Method method =
            getClass().getDeclaredMethod("methodWithComposedAnnotationMetaAnnotatedWithRepeatableAnnotations");
    ...
    /**
     * Mock of {@code org.springframework.web.bind.annotation.GetMapping}, except that the String arrays are overridden
     * with single String elements.
     */
    @Retention(RetentionPolicy.RUNTIME)
    ...
    /**
     * Mock of {@code org.springframework.web.bind.annotation.PostMapping}, except that the path is overridden by
     * convention with single String element.
     */
    @Retention(RetentionPolicy.RUNTIME)
