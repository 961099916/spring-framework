...
class PropertySourcesPropertyResolverTests {
    ...
    void setRequiredProperties_andValidateRequiredProperties() {
        ...
        assertThatExceptionOfType(MissingRequiredPropertiesException.class)
            ...
            .withMessage("The following properties were declared as required " + "but could not be resolved: [bar]");
    ...
    void resolveNestedPropertyPlaceholders() {
        ...
        ps.addFirst(
            new MockPropertySource().withProperty("p1", "v1").withProperty("p2", "v2").withProperty("p3", "${p1}:${p2}") // nested
                                                                                                                         // placeholders
