 ...
 * {@link MessageRequestReplyOperations} for JMS related operations that allow to specify a destination name rather than
 * the actual {@link javax.jms.Destination}.
 *
...
public interface JmsMessageOperations extends MessageSendingOperations<Destination>,
     ...
     * {@link org.springframework.messaging.converter.MessageConverter}, wrap it as a message and send it to the given
     * destination.
     * 
     * @param destinationName
     *            the name of the target destination
    ...
    /**
     * Convert the given Object to serialized form, possibly using a
     * {@link org.springframework.messaging.converter.MessageConverter}, wrap it as a message with the given headers and
    ...
    /**
     * Convert the given Object to serialized form, possibly using a
     * {@link org.springframework.messaging.converter.MessageConverter}, wrap it as a message, apply the given post
     * processor, and send the resulting message to the given destination.
     * 
     * @param destinationName
     *            the name of the target destination
     * @param payload
    ...
    /**
     * Convert the given Object to serialized form, possibly using a
     * {@link org.springframework.messaging.converter.MessageConverter}, wrap it as a message with the given headers,
     * apply the given post processor, and send the resulting message to the given destination.
     * 
     * @param destinationName
     *            the name of the target destination
     * @param payload
     ...
     * @param destinationName
     *            the name of the target destination
     * @return the received message, possibly {@code null} if the message could not be received, for example due to a
     *         timeout
     */
    @Nullable
     ...
     *            the name of the target destination
     * @param targetClass
     *            the target class to convert the payload to
     * @return the converted payload of the reply message, possibly {@code null} if the message could not be received,
     ...
     * {@link org.springframework.messaging.converter.MessageConverter}, send it as a {@link Message} to the given
     * destination, receive the reply and convert its body of the specified target class.
     * 
     * @param destinationName
     *            the name of the target destination
     * @param request
     ...
     * @return the payload of the reply message, possibly {@code null} if the message could not be received, for example
     *         due to a timeout
     */
    @Nullable
    ...
    /**
     * Convert the given request Object to serialized form, possibly using a
     * {@link org.springframework.messaging.converter.MessageConverter}, send it as a {@link Message} with the given
     * headers, to the specified destination, receive the reply and convert its body of the specified target class.
     * 
     * @param destinationName
     *            the name of the target destination
     * @param request
    ...
    /**
     * Convert the given request Object to serialized form, possibly using a
     * {@link org.springframework.messaging.converter.MessageConverter}, apply the given post processor and send the
     * resulting {@link Message} to the given destination, receive the reply and convert its body of the given target
     * class.
     * 
     * @param destinationName
     *            the name of the target destination
     ...
     * @param targetClass
     *            the target type to convert the payload of the reply to
     * @param requestPostProcessor
     *            post process to apply to the request message
     * @return the payload of the reply message, possibly {@code null} if the message could not be received, for example
     *         due to a timeout
     */
    @Nullable
     ...
     * Convert the given request Object to serialized form, possibly using a
     * {@link org.springframework.messaging.converter.MessageConverter}, wrap it as a message with the given headers,
     * apply the given post processor and send the resulting {@link Message} to the specified destination, receive the
     * reply and convert its body of the given target class.
     * 
     * @param destinationName
     *            the name of the target destination
     * @param request
