 ...
 *
 * <p>
 * This allows for further modification of the message after it has been processed by the converter and is useful for
 * setting JMS headers and properties.
 *
 * <p>
...
public interface MessagePostProcessor {
     ...
     * @return a post-processed variant of the message, or simply the incoming message; never {@code null}
