...
public class JmsMessagingTemplate extends AbstractMessagingTemplate<Destination>
    ...
    /**
     * Constructor for use with bean properties. Requires {@link #setConnectionFactory} or {@link #setJmsTemplate} to be
     * called.
     */
    public JmsMessagingTemplate() {}

    /**
     * Create a {@code JmsMessagingTemplate} instance with the JMS {@link ConnectionFactory} to use, implicitly building
     * a {@link JmsTemplate} based on it.
     * 
     * @since 4.1.2
     */
    ...
    /**
     * Return the {@link MessageConverter} to use to convert a {@link Message} from the messaging to and from a
    ...
    /**
     * Set the {@link MessageConverter} to use to convert a {@link Message} from the messaging to and from a
     * {@link javax.jms.Message}. By default, a {@link MessagingMessageConverter} is defined using a
     ...
     * {@link MessagingMessageConverter#setPayloadConverter(MessageConverter) payload converter} for more advanced
     * scenarios.
     *
    ...
    /**
     * Configure the default destination name to use in send methods that don't have a destination argument. If a
     * default destination is not configured, send methods without a destination argument will raise an exception if
     * invoked.
     *
