 ...
 *
 * <p>
 * To be used with {@link JmsTemplate}'s callback methods that take a {@link ProducerCallback} argument, often
 * implemented as an anonymous inner class or as a lambda expression.
 *
 * <p>
 * The typical implementation will perform multiple operations on the supplied JMS {@link Session} and
...
public interface ProducerCallback<T> {
     ...
     * 
     * @param session
     *            the JMS {@code Session} object to use
     * @param producer
     *            the JMS {@code MessageProducer} object to use
