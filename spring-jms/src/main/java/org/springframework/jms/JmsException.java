...
public abstract class JmsException extends NestedRuntimeException {
     ...
     *            the detail message
     * @param cause
     *            the cause of the exception. This argument is generally expected to be a proper subclass of
     *            {@link javax.jms.JMSException}, but can also be a JNDI NamingException or the like.
     */
    ...
    /**
     * Constructor that takes a plain root cause, intended for subclasses mirroring corresponding {@code javax.jms}
     * exceptions.
     * 
     * @param cause
     *            the cause of the exception. This argument is generally expected to be a proper subclass of
     ...
     * 
     * @return a string specifying the vendor-specific error code if the root cause is an instance of JMSException, or
     *         {@code null}
     */
    @Nullable
