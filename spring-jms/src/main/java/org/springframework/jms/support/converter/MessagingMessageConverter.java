...
/**
 * Convert a {@link Message} from the messaging abstraction to and from a {@link javax.jms.Message} using an underlying
 * {@link MessageConverter} for the payload and a {@link org.springframework.jms.support.JmsHeaderMapper} to map the JMS
...
public class MessagingMessageConverter implements MessageConverter, InitializingBean {
    ...
    /**
     * Create a JMS message for the specified payload and conversionHint. The conversion hint is an extra object passed
     * to the {@link MessageConverter}, e.g. the associated {@code MethodParameter} (may be {@code null}}.
     * 
     * @since 4.3
