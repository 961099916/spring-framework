...
/**
 * Generic utility methods for working with JMS. Mainly for internal use within the framework, but also useful for
 * custom JMS access code.
 *
...
public abstract class JmsUtils {
    ...
    /**
     * Close the given JMS Connection and ignore any thrown exception. This is useful for typical {@code finally} blocks
     * in manual JMS code.
     * 
     * @param con
     *            the JMS Connection to close (may be {@code null})
     */
     ...
     *            the JMS Connection to close (may be {@code null})
     * @param stop
     *            whether to call {@code stop()} before closing
     */
    ...
    /**
     * Close the given JMS Session and ignore any thrown exception. This is useful for typical {@code finally} blocks in
     * manual JMS code.
     * 
     * @param session
    ...
    /**
     * Close the given JMS MessageProducer and ignore any thrown exception. This is useful for typical {@code finally}
     * blocks in manual JMS code.
     * 
     * @param producer
    ...
    /**
     * Close the given JMS MessageConsumer and ignore any thrown exception. This is useful for typical {@code finally}
     * blocks in manual JMS code.
     * 
     * @param consumer
    ...
    /**
     * Close the given JMS QueueBrowser and ignore any thrown exception. This is useful for typical {@code finally}
     * blocks in manual JMS code.
     * 
     * @param browser
     *            the JMS QueueBrowser to close (may be {@code null})
     */
    ...
    /**
     * Close the given JMS QueueRequestor and ignore any thrown exception. This is useful for typical {@code finally}
     * blocks in manual JMS code.
     * 
     * @param requestor
     *            the JMS QueueRequestor to close (may be {@code null})
     */
    ...
    /**
     * Build a descriptive exception message for the given JMSException, incorporating a linked exception's message if
     * appropriate.
     * 
     * @param ex
     *            the JMSException to build a message for
