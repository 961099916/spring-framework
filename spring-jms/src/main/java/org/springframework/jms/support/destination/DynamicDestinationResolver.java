...
/**
 * Simple {@link DestinationResolver} implementation resolving destination names as dynamic destinations.
 *
...
public class DynamicDestinationResolver implements DestinationResolver {
     ...
     *            the current JMS Session
     * @param topicName
     *            the name of the desired {@link Topic}
     ...
     *            the current JMS Session
     * @param queueName
     *            the name of the desired {@link Queue}
