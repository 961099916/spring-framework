...
/**
 * Base class for {@link org.springframework.jms.core.JmsTemplate} and other JMS-accessing gateway helpers, adding
 * destination-related properties to {@link JmsAccessor JmsAccessor's} common properties.
 *
 * <p>
...
public abstract class JmsDestinationAccessor extends JmsAccessor {
    ...
    /**
     * Timeout value indicating that a receive operation should check if a message is immediately available without
     * blocking.
     * 
     * @since 4.3
     */
    ...
    /**
     * Set the {@link DestinationResolver} that is to be used to resolve {@link javax.jms.Destination} references for
     * this accessor.
     * <p>
     ...
     *
     * @param pubSubDomain
     *            "true" for the Publish/Subscribe domain ({@link javax.jms.Topic Topics}), "false" for the
     *            Point-to-Point domain ({@link javax.jms.Queue Queues})
    ...
    /**
     * Resolve the given destination name into a JMS {@link Destination}, via this accessor's
     ...
     * @param timeout
     *            the receive timeout (a negative value indicates a no-wait receive; 0 indicates an indefinite wait
     *            attempt)
