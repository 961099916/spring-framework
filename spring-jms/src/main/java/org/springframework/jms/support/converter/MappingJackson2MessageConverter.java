...
public class MappingJackson2MessageConverter implements SmartMessageConverter, BeanClassLoaderAware {
     ...
     * will be "UTF-8".
     * <p>
     * When reading from a text-based message, an encoding may have been suggested through a special JMS property which
     * will then be preferred over the encoding set on this MessageConverter instance.
     * 
    ...
    /**
     * Convert a Java object to a JMS Message using the specified json view and the supplied session to create the
     * message object.
     * 
     * @param object
     ...
     * @param jsonView
     *            the view to use to filter the content
     ...
     * @param message
     *            the JMS Message on which to set the type id property
     * @throws JMSException
     *             if thrown by JMS methods
     ...
     * 
     * @param message
     *            the JMS Message from which to get the type id property
     * @throws JMSException
     *             if thrown by JMS methods
     ...
     *            the conversion hint Object as passed into the converter for the current conversion attempt
