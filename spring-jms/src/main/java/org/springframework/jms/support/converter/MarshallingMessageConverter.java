 ...
 * {@link MessageType#TEXT}. Unmarshals from a {@link TextMessage} or {@link BytesMessage} to an object.
 *
...
public class MarshallingMessageConverter implements MessageConverter, InitializingBean {
    ...
    /**
     * Construct a new {@code MarshallingMessageConverter} with no {@link Marshaller} or {@link Unmarshaller} set. The
     * marshaller must be set after construction by invoking {@link #setMarshaller(Marshaller)} and
     ...
     *             when {@code marshaller} does not implement the {@link Unmarshaller} interface as well
     */
     ...
     * {@link javax.jms.BytesMessage}. The desired message type can be defined by setting the {@link #setTargetType
     * "marshalTo"} property.
     * 
    ...
    /**
     * Template method that allows for custom message marshalling. Invoked when {@link #setTargetType} is not
