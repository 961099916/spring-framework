...
/**
 * Resource holder wrapping a JMS {@link Connection} and a JMS {@link Session}. {@link JmsTransactionManager} binds
 * instances of this class to the thread, for a given JMS {@link ConnectionFactory}.
 *
 * <p>
...
public class JmsResourceHolder extends ResourceHolderSupport {
     ...
     *            the JMS ConnectionFactory that this resource holder is associated with (may be {@code null})
     */
    ...
    /**
     * Return whether this resource holder is frozen, i.e. does not allow for adding further Connections and Sessions to
     * it.
     * 
     * @see #addConnection
     * @see #addSession
     ...
     * <p>
     * In contrast to {@link #getSession()}, this must not lazily initialize a new Session, not even in
     * {@link JmsResourceHolder} subclasses.
     */
    @Nullable
