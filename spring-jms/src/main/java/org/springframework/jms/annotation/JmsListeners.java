 ...
 *
 * <p>
 * Can be used natively, declaring several nested {@link JmsListener} annotations. Can also be used in conjunction with
 * Java 8's support for repeatable annotations, where {@link JmsListener} can simply be declared several times on the
