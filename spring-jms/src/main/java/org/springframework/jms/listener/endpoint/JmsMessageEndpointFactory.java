...
/**
 * JMS-specific implementation of the JCA 1.7 {@link javax.resource.spi.endpoint.MessageEndpointFactory} interface,
 * providing transaction management capabilities for a JMS listener object (e.g. a {@link javax.jms.MessageListener}
 * object).
 *
 * <p>
 * Uses a static endpoint implementation, simply wrapping the specified message listener object and exposing all of its
 * implemented interfaces on the endpoint instance.
 *
 * <p>
 * Typically used with Spring's {@link JmsMessageEndpointManager}, but not tied to it. As a consequence, this endpoint
 * factory could also be used with programmatic endpoint management on a native
