...
/**
 * A {@link javax.jms.MessageListener} adapter that invokes a configurable {@link InvocableHandlerMethod}.
 *
 * <p>
 * Wraps the incoming {@link javax.jms.Message} to Spring's {@link Message} abstraction, copying the JMS standard
 * headers using a configurable {@link JmsHeaderMapper}.
 *
 * <p>
 * The original {@link javax.jms.Message} and the {@link javax.jms.Session} are provided as additional arguments so that
 * these can be injected as method arguments if necessary.
 *
...
public class MessagingMessageListenerAdapter extends AbstractAdaptableMessageListener {
    ...
    /**
     * Invoke the handler, wrapping any exception to a {@link ListenerExecutionFailedException} with a dedicated error
     * message.
     */
    @Nullable
