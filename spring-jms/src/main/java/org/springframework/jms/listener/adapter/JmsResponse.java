...
/**
 * Return type of any JMS listener method used to indicate the actual response destination alongside the response
 * itself. Typically used when said destination needs to be computed at runtime.
 *
 * <p>
 ...
 * {@link org.springframework.messaging.handler.annotation.SendTo @SendTo} is the recommended declarative approach.
 *
...
public class JmsResponse<T> {
    ...
    /**
     * Resolve the {@link Destination} to use for this instance. The {@link DestinationResolver} and {@link Session} can
     * be used to resolve a destination at runtime.
     *
     * @param destinationResolver
     *            the destination resolver to use if necessary
     * @param session
     *            the session to use, if necessary
