...
/**
 * Abstract parser for JMS listener container elements, providing support for common properties that are identical for
 * all listener container variants.
 *
...
abstract class AbstractListenerContainerParser implements BeanDefinitionParser {
    ...
    public BeanDefinition parse(Element element, ParserContext parserContext) {
        ...
        if (StringUtils.hasText(factoryId)) {
            RootBeanDefinition beanDefinition =
                createContainerFactory(factoryId, element, parserContext, commonProperties, specificProperties);
    ...
    /**
     * Parse the common properties for all listeners as defined by the specified container {@link Element}.
     */
    protected abstract MutablePropertyValues parseSpecificContainerProperties(Element containerEle,
        ParserContext parserContext);

    /**
     * Create the {@link BeanDefinition} for the container factory using the specified shared property values.
     */
    @Nullable
