...
public class JmsListenerEndpointRegistrar implements BeanFactoryAware, InitializingBean {
    ...
    /**
     * Set the {@link JmsListenerContainerFactory} to use in case a {@link JmsListenerEndpoint} is registered with a
     * {@code null} container factory.
     * <p>
     * Alternatively, the bean name of the {@link JmsListenerContainerFactory} to use can be specified for a lazy
     * lookup, see {@link #setContainerFactoryBeanName}.
     */
    ...
    /**
     * Set the bean name of the {@link JmsListenerContainerFactory} to use in case a {@link JmsListenerEndpoint} is
     * registered with a {@code null} container factory. Alternatively, the container factory instance can be registered
     * directly: see {@link #setContainerFactory(JmsListenerContainerFactory)}.
     * 
     * @see #setBeanFactory
     */
    ...
    private JmsListenerContainerFactory<?> resolveContainerFactory(JmsListenerEndpointDescriptor descriptor) {
        if (descriptor.containerFactory != null) {
            ...
            this.containerFactory =
                this.beanFactory.getBean(this.containerFactoryBeanName, JmsListenerContainerFactory.class);
            return this.containerFactory;
        } else {
    ...
    /**
     * Register a new {@link JmsListenerEndpoint} alongside the {@link JmsListenerContainerFactory} to use to create the
    ...
    /**
     * Register a new {@link JmsListenerEndpoint} using the default {@link JmsListenerContainerFactory} to create the
     * underlying container.
     * 
