...
public class JmsNamespaceHandlerTests {
    ...
    public void testComponentRegistration() {
        ...
        assertThat(context.containsComponentDefinition(DefaultMessageListenerContainer.class.getName() + "#0"))
            .as("Parser should have registered a component named '" + DefaultMessageListenerContainer.class.getName()
                + "#0'")
            .isTrue();
        assertThat(context.containsComponentDefinition(JmsMessageEndpointManager.class.getName() + "#0"))
            .as("Parser should have registered a component named '" + JmsMessageEndpointManager.class.getName() + "#0'")
            .isTrue();
    ...
    public void testSourceExtraction() {
        ...
        while (iterator.hasNext()) {
            ...
            assertThat(compDef.getSource())
                .as("CompositeComponentDefinition '" + compDef.getName() + "' has no source attachment").isNotNull();
    ...
    /**
     * Internal extension that registers a {@link ReaderEventListener} to store registered {@link ComponentDefinition}s.
     */
