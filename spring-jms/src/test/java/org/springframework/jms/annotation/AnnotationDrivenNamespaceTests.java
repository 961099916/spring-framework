...
class AnnotationDrivenNamespaceTests extends AbstractJmsAnnotationDrivenTests {
    ...
    void fullConfigurableConfiguration() {
        ApplicationContext context =
            new ClassPathXmlApplicationContext("annotation-driven-full-configurable-config.xml", getClass());
        testFullConfiguration(context);
    }
    ...
    void explicitContainerFactory() {
        ApplicationContext context =
            new ClassPathXmlApplicationContext("annotation-driven-custom-container-factory.xml", getClass());
    ...
    void defaultContainerFactory() {
        ApplicationContext context =
            new ClassPathXmlApplicationContext("annotation-driven-default-container-factory.xml", getClass());
    ...
    void jmsHandlerMethodFactoryConfiguration() throws JMSException {
        ApplicationContext context =
            new ClassPathXmlApplicationContext("annotation-driven-custom-handler-method-factory.xml", getClass());
    ...
    void jmsListenerIsRepeatable() {
        ApplicationContext context =
            new ClassPathXmlApplicationContext("annotation-driven-jms-listener-repeatable.xml", getClass());
