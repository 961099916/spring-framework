 ...
 *
 * <p>
 * An {@code EmbeddedDatabase} is also a {@link DataSource} and adds a {@link #shutdown} operation so that the embedded
 * database instance can be shut down gracefully.
 *
 * @author Keith Donald
 * @author Sam Brannen
 * @since 3.0
