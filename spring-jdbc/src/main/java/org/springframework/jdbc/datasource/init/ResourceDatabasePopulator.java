...
public class ResourceDatabasePopulator implements DatabasePopulator {
     ...
     * 
     * @param scripts
     *            the scripts to execute to initialize or clean up the database (never {@code null})
     * @since 4.0.3
     */
     ...
     *            the encoding for the supplied SQL scripts (may be {@code null} or <em>empty</em> to indicate platform
     *            encoding)
     * @param scripts
     *            the scripts to execute to initialize or clean up the database (never {@code null})
     * @since 4.0.3
     ...
     * 
     * @param script
     *            the path to an SQL script (never {@code null})
     */
     ...
     * 
     * @param scripts
     *            the scripts to execute (never {@code null})
     */
     ...
     * 
     * @param sqlScriptEncoding
     *            the encoding used in scripts (may be {@code null} or empty to indicate platform encoding)
     ...
     *            the start delimiter for block comments (never {@code null} or empty)
     * @since 4.0.3
     ...
     * {@code DROP} statement.
     * <p>
     * The default is {@code false} so that if the populator runs accidentally, it will fail fast if a script starts
     ...
     * 
     * @param dataSource
     *            the {@code DataSource} to execute against (never {@code null})
