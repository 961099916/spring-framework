...
/**
 * Resource holder wrapping a JDBC {@link Connection}. {@link DataSourceTransactionManager} binds instances of this
 * class to the thread, for a specific {@link javax.sql.DataSource}.
 *
 * <p>
...
public class ConnectionHolder extends ResourceHolderSupport {
    ...
    /**
     * Create a new ConnectionHolder for the given JDBC Connection, wrapping it with a {@link SimpleConnectionHandle},
     * assuming that there is no ongoing transaction.
     * 
     * @param connection
     *            the JDBC Connection to hold
     ...
     *            whether the given Connection is involved in an ongoing transaction
     * @see SimpleConnectionHandle
     */
     ...
     * <p>
     * This will be the same Connection until {@code released} gets called on the ConnectionHolder, which will reset the
    ...
    /**
     * Override the existing Connection handle with the given Connection. Reset the handle if given {@code null}.
     * <p>
    ...
    /**
     * Create a new JDBC 3.0 Savepoint for the current Connection, using generated savepoint names that are unique for
     * the Connection.
     * 
