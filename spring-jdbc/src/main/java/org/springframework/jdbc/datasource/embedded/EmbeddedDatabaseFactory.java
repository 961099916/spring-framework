 ...
 * <li>Call {@link #setDatabaseType} to set the database type if you wish to use one of the supported types.
 * <li>Call {@link #setDatabaseConfigurer} to configure support for a custom embedded database type.
 * <li>Call {@link #setDatabasePopulator} to change the algorithm used to populate the database.
 * <li>Call {@link #setDataSourceFactory} to change the type of {@link DataSource} used to connect to the database.
 * </ul>
 *
 * <p>
 * After configuring the factory, call {@link #getDatabase()} to obtain a reference to the {@link EmbeddedDatabase}
 * instance.
 *
 * @author Keith Donald
...
public class EmbeddedDatabaseFactory {
    ...
    /**
     * Set the {@code generateUniqueDatabaseName} flag to enable or disable generation of a pseudo-random unique ID to
     * be used as the database name.
     * <p>
     * Setting this flag to {@code true} overrides any explicit name set via {@link #setDatabaseName}.
     * 
     * @since 4.2
     * @see #setDatabaseName
     */
     ...
     * <p>
     * Will be overridden if the {@code generateUniqueDatabaseName} flag has been set to {@code true}.
     * 
     * @param databaseName
    ...
    /**
     * Factory method that returns the {@linkplain EmbeddedDatabase embedded database} instance, which is also a
     * {@link DataSource}.
     */
     ...
     * <p>
     * If the {@code generateUniqueDatabaseName} flag has been set to {@code true}, the current value of the
     * {@linkplain #setDatabaseName database name} will be overridden with an auto-generated name.
     * <p>
     * Subclasses may call this method to force initialization; however, this method should only be invoked once.
     * <p>
     * After calling this method, {@link #getDataSource()} returns the {@link DataSource} providing connectivity to the
     * database.
     */
     ...
     * <p>
     * Returns {@code null} if the {@code DataSource} has not been initialized or if the database has been shut down.
     * Subclasses may call this method to access the {@code DataSource} instance directly.
     */
    @Nullable
