 ...
 *
 * <p>
 * Will lookup Spring managed beans identified by bean name, expecting them to be of type {@code javax.sql.DataSource}.
 *
 * @author Costin Leau
...
public class BeanFactoryDataSourceLookup implements DataSourceLookup, BeanFactoryAware {
     ...
     * {@link BeanFactory} will be replaced by the {@link BeanFactory} that creates it (c.f. the
     * {@link BeanFactoryAware} contract). So only use this constructor if you are using this class outside the context
     * of a Spring IoC container.
     * 
     * @param beanFactory
     *            the bean factory to be used to lookup {@link DataSource DataSources}
     */
