...
/**
 * Simple implementation of the standard JDBC {@link javax.sql.DataSource} interface, configuring a plain old JDBC
 * {@link java.sql.Driver} via bean properties, and returning a new {@link java.sql.Connection} from every
