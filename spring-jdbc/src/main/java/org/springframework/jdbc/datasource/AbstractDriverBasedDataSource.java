...
public abstract class AbstractDriverBasedDataSource extends AbstractDataSource {
     ...
     * <p>
     * Can also contain "user" and "password" properties. However, any "username" and "password" bean properties
     * specified on this DataSource will override the corresponding connection properties.
     *
     * @see java.sql.Driver#connect(String, java.util.Properties)
     */
    ...
    /**
     * This implementation delegates to {@code getConnectionFromDriver}, using the default username and password of this
     * DataSource.
     * 
    ...
    /**
     * This implementation delegates to {@code getConnectionFromDriver}, using the given username and password.
     * 
     * @see #getConnectionFromDriver(String, String)
     */
    @Override
    ...
    /**
     * Build properties for the Driver, including the given username and password (if any), and obtain a corresponding
     * Connection.
     * 
     * @param username
