...
public class MapDataSourceLookup implements DataSourceLookup {
     ...
     * 
     * @param dataSources
     *            the {@link Map} of {@link DataSource DataSources}; the keys are {@link String Strings}, the values are
     *            actual {@link DataSource} instances.
     */
     ...
     *            the name under which the supplied {@link DataSource} is to be added
     * @param dataSource
     *            the {@link DataSource} to be added
     */
    ...
    /**
     * Set the {@link Map} of {@link DataSource DataSources}; the keys are {@link String Strings}, the values are actual
     * {@link DataSource} instances.
     * <p>
     * If the supplied {@link Map} is {@code null}, then this method call effectively has no effect.
     *
     * @param dataSources
     *            said {@link Map} of {@link DataSource DataSources}
     */
     ...
     *            the name under which the supplied {@link DataSource} is to be added
     * @param dataSource
     *            the {@link DataSource} to be so added
     */
