...
/**
 * Convenient base class for JDBC-aware transaction objects. Can contain a {@link ConnectionHolder} with a JDBC
 * {@code Connection}, and implements the {@link SavepointManager} interface based on that {@code ConnectionHolder}.
 *
 * <p>
 * Allows for programmatic management of JDBC {@link java.sql.Savepoint Savepoints}. Spring's
 * {@link org.springframework.transaction.support.DefaultTransactionStatus} automatically delegates to this, as it
 * autodetects transaction objects which implement the {@link SavepointManager} interface.
 *
