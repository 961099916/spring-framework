...
/**
 * RdbmsOperation using a JdbcTemplate and representing an SQL-based call such as a stored procedure or a stored
 * function.
 *
 * <p>
...
public abstract class SqlCall extends RdbmsOperation {
    ...
    /**
     * Flag used to indicate that the sql for this call should be used exactly as it is defined. No need to add the
     * escape syntax and parameter place holders.
     */
    private boolean sqlReadyForUse = false;

    /**
     * Call string as defined in java.sql.CallableStatement. String of form {call add_invoice(?, ?, ?)} or {? = call
     * get_invoice_count(?)} if isFunction is set to true. Updated after each parameter is added.
     */
    @Nullable
     ...
     * 
     * @param inParamMapper
     *            parametermapper. May not be {@code null}.
     */
