...
public class SqlUpdate extends SqlOperation {
    ...
    /**
     * Maximum number of rows the update may affect. If more are affected, an exception will be thrown. Ignored if 0.
     */
     ...
     * @param types
     *            the SQL types of the parameters, as defined in the {@code java.sql.Types} class
     * @param maxRowsAffected
     *            the maximum number of rows that may be affected by the update
     * @see java.sql.Types
     */
    ...
    /**
     * Set the maximum number of rows that may be affected by this update. The default value is 0, which does not limit
     * the number of rows affected.
     * 
     * @param maxRowsAffected
     *            the maximum number of rows that can be affected by this update without this class's update method
    ...
    /**
     * Set the <i>exact</i> number of rows that must be affected by this update. The default value is 0, which allows
     * any number of rows to be affected.
     * <p>
     * This is an alternative to setting the <i>maximum</i> number of rows that may be affected.
     * 
     * @param requiredRowsAffected
     *            the exact number of rows that must be affected by this update without this class's update method
     *            considering it an error
     */
     ...
     *            the KeyHolder that will hold the generated keys
     * @return the number of rows affected by the update
     */
