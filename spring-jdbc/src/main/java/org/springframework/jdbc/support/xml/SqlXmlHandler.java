...
/**
 * Abstraction for handling XML fields in specific databases. Its main purpose is to isolate database-specific handling
 * of XML stored in the database.
 *
 * <p>
 * JDBC 4.0 introduces the new data type {@code java.sql.SQLXML} but most databases and their drivers currently rely on
 * database-specific data types and features.
 *
 * <p>
 * Provides accessor methods for XML fields and acts as factory for {@link SqlXmlValue} instances.
 *
...
public interface SqlXmlHandler {
     ...
     * <p>
     * Might simply invoke {@code ResultSet.getString} or work with {@code SQLXML} or database-specific classes
     ...
     * <p>
     * Might simply invoke {@code ResultSet.getAsciiStream} or work with {@code SQLXML} or database-specific classes
     * depending on the database and driver.
     * 
     * @param rs
     *            the ResultSet to retrieve the content from
     ...
     * <p>
     * Might simply invoke {@code ResultSet.getCharacterStream} or work with {@code SQLXML} or database-specific classes
     * depending on the database and driver.
     * 
     * @param rs
     *            the ResultSet to retrieve the content from
     ...
     * <p>
     * Might work with {@code SQLXML} or database-specific classes depending on the database and driver.
     * 
     * @param rs
     *            the ResultSet to retrieve the content from
     * @param columnName
     ...
     * 
     * @param provider
     *            the {@code XmlBinaryStreamProvider} providing XML data
     * @return the implementation specific instance
     * @see SqlXmlValue
     ...
     * 
     * @param provider
     *            the {@code XmlCharacterStreamProvider} providing XML data
     * @return the implementation specific instance
     * @see SqlXmlValue
     ...
     * 
     * @param resultClass
     *            the Result implementation class to be used
     * @param provider
     *            the {@code XmlResultProvider} that will provide the XML data
     * @return the implementation specific instance
     * @see SqlXmlValue
