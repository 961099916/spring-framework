...
/**
 * JavaBean for holding JDBC error codes for a particular database. Instances of this class are normally loaded through
 * a bean factory.
 *
 * <p>
 * Used by Spring's {@link SQLErrorCodeSQLExceptionTranslator}. The file "sql-error-codes.xml" in this package contains
 * default {@code SQLErrorCodes} instances for various databases.
 *
...
public class SQLErrorCodes {
    ...
    /**
     * Set this property to specify multiple database names that contains spaces, in which case we can not use bean
     * names for lookup.
     */
    ...
    /**
     * Set this property to true for databases that do not provide an error code but that do provide SQL State (this
     * includes PostgreSQL).
     */
    ...
    public void
        setCustomSqlExceptionTranslatorClass(@Nullable Class<? extends SQLExceptionTranslator> customTranslatorClass) {
