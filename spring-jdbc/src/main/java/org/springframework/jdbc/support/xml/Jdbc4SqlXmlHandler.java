...
/**
 * Default implementation of the {@link SqlXmlHandler} interface. Provides database-specific implementations for storing
 * and retrieving XML documents to and from fields in a database, relying on the JDBC 4.0 {@code java.sql.SQLXML}
 * facility.
 *
