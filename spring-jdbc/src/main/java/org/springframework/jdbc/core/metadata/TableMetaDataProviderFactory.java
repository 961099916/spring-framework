...
/**
 * Factory used to create a {@link TableMetaDataProvider} implementation based on the type of database being used.
 *
        ...
        try {
            return JdbcUtils.extractDatabaseMetaData(dataSource, databaseMetaData -> {
                ...
                if ("Oracle".equals(databaseProductName)) {
                    provider =
                        new OracleTableMetaDataProvider(databaseMetaData, context.isOverrideIncludeSynonymsDefault());
