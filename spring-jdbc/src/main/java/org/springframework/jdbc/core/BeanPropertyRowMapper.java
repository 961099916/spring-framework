...
public class BeanPropertyRowMapper<T> implements RowMapper<T> {
     ...
     *            the {@link ConversionService} for binding JDBC values to bean properties, or {@code null} for none
     * @since 5.2.3
     ...
     * <p>
     * Default is a {@link DefaultConversionService}, as of Spring 4.3. This provides support for {@code java.time}
