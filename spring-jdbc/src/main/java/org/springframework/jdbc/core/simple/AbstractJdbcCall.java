...
public abstract class AbstractJdbcCall {
    ...
    /**
     * A delegate enabling us to create CallableStatementCreators efficiently, based on this class's declared
     * parameters.
     */
    @Nullable
     ...
     * <p>
     * Only parameters declared as {@code SqlParameter} and {@code SqlInOutParameter} will be used to provide input
     * values. This is different from the {@code StoredProcedure} class which - for backwards compatibility reasons -
     * allows input values to be provided for parameters declared as {@code SqlOutParameter}.
     * 
     * @param parameter
     *            the {@link SqlParameter} to add
     */
     ...
     * <p>
     * This finalizes the configuration for this object and subsequent attempts to compile are ignored. This will be
     * implicitly called the first time an un-compiled call is executed.
     * 
     ...
     *            parameter names and values to be used in call
     ...
     * 
     * @param args
     *            array of parameter values. The order of values must match the order declared for the stored procedure.
     * @return a Map of out parameters
     */
     ...
     * 
     * @param args
     *            a Map of parameter name and values
     * @return a Map of out parameters
     */
    ...
    /**
     * Get a List of all the call parameters to be used for call. This includes any parameters added based on meta-data
     * processing.
     */
