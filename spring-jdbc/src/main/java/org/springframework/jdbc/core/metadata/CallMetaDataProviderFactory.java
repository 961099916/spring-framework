...
/**
 * Factory used to create a {@link CallMetaDataProvider} implementation based on the type of database being used.
 *
...
public final class CallMetaDataProviderFactory {
     ...
     * 
     * @param dataSource
     *            the JDBC DataSource to use for retrieving meta-data
     * @param context
                ...
                if (context.isFunction()) {
                    if (!supportedDatabaseProductsForFunctions.contains(databaseProductName)) {
                        if (logger.isInfoEnabled()) {
                            logger.info(
                                databaseProductName + " is not one of the databases fully supported for function calls "
