...
public class CallMetaDataContext {
    ...
    /**
     * Create a ReturnResultSetParameter/SqlOutParameter depending on the support provided by the JDBC driver used for
     * the database in use.
     *
     * @param parameterName
     *            the name of the parameter (also used as the name of the List returned in the output)
     * @param rowMapper
    ...
    /**
     * Get the name of the single out parameter for this call. If there are multiple parameters, the name of the first
    ...
    /**
     * Process the list of parameters provided, and if procedure column meta-data is used, the parameters will be
     * matched against the meta-data information and any missing ones will be automatically included.
     *
     * @param parameters
