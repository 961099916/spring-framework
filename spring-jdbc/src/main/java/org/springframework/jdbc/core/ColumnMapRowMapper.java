...
public class ColumnMapRowMapper implements RowMapper<Map<String, Object>> {
     ...
     * <p>
     * The default implementation uses the {@code getObject} method. Additionally, this implementation includes a "hack"
     * to get around Oracle returning a non standard object for their TIMESTAMP datatype.
     * 
     * @param rs
