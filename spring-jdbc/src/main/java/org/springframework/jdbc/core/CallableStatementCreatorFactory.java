...
/**
 * Helper class that efficiently creates multiple {@link CallableStatementCreator} objects with different parameters
...
public class CallableStatementCreatorFactory {
    ...
    private class CallableStatementCreatorImpl implements CallableStatementCreator, SqlProvider, ParameterDisposer {
         ...
         * 
         * @param inParamMapper
         *            the ParameterMapper implementation for mapping input parameters
         */
