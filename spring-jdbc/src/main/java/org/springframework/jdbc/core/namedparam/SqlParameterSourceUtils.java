...
public abstract class SqlParameterSourceUtils {
    ...
    /**
     * Create an array of {@link SqlParameterSource} objects populated with data from the values passed in (either a
     * {@link Map} or a bean object). This will define what is included in a batch operation.
     * 
     * @param candidates
     *            object array of objects containing the values to be used
     ...
     * 
     * @param candidates
     *            collection of objects containing the values to be used
     * @return an array of {@link SqlParameterSource}
     * @since 5.0.2
     * @see MapSqlParameterSource
     * @see BeanPropertySqlParameterSource
    ...
    /**
     * Create an array of {@link MapSqlParameterSource} objects populated with data from the values passed in. This will
     * define what is included in a batch operation.
     * 
     * @param valueMaps
     *            array of {@link Map} instances containing the values to be used
     * @return an array of {@link SqlParameterSource}
     * @see MapSqlParameterSource
     ...
     * 
     * @param source
     *            the source of parameter values and type information
     * @param parameterName
