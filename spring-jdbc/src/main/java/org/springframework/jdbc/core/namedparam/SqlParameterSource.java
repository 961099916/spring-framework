 ...
 * serving as argument for {@link NamedParameterJdbcTemplate} operations.
 *
 * <p>
 * This interface allows for the specification of SQL type in addition to parameter values. All parameter values and
...
public interface SqlParameterSource {
    ...
    /**
     * Constant that indicates an unknown (or unspecified) SQL type. To be returned from {@code getType} when no
     * specific SQL type known.
     * 
     * @see #getSqlType
     * @see java.sql.Types
     */
