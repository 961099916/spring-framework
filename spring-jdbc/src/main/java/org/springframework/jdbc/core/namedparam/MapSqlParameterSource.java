 ...
 *
 * <p>
 * The {@code addValue} methods on this class will make adding several values easier. The methods return a reference to
 * the {@link MapSqlParameterSource} itself, so you can chain several method calls together within a single statement.
 *
