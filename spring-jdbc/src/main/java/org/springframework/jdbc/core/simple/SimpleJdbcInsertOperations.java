...
/**
 * Interface specifying the API for a Simple JDBC Insert implemented by {@link SimpleJdbcInsert}. This interface is not
...
public interface SimpleJdbcInsertOperations {
     ...
     * <p>
     * Note: This is only necessary to include for Oracle since other databases supporting synonyms seems to include the
     ...
     * 
     * @param args
     *            a Map containing column names and corresponding value
     ...
     *            the SqlParameterSource containing values to use for insert
     * @return the number of rows affected as returned by the JDBC driver
     */
     ...
     * <p>
     * This requires that the name of the columns with auto generated keys have been specified. This method will always
     * return a KeyHolder but the caller must verify that it actually contains the generated keys.
     * 
     * @param args
     *            a Map containing column names and corresponding value
