 ...
 *
 * <p>
 * Alternatively, consider subclassing MappingSqlQuery from the {@code jdbc.object} package: Instead of working with
 * separate JdbcTemplate and RowMapper objects, you can have executable query objects (containing row-mapping logic)
 * there.
 *
