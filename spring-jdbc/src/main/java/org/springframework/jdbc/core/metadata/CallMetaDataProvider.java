...
public interface CallMetaDataProvider {
    ...
    /**
     * Initialize the database specific management of procedure column meta-data. This is only called for databases that
     * are supported. This initialization can be turned off by specifying that column meta-data should not be used.
     * 
     * @param databaseMetaData
     *            used to retrieve database specific information
     * @param catalogName
     *            name of catalog to use (or {@code null} if none)
     * @param schemaName
     *            name of schema name to use (or {@code null} if none)
     * @param procedureName
    ...
    /**
     * Provide any modification of the procedure name passed in to match the meta-data currently used. This could
     * include altering the case.
     */
    @Nullable
    String procedureNameToUse(@Nullable String procedureName);

    /**
     * Provide any modification of the catalog name passed in to match the meta-data currently used. This could include
     * altering the case.
     */
    @Nullable
    ...
    /**
     * Provide any modification of the schema name passed in to match the meta-data currently used. This could include
     * altering the case.
     */
    @Nullable
    ...
    /**
     * Provide any modification of the catalog name passed in to match the meta-data currently used. The returned value
     * will be used for meta-data lookups. This could include altering the case used or providing a base catalog if none
     * is provided.
     */
    @Nullable
    ...
    /**
     * Provide any modification of the schema name passed in to match the meta-data currently used. The returned value
     * will be used for meta-data lookups. This could include altering the case used or providing a base schema if none
     * is provided.
     */
    @Nullable
    ...
    /**
     * Provide any modification of the column name passed in to match the meta-data currently used. This could include
     * altering the case.
     * 
     * @param parameterName
    ...
    /**
     * Create a default out parameter based on the provided meta-data. This is used when no explicit parameter
    ...
    /**
     * Create a default in/out parameter based on the provided meta-data. This is used when no explicit parameter
     * declaration has been made.
     * 
     * @param parameterName
     *            the name of the parameter
    ...
    /**
     * Create a default in parameter based on the provided meta-data. This is used when no explicit parameter
     * declaration has been made.
     * 
     * @param parameterName
     *            the name of the parameter
    ...
    /**
     * Get the {@link java.sql.Types} type for columns that return ResultSets as ref cursors if this feature is
     * supported.
     */
