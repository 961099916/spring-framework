...
public abstract class NamedParameterUtils {
    ...
    /**
     * Set of characters that qualify as parameter separators, indicating that a parameter name in an SQL String has
     * ended.
     */
    ...
    /**
     * Parse the SQL statement and locate any placeholders or named parameters. Named parameters are substituted for a
     * JDBC placeholder, and any select list is expanded to the required number of placeholders. Select lists may
     * contain an array of objects, and in that case the placeholders will be grouped and enclosed with parentheses.
     * This allows for the use of "expression lists" in the SQL statement like: <br />
     * <br />
     ...
     *            the List of declared SqlParameter objects (may be {@code null}). If specified, the parameter metadata
     *            will be built into the value array in the form of SqlParameterValue objects.
    ...
    /**
     * Convert parameter types from an SqlParameterSource into a corresponding int array. This is necessary in order to
     * reuse existing methods on JdbcTemplate. Any named parameter types are placed in the correct position in the
    ...
    /**
     * Convert parameter declarations from an SqlParameterSource to a corresponding List of SqlParameters. This is
     * necessary in order to reuse existing methods on JdbcTemplate. The SqlParameter for a named parameter is placed in
     * the correct position in the resulting list based on the parsed SQL statement info.
     * 
     * @param parsedSql
     *            the parsed SQL statement
     * @param paramSource
     ...
     * JDBC placeholder.
     * <p>
     * This is a shortcut version of {@link #parseSqlStatement(String)} in combination with
    ...
    /**
     * Parse the SQL statement and locate any placeholders or named parameters. Named parameters are substituted for a
     * JDBC placeholder and any select list is expanded to the required number of placeholders.
     * <p>
     * This is a shortcut version of {@link #substituteNamedParameters(ParsedSql, SqlParameterSource)}.
     * 
     * @param sql
     *            the SQL statement
     * @param paramSource
     ...
     * Convert a Map of named parameter values to a corresponding array.
     * <p>
     * This is a shortcut version of {@link #buildValueArray(ParsedSql, SqlParameterSource, java.util.List)}.
     * 
     * @param sql
     *            the SQL statement
     * @param paramMap
