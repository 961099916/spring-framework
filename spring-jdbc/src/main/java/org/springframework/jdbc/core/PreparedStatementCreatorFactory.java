...
/**
 * Helper class that efficiently creates multiple {@link PreparedStatementCreator} objects with different parameters
...
public class PreparedStatementCreatorFactory {
     ...
     *            list of {@link SqlParameter} objects
     */
     ...
     * 
     * @param params
     *            list of parameters (may be {@code null})
     */
     ...
     * 
     * @param params
     *            the parameter array (may be {@code null})
     */
     ...
     * 
     * @param sqlToUse
     *            the actual SQL statement to use (if different from the factory's, for example because of named
     *            parameter expanding)
     * @param params
     *            the parameter array (may be {@code null})
     */
