 ...
 * object. The names of the bean properties have to match the parameter names.
 *
 * <p>
...
public class BeanPropertySqlParameterSource extends AbstractSqlParameterSource {
    ...
    /**
     * Provide access to the property names of the wrapped bean. Uses support provided in the {@link PropertyAccessor}
     * interface.
     * 
