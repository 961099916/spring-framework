...
/**
 * Subclass of {@link SqlOutParameter} to represent an INOUT parameter. Will return {@code true} for SqlParameter's
 * {@link #isInputValueProvided} test, in contrast to a standard SqlOutParameter.
 *
 * <p>
...
public class SqlInOutParameter extends SqlOutParameter {
     ...
     * @param sqlType
     *            the parameter SQL type according to {@code java.sql.Types}
     */
     ...
     *            the parameter SQL type according to {@code java.sql.Types}
     * @param rse
     *            the {@link ResultSetExtractor} to use for parsing the {@link ResultSet}
     */
     ...
     *            the parameter SQL type according to {@code java.sql.Types}
     * @param rch
     *            the {@link RowCallbackHandler} to use for parsing the {@link ResultSet}
     */
     ...
     *            the parameter SQL type according to {@code java.sql.Types}
     * @param rm
     *            the {@link RowMapper} to use for parsing the {@link ResultSet}
     */
