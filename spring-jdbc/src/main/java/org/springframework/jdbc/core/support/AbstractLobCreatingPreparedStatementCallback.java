...
/**
 * Abstract {@link PreparedStatementCallback} implementation that manages a {@link LobCreator}. Typically used as inner
 * class, with access to surrounding method arguments.
 *
 * <p>
 * Delegates to the {@code setValues} template method for setting values on the PreparedStatement, using a given
...
public abstract class AbstractLobCreatingPreparedStatementCallback implements PreparedStatementCallback<Integer> {
     ...
     * 
     * @param lobHandler
     *            the LobHandler to create LobCreators with
     */
