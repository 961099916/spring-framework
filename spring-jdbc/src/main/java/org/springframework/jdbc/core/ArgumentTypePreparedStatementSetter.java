...
/**
 * Simple adapter for {@link PreparedStatementSetter} that applies given arrays of arguments and JDBC argument types.
 *
...
public class ArgumentTypePreparedStatementSetter implements PreparedStatementSetter, ParameterDisposer {
    ...
    /**
     * Set the value for the prepared statement's specified parameter position using the passed in value and type. This
