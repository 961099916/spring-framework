...
/**
 * Subinterface of {@link SqlTypeValue} that adds a cleanup callback, to be invoked after the value has been set and the
 * corresponding statement has been executed.
 *
