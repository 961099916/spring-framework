 ...
 * {@code setObject} method. This is effectively an extended variant of
 ...
 * {@code setTypeValue} which can throw SQLExceptions that will be caught and translated by the calling code. This
...
public interface SqlTypeValue {
    ...
    /**
     * Constant that indicates an unknown (or unspecified) SQL type. Passed into {@code setTypeValue} if the original
     * operation method does not specify an SQL type.
     * 
     * @see java.sql.Types
