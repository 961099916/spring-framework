...
/**
 * Interface specifying the API to be implemented by a class providing table meta-data. This is intended for internal
 * use by the Simple JDBC classes.
 *
...
public interface TableMetaDataProvider {
    ...
    /**
     * Initialize using provided database meta-data, table and column information. This initialization can be turned off
    ...
    /**
     * Does this database support a simple query to retrieve the generated key when the JDBC 3.0 feature of retrieving
     * generated keys is not supported?
     * 
