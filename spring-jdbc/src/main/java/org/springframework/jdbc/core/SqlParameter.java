 ...
 *
 * <p>
 * Parameters may be anonymous, in which case "name" is {@code null}. However, all parameters must define an SQL type
 * according to {@link java.sql.Types}.
 *
 * @author Rod Johnson
...
public class SqlParameter {
    ...
    /**
     * Convert a list of JDBC types, as defined in {@code java.sql.Types}, to a List of SqlParameter objects as used in
     * this package.
     */
     ...
     * {@code CallableStatement.getMoreResults/getUpdateCount}.
     * <p>
