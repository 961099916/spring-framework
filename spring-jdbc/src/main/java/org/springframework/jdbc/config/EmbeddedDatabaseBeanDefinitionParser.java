...
/**
 * {@link org.springframework.beans.factory.xml.BeanDefinitionParser} that parses an {@code embedded-database} element
 * and creates a {@link BeanDefinition} for an {@link EmbeddedDatabaseFactoryBean}.
 *
 * <p>
 * Picks up nested {@code script} elements and configures a {@link ResourceDatabasePopulator} for each of them.
 *
