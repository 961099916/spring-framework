...
/**
 * Encapsulates an object and a {@link TypeDescriptor} that describes it. The type descriptor can contain generic
 * declarations that would not be accessible through a simple {@code getClass()} call on the object.
 *
 * @author Andy Clement
...
public class TypedValue {
    ...
    /**
     * Create a {@link TypedValue} for a simple object. The {@link TypeDescriptor} is inferred from the object, so no
     * generic declarations are preserved.
     * 
     * @param value
     *            the object value
     */
    ...
    /**
     * Create a {@link TypedValue} for a particular value with a particular {@link TypeDescriptor} which may contain
     * additional generic declarations.
     * 
     * @param value
     *            the object value
