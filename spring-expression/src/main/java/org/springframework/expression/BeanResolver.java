 ...
 * {@code @myBeanName} and {@code &myBeanName} expressions. The <tt>&</tt> variant syntax allows access to the factory
 * bean where relevant.
 *
 * @author Andy Clement
 * @since 3.0.3
...
public interface BeanResolver {
    ...
    /**
     * Look up a bean by the given name and return a corresponding instance for it. For attempting access to a factory
     * bean, the name needs a <tt>&</tt> prefix.
     * 
     * @param context
