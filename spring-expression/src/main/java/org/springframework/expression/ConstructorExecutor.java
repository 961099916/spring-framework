...
public interface ConstructorExecutor {
     ...
     * 
     * @param context
     *            the evaluation context in which the command is being executed
     * @param arguments
     *            the arguments to the constructor call, should match (in terms of number and type) whatever the command
     *            will need to run
