...
public interface Expression {
    ...
    /**
     * Evaluate the expression in the default context. If the result of the evaluation does not match (and cannot be
    ...
    /**
     * Evaluate the expression in the default context against the specified root object. If the result of the evaluation
     * does not match (and cannot be converted to) the expected result type then an exception will be returned.
     * 
     * @param rootObject
     *            the root object against which to evaluate the expression
     * @param desiredResultType
    ...
    /**
     * Evaluate this expression in the provided context and return the result of evaluation, but use the supplied root
     * context as an override for any default root object specified in the context.
     * 
     * @param context
     *            the context in which to evaluate the expression
     * @param rootObject
    ...
    /**
     * Return the most general type that can be passed to a {@link #setValue} method using the default context.
     * 
    ...
    /**
     * Return the most general type that can be passed to the {@link #setValue(Object, Object)} method using the default
     * context.
     * 
     * @param rootObject
     *            the root object against which to evaluate the expression
    ...
    /**
     * Return the most general type that can be passed to the {@link #setValue(EvaluationContext, Object, Object)}
    ...
    /**
     * Determine if an expression can be written to, i.e. setValue() can be called. The supplied root object overrides
     * any specified in the context.
     * 
     * @param context
     *            the context in which the expression should be checked
     * @param rootObject
     ...
     * 
     * @param context
     *            the context in which to set the value of the expression
     * @param value
     *            the new value
     * @throws EvaluationException
     *             if there is a problem during evaluation
    ...
    /**
     * Set this expression in the provided context to the value provided. The supplied root object overrides any
