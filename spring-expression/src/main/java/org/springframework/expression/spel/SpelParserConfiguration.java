...
public class SpelParserConfiguration {
    ...
    static {
        ...
        defaultCompilerMode =
            (compilerMode != null ? SpelCompilerMode.valueOf(compilerMode.toUpperCase()) : SpelCompilerMode.OFF);
    }
     ...
     * 
     * @param compilerMode
     *            the compiler mode for the parser
     ...
     * Create a new {@code SpelParserConfiguration} instance.
     * 
     * @param autoGrowNullReferences
     *            if null references should automatically grow
     * @param autoGrowCollections
     ...
     * 
     * @param compilerMode
     *            the compiler mode that parsers using this configuration object should use
     * @param compilerClassLoader
     *            the ClassLoader to use as the basis for expression compilation
     * @param autoGrowNullReferences
     *            if null references should automatically grow
