 ...
 * will return {@code true} when {@link #getValue} is called if the first operand matches the regex.
 *
 * @author Andy Clement
...
public class OperatorMatches extends Operator {
     ...
     * @return {@code true} if the first operand matches the regex specified as the second operand, otherwise
     *         {@code false}
