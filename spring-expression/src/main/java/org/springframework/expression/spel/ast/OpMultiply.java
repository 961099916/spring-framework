 ...
 * <a href="https://java.sun.com/docs/books/jls/third_edition/html/conversions.html">Section 5.6.2 of the Java Language
 * Specification</a>, with the addiction of {@code BigDecimal}/{@code BigInteger} management:
 *
 * <p>
 * If any of the operands is of a reference type, unboxing conversion (Section 5.1.8) is performed. Then:<br>
...
public class OpMultiply extends Operator {
    ...
    /**
     * Implements the {@code multiply} operator directly here for certain types of supported operands and otherwise
     * delegates to any registered overloader for types not supported here.
     * <p>
