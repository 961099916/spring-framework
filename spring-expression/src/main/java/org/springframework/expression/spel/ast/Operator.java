...
public abstract class Operator extends SpelNodeImpl {
     ...
     * <p>
     * This method is not just used for reflective comparisons in subclasses but also from compiled expression code,
     * which is why it needs to be declared as {@code public static} here.
     *
     * @param context
    ...
    /**
     * A descriptor comparison encapsulates the result of comparing descriptor for two operands and describes at what
    ...
    protected static final class DescriptorComparison {
         ...
         * <p>
         * A declared descriptor is what could statically be determined (e.g. from looking at the return value of a
         * property accessor method) whilst an actual descriptor is the type of an actual object that was returned,
         * which may differ.
         * <p>
         * For generic types with unbound type variables, the declared descriptor discovered may be 'Object' but from
         * the actual descriptor it is possible to observe that the objects are really numeric values (e.g. ints).
         * 
         * @param leftDeclaredDescriptor
         *            the statically determinable left descriptor
         * @param rightDeclaredDescriptor
         *            the statically determinable right descriptor
         * @param leftActualDescriptor
         *            the dynamic/runtime left object descriptor
         * @param rightActualDescriptor
