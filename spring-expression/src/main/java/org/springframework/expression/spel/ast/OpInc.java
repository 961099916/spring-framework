...
/**
 * Increment operator. Can be used in a prefix or postfix form. This will throw appropriate exceptions if the operand in
 * question does not support increment.
 *
 * @author Andy Clement
