...
/**
 * Represents a bean reference to a type, for example <tt>@foo</tt> or <tt>@'foo.bar'</tt>. For a FactoryBean the syntax
 * <tt>&foo</tt> can be used to access the factory itself.
 *
 * @author Andy Clement
 */
