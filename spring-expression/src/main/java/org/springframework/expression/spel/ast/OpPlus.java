 ...
 *
 * <p>
 * It can be used as a unary operator for numbers. The standard promotions are performed when the operand types vary
 * (double+int=double). For other options it defers to the registered overloader.
 *
 * @author Andy Clement
...
public class OpPlus extends Operator {
    ...
    /**
     * Walk through a possible tree of nodes that combine strings and append them all to the same (on stack)
     * StringBuilder.
     */
