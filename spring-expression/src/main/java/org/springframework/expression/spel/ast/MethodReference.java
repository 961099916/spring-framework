...
public class MethodReference extends SpelNodeImpl {
    ...
    private TypedValue getValueInternal(EvaluationContext evaluationContext, @Nullable Object value,
        ...
        this.cachedExecutor = new CachedMethodExecutor(executorToUse, (value instanceof Class ? (Class<?>)value : null),
    ...
    /**
     * A method reference is compilable if it has been resolved to a reflectively accessible method and the child nodes
     * (arguments to the method) are also compilable.
     */
    @Override
