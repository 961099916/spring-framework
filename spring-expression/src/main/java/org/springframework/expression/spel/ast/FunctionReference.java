 ...
 * expression being evaluated. Functions may also be static Java methods, registered in the context prior to invocation
 * of the expression.
 *
 * <p>
...
public class FunctionReference extends SpelNodeImpl {
     ...
     * 
     * @param state
     *            the expression evaluation state
     * @param method
     *            the method to invoke
     * @return the return value of the invoked Java method
     * @throws EvaluationException
     *             if there is any problem invoking the method
     */
