...
/**
 * Represents the elvis operator ?:. For an expression "a?:b" if a is not null, the value of the expression is "a", if a
 * is null then the value of the expression is "b".
 *
 * @author Andy Clement
...
public class Elvis extends SpelNodeImpl {
     ...
     *             if the condition does not evaluate correctly to a boolean or there is a problem executing the chosen
     *             alternative
     */
    @Override
