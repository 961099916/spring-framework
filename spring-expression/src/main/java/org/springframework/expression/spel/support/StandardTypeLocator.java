...
/**
 * A simple implementation of {@link TypeLocator} that uses the context ClassLoader (or any ClassLoader set upon it). It
...
public class StandardTypeLocator implements TypeLocator {
     ...
     * 
     * @param classLoader
     *            the ClassLoader to delegate to
     */
    ...
    /**
     * Find a (possibly unqualified) type reference - first using the type name as-is, then trying any registered
     * prefixes if the type name cannot be found.
     * 
     * @param typeName
     *            the type to locate
