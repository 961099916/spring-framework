 ...
 * {@link org.springframework.expression.spel.support.StandardEvaluationContext} which can be extended, rather than
 * having to implement everything manually.
 *
 * @author Andy Clement
...
public interface EvaluationContext {
    ...
    /**
     * Return the default root context object against which unqualified properties/methods/etc should be resolved. This
     * can be overridden when evaluating an expression.
     */
