...
public abstract class ExpressionUtils {
     ...
     * 
     * @param context
     *            the evaluation context that may define a type converter
     * @param typedValue
     ...
     *             if there is a problem during conversion or conversion of the value to the specified type is not
     *             supported
     */
