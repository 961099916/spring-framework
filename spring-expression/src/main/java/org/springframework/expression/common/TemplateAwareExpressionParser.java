...
public abstract class TemplateAwareExpressionParser implements ExpressionParser {
     ...
     * functionality are supported without any problem. The parsing is aware of the structure of an embedded expression.
     * It assumes that parentheses '(', square brackets '[' and curly brackets '}' must be in pairs within the
     * expression unless they are within a string literal and a string literal starts and terminates with a single quote
     * '.
     * 
     ...
     *             when the expressions cannot be parsed
     */
     ...
     * 
     * @param expressionString
     *            the expression string which may contain the suffix
     * @param pos
     *            the start position at which to check for the suffix
     * @param suffix
     *            the suffix string
     */
    ...
    /**
     * This captures a type of bracket and the position in which it occurs in the expression. The positional information
     * is used if an error has to be reported because the related end bracket cannot be found. Bracket is used to
     * describe: square brackets [] round brackets () and curly brackets {}
     */
