...
public interface MethodResolver {
     ...
     * arguments. Return a {@link MethodExecutor} that can be used to invoke that method, or {@code null} if no method
     * could be found.
     * 
     * @param context
     *            the current evaluation context
     * @param targetObject
     *            the object upon which the method is being called
     * @param argumentTypes
