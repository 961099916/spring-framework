...
public class ExpressionException extends RuntimeException {
     ...
     *            the expression string
     * @param position
     *            the position in the expression string where the problem occurred
     * @param message
     *            a descriptive message
     */
    ...
    /**
     * Return the exception message. As of Spring 4.0, this method returns the same result as
     * {@link #toDetailedString()}.
     * 
    ...
    /**
     * Return a detailed description of this exception, including the expression String and position (if available) as
     * well as the actual exception message.
     */
