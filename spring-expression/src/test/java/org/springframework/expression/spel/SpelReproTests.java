...
public class SpelReproTests extends AbstractExpressionTests {
    ...
    public void reservedWordProperties_SPR9862() {
        ...
        SpelExpression expression =
            parser.parseRaw("T(org.springframework.expression.spel.testresources.le.div.mod.reserved.Reserver).CONST");
        Object value = expression.getValue(context);
        assertThat(Reserver.CONST).isEqualTo(value);
    }

    /**
     * We add property accessors in the order: First, Second, Third, Fourth. They are not utilized in this order;
     * preventing a priority or order of operations in evaluation of SPEL expressions for a given context.
     */
    @Test
    ...
    /**
     * Test the ability to subclass the ReflectiveMethodResolver and change how it determines the set of methods for a
     * type.
     */
    @Test
    ...
    public void SPR10125() {
        ...
        String fromInterface =
            parser.parseExpression("T(" + StaticFinalImpl1.class.getName() + ").VALUE").getValue(context, String.class);
        assertThat(fromInterface).isEqualTo("interfaceValue");
        String fromClass =
            parser.parseExpression("T(" + StaticFinalImpl2.class.getName() + ").VALUE").getValue(context, String.class);
    ...
    public void SPR12803() {
        ...
        Expression expression = parser
            .parseExpression("T(org.springframework.expression.spel.SpelReproTests.FooLists).newArrayList(#iterable)");
    ...
    public void SPR12808() {
        ...
        Expression expression =
            parser.parseExpression("T(org.springframework.expression.spel.SpelReproTests.DistanceEnforcer).from(#no)");
        StandardEvaluationContext sec = new StandardEvaluationContext();
