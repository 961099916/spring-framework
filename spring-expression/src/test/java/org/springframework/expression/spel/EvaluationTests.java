...
public class EvaluationTests extends AbstractExpressionTests {
    ...
    public void testMatchesWithPatternAccessThreshold() {
        ...
        String expression =
            "'abcde-fghijklmn-o42pasdfasdfasdf.qrstuvwxyz10x.xx.yyy.zasdfasfd' matches \'" + pattern + "\'";
    ...
    public void testComparison() {
        ...
        boolean trueValue =
            parser.parseExpression("T(java.util.Date) == Birthdate.Class").getValue(context, Boolean.class);
    ...
    /**
     * SPR-6984: attempting to index a collection on write using an index that doesn't currently exist in the collection
     * (address.crossStreets[0] below)
     */
    @Test
    ...
    /**
     * This test is checking that with the changes for 9751 that the refactoring in Indexer is coping correctly for
     * references beyond collection boundaries.
     */
    @Test
    ...
    public void incrementAllNodeTypes() throws SecurityException, NoSuchMethodException {
        ...
        // Projection
        expectFailNotIncrementable(parser, ctx, "({1,2,3}.![#isEven(#this)])++"); // projection would be
                                                                                  // {false,true,false}
        expectFailNotDecrementable(parser, ctx, "--({1,2,3}.![#isEven(#this)])"); // projection would be
                                                                                  // {false,true,false}
        expectFailNotAssignable(parser, ctx, "({1,2,3}.![#isEven(#this)])=({1,2,3}.![#isEven(#this)])");
