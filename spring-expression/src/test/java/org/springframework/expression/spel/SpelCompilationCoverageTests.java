...
public class SpelCompilationCoverageTests extends AbstractExpressionTests {
    ...
    public void compilationOfBasicNullSafeMethodReference() {
        SpelExpressionParser parser =
            new SpelExpressionParser(new SpelParserConfiguration(SpelCompilerMode.OFF, getClass().getClassLoader()));
    ...
    public void elvisOperator_SPR17214() throws Exception {
        ...
        expression =
            sep.parseExpression("record.get('abc')==null?record.put('abc',expression.someLong?.longValue()):null");
        rh = new RecordHolder();
    ...
    private void verifyCompilationAndBehaviourWithNull(String expressionText, SpelExpressionParser parser,
        ...
        r.setValue2(1); // having a value in value2 fields will enable compilation to succeed, then can switch it to
                        // null
