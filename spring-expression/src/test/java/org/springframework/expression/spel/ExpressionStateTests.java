...
public class ExpressionStateTests extends AbstractExpressionTests {
    ...
    public void testRootContextObject() {
        ...
        // although the root object is being set on the evaluation context, the value in the 'state' remains what it was
        // when constructed
    ...
    public void testOperators() {
        ...
        assertThatExceptionOfType(SpelEvaluationException.class)
            .isThrownBy(() -> state.operate(Operation.ADD, null, null)).satisfies(
                ex -> assertThat(ex.getMessageCode()).isEqualTo(SpelMessage.OPERATOR_NOT_SUPPORTED_BETWEEN_TYPES));
    }
