...
public class StandardServletEnvironmentTests {
    ...
    public void propertySourceOrder() throws Exception {
        ...
        assertThat(
            sources.precedenceOf(PropertySource.named(StandardServletEnvironment.SERVLET_CONFIG_PROPERTY_SOURCE_NAME)))
                .isEqualTo(0);
        assertThat(
            sources.precedenceOf(PropertySource.named(StandardServletEnvironment.SERVLET_CONTEXT_PROPERTY_SOURCE_NAME)))
                .isEqualTo(1);
