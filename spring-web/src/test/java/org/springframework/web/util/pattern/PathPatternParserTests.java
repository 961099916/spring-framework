...
public class PathPatternParserTests {
    ...
    /**
     * Delegates to {@link #checkError(String, int, PatternMessage, String...)}, passing {@code -1} as the
     * {@code expectedPos}.
     * 
     * @since 5.2
     */
    ...
    /**
     * @param expectedPos
     *            the expected position, or {@code -1} if the position should not be checked
     */
