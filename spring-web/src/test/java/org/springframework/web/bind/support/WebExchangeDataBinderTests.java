...
public class WebExchangeDataBinderTests {
    ...
    private ServerWebExchange exchange(MultiValueMap<String, String> formData) {
        ...
        return MockServerWebExchange.from(
            MockServerHttpRequest.post("/").contentType(MediaType.APPLICATION_FORM_URLENCODED).body(request.getBody()));
    }
    ...
    private ServerWebExchange exchangeMultipart(MultiValueMap<String, ?> multipartData) {
        ...
        return MockServerWebExchange.from(
            MockServerHttpRequest.post("/").contentType(request.getHeaders().getContentType()).body(request.getBody()));
    }
