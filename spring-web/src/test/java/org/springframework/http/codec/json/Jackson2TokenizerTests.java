...
public class Jackson2TokenizerTests extends AbstractLeakCheckingTests {
    ...
    public void tokenizeArrayElements() {
        ...
        testTokenize(
            asList("[", "{\"id\":1,\"name\":\"Robert\"}", ",", "{\"id\":2,\"name\":\"Raide\"}", ",",
                "{\"id\":3,\"name\":\"Ford\"}", "]"),
            asList("{\"id\":1,\"name\":\"Robert\"}", "{\"id\":2,\"name\":\"Raide\"}", "{\"id\":3,\"name\":\"Ford\"}"),
            true);
    ...
    public void errorInStream() {
        ...
        Flux<TokenBuffer> result =
            Jackson2Tokenizer.tokenize(source, this.jsonFactory, this.objectMapper, true, false, -1);
    ...
    public void jsonEOFExceptionIsWrappedAsDecodingError() {
        ...
        Flux<TokenBuffer> tokens =
            Jackson2Tokenizer.tokenize(source, this.jsonFactory, this.objectMapper, false, false, -1);
    ...
    public void useBigDecimalForFloats(boolean useBigDecimalForFloats) {
        ...
        Flux<TokenBuffer> tokens =
            Jackson2Tokenizer.tokenize(source, this.jsonFactory, this.objectMapper, false, useBigDecimalForFloats, -1);
