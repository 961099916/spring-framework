...
public class ServerSentEventHttpMessageReaderTests extends AbstractLeakCheckingTests {
    ...
    public void readServerSentEvents() {
        ...
        Flux<ServerSentEvent> events =
            this.reader.read(ResolvableType.forClassWithGenerics(ServerSentEvent.class, String.class), request,
                Collections.emptyMap()).cast(ServerSentEvent.class);
    ...
    public void readServerSentEventsWithMultipleChunks() {
        ...
        Flux<ServerSentEvent> events =
            reader.read(ResolvableType.forClassWithGenerics(ServerSentEvent.class, String.class), request,
                Collections.emptyMap()).cast(ServerSentEvent.class);
    ...
    public void readString() {
        MockServerHttpRequest request =
            MockServerHttpRequest.post("/").body(Mono.just(stringBuffer("data:foo\ndata:bar\n\ndata:baz\n\n")));

        Flux<String> data =
            reader.read(ResolvableType.forClass(String.class), request, Collections.emptyMap()).cast(String.class);
    ...
    public void readPojo() {
        ...
        Flux<Pojo> data =
            reader.read(ResolvableType.forClass(Pojo.class), request, Collections.emptyMap()).cast(Pojo.class);
    ...
    void readPojoWithCommentOnly() {
        MockServerHttpRequest request =
            MockServerHttpRequest.post("/").body(Flux.just(stringBuffer(":ping\n"), stringBuffer("\n")));
    ...
    public void maxInMemoryLimit() {
        ...
        Flux<String> data =
            this.reader.read(ResolvableType.forClass(String.class), request, Collections.emptyMap()).cast(String.class);
    ...
    public void maxInMemoryLimitAllowsReadingPojoLargerThanDefaultSize() {
        ...
        Flux<Pojo> data =
            messageReader.read(ResolvableType.forClass(Pojo.class), request, Collections.emptyMap()).cast(Pojo.class);
