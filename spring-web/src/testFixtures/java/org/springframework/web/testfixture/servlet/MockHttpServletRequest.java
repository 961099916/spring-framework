 ...
 *
 * <p>
 * The default, preferred {@link Locale} for the <em>server</em> mocked by this request is {@link Locale#ENGLISH}. This
 * value can be changed via {@link #addPreferredLocale} or {@link #setPreferredLocales}.
 *
 * <p>
...
public class MockHttpServletRequest implements HttpServletRequest {
     ...
     *            the ServletContext that the request runs in (may be {@code null} to use a default
    ...
    /**
     * Create a new {@code MockHttpServletRequest} with the supplied {@link ServletContext}, {@code method}, and
     * {@code requestURI}.
     * <p>
     ...
     * <p>
     * If the supplied byte array represents text such as XML or JSON, the {@link #setCharacterEncoding character
     * encoding} should typically be set as well.
     *
    ...
    /**
     * Get the content of the request body as a {@code String}, using the configured {@linkplain #getCharacterEncoding
     * character encoding}.
     *
    ...
    public ServletInputStream getInputStream() {
        ...
        this.inputStream = (this.content != null
            ? new DelegatingServletInputStream(new ByteArrayInputStream(this.content)) : EMPTY_SERVLET_INPUT_STREAM);
        return this.inputStream;
    }
    ...
    /**
     * Set all provided parameters <strong>replacing</strong> any existing values for the provided parameter names. To
     * add without replacing existing values, use {@link #addParameters(java.util.Map)}.
     */
     ...
     * <p>
     * If no locales have been explicitly configured, the default, preferred {@link Locale} for the <em>server</em>
     * mocked by this request is {@link Locale#ENGLISH}.
     * <p>
     * In contrast to the Servlet specification, this mock implementation does <strong>not</strong> take into
     * consideration any locales specified via the {@code Accept-Language} header.
     *
    ...
    /**
     * Return an {@linkplain Enumeration enumeration} of the preferred {@linkplain Locale locales} configured in this
     * mock request.
     * <p>
     * If no locales have been explicitly configured, the default, preferred {@link Locale} for the <em>server</em>
     * mocked by this request is {@link Locale#ENGLISH}.
    ...
    /**
     * Return {@code true} if the {@link #setSecure secure} flag has been set to {@code true} or if the
     * {@link #getScheme scheme} is {@code https}.
     * 
    ...
    /**
     * Set the boolean {@code secure} flag indicating whether the mock request was made using a secure channel, such as
     * HTTPS.
     *
     * @see #isSecure()
     * @see #getScheme()
     ...
     * <p>
     * If the internal value representation is a String, this method will try to parse it as a date using the supported
     * date formats:
     * <ul>
    ...
    /**
     * The implementation of this (Servlet 3.1+) method calls {@link MockHttpSession#changeSessionId()} if the session
     * is a mock session. Otherwise it simply returns the current session id.
     * 
     * @since 4.0.3
     */
    @Override
