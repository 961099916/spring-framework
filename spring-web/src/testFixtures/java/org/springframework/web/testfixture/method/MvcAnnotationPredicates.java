...
public class MvcAnnotationPredicates {
    ...
    public static class RequestParamPredicate implements Predicate<MethodParameter> {
        ...
        public boolean test(MethodParameter parameter) {
            ...
            return annotation != null && (this.name == null || annotation.name().equals(this.name))
                && annotation.required() == this.required && annotation.defaultValue().equals(this.defaultValue);
        }
    }
    ...
    public static class RequestMappingPredicate implements Predicate<Method> {
        ...
        public boolean test(Method method) {
            ...
            return annot != null && Arrays.equals(this.path, annot.path()) && Arrays.equals(this.method, annot.method())
    ...
    public static class MatrixVariablePredicate implements Predicate<MethodParameter> {
        ...
        public boolean test(MethodParameter parameter) {
            ...
            return annotation != null && (this.name == null || this.name.equalsIgnoreCase(annotation.name()))
