...
/**
 * Mock extension of {@link AbstractServerHttpRequest} for use in tests without an actual server. Use the static methods
 * to obtain a builder.
 *
...
public final class MockServerHttpRequest extends AbstractServerHttpRequest {
    ...
    private MockServerHttpRequest(@Nullable HttpMethod httpMethod, @Nullable String customHttpMethod, URI uri,
        @Nullable String contextPath, HttpHeaders headers, MultiValueMap<String, HttpCookie> cookies,
        @Nullable InetSocketAddress localAddress, @Nullable InetSocketAddress remoteAddress, @Nullable SslInfo sslInfo,
    ...
    /**
     * Create an HTTP GET builder with the given URI template. The given URI may contain query parameters, or those may
     * be added later via {@link BaseBuilder#queryParam queryParam} builder methods.
     *
     * @param urlTemplate
    ...
    /**
     * HTTP PUT variant. See {@link #get(String, Object...)} for general info. {@link BaseBuilder#queryParam queryParam}
     * builder methods.
     *
     * @param urlTemplate
     *            a URL template; the resulting URL will be encoded
    ...
    /**
     * Alternative to {@link #method(HttpMethod, URI)} that accepts a URI template. The given URI may contain query
     * parameters, or those may be added later via {@link BaseBuilder#queryParam queryParam} builder methods.
     *
     * @param method
     *            the HTTP method (GET, POST, etc)
     * @param urlTemplate
     *            the URL template
     * @param vars
     *            variables to expand into the template
     * @return the created builder
     */
    ...
    /**
     * Create a builder with a raw HTTP method value that is outside the range of {@link HttpMethod} enum values.
     *
     * @param method
    ...
    public interface BaseBuilder<B extends BaseBuilder<B>> {
        ...
        /**
         * Append the given query parameter to the existing query parameters. If no values are given, the resulting URI
         * will contain the query parameter name only (i.e. {@code ?foo} instead of {@code ?foo=bar}).
         * <p>
        ...
        /**
         * Set the list of acceptable {@linkplain Locale locales}, as specified by the {@code Accept-Languages} header.
         * 
    ...
    public interface BodyBuilder extends BaseBuilder<BodyBuilder> {
         ...
         * Set the body of the request and build it.
         * <p>
         * The String is assumed to be UTF-8 encoded unless the request has a "content-type" header with a charset
         * attribute.
         * 
         * @param body
         *            the body as text
    ...
    private static class DefaultBodyBuilder implements BodyBuilder {
        ...
        private URI getUrlToUse() {
            MultiValueMap<String, String> params = this.queryParamsBuilder.buildAndExpand().encode().getQueryParams();
            if (!params.isEmpty()) {
