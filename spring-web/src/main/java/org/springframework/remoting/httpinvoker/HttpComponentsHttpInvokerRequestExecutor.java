 ...
 * <a href="https://hc.apache.org/httpcomponents-client-ga/httpclient/">Apache HttpComponents HttpClient</a> to execute
 * POST requests.
 *
 * <p>
...
public class HttpComponentsHttpInvokerRequestExecutor extends AbstractHttpInvokerRequestExecutor {
     ...
     * underlying HttpClient. A timeout value of 0 specifies an infinite timeout.
     * <p>
     * Additional properties can be configured by specifying a {@link RequestConfig} instance on a custom
     * {@link HttpClient}.
     * 
    ...
    /**
     * Create a {@link RequestConfig} for the given configuration. Can return {@code null} to indicate that no custom
     * request config should be set and the defaults of the {@link HttpClient} should be used.
     * <p>
     * The default implementation tries to merge the defaults of the client with the local customizations of the
     * instance, if any.
     * 
     * @param config
     *            the HTTP invoker configuration that specifies the target service
     ...
     *            the HTTP invoker configuration that specifies the target service
     * @param httpPost
     *            the HttpPost to set the request body on
     * @param baos
