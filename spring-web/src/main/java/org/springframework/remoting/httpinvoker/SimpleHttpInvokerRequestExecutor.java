...
/**
 * {@link org.springframework.remoting.httpinvoker.HttpInvokerRequestExecutor} implementation that uses standard Java
 * facilities to execute POST requests, without support for HTTP authentication or advanced configuration options.
 *
 * <p>
 * Designed for easy subclassing, customizing specific template methods. However, consider
 * {@code HttpComponentsHttpInvokerRequestExecutor} for more sophisticated needs: The standard {@link HttpURLConnection}
...
public class SimpleHttpInvokerRequestExecutor extends AbstractHttpInvokerRequestExecutor {
     ...
     * <p>
     * The default implementation specifies POST as method, "application/x-java-serialized-object" as "Content-Type"
     * header, and the given content length as "Content-Length" header.
     * 
     * @param connection
     ...
     * <p>
     * The default implementation simply write the serialized invocation to the HttpURLConnection's OutputStream. This
     * can be overridden, for example, to write a specific encoding and potentially set appropriate HTTP request
     * headers.
     * 
     * @param config
     *            the HTTP invoker configuration that specifies the target service
     * @param con
     *            the HttpURLConnection to write the request body to
     * @param baos
    ...
    /**
     * Validate the given response as contained in the {@link HttpURLConnection} object, throwing an exception if it
     ...
     * <p>
     * The default implementation simply reads the serialized invocation from the HttpURLConnection's InputStream. If
     * the response is recognized as GZIP response, the InputStream will get wrapped in a GZIPInputStream.
     * 
     * @param config
     *            the HTTP invoker configuration that specifies the target service
     * @param con
