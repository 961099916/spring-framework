...
/**
 * HTTP request handler that exports the specified service bean as Hessian service endpoint, accessible via a Hessian
 * proxy. Designed for Sun's JRE 1.6 HTTP server, implementing the {@link com.sun.net.httpserver.HttpHandler} interface.
 *
 * <p>
 * Hessian is a slim, binary RPC protocol. For information on Hessian, see the
 * <a href="http://hessian.caucho.com">Hessian website</a>. <b>Note: As of Spring 4.0, this exporter requires Hessian
 * 4.0 or above.</b>
 *
 * <p>
 * Hessian services exported with this class can be accessed by any Hessian client, as there isn't any special handling
 * involved.
 *
