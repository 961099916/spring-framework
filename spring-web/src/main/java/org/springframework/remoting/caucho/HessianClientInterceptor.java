...
/**
 * {@link org.aopalliance.intercept.MethodInterceptor} for accessing a Hessian service. Supports authentication via
 * username and password. The service URL must be an HTTP URL exposing a Hessian service.
 *
 * <p>
 * Hessian is a slim, binary RPC protocol. For information on Hessian, see the
 * <a href="http://hessian.caucho.com">Hessian website</a> <b>Note: As of Spring 4.0, this client requires Hessian 4.0
 * or above.</b>
 *
 * <p>
 * Note: There is no requirement for services accessed with this proxy factory to have been exported using Spring's
 * {@link HessianServiceExporter}, as there is no special handling involved. As a consequence, you can also access
 * services that have been exported using Caucho's {@link com.caucho.hessian.server.HessianServlet}.
 *
...
public class HessianClientInterceptor extends UrlBasedRemoteAccessor implements MethodInterceptor {
    ...
    /**
     * Set whether version 2 of the Hessian protocol should be used for parsing requests and replies. Default is
     * "false".
     * 
