...
/**
 * Abstract base class for Jackson based and content type independent {@link HttpMessageConverter} implementations.
 *
 * <p>
...
public abstract class AbstractJackson2HttpMessageConverter extends AbstractGenericHttpMessageConverter<Object> {
     ...
     * @param cause
     *            the Jackson-thrown exception to evaluate (typically a {@link JsonMappingException})
     * @since 4.3
     */
     ...
     * <p>
     * By default this is either the charset from the input {@code MediaType} or otherwise falling back on
     * {@code UTF-8}. Can be overridden in subclasses.
     * 
     * @param contentType
     *            the content type of the HTTP input message
