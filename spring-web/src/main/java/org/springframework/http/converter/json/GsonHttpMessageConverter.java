 ...
 * the <a href="https://code.google.com/p/google-gson/">Google Gson</a> library.
 *
 * <p>
...
public class GsonHttpMessageConverter extends AbstractJsonHttpMessageConverter {
    ...
    /**
     * Set the {@code Gson} instance to use. If not set, a default {@link Gson#Gson() Gson} instance will be used.
     * <p>
