...
public abstract class AbstractJaxb2HttpMessageConverter<T> extends AbstractXmlHttpMessageConverter<T> {
    ...
    /**
     * Customize the {@link Marshaller} created by this message converter before using it to write the object to the
     * output.
     * 
     * @param marshaller
     *            the marshaller to customize
     * @since 4.0.3
    ...
    /**
     * Customize the {@link Unmarshaller} created by this message converter before using it to read the object from the
     * input.
     * 
     * @param unmarshaller
     *            the unmarshaller to customize
     * @since 4.0.3
