 ...
 * Specifically, this converter can handle {@link Channel} objects from the
 ...
 *
 * <p>
 * By default, this converter reads and writes the media type ({@code application/rss+xml}). This can be overridden
 * through the {@link #setSupportedMediaTypes supportedMediaTypes} property.
 *
