...
/**
 * Implementation of {@link HttpMessageConverter} that can read/write {@link Resource Resources} and supports byte range
 * requests.
 *
 * <p>
 * By default, this converter can read all media types. The {@link MediaTypeFactory} is used to determine the
...
public class ResourceHttpMessageConverter extends AbstractHttpMessageConverter<Resource> {
    ...
    /**
     * Create a new instance of the {@code ResourceHttpMessageConverter} that supports read streaming, i.e. can convert
     * an {@code HttpInputMessage} to {@code InputStreamResource}.
     */
     ...
     *            whether the converter should support read streaming, i.e. convert to {@code InputStreamResource}
     * @since 5.0
     */
