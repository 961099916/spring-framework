 ...
 * {@code Content-Type} of {@code text/plain}. This can be overridden by setting the {@link #setSupportedMediaTypes
...
public class StringHttpMessageConverter extends AbstractHttpMessageConverter<String> {
    ...
    /**
     * Whether the {@code Accept-Charset} header should be written to any outgoing request sourced from the value of
     * {@link Charset#availableCharsets()}. The behavior is suppressed if the header has already been set.
     * <p>
