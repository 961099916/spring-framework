 ...
 *
 * <p>
 * This converter can read {@linkplain Collection collections} that contain classes annotated with
 * {@link XmlRootElement} and {@link XmlType}. Note that this converter does not support writing.
 *
...
public class Jaxb2CollectionHttpMessageConverter<T extends Collection> extends AbstractJaxb2HttpMessageConverter<T>
    ...
    /**
     * Always returns {@code false} since Jaxb2CollectionHttpMessageConverter required generic type information in order
     ...
     * {@inheritDoc}
     * <p>
     * Jaxb2CollectionHttpMessageConverter can read a generic {@link Collection} where the generic type is a JAXB type
     * annotated with {@link XmlRootElement} or {@link XmlType}.
     */
    @Override
    ...
    /**
     * Always returns {@code false} since Jaxb2CollectionHttpMessageConverter does not convert collections to XML.
     */
    @Override
    ...
    /**
     * Create an {@code XMLInputFactory} that this converter will use to create {@link javax.xml.stream.XMLStreamReader}
