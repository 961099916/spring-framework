 ...
 * com.google.protobuf.Messages} using <a href="https://developers.google.com/protocol-buffers/">Google Protocol
 * Buffers</a>.
 *
 * <p>
 ...
 *
 * <p>
 * This converter supports by default {@code "application/x-protobuf"} and {@code "text/plain"} with the official
 * {@code "com.google.protobuf:protobuf-java"} library. Other formats can be supported with one of the following
 * additional libraries on the classpath:
 * <ul>
 * <li>{@code "application/json"}, {@code "application/xml"}, and {@code "text/html"} (write-only) with the
 * {@code "com.googlecode.protobuf-java-format:protobuf-java-format"} third-party library
 * <li>{@code "application/json"} with the official {@code "com.google.protobuf:protobuf-java-util"} for Protobuf 3 (see
 * {@link ProtobufJsonFormatHttpMessageConverter} for a configurable variant)
 * </ul>
 *
 * <p>
 * Requires Protobuf 2.6 or higher (and Protobuf Java Format 1.4 or higher for formatting). This converter will
 * auto-adapt to Protobuf 3 and its default {@code protobuf-java-util} JSON format if the Protobuf 2 based
 * {@code protobuf-java-format} isn't present; however, for more explicit JSON setup on Protobuf 3, consider
 * {@link ProtobufJsonFormatHttpMessageConverter}.
 *
 * @author Alex Antonov
 * @author Brian Clozel
...
public class ProtobufHttpMessageConverter extends AbstractHttpMessageConverter<Message> {
    ...
    /**
     * Construct a new {@code ProtobufHttpMessageConverter} with an initializer that allows the registration of message
     * extensions.
     * 
     * @param registryInitializer
    ...
    /**
     * Construct a new {@code ProtobufHttpMessageConverter} with a registry that specifies protocol message extensions.
     * 
     ...
     * <p>
     * <b>Note:</b> <code>outputMessage.getBody()</code> should not have been called before because it writes HTTP
     * headers (making them read only).
     * </p>
     */
    ...
    /**
     * {@link ProtobufFormatSupport} implementation used when {@code com.googlecode.protobuf.format.FormatFactory} is
     * available.
     */
    ...
    /**
     * {@link ProtobufFormatSupport} implementation used when {@code com.google.protobuf.util.JsonFormat} is available.
     */
