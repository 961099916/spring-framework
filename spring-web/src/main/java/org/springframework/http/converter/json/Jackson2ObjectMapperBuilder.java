 ...
 * <ul>
 * <li><a href="https://github.com/FasterXML/jackson-datatype-jdk8">jackson-datatype-jdk8</a>: support for other Java 8
 * types like {@link java.util.Optional}</li>
 * <li><a href="https://github.com/FasterXML/jackson-datatype-jsr310">jackson-datatype-jsr310</a>: support for Java 8
 * Date & Time API types</li>
 * <li><a href="https://github.com/FasterXML/jackson-datatype-joda">jackson-datatype-joda</a>: support for Joda-Time
 * types</li>
 * <li><a href="https://github.com/FasterXML/jackson-module-kotlin">jackson-module-kotlin</a>: support for Kotlin
 * classes and data classes</li>
 * </ul>
 *
 * <p>
...
public class Jackson2ObjectMapperBuilder {
    ...
    /**
     * Obtain a {@link Jackson2ObjectMapperBuilder} instance in order to build a regular JSON {@link ObjectMapper}
     * instance.
     */
    ...
    /**
     * Obtain a {@link Jackson2ObjectMapperBuilder} instance in order to build a Smile data format {@link ObjectMapper}
     * instance.
     *
     * @since 5.0
     */
    ...
    /**
     * Obtain a {@link Jackson2ObjectMapperBuilder} instance in order to build a CBOR data format {@link ObjectMapper}
     * instance.
     *
     * @since 5.0
     */
    ...
    /**
     * If set to {@code true}, an {@link XmlMapper} will be created using its default constructor. This is only
     * applicable to {@link #build()} calls, not to {@link #configure} calls.
     */
     ...
     * <p>
     * Note: Setting this property makes the exposed {@link ObjectMapper} non-thread-safe, according to Jackson's thread
     * safety rules.
     *
     ...
     *
     * @param localeString
     *            the locale ID as a String representation
     * @since 4.1.5
     */
     ...
     *            the zone ID as a String representation
     * @since 4.1.5
     */
    ...
    /**
     * Alternative to {@link #annotationIntrospector(AnnotationIntrospector)} that allows combining with rather than
     * replacing the currently set introspector, e.g. via
     * {@link AnnotationIntrospectorPair#pair(AnnotationIntrospector, AnnotationIntrospector)}.
     *
     * @param pairingFunction
     *            a function to apply to the currently set introspector (possibly {@code null}); the result of the
     *            function becomes the new introspector.
     * @since 5.2.4
     */
    ...
    /**
     * Specify a {@link com.fasterxml.jackson.databind.PropertyNamingStrategy} to configure the {@link ObjectMapper}
     * with.
     */
     ...
     * @param mixinSource
     *            class (or interface) whose annotations are to be "added" to target's annotations as value
     * @since 4.1.2
     ...
     *
     * @param mixIns
     *            a Map of entries with target classes (or interface) whose annotations to effectively override as key
     *            and mix-in classes (or interface) whose annotations are to be "added" to target's annotations as
     *            value.
     * @since 4.1.2
     * @see com.fasterxml.jackson.databind.ObjectMapper#addMixIn(Class, Class)
     */
    ...
    /**
     * Specify one or more modules to be registered with the {@link ObjectMapper}. Multiple invocations are not
     * additive, the last one defines the modules to register.
     * <p>
     * Note: If this is set, no finding of modules is going to happen - not by Jackson, and not by Spring either (see
     * {@link #findModulesViaServiceLoader}). As a consequence, specifying an empty list here will suppress any kind of
     * module detection.
     * <p>
    ...
    /**
     * Set a complete list of modules to be registered with the {@link ObjectMapper}. Multiple invocations are not
     * additive, the last one defines the modules to register.
     * <p>
     * Note: If this is set, no finding of modules is going to happen - not by Jackson, and not by Spring either (see
     * {@link #findModulesViaServiceLoader}). As a consequence, specifying an empty list here will suppress any kind of
     ...
     * additive, the last one defines the modules to register.
     * <p>
     * Modules specified here will be registered after Spring's autodetection of JSR-310 and Joda-Time, or Jackson's
     * finding of modules (see {@link #findModulesViaServiceLoader}), allowing to eventually override their
     * configuration.
     * <p>
    ...
    /**
     * Specify one or more modules by class to be registered with the {@link ObjectMapper}. Multiple invocations are not
     * additive, the last one defines the modules to register.
     * <p>
     * Modules specified here will be registered after Spring's autodetection of JSR-310 and Joda-Time, or Jackson's
     * finding of modules (see {@link #findModulesViaServiceLoader}), allowing to eventually override their
    ...
    /**
     * Set whether to let Jackson find available modules via the JDK ServiceLoader, based on META-INF metadata in the
     * classpath.
     * <p>
     * If this mode is not set, Spring's Jackson2ObjectMapperBuilder itself will try to find the JSR-310 and Joda-Time
     * support modules on the classpath - provided that Java 8 and Joda-Time themselves are available, respectively.
     *
     ...
     * <p>
     * Each build operation produces an independent {@link ObjectMapper} instance. The builder's settings can get
     * modified, with a subsequent build operation then producing a new {@link ObjectMapper} based on the most recent
     * settings.
     *
    ...
    /**
     * Configure an existing {@link ObjectMapper} instance with this builder's settings. This can be applied to any
     * number of {@code ObjectMappers}.
     *
     * @param objectMapper
