...
/**
 * Extension of {@link HttpEntity} that adds an {@link HttpStatus} status code. Used in {@code RestTemplate} as well as
 * in {@code @Controller} methods.
 *
 * <p>
 * In {@code RestTemplate}, this class is returned by {@link org.springframework.web.client.RestTemplate#getForEntity
 * getForEntity()} and {@link org.springframework.web.client.RestTemplate#exchange exchange()}:
 * 
 * <pre class="code">
...
public class ResponseEntity<T> extends HttpEntity<T> {
    ...
    /**
     * Create a {@code ResponseEntity} with the given body, headers, and status code. Just used behind the nested
     * builder API.
     * 
     * @param body
     *            the entity body
     ...
     *
     * @param body
     *            the body of the response entity (possibly empty)
    ...
    /**
     * A shortcut for creating a {@code ResponseEntity} with the given body and the {@linkplain HttpStatus#OK OK}
     * status, or an empty body and a {@linkplain HttpStatus#NOT_FOUND NOT FOUND} status in case of an
    ...
    /**
     * Create a new builder with a {@linkplain HttpStatus#CREATED CREATED} status and a location header set to the given
     * URI.
     *
     * @param location
     *            the location URI
    ...
    public interface HeadersBuilder<B extends HeadersBuilder<B>> {
        ...
        /**
         * Manipulate this entity's headers with the given consumer. The headers provided to the consumer are "live", so
