...
/**
 * {@link ClientHttpRequestInterceptor} to apply a given HTTP Basic Authentication username/password pair, unless a
 * custom {@code Authorization} header has already been set.
 *
...
public class BasicAuthenticationInterceptor implements ClientHttpRequestInterceptor {
    ...
    /**
     * Create a new interceptor which adds Basic Authentication for the given username and password, encoded using the
     * specified charset.
     * 
     * @param username
     *            the username to use
