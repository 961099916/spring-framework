 ...
 * <a href="https://hc.apache.org/httpcomponents-asyncclient-dev/">Apache HttpComponents HttpAsyncClient 4.0</a> to
 * create requests.
 *
...
public class HttpComponentsAsyncClientHttpRequestFactory extends HttpComponentsClientHttpRequestFactory
     ...
     * 
     * @param httpClient
     *            the CloseableHttpClient instance to use for this request factory
     * @param asyncClient
     *            the CloseableHttpAsyncClient instance to use for this request factory
     */
    ...
    /**
     * Return the {@code HttpAsyncClient} used for {@linkplain #createAsyncRequest(URI, HttpMethod) synchronous
     * execution}.
     *
     * @since 4.3.10
     * @see #getHttpClient()
    ...
    /**
     * Set the {@code HttpAsyncClient} used for {@linkplain #createAsyncRequest(URI, HttpMethod) synchronous execution}.
     *
     * @since 4.3.10
    ...
    /**
     * Return the {@code CloseableHttpAsyncClient} used for {@linkplain #createAsyncRequest(URI, HttpMethod)
    ...
    /**
     * Set the {@code CloseableHttpAsyncClient} used for {@linkplain #createAsyncRequest(URI, HttpMethod) asynchronous
     * execution}.
     *
