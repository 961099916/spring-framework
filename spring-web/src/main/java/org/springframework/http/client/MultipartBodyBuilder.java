...
/**
 * Prepare the body of a multipart request, resulting in a {@code MultiValueMap<String, HttpEntity>}. Parts may be
 * concrete values or via asynchronous types such as Reactor {@code Mono}, {@code Flux}, and others registered in the
 * {@link org.springframework.core.ReactiveAdapterRegistry ReactiveAdapterRegistry}.
 *
 * <p>
 * This builder is intended for use with the reactive {@link org.springframework.web.reactive.function.client.WebClient
 * WebClient}. For multipart requests with the {@code RestTemplate}, simply create and populate a
 * {@code MultiValueMap<String, HttpEntity>} as shown in the Javadoc for
 * {@link org.springframework.http.converter.FormHttpMessageConverter FormHttpMessageConverter} and in the <a href=
...
public final class MultipartBodyBuilder {
     ...
     * <li>{@link HttpEntity} -- part content and headers although generally it's easier to add headers through the
     * returned builder
     ...
     *            the part data
     * @param contentType
     *            the media type to help with encoding the part
     * @return builder that allows for further customization of part headers
     */
     ...
     *            the name of the part to add
     * @param publisher
     *            a Publisher of content for the part
     * @param elementClass
    ...
    /**
     * Variant of {@link #asyncPart(String, Publisher, Class)} with a {@link ParameterizedTypeReference} for the element
     * type information.
     * 
     * @param name
     *            the name of the part to add
    ...
    public interface PartBuilder {
         ...
         * {@link org.springframework.core.io.Resource Resource} based parts that expose a filename but may be useful
         * for {@link Publisher} parts.
         * 
         * @param filename
         *            the filename to set on the Content-Disposition
         * @since 5.2
         */
         ...
         * 
         * @param headerName
         *            the part header name
         * @param headerValues
         *            the part header value(s)
         * @return this builder
         ...
         *            consumer to manipulate the part headers with
         * @return this builder
         */
    ...
    /**
     * Specialization of {@link HttpEntity} for use with a {@link Publisher}-based body, for which we also need to keep
     * track of the element type.
     * 
     * @param <T>
