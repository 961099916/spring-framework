...
public class Netty4ClientHttpRequestFactory
     ...
     * <p>
     * <b>NOTE:</b> the given group will <strong>not</strong> be {@linkplain EventLoopGroup#shutdownGracefully()
     * shutdown} by this factory; doing so becomes the responsibility of the caller.
     */
    ...
    /**
     * Set the SSL context. When configured it is used to create and insert an {@link io.netty.handler.ssl.SslHandler}
