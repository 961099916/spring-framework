...
public class JettyClientHttpConnector implements ClientHttpConnector {
    ...
    /**
     * Constructor with an initialized {@link HttpClient} and configures it with the given {@link JettyResourceFactory}.
     * 
     * @param httpClient
     *            the {@link HttpClient} to use
     * @param resourceFactory
     *            the {@link JettyResourceFactory} to use
     * @since 5.2
     */
     ...
     *            the {@link JettyResourceFactory} to use
     * @param customizer
     *            the lambda used to customize the {@link HttpClient}
    ...
    public Mono<ClientHttpResponse> connect(HttpMethod method, URI uri,
        ...
        return requestCallback.apply(new JettyClientHttpRequest(request, this.bufferFactory)).then(
            Mono.fromDirect(ReactiveRequest.newBuilder(request).build().response((reactiveResponse, chunkPublisher) -> {
