...
public interface ClientHttpResponse extends HttpInputMessage, Closeable {
     ...
     * <p>
     * For status codes not supported by {@code HttpStatus}, use {@link #getRawStatusCode()} instead.
     * 
    ...
    /**
     * Get the HTTP status code (potentially non-standard and not resolvable through the {@link HttpStatus} enum) as an
     * integer.
     * 
