 ...
 * {@linkplain org.springframework.web.client.AsyncRestTemplate#setInterceptors registered} with the
 * {@link org.springframework.web.client.AsyncRestTemplate} as to modify the outgoing {@link HttpRequest} and/or
...
public interface AsyncClientHttpRequestInterceptor {
    ...
    /**
     * Intercept the given request, and return a response future. The given {@link AsyncClientHttpRequestExecution}
     * allows the interceptor to pass on the request to the next entity in the chain.
     * <p>
     * An implementation might follow this pattern:
     * <ol>
     * <li>Examine the {@linkplain HttpRequest request} and body</li>
     * <li>Optionally {@linkplain org.springframework.http.client.support.HttpRequestWrapper wrap} the request to filter
     * HTTP attributes.</li>
     ...
     * {@link org.springframework.util.concurrent.ListenableFutureAdapter ListenableFutureAdapter}.</li>
     * </ol>
     * 
     * @param request
