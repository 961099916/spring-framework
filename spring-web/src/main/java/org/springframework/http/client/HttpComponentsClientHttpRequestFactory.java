 ...
 * <a href="https://hc.apache.org/httpcomponents-client-ga/">Apache HttpComponents HttpClient</a> to create requests.
 *
 * <p>
...
public class HttpComponentsClientHttpRequestFactory implements ClientHttpRequestFactory, DisposableBean {
    ...
    /**
     * Set the connection timeout for the underlying {@link RequestConfig}. A timeout value of 0 specifies an infinite
     * timeout.
     * <p>
     * Additional properties can be configured by specifying a {@link RequestConfig} instance on a custom
     * {@link HttpClient}.
     * <p>
     * This options does not affect connection timeouts for SSL handshakes or CONNECT requests; for that, it is required
     * to use the {@link org.apache.http.config.SocketConfig} on the {@link HttpClient} itself.
     * 
     * @param timeout
    ...
    /**
     * Set the timeout in milliseconds used when requesting a connection from the connection manager using the
     * underlying {@link RequestConfig}. A timeout value of 0 specifies an infinite timeout.
     * <p>
     * Additional properties can be configured by specifying a {@link RequestConfig} instance on a custom
     * {@link HttpClient}.
     * 
    ...
    /**
     * Set the socket read timeout for the underlying {@link RequestConfig}. A timeout value of 0 specifies an infinite
     * timeout.
     * <p>
     * Additional properties can be configured by specifying a {@link RequestConfig} instance on a custom
     * {@link HttpClient}.
     ...
     * property to {@code false}, so as not to run out of memory.
     * 
     * @since 4.0
     */
     ...
     * client certificate such that all calls made through a given {@code RestTemplate} instance as associated for the
     * same client identity. {@link HttpClientContext#setUserToken(Object)} can be used to specify a fixed user token
     * for all requests.
     * 
     * @param httpContextFactory
    ...
    /**
     * Create a default {@link RequestConfig} to use with the given client. Can return {@code null} to indicate that no
     * custom request config should be set and the defaults of the {@link HttpClient} should be used.
     * <p>
     * The default implementation tries to merge the defaults of the client with the local customizations of this
     * factory instance, if any.
     * 
     * @param client
     *            the {@link HttpClient} (or {@code HttpAsyncClient}) to check
    ...
    /**
     * Merge the given {@link HttpClient}-level {@link RequestConfig} with the factory-level {@link RequestConfig}, if
     * necessary.
     * 
     * @param clientConfig
     *            the config held by the current
    ...
    /**
     * Shutdown hook that closes the underlying {@link org.apache.http.conn.HttpClientConnectionManager
     ...
     * {@link org.apache.http.client.methods.HttpRequestBase} and hence allows HTTP delete with a request body. For use
     * with the RestTemplate exchange methods which allow the combination of HTTP DELETE with an entity.
     * 
     * @since 4.1.2
     */
