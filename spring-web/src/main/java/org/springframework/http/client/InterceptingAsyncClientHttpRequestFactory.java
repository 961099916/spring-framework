...
/**
 * Wrapper for a {@link AsyncClientHttpRequestFactory} that has support for {@link AsyncClientHttpRequestInterceptor
...
public class InterceptingAsyncClientHttpRequestFactory implements AsyncClientHttpRequestFactory {
    ...
    /**
     * Create new instance of {@link InterceptingAsyncClientHttpRequestFactory} with delegated request factory and list
     * of interceptors.
     * 
     * @param delegate
