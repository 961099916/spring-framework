...
public abstract class HttpAccessor {
     ...
     * <p>
     * The default is a {@link SimpleClientHttpRequestFactory} based on the JDK's own HTTP libraries
     * ({@link java.net.HttpURLConnection}).
     * <p>
     * <b>Note that the standard JDK HTTP library does not support the HTTP PATCH method. Configure the Apache
     * HttpComponents or OkHttp request factory to enable PATCH.</b>
     *
     ...
     * <p>
     * The returned {@link List} is active and may be modified. Note, however, that the initializers will not be
     * resorted according to their {@linkplain AnnotationAwareOrderComparator#sort(List) order} before the
