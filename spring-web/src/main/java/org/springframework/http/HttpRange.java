...
public abstract class HttpRange {
    ...
    /**
     * Convert each {@code HttpRange} into a {@code ResourceRegion}, selecting the appropriate segment of the given
     * {@code Resource} using HTTP Range information.
     *
     * @param ranges
     *            the list of ranges
     * @param resource
    ...
    /**
     * Turn a {@code Resource} into a {@link ResourceRegion} using the range information contained in the current
     * {@code HttpRange}.
     *
     * @param resource
