...
/**
 * Represents an HTTP cookie as a name-value pair consistent with the content of the "Cookie" request header. The
 * {@link ResponseCookie} sub-class has the additional attributes expected in the "Set-Cookie" response header.
 *
