...
public class ServerSentEventHttpMessageWriter implements HttpMessageWriter<Object> {
    ...
    /**
     * Constructor without an {@code Encoder}. In this mode only {@code String} is supported for event data to be
     * encoded.
     */
    ...
    /**
     * Constructor with JSON {@code Encoder} for encoding objects. Support for {@code String} event data is built-in.
     * 
     * @param encoder
     *            the Encoder to use (may be {@code null})
     */
    ...
    private Flux<Publisher<DataBuffer>> encode(Publisher<?> input, ResolvableType elementType, MediaType mediaType,
        ...
        ResolvableType dataType =
            (ServerSentEvent.class.isAssignableFrom(elementType.toClass()) ? elementType.getGeneric() : elementType);
