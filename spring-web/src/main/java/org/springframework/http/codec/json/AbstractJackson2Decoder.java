 ...
 * @since 5.0
 * @see <a href="https://github.com/FasterXML/jackson-core/issues/57" target="_blank">Add support for non-blocking
 *      ("async") JSON parsing</a>
 */
public abstract class AbstractJackson2Decoder extends Jackson2CodecSupport implements HttpMessageDecoder<Object> {
     ...
     * when decoding as a whole, or the size of one top-level JSON object within a JSON stream. When the limit is
    ...
    /**
     * Process the input publisher into a flux. Default implementation returns {@link Flux#from(Publisher)}, but
     * subclasses can choose to customize this behavior.
     * 
     * @param input
     *            the {@code DataBuffer} input stream to process
     * @param elementType
