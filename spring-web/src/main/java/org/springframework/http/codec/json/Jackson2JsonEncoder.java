...
/**
 * Encode from an {@code Object} stream to a byte stream of JSON objects using Jackson 2.9. For non-streaming use cases,
 * {@link Flux} elements are collected into a {@link List} before serialization for performance reason.
 *
