...
/**
 * Implementation of an {@link HttpMessageReader} to read HTML form data, i.e. request body with media type
...
public class FormHttpMessageReader extends LoggingCodecSupport
    ...
    /**
     * Set the default character set to use for reading form data when the request Content-Type header does not
    ...
    /**
     * Set the max number of bytes for input form data. As form data is buffered before it is parsed, this helps to
    ...
    public boolean canRead(ResolvableType elementType, @Nullable MediaType mediaType) {
        boolean multiValueUnresolved =
            elementType.hasUnresolvableGenerics() && MultiValueMap.class.isAssignableFrom(elementType.toClass());
