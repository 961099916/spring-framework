...
/**
 * Extension of {@link CodecConfigurer} for HTTP message reader and writer options relevant on the server side.
 *
 * <p>
...
public interface ServerCodecConfigurer extends CodecConfigurer {
    ...
    interface ServerDefaultCodecs extends DefaultCodecs {
         ...
         * <p>
         * By default, if <a href="https://github.com/synchronoss/nio-multipart">Synchronoss NIO Multipart</a> is
         * present, this is set to {@link org.springframework.http.codec.multipart.MultipartHttpMessageReader
         ...
         * <p>
         * Note that {@link #maxInMemorySize(int)} and/or {@link #enableLoggingRequestDetails(boolean)}, if configured,
         * will be applied to the given reader, if applicable.
         * 
         * @param reader
         *            the message reader to use for multipart requests.
         * @since 5.1.11
         */
         ...
         * <p>
         * By default if this is not set, and Jackson is available, the {@link #jackson2JsonEncoder} override is used
         * instead. Use this method to customize the SSE encoder.
         */
