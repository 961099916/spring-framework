...
class ClientDefaultCodecsImpl extends BaseDefaultCodecs implements ClientCodecConfigurer.ClientDefaultCodecs {
    ...
    ClientDefaultCodecsImpl(ClientDefaultCodecsImpl other) {
        ...
        this.multipartCodecs =
            (other.multipartCodecs != null ? new DefaultMultipartCodecs(other.multipartCodecs) : null);
        this.sseDecoder = other.sseDecoder;
    }

    /**
     * Set a supplier for part writers to use when {@link #multipartCodecs()} are not explicitly configured. That's the
     * same set of writers as for general except for the multipart writer itself.
     */
    ...
    protected void extendObjectReaders(List<HttpMessageReader<?>> objectReaders) {
        ...
        Decoder<?> decoder =
            (this.sseDecoder != null ? this.sseDecoder : jackson2Present ? getJackson2JsonDecoder() : null);
