...
/**
 * Internal delegate for loading the default codec configurer class names. Models a loose relationship with the default
 * implementations in the support package, literally only needing to know the default class name to use.
 *
