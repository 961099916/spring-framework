 ...
 *
 * <p>
 * Also an implementation of {@code HttpMessageWriter} with support for writing one or more {@link ResourceRegion}'s
 * based on the HTTP ranges specified in the request.
 *
 * <p>
 * For reading to a Resource, use {@link ResourceDecoder} wrapped with {@link DecoderHttpMessageReader}.
 *
...
public class ResourceHttpMessageWriter implements HttpMessageWriter<Resource> {
    ...
    private Mono<Void> encodeAndWriteRegions(Publisher<? extends ResourceRegion> publisher,
        ...
        Flux<DataBuffer> body =
            this.regionEncoder.encode(publisher, message.bufferFactory(), REGION_TYPE, mediaType, hints);
