...
/**
 * Strategy for reading from a {@link ReactiveHttpInputMessage} and decoding the stream of bytes to Objects of type
 * {@code <T>}.
 *
...
public interface HttpMessageReader<T> {
     ...
     * @param mediaType
     *            the media type for the read (possibly {@code null})
     ...
     *            {@link #canRead(ResolvableType, MediaType)}
     * @param message
    ...
    /**
     * Server-side only alternative to {@link #read(ResolvableType, ReactiveHttpInputMessage, Map)} with additional
     * context available.
     * 
     * @param actualType
     *            the actual type of the target method parameter; for annotated controllers, the {@link MethodParameter}
     *            can be accessed via {@link ResolvableType#getSource()}.
     * @param elementType
     *            the type of Objects in the output stream
     * @param request
     *            the current request
     * @param response
    ...
    /**
     * Server-side only alternative to {@link #readMono(ResolvableType, ReactiveHttpInputMessage, Map)} with additional,
     * context available.
     * 
     * @param actualType
     *            the actual type of the target method parameter; for annotated controllers, the {@link MethodParameter}
