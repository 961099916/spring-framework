...
/**
 * Extension of {@link CodecConfigurer} for HTTP message reader and writer options relevant on the client side.
 *
 * <p>
 ...
 * <li>{@link String}
 * <li>{@link org.springframework.util.MultiValueMap MultiValueMap&lt;String,String&gt;} for form data
 ...
 * <li>{@link String}
 * <li>{@link org.springframework.util.MultiValueMap MultiValueMap&lt;String,String&gt;} for form data
 * <li>{@link org.springframework.util.MultiValueMap MultiValueMap&lt;String,Object&gt;} for multipart data
 * <li>JSON and Smile, if Jackson is present
 * <li>XML, if JAXB2 is present
 * </ul>
 *
...
public interface ClientCodecConfigurer extends CodecConfigurer {
     ...
     * {@inheritDoc}
     * <p>
     * On the client side, built-in default also include customizations related to multipart readers and writers, as
     * well as the decoder for SSE.
     */
    @Override
    ...
    interface ClientDefaultCodecs extends DefaultCodecs {
         ...
         * {@link org.springframework.http.codec.multipart.MultipartHttpMessageWriter MultipartHttpMessageWriter}.
         */
         ...
         * <p>
         * By default if this is not set, and Jackson is available, the {@link #jackson2JsonDecoder} override is used
         * instead. Use this property if you want to further customize the SSE decoder.
         * <p>
    ...
    interface MultipartCodecs {
        ...
        /**
         * Add a Part {@link HttpMessageWriter}. For writers of type {@link EncoderHttpMessageWriter} consider using the
         * shortcut {@link #encoder(Encoder)} instead.
         * 
         * @param writer
         *            the writer to add
         */
