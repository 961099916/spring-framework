...
/**
 * {@code HttpMessageWriter} that can write a protobuf {@link Message} and adds {@code X-Protobuf-Schema},
 * {@code X-Protobuf-Message} headers and a {@code delimited=true} parameter is added to the content type if a flux is
 * serialized.
 *
 * <p>
 * For {@code HttpMessageReader}, just use {@code new DecoderHttpMessageReader(new ProtobufDecoder())}.
 *
