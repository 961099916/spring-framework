...
public final class ContentDisposition {
     ...
     *
     * @param type
     *            the disposition type like for example {@literal inline}, {@literal attachment}, or
     *            {@literal form-data}
     * @return the builder
     */
     ...
     * @param charset
     *            the charset of the header field param string, only the US-ASCII, UTF-8 and ISO-8859-1 charsets are
     *            supported
     * @return the encoded header field param
     * @see <a href="https://tools.ietf.org/html/rfc5987">RFC 5987</a>
     */
    ...
    /**
     * Return the disposition type, like for example {@literal inline}, {@literal attachment}, {@literal form-data}, or
    ...
    /**
     * Return the value of the {@literal filename} parameter (or the value of the {@literal filename*} one decoded as
     * defined in the RFC 5987), or {@code null} if not defined.
     */
    @Nullable
     ...
     *
     * @deprecated since 5.2.3 as per <a href="https://tools.ietf.org/html/rfc6266#appendix-B">RFC 6266, Apendix B</a>,
    ...
    public interface Builder {
        ...
        /**
         * Set the value of the {@literal filename} parameter. The given filename will be formatted as quoted-string, as
         * defined in RFC 2616, section 2.2, and any quote characters within the filename value will be escaped with a
         * backslash, e.g. {@code "foo\"bar.txt"} becomes {@code "foo\\\"bar.txt"}.
         */
        Builder filename(String filename);

        /**
         * Set the value of the {@literal filename*} that will be encoded as defined in the RFC 5987. Only the US-ASCII,
         * UTF-8 and ISO-8859-1 charsets are supported.
         * <p>
         * <strong>Note:</strong> Do not use this for a {@code "multipart/form-data"} requests as per
         * <a link="https://tools.ietf.org/html/rfc7578#section-4.2">RFC 7578, Section 4.2</a> and also RFC 5987 itself
         * mentions it does not apply to multipart requests.
         */
         ...
         * 
         * @deprecated since 5.2.3 as per <a href="https://tools.ietf.org/html/rfc6266#appendix-B">RFC 6266, Apendix
