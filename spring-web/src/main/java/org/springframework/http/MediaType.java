...
/**
 * A subclass of {@link MimeType} that adds support for quality parameters as defined in the HTTP specification.
 *
...
public class MediaType extends MimeType implements Serializable {
     ...
     *             <a href="https://bugs.chromium.org/p/chromium/issues/detail?id=438464"> now comply with the
     ...
     *
     * @deprecated as of 5.2 in favor of {@link #APPLICATION_JSON_VALUE} since major browsers like Chrome
     *             <a href="https://bugs.chromium.org/p/chromium/issues/detail?id=438464"> now comply with the
     *             specification</a> and interpret correctly UTF-8 special characters without requiring a
     *             {@code charset=UTF-8} parameter.
     */
     ...
     * @see <a href="https://tools.ietf.org/html/rfc7807#section-6.1"> Problem Details for HTTP APIs, 6.1.
     *      application/problem+json</a>
     * @deprecated as of 5.2 in favor of {@link #APPLICATION_PROBLEM_JSON} since major browsers like Chrome
     *             <a href="https://bugs.chromium.org/p/chromium/issues/detail?id=438464"> now comply with the
     *             specification</a> and interpret correctly UTF-8 special characters without requiring a
     *             {@code charset=UTF-8} parameter.
     */
     ...
     *
     * @since 5.0
     * @deprecated as of 5.2 in favor of {@link #APPLICATION_PROBLEM_JSON_VALUE} since major browsers like Chrome
     *             <a href="https://bugs.chromium.org/p/chromium/issues/detail?id=438464"> now comply with the
     *             specification</a> and interpret correctly UTF-8 special characters without requiring a
     *             {@code charset=UTF-8} parameter.
     */
     ...
     * @see <a href="https://tools.ietf.org/html/rfc7231#section-5.3.2">HTTP 1.1: Semantics and Content, section
     *      5.3.2</a>
     */
     ...
     * <p>
     * Simply calls {@link MimeType#includes(MimeType)} but declared with a {@code MediaType} parameter for binary
     ...
     * <p>
     * Simply calls {@link MimeType#isCompatibleWith(MimeType)} but declared with a {@code MediaType} parameter for
