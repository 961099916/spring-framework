...
public class ServletServerHttpRequest implements ServerHttpRequest {
    ...
    /**
     * Use {@link javax.servlet.ServletRequest#getParameterMap()} to reconstruct the body of a form 'POST' providing a
     * predictable outcome as opposed to reading from the body, which can fail if any other code has used the
     * ServletRequest to access a parameter, thus causing the input stream to be "consumed".
     */
