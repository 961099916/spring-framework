...
/**
 * {@link ServletHttpHandlerAdapter} extension that uses Tomcat APIs for reading from the request and writing to the
    ...
    private static final class TomcatServerHttpRequest extends ServletServerHttpRequest {
        ...
        private static HttpHeaders createTomcatHttpHeaders(HttpServletRequest request) {
            ...
            org.apache.catalina.connector.Request connectorRequest =
                (org.apache.catalina.connector.Request)ReflectionUtils.getField(COYOTE_REQUEST_FIELD, requestFacade);
    ...
    private static final class TomcatServerHttpResponse extends ServletServerHttpResponse {
        ...
        private static HttpHeaders createTomcatHttpHeaders(HttpServletResponse response) {
            ...
            org.apache.catalina.connector.Response connectorResponse =
                (org.apache.catalina.connector.Response)ReflectionUtils.getField(COYOTE_RESPONSE_FIELD, responseFacade);
