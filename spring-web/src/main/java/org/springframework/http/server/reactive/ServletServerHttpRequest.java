...
class ServletServerHttpRequest extends AbstractServerHttpRequest {
    ...
    public ServletServerHttpRequest(HttpHeaders headers, HttpServletRequest request, AsyncContext asyncContext,
        String servletPath, DataBufferFactory bufferFactory, int bufferSize) throws IOException, URISyntaxException {
     ...
     * 
     * @return a DataBuffer with data read, or {@link #EOF_BUFFER} if the input stream returned -1, or null if 0 bytes
     *         were read.
     */
    @Nullable
