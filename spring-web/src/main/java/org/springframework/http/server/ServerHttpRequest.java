...
public interface ServerHttpRequest extends HttpRequest, HttpInputMessage {
    ...
    /**
     * Return a control that allows putting the request in asynchronous mode so the response remains open until closed
     * explicitly from the current or another thread.
     */
