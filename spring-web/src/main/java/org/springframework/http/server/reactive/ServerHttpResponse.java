...
public interface ServerHttpResponse extends ReactiveHttpOutputMessage {
     ...
     * @return {@code false} if the status code change wasn't processed because the HTTP response is committed,
     *         {@code true} if successfully set.
     */
    boolean setStatusCode(@Nullable HttpStatus status);

    /**
     * Return the status code that has been set, or otherwise fall back on the status of the response from the
     * underlying server. The return value may be {@code null} if the status code value is outside the
     * {@link HttpStatus} enum range, or if there is no default value from the underlying server.
     */
    @Nullable
    ...
    /**
     * Return the status code that has been set, or otherwise fall back on the status of the response from the
     * underlying server. The return value may be {@code null} if there is no default value from the underlying server.
     * 
     * @since 5.2.4
     */
    @Nullable
