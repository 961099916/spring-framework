...
public abstract class AbstractListenerServerHttpResponse extends AbstractServerHttpResponse {
    ...
    /**
     * Abstract template method to create a {@code Processor<Publisher<DataBuffer>, Void>} that will write the response
     * body with flushes to the underlying output. Called from {@link #writeAndFlushWithInternal(Publisher)}.
     */
