...
/**
 * {@link java.beans.PropertyEditor Editor} for {@link MediaType} descriptors, to automatically convert {@code String}
 * specifications (e.g. {@code "text/html"}) to {@code MediaType} properties.
 *
