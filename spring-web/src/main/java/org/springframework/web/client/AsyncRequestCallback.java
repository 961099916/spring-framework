...
/**
 * Callback interface for code that operates on an {@link org.springframework.http.client.AsyncClientHttpRequest}.
...
public interface AsyncRequestCallback {
    ...
    /**
     * Gets called by {@link AsyncRestTemplate#execute} with an opened {@code ClientHttpRequest}. Does not need to care
     * about closing the request or about handling errors: this will all be handled by the {@code RestTemplate}.
     * 
     * @param request
