...
/**
 * Interface specifying a basic set of asynchronous RESTful operations. Implemented by {@link AsyncRestTemplate}. Not
...
public interface AsyncRestOperations {
    ...
    /**
     * Asynchronously retrieve an entity by doing a GET on the specified URL. The response is converted and stored in an
     * {@link ResponseEntity}.
     * <p>
    ...
    /**
     * Asynchronously retrieve a representation by doing a GET on the URI template. The response is converted and stored
    ...
    /**
     * Asynchronously retrieve a representation by doing a GET on the URL. The response is converted and stored in an
     * {@link ResponseEntity}.
     * 
     * @param url
     *            the URL
    ...
    /**
     * Create a new resource by POSTing the given object to the URI template, and asynchronously returns the value of
    ...
    /**
     * Create a new resource by POSTing the given object to the URL, and asynchronously returns the value of the
    ...
    /**
     * Create a new resource by POSTing the given object to the URI template, and asynchronously returns the response as
     * {@link ResponseEntity}.
     * <p>
     * URI Template variables are expanded using the given URI variables, if any.
     * 
    ...
    /**
     * Create a new resource by POSTing the given object to the URL, and asynchronously returns the response as
     * {@link ResponseEntity}.
     * 
     * @param url
     *            the URL
    ...
    /**
     * Asynchronously execute the HTTP method to the given URI template, writing the given request entity to the
     ...
     * @param requestEntity
     *            the entity (headers and/or body) to write to the request (may be {@code null})
     * @param responseType
     *            the type of the return value
     * @param uriVariables
     *            the variables to expand in the template
    ...
    /**
     * Asynchronously execute the HTTP method to the given URI template, writing the given request entity to the
     * request, and returns the response as {@link ResponseEntity}. The given {@link ParameterizedTypeReference} is used
     * to pass generic type information:
     * 
     * <pre class="code">
