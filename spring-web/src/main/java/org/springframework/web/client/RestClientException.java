...
/**
 * Base class for exceptions thrown by {@link RestTemplate} in case a request fails because of a server error response,
 * as determined via {@link ResponseErrorHandler#hasError(ClientHttpResponse)}, failure to decode the response, or a low
 * level I/O error.
 *
