...
public interface RestOperations {
     ...
     * <p>
     * The body of the entity, or {@code request} itself, can be a {@link org.springframework.util.MultiValueMap
     * MultiValueMap} to create a multipart request. The values in the {@code MultiValueMap} can be any Object
     * representing the body of the part, or an {@link org.springframework.http.HttpEntity HttpEntity} representing a
     * part with body and headers.
     * 
     * @param url
     *            the URL
     * @param request
    ...
    /**
     * Create a new resource by POSTing the given object to the URL, and returns the value of the {@code Location}
    ...
    /**
     * Update a resource by PATCHing the given object to the URI template, and return the representation found in the
     * response.
     * <p>
     * URI Template variables are expanded using the given URI variables, if any.
     * <p>
     * The {@code request} parameter can be a {@link HttpEntity} in order to add additional HTTP headers to the request.
     * <p>
     * <b>NOTE: The standard JDK HTTP library does not support HTTP PATCH. You need to use the Apache HttpComponents or
     * OkHttp request factory.</b>
     * 
     * @param url
     *            the URL
     * @param request
     *            the object to be PATCHed (may be {@code null})
     * @param responseType
     *            the type of the return value
     * @param uriVariables
     *            the variables to expand the template
    ...
    /**
     * Execute the HTTP method to the given URI template, writing the given request entity to the request, and returns
     * the response as {@link ResponseEntity}. The given {@link ParameterizedTypeReference} is used to pass generic type
     * information:
     * 
     * <pre class="code">
     ...
     * {@link ResponseEntity}. Typically used in combination with the static builder methods on {@code RequestEntity},
     * for instance:
     * 
     * <pre class="code">
     * MyRequest body = ...
    ...
    /**
     * Execute the request specified in the given {@link RequestEntity} and return the response as
     * {@link ResponseEntity}. The given {@link ParameterizedTypeReference} is used to pass generic type information:
     * 
     * <pre class="code">
     * MyRequest body = ...
     * RequestEntity request = RequestEntity
