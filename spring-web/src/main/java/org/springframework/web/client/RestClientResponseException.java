...
public class RestClientResponseException extends RestClientException {
    ...
    /**
     * Return the response body converted to String. The charset used is that of the response "Content-Type" or
     ...
     *            the charset to use on if the response doesn't specify.
     * @since 5.1.11
     */
