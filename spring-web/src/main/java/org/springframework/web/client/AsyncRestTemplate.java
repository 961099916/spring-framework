...
/**
 * <strong>Spring's central class for asynchronous client-side HTTP access.</strong> Exposes similar methods as
 * {@link RestTemplate}, but returns {@link ListenableFuture} wrappers as opposed to concrete results.
 *
 * <p>
 * The {@code AsyncRestTemplate} exposes a synchronous {@link RestTemplate} via the {@link #getRestOperations()} method
 * and shares its {@linkplain #setErrorHandler error handler} and {@linkplain #setMessageConverters message converters}
 * with that {@code RestTemplate}.
 *
 * <p>
 * <strong>Note:</strong> by default {@code AsyncRestTemplate} relies on standard JDK facilities to establish HTTP
 * connections. You can switch to use a different HTTP library such as Apache HttpComponents, Netty, and OkHttp by using
 * a constructor accepting an {@link org.springframework.http.client.AsyncClientHttpRequestFactory}.
 *
 * <p>
...
public class AsyncRestTemplate extends org.springframework.http.client.support.InterceptingAsyncHttpAccessor
     ...
     * <p>
     * This constructor uses a {@link SimpleClientHttpRequestFactory} in combination with a
    ...
    /**
     * Create a new instance of the {@code AsyncRestTemplate} using the given {@link AsyncTaskExecutor}.
     * <p>
     * This constructor uses a {@link SimpleClientHttpRequestFactory} in combination with the given
     ...
     * <p>
     * This constructor will cast the given asynchronous {@code AsyncClientHttpRequestFactory} to a
     * {@link ClientHttpRequestFactory}. Since all implementations of {@code ClientHttpRequestFactory} provided in
     * Spring also implement {@code AsyncClientHttpRequestFactory}, this should not result in a
    ...
    /**
     * Creates a new instance of the {@code AsyncRestTemplate} using the given asynchronous and synchronous request
     * factories.
     * 
     * @param asyncRequestFactory
     *            the asynchronous request factory
     * @param syncRequestFactory
     ...
     * <p>
     * By default, AsyncRestTemplate uses a {@link org.springframework.web.client.DefaultResponseErrorHandler}.
     */
     ...
     * see {@link RestTemplate#setUriTemplateHandler}.
     *
     * @param handler
    ...
    /**
     * Execute the given method on the provided URI. The {@link org.springframework.http.client.ClientHttpRequest} is
     * processed using the {@link RequestCallback}; the response with the {@link ResponseExtractor}.
     * 
     * @param url
     ...
     *            object that extracts the return value from the response (can be {@code null})
    ...
    /**
     * Returns a request callback implementation that prepares the request {@code Accept} headers based on the given
     * response type and configured {@linkplain #getMessageConverters() message converters}.
     */
    ...
    private static class AsyncRequestCallbackAdapter implements AsyncRequestCallback {
         ...
         *
         * @param requestCallback
         *            the callback to base this adapter on
         */
    ...
    /**
     * Future returned from {@link #doExecute(URI, HttpMethod, AsyncRequestCallback, ResponseExtractor)}.
     */
