...
/**
 * Special JSF {@code ELResolver} that exposes the Spring {@code WebApplicationContext} instance under a variable named
 * "webApplicationContext".
 *
 * <p>
 * In contrast to {@link SpringBeanFacesELResolver}, this ELResolver variant does <i>not</i> resolve JSF variable names
 * as Spring bean names. It rather exposes Spring's root WebApplicationContext <i>itself</i> under a special name, and
 * is able to resolve "webApplicationContext.mySpringManagedBusinessObject" dereferences to Spring-defined beans in that
 * application context.
 *
 * <p>
...
public class WebApplicationContextFacesELResolver extends ELResolver {
     ...
     * <p>
     * The default implementation delegates to {@link FacesContextUtils}, returning {@code null} if no
     * {@code WebApplicationContext} found.
     * 
     * @param elContext
