 ...
 * {@link MultipartResolver} configuration the part is accessed through a {@link MultipartFile}. Or if using Servlet 3.0
 * multipart processing the part is accessed through {@code ServletRequest.getPart}.
 *
...
public class RequestPartServletServerHttpRequest extends ServletServerHttpRequest {
     ...
     * @param requestPartName
     *            the name of the part to adapt to the {@link ServerHttpRequest} contract
     * @throws MissingServletRequestPartException
     *             if the request part cannot be found
