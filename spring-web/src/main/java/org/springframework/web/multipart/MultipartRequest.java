...
/**
 * This interface defines the multipart request access operations that are exposed for actual multipart requests. It is
 * extended by {@link MultipartHttpServletRequest}.
 *
...
public interface MultipartRequest {
    ...
    /**
     * Return an {@link java.util.Iterator} of String objects containing the parameter names of the multipart files
    ...
    /**
     * Return the contents plus description of an uploaded file in this request, or {@code null} if it does not exist.
     * 
     * @param name
