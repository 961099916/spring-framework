...
public class ResponseStatusException extends NestedRuntimeException {
    ...
    /**
     * Constructor with a response status and a reason to add to the exception message as explanation, as well as a
     * nested exception.
     * 
     * @param status
     *            the HTTP status (required)
    ...
    /**
     * Return headers associated with the exception that should be added to the error response, e.g. "Allow", "Accept",
     * etc.
     * <p>
