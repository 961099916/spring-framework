...
/**
 * {@link LocaleContextResolver} implementation that always returns a fixed locale and optionally time zone. Default is
 * the current JVM's default locale.
 *
 * <p>
 * Note: Does not support {@link #setLocaleContext}, as the fixed locale and time zone cannot be changed.
 *
...
public class FixedLocaleContextResolver implements LocaleContextResolver {
    ...
    /**
     * Create a default FixedLocaleResolver, exposing a configured default locale (or the JVM's default locale as
     * fallback).
     */
