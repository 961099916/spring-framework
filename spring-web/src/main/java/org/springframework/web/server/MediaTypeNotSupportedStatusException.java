 ...
 * @since 5.0
 * @deprecated in favor of {@link UnsupportedMediaTypeStatusException}, with this class never thrown by Spring code and
...
public class MediaTypeNotSupportedStatusException extends ResponseStatusException {
    ...
    /**
     * Return the list of supported content types in cases when the Accept header is parsed but not supported, or an
