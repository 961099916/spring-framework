...
public class CookieWebSessionIdResolver implements WebSessionIdResolver {
    ...
    /**
     * Set the value for the "Max-Age" attribute of the cookie that holds the session id. For the range of values see
     * {@link ResponseCookie#getMaxAge()}.
     * <p>
     * By default set to -1.
     *
     * @param maxAge
    ...
    /**
     * Add a {@link Consumer} for a {@code ResponseCookieBuilder} that will be invoked for each cookie being built, just
     * before the call to {@code build()}.
     * 
     * @param initializer
     *            consumer for a cookie builder
     * @since 5.1
     */
