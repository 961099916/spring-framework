...
public class HeaderWebSessionIdResolver implements WebSessionIdResolver {
    ...
    /**
     * Set the name of the session header to use for the session id. The name is used to extract the session id from the
     * request headers as well to set the session id on the response headers.
     * <p>
