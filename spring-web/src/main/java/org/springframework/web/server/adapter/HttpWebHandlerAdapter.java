...
public class HttpWebHandlerAdapter extends WebHandlerDecorator implements HttpHandler {
     ...
     * <p>
     * To avoid filling logs with unnecessary stack traces, we make an effort to identify such network failures on a
     * per-server basis, and then log under a separate log category a simple one-line message at DEBUG level or a full
     * stack trace only at TRACE level.
     */
    ...
    /**
     * Configure a custom {@link WebSessionManager} to use for managing web sessions. The provided instance is set on
    ...
    /**
     * Configure the {@code ApplicationContext} associated with the web application, if it was initialized with one via
