...
/**
 * Exception for errors that fit response status 400 (bad request) for use in Spring Web applications. The exception
 * provides additional fields (e.g. an optional {@link MethodParameter} if related to the error).
 *
