...
/**
 * A generic composite servlet {@link Filter} that just delegates its behavior to a chain (list) of user-supplied
...
public class CompositeFilter implements Filter {
    ...
    /**
     * Forms a temporary chain from the list of delegate filters supplied ({@link #setFilters}) and executes them in
     * order. Each filter delegates to the next one in the list, achieving the normal behavior of a {@link FilterChain},
     * despite the fact that this is a {@link Filter}.
     * 
