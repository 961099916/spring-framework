...
/**
 * Inserts an attribute in the Reactor {@link Context} that makes the current {@link ServerWebExchange} available under
 * the attribute name {@link #EXCHANGE_CONTEXT_ATTRIBUTE}. This is useful for access to the exchange without explicitly
 * passing it to components that participate in request processing.
 *
 * <p>
...
public class ServerWebExchangeContextFilter implements WebFilter {
     ...
     * {@link ServerWebExchangeContextFilter} is configured for use and the give context was obtained from a request
     * processing chain.
     *
     * @param context
