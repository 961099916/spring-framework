...
/**
 * {@link ServletRequestBindingException} subclass that indicates that a matrix variable expected in the method
 * parameters of an {@code @RequestMapping} method is not present among the matrix variables extracted from the URL.
 *
...
public class MissingMatrixVariableException extends ServletRequestBindingException {
     ...
     * 
     * @param variableName
     *            the name of the missing matrix variable
     * @param parameter
