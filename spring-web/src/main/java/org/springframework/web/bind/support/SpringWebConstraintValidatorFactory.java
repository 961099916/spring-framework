 ...
 *
 * <p>
 * In contrast to {@link org.springframework.validation.beanvalidation.SpringConstraintValidatorFactory}, this variant
 * is meant for declarative use in a standard {@code validation.xml} file, e.g. in combination with JAX-RS or JAX-WS.
 *
...
public class SpringWebConstraintValidatorFactory implements ConstraintValidatorFactory {
    ...
    /**
     * Retrieve the Spring {@link WebApplicationContext} to use. The default implementation returns the current
     * {@link WebApplicationContext} as registered for the thread context class loader.
     * 
