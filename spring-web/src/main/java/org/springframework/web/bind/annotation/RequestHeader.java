 ...
 * {@link org.springframework.http.HttpHeaders HttpHeaders} then the map is populated with all header names and values.
 *
...
public @interface RequestHeader {
     ...
     * <p>
     * Defaults to {@code true}, leading to an exception being thrown if the header is missing in the request. Switch
     * this to {@code false} if you prefer a {@code null} value if the header is not present in the request.
     * <p>
