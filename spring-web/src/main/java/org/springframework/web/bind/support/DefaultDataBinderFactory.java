...
/**
 * Create a {@link WebRequestDataBinder} instance and initialize it with a {@link WebBindingInitializer}.
 *
...
public class DefaultDataBinderFactory implements WebDataBinderFactory {
     ...
     * 
     * @param initializer
     *            for global data binder initialization (or {@code null} if none)
     */
    ...
    /**
     * Extension point to further initialize the created data binder instance (e.g. with {@code @InitBinder} methods)
     * after "global" initialization via {@link WebBindingInitializer}.
     * 
     * @param dataBinder
