 ...
 *
 * <p>
 * This component is not concerned with how a {@code CorsConfiguration} is selected but rather takes follow-up actions
 * such as applying CORS validation checks and either rejecting the response or adding CORS headers to the response.
 *
