...
/**
 * Central class to determine requested {@linkplain MediaType media types} for a request. This is done by delegating to
 * a list of configured {@code ContentNegotiationStrategy} instances.
 *
 * <p>
 * Also provides methods to look up file extensions for a media type. This is done by delegating to the list of
 * configured {@code MediaTypeFileExtensionResolver} instances.
 *
...
public class ContentNegotiationManager implements ContentNegotiationStrategy, MediaTypeFileExtensionResolver {
    ...
    /**
     * Create an instance with the given list of {@code ContentNegotiationStrategy} strategies each of which may also be
     ...
     * {@link PathExtensionContentNegotiationStrategy} or {@link ParameterContentNegotiationStrategy}. At runtime if
     * there is a "path extension" strategy and its
     * {@link PathExtensionContentNegotiationStrategy#setUseRegisteredExtensionsOnly(boolean)
     * useRegisteredExtensionsOnly} property is set to "false", the list of extensions may increase as file extensions
     * are resolved via {@link org.springframework.http.MediaTypeFactory} and cached.
     */
    @Override
    ...
    /**
     * Return all registered lookup key to media type mappings by iterating {@link MediaTypeFileExtensionResolver}s.
     * 
     * @since 5.2.4
     */
