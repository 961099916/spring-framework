 ...
 *
 * <p>
 * {@link org.springframework.web.accept.ContentNegotiationStrategy} is the main abstraction for determining requested
 * {@linkplain org.springframework.http.MediaType media types} with implementations based on
 ...
 *
 * <p>
 * {@link org.springframework.web.accept.ContentNegotiationManager} is used to delegate to one ore more of the above
 * strategies in a specific order.
 */
@NonNullApi @NonNullFields package org.springframework.web.accept;
