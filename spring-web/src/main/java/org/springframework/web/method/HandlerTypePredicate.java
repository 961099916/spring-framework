...
/**
 * A {@code Predicate} to match request handling component types if <strong>any</strong> of the following selectors
 * match:
 * <ul>
 ...
 *     HandlerTypePredicate.forAnnotation(RestController.class).and(HandlerTypePredicate.forBasePackage("org.example"));
 * </pre>
 *
...
public final class HandlerTypePredicate implements Predicate<Class<?>> {
    ...
    /**
     * Type-safe alternative to {@link #forBasePackage(String...)} to specify a base package through a class.
     *
