...
/**
 * Utility class for tag library related code, exposing functionality such as translating {@link String Strings} to web
 * scopes.
 *
 * <p>
 * <ul>
 ...
 * <li>{@code application} will be transformed to {@link javax.servlet.jsp.PageContext#APPLICATION_SCOPE
...
public abstract class TagUtils {
     ...
     *             if the supplied {@code scope} is {@code null}
     */
     ...
     * 
     * @param tag
     *            the tag whose ancestors are to be checked
     * @param ancestorTagClass
     *            the ancestor {@link Class} being searched for
     * @return {@code true} if the supplied {@link Tag} has any ancestor tag of the supplied type
     * @throws IllegalArgumentException
     *             if either of the supplied arguments is {@code null}; or if the supplied {@code ancestorTagClass} is
     *             not type-assignable to the {@link Tag} class
     */
    ...
    /**
     * Determine whether the supplied {@link Tag} has any ancestor tag of the supplied type, throwing an
     ...
     *            the ancestor {@link Class} being searched for
     * @param tagName
     *            the name of the {@code tag}; for example '{@code option}'
     * @param ancestorTagName
     *            the name of the ancestor {@code tag}; for example '{@code select}'
     * @throws IllegalStateException
     *             if the supplied {@code tag} does not have a tag of the supplied {@code parentTagClass} as an ancestor
     * @throws IllegalArgumentException
     *             if any of the supplied arguments is {@code null}, or in the case of the {@link String}-typed
     *             arguments, is composed wholly of whitespace; or if the supplied {@code ancestorTagClass} is not
