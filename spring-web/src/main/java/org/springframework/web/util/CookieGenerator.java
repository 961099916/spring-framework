...
/**
 * Helper class for cookie generation, carrying cookie descriptor settings as bean properties and being able to add and
 * remove cookie to/from a given response.
 *
 * <p>
 * Can serve as base class for components that generate specific cookies, such as CookieLocaleResolver and
 * CookieThemeResolver.
 *
...
public class CookieGenerator {
     ...
     * the receiving browser, not processed by the HTTP server itself.
     * <p>
     * Default is "false".
     *
     ...
     * 
     * @param response
     *            the HTTP response to add the cookie to
     * @param cookieValue
     ...
     * 
     * @param response
     *            the HTTP response to remove the cookie from
     * @see #setCookieName
     * @see #setCookieDomain
     * @see #setCookiePath
     */
