...
/**
 * A separator path element. In the pattern '/foo/bar' the two occurrences of '/' will be represented by a
 * SeparatorPathElement (if the default separator of '/' is being used).
 *
 * @author Andy Clement
 * @since 5.0
 */
