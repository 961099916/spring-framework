 ...
 * {@linkplain #getInputStream() input stream} and {@linkplain #getReader() reader}, and allows this content to be
 * retrieved via a {@link #getContentAsByteArray() byte array}.
 *
 * <p>
 * Used e.g. by {@link org.springframework.web.filter.AbstractRequestLoggingFilter}. Note: As of Spring Framework 5.0,
 * this wrapper is built on the Servlet 3.1 API.
 *
