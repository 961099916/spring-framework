 ...
 * <ul>
 * <li>{@code "encodeXyz"} -- these encode a specific URI component (e.g. path, query) by percent encoding illegal
 * characters, which includes non-US-ASCII characters, and also characters that are otherwise illegal within the given
 * URI component type, as defined in RFC 3986. The effect of this method, with regards to encoding, is comparable to
 * using the multi-argument constructor of {@link URI}.
 * <li>{@code "encode"} and {@code "encodeUriVariables"} -- these can be used to encode URI variable values by percent
 * encoding all characters that are either illegal, or have any reserved meaning, anywhere within a URI.
 * </ul>
 *
...
public abstract class UriUtils {
     ...
     * <p>
     * This can be used with {@link UriComponentsBuilder#queryParams(MultiValueMap)} when building a URI from an already
     * encoded template.
     * 
     * <pre class="code">
     ...
     * // add to params...
     *
     * ServletUriComponentsBuilder.fromCurrentRequest().queryParams(UriUtils.encodeQueryParams(params)).build(true)
     *     .toUriString();
     * </pre>
     * 
     * @param params
    ...
    /**
     * Encode all characters that are either illegal, or have any reserved meaning, anywhere within a URI, as defined in
     * <a href="https://tools.ietf.org/html/rfc3986">RFC 3986</a>. This is useful to ensure that the given String will
     * be preserved as-is and will not have any o impact on the structure or meaning of the URI.
     * 
     * @param source
     *            the String to be encoded
     * @param charset
