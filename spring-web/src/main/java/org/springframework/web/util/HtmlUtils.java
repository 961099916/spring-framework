 ...
 *
 * <p>
 * Reference: <a href="https://www.w3.org/TR/html4/charset.html">https://www.w3.org/TR/html4/charset.html</a>
 *
 * <p>
 * For a comprehensive set of String escaping utilities, consider
 * <a href="https://commons.apache.org/proper/commons-text/">Apache Commons Text</a> and its {@code StringEscapeUtils}
 * class. We do not use that class here in order to avoid a runtime dependency on Commons Text just for HTML escaping.
 * Furthermore, Spring's HTML escaping is more flexible and 100% HTML 4.0 compliant.
 *
...
public abstract class HtmlUtils {
     ...
     * Handles complete character set defined in HTML 4.01 recommendation.
     * <p>
     * Escapes all special characters to their corresponding entity reference (e.g. {@code &lt;}) at least as required
     * by the specified encoding. In other words, if a special character does not have to be escaped for the given
     * encoding, it may not be.
     * <p>
     * Reference: <a href="https://www.w3.org/TR/html4/sgml/entities.html">
     * https://www.w3.org/TR/html4/sgml/entities.html </a>
     * 
     ...
     * Handles complete character set defined in HTML 4.01 recommendation.
     * <p>
     * Escapes all special characters to their corresponding numeric reference in decimal format (&#<i>Decimal</i>;).
     * <p>
     * Reference: <a href="https://www.w3.org/TR/html4/sgml/entities.html">
     * https://www.w3.org/TR/html4/sgml/entities.html </a>
     * 
     ...
     * Handles complete character set defined in HTML 4.01 recommendation.
     * <p>
     * Escapes all special characters to their corresponding numeric reference in decimal format (&#<i>Decimal</i>;) at
     * least as required by the specified encoding. In other words, if a special character does not have to be escaped
     * for the given encoding, it may not be.
     * <p>
     * Reference: <a href="https://www.w3.org/TR/html4/sgml/entities.html">
     * https://www.w3.org/TR/html4/sgml/entities.html </a>
     * 
     ...
     * Handles complete character set defined in HTML 4.01 recommendation.
     * <p>
     * Escapes all special characters to their corresponding numeric reference in hex format (&#x<i>Hex</i>;).
     * <p>
     * Reference: <a href="https://www.w3.org/TR/html4/sgml/entities.html">
     * https://www.w3.org/TR/html4/sgml/entities.html </a>
     * 
     ...
     * Handles complete character set defined in HTML 4.01 recommendation.
     * <p>
     * Escapes all special characters to their corresponding numeric reference in hex format (&#x<i>Hex</i>;) at least
     * as required by the specified encoding. In other words, if a special character does not have to be escaped for the
     * given encoding, it may not be.
     * <p>
     * Reference: <a href="https://www.w3.org/TR/html4/sgml/entities.html">
     * https://www.w3.org/TR/html4/sgml/entities.html </a>
     * 
     ...
     * entity).
     * <p>
     * Correctly converts the following formats: <blockquote> &amp;#<i>Entity</i>; - <i>(Example: &amp;amp;) case
     * sensitive</i> &amp;#<i>Decimal</i>; - <i>(Example: &amp;#68;)</i><br>
