 ...
 * {@linkplain #getOutputStream() output stream} and {@linkplain #getWriter() writer}, and allows this content to be
 * retrieved via a {@link #getContentAsByteArray() byte array}.
 *
 * <p>
 * Used e.g. by {@link org.springframework.web.filter.ShallowEtagHeaderFilter}. Note: As of Spring Framework 5.0, this
 * wrapper is built on the Servlet 3.1 API.
 *
...
public class ContentCachingResponseWrapper extends HttpServletResponseWrapper {
     ...
     * 
     * @param complete
     *            whether to set a corresponding content length for the complete cached body content
     * @since 4.2
     */
