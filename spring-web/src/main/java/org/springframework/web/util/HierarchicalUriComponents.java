...
final class HierarchicalUriComponents extends UriComponents {
    ...
    /**
     * Encode the given source into an encoded String using the rules specified by the given component and with the
     * given options.
     *
     * @param source
     *            the source String
    ...
    /**
     * Identical to {@link #encode()} but skipping over URI variable placeholders. Also {@link #variableEncoder} is
     * initialized with the given charset for use later when URI variables are expanded.
     */
    ...
    private enum EncodeState {
        ...
        /**
         * URI vars expanded first and then each URI component encoded by quoting only illegal characters within that
         * URI component.
         */
        FULLY_ENCODED,

        /**
         * URI template encoded first by quoting illegal characters only, and then URI vars encoded more strictly when
         * expanded, by quoting both illegal chars and chars with reserved meaning.
         */
        TEMPLATE_ENCODED;
