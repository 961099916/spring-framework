 ...
 *
 * <p>
 * A text may contain {@code ${...}} placeholders, to be resolved as servlet context init parameters or system
 * properties: e.g. {@code ${user.dir}}. Default values can be supplied using the ":" separator between key and value.
 *
...
public abstract class ServletContextPropertyUtils {
    ...
    /**
     * Resolve ${...} placeholders in the given text, replacing them with corresponding servlet context init parameter
     * or system property values.
     * 
     * @param text
     *            the String to resolve
     * @param servletContext
     *            the servletContext to use for lookups.
    ...
    /**
     * Resolve ${...} placeholders in the given text, replacing them with corresponding servlet context init parameter
     * or system property values. Unresolvable placeholders with no default value are ignored and passed through
     * unchanged if the flag is set to true.
     * 
     * @param text
     *            the String to resolve
     * @param servletContext
