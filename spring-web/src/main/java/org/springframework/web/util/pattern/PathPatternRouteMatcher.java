...
/**
 * {@code RouteMatcher} built on {@link PathPatternParser} that uses {@link PathContainer} and {@link PathPattern} as
 * parsed representations of routes and patterns.
 *
...
public class PathPatternRouteMatcher implements RouteMatcher {
     ...
     * {@link org.springframework.http.server.PathContainer.Options#MESSAGE_ROUTE MESSAGE_ROUTE} and without matching of
     * trailing separator.
     */
