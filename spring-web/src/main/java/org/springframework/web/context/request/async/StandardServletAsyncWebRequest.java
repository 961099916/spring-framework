 ...
 *
 * <p>
 * The servlet and all filters involved in an async request must have async support enabled using the Servlet API or by
 * adding an <code>&ltasync-supported&gttrue&lt/async-supported&gt</code> element to servlet and filter declarations in
 * {@code web.xml}.
 *
...
public class StandardServletAsyncWebRequest extends ServletWebRequest implements AsyncWebRequest, AsyncListener {
     ...
     * <p>
     * It is important to avoid use of request and response objects after async processing has completed. Servlet
     * containers often re-use them.
     */
    @Override
