...
/**
 * Abstract adapter class for the {@link DeferredResultProcessingInterceptor} interface for simplified implementation of
 * individual methods.
 *
...
public abstract class DeferredResultProcessingInterceptorAdapter implements DeferredResultProcessingInterceptor {
    ...
    /**
     * This implementation returns {@code true} by default allowing other interceptors to be given a chance to handle
     * the timeout.
     */
    @Override
