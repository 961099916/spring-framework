...
/**
 * HttpServletRequest decorator that makes all Spring beans in a given WebApplicationContext accessible as request
...
public class ContextExposingHttpServletRequest extends HttpServletRequestWrapper {
     ...
     * @param context
     *            the WebApplicationContext that this request runs in
     * @param exposedContextBeanNames
     *            the names of beans in the context which are supposed to be exposed (if this is non-null, only the
     *            beans in this Set are eligible for exposure as attributes)
     */
    public ContextExposingHttpServletRequest(HttpServletRequest originalRequest, WebApplicationContext context,
