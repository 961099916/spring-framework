 ...
 *
 * <p>
 * Accesses objects from servlet request and HTTP session scope, with no distinction between "session" and "global
 * session".
 *
...
public class ServletRequestAttributes extends AbstractRequestAttributes {
    ...
    /**
     * Determine whether the given value is to be considered as an immutable session attribute, that is, doesn't have to
     * be re-set via {@code session.setAttribute} since its value cannot meaningfully change internally.
     * <p>
     * The default implementation returns {@code true} for {@code String}, {@code Character}, {@code Boolean} and
     * standard {@code Number} values.
     * 
     * @param name
     *            the name of the attribute
     * @param value
     *            the corresponding value to check
     * @return {@code true} if the value is to be considered as immutable for the purposes of session attribute
     *         management; {@code false} otherwise
