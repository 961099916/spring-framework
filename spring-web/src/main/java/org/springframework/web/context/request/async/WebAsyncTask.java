...
public class WebAsyncTask<V> implements BeanFactoryAware {
     ...
     * 
     * @param timeout
     *            the timeout value in milliseconds; ignored if {@code null}
     * @param executorName
     *            the name of an executor bean to use
     * @param callable
     *            the callable for concurrent handling
     */
     ...
     * <p>
     * This factory reference will automatically be set when {@code WebAsyncTask} is used within a Spring MVC
     * controller.
     */
    @Override
     ...
     * <p>
     * This method is called from a container thread when an async request times out before the {@code Callable} has
     * completed. The callback is executed in the same thread and therefore should return without blocking. It may
     ...
     * <p>
     * This method is called from a container thread when an error occurred while processing an async request before the
     * {@code Callable} has completed. The callback is executed in the same thread and therefore should return without
     * blocking. It may return an alternative value to use, including an {@link Exception} or return
     * {@link CallableProcessingInterceptor#RESULT_NONE RESULT_NONE}.
     * 
     * @since 5.0
     */
