 ...
 * specify the context class type, falling back to
 * {@link org.springframework.web.context.support.XmlWebApplicationContext} if not found. With the default ContextLoader
 * implementation, any context class specified needs to implement the {@link ConfigurableWebApplicationContext}
 * interface.
 *
 * <p>
...
public class ContextLoader {
     ...
     * ContextLoaderListener} subclass as a {@code <listener>} within {@code web.xml}, as a no-arg constructor is
     * required.
     * <p>
     ...
     * context used by this {@code ContextLoader}.
     *
     * @since 4.2
    ...
    protected void customizeContext(ServletContext sc, ConfigurableWebApplicationContext wac) {
        ...
        for (Class<
            ApplicationContextInitializer<ConfigurableApplicationContext>> initializerClass : initializerClasses) {
