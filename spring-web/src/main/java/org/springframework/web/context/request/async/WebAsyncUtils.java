...
public abstract class WebAsyncUtils {
    ...
    /**
     * Obtain the {@link WebAsyncManager} for the current request, or if not found, create and associate it with the
     * request.
     */
    ...
    /**
     * Create an AsyncWebRequest instance. By default, an instance of {@link StandardServletAsyncWebRequest} gets
     * created.
     * 
     * @param request
     *            the current request
