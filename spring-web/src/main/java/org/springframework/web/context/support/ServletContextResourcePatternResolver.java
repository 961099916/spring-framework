...
/**
 * ServletContext-aware subclass of {@link PathMatchingResourcePatternResolver}, able to find matching resources below
 * the web application root directory via {@link ServletContext#getResourcePaths}. Falls back to the superclass' file
 * system checking for other resources.
 *
...
public class ServletContextResourcePatternResolver extends PathMatchingResourcePatternResolver {
    ...
    /**
     * Overridden version which checks for ServletContextResource and uses {@code ServletContext.getResourcePaths} to
     ...
     * 
     * @param servletContext
     *            the ServletContext to work on
     * @param fullPattern
     *            the pattern to match against, with preprended root directory path
     * @param dir
     ...
     * @param entryPattern
     *            the pattern for jar entries to match
     * @param result
     *            the Set of matching Resources to add to
     */
