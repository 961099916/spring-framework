...
public class ConfigurableMimeFileTypeMapTests {
    ...
    public void againstDefaultConfiguration() throws Exception {
        ...
        assertThat(ftm.getContentType("foobar.foo")).as("Invalid default content type")
    ...
    public void againstDefaultConfigurationWithFilePath() throws Exception {
        ConfigurableMimeFileTypeMap ftm = new ConfigurableMimeFileTypeMap();
        assertThat(ftm.getContentType(new File("/tmp/foobar.HTM"))).as("Invalid content type for HTM")
            .isEqualTo("text/html");
    }
    ...
    public void withAdditionalMappings() throws Exception {
        ...
        assertThat(ftm.getContentType("foobar.HTM")).as("Invalid content type for HTM - override didn't work")
            .isEqualTo("foo/bar");
        assertThat(ftm.getContentType("foobar.c++")).as("Invalid content type for c++ - override didn't work")
            .isEqualTo("foo/cpp");
        assertThat(ftm.getContentType("bar.foo")).as("Invalid content type for foo - new mapping didn't work")
            .isEqualTo("foo/bar");
    }
