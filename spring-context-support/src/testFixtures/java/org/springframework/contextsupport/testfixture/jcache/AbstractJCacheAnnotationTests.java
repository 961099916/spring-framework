...
public abstract class AbstractJCacheAnnotationTests {
    ...
    public void cacheExceptionRewriteCallStack() {
        ...
        assertThatExceptionOfType(UnsupportedOperationException.class)
            .isThrownBy(() -> service.cacheWithException(this.keyItem, true)).satisfies(first -> {
                ...
                assertThat(contain(first, AbstractJCacheAnnotationTests.class.getName(), "methodInCallStack"))
                    .isFalse();
                assertThat(contain(second, AbstractJCacheAnnotationTests.class.getName(), "methodInCallStack"))
                    .isTrue();
            });
    }
    ...
    public void removeWithExceptionVetoRemove() {
        ...
        assertThatNullPointerException().isThrownBy(() -> service.removeWithException(this.keyItem, false));
    ...
    public void earlyRemoveWithExceptionVetoRemove() {
        ...
        assertThatNullPointerException().isThrownBy(() -> service.earlyRemoveWithException(this.keyItem, false));
    ...
    /**
     * The only purpose of this method is to invoke a particular method on the service so that the call stack is
     * different.
     */
