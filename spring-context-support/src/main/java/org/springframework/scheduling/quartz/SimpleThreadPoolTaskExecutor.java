...
/**
 * Subclass of Quartz's SimpleThreadPool that implements Spring's {@link org.springframework.core.task.TaskExecutor}
 * interface and listens to Spring lifecycle callbacks.
 *
 * <p>
 * Can be shared between a Quartz Scheduler (specified as "taskExecutor") and other TaskExecutor users, or even used
 * completely independent of a Quartz Scheduler (as plain TaskExecutor backend).
 *
