...
/**
 * A Spring {@link FactoryBean} for creating a Quartz {@link org.quartz.CronTrigger} instance, supporting bean-style
 * usage for trigger configuration.
 *
 * <p>
 * {@code CronTrigger(Impl)} itself is already a JavaBean but lacks sensible defaults. This class uses the Spring bean
...
public class CronTriggerFactoryBean implements FactoryBean<CronTrigger>, BeanNameAware, InitializingBean {
    ...
    /**
     * Set the misfire instruction via the name of the corresponding constant in the {@link org.quartz.CronTrigger}
