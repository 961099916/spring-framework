 ...
 *
 * <p>
 * {@code JobDetail(Impl)} itself is already a JavaBean but lacks sensible defaults. This class uses the Spring bean
 * name as job name, and the Quartz default group ("DEFAULT") as job group if not specified.
 *
...
public class JobDetailFactoryBean
    ...
    /**
     * Specify the job's durability, i.e. whether it should remain stored in the job store even if no triggers point to
     * it anymore.
     */
    ...
    /**
     * Set the recovery flag for this job, i.e. whether or not the job should get re-executed if a 'recovery' or
     ...
     * <p>
     * <b>Note: When using persistent job stores where JobDetail contents will be kept in the database, do not put an
     * ApplicationContext reference into the JobDataMap but rather into the SchedulerContext.</b>
     * 
