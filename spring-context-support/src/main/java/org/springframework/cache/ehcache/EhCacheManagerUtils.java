...
/**
 * Convenient builder methods for EhCache 2.5+ {@link CacheManager} setup, providing easy programmatic bootstrapping
 * from a Spring-provided resource. This is primarily intended for use within {@code @Bean} methods in a Spring
 * configuration class.
 *
 * <p>
 * These methods are a simple alternative to custom {@link CacheManager} setup code. For any advanced purposes, consider
...
public abstract class EhCacheManagerUtils {
     ...
     * <p>
     * The CacheManager will be configured from "ehcache.xml" in the root of the class path (that is, default EhCache
     * initialization - as defined in the EhCache docs - will apply). If no configuration file can be found, a fail-safe
     ...
     * 
     * @param name
     *            the desired name of the cache manager
     * @return the new EhCache CacheManager
     * @throws CacheException
     *             in case of configuration parsing failure
     */
     ...
     *            the location of the configuration file (as a Spring resource)
     * @return the new EhCache CacheManager
     * @throws CacheException
     *             in case of configuration parsing failure
     */
