...
abstract class AbstractJCacheKeyOperation<A extends Annotation> extends AbstractJCacheOperation<A> {
     ...
     * 
     * @param methodDetails
     *            the {@link CacheMethodDetails} related to the cached method
     * @param cacheResolver
     *            the cache resolver to resolve regular caches
     * @param keyGenerator
     *            the key generator to compute cache keys
     */
    ...
    /**
     * Return the {@link CacheInvocationParameter} for the parameters that are to be used to compute the key.
     * <p>
     * Per the spec, if some method parameters are annotated with {@link javax.cache.annotation.CacheKey}, only those
     * parameters should be part of the key. If none are annotated, all parameters except the parameter annotated with
     ...
     * @return the {@link CacheInvocationParameter} instances for the parameters to be used to compute the key
     */
