...
class CacheResultOperation extends AbstractJCacheKeyOperation<CacheResult> {
    ...
    /**
     * Specify if the method should always be invoked regardless of a cache hit. By default, the method is only invoked
    ...
    /**
     * Return the {@link CacheResolver} instance to use to resolve the cache to use for matching exceptions thrown by
     * this operation.
     */
    @Nullable
