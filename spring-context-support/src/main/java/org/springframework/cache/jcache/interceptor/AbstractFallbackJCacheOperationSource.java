...
/**
 * Abstract implementation of {@link JCacheOperationSource} that caches attributes for methods and implements a fallback
 * policy: 1. specific target method; 2. declaring method.
 *
 * <p>
...
public abstract class AbstractFallbackJCacheOperationSource implements JCacheOperationSource {
     ...
     * 
     * @param method
     *            the method to retrieve the operation for
     * @param targetType
     *            the target class
