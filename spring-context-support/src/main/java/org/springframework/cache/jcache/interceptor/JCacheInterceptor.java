 ...
 *
 * <p>
 * Derives from the {@link JCacheAspectSupport} class which contains the integration with Spring's underlying caching
 * API. JCacheInterceptor simply calls the relevant superclass method.
 *
 * <p>
...
public class JCacheInterceptor extends JCacheAspectSupport implements MethodInterceptor, Serializable {
     ...
     * 
     * @param errorHandler
     *            a supplier for the error handler to use, applying the default error handler if the supplier is not
     *            resolvable
     * @since 5.1
     */
