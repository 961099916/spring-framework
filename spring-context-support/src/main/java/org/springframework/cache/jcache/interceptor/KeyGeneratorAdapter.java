 ...
 * {@link javax.cache.annotation.CacheKeyGenerator}, or wrap a standard {@link KeyGenerator} so that only relevant
...
class KeyGeneratorAdapter implements KeyGenerator {
    ...
    /**
     * Create an instance with the given {@link KeyGenerator} so that {@link javax.cache.annotation.CacheKey} and
