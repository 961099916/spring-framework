 ...
 *
 * <p>
 * A cache operation can be statically cached as it does not contain any runtime operation of a specific cache
 * invocation.
 *
 * @author Stephane Nicoll
 * @since 4.1
 * @param <A>
 *            the type of the JSR-107 annotation
 */
public interface JCacheOperation<A extends Annotation> extends BasicOperation, CacheMethodDetails<A> {

    /**
     * Return the {@link CacheResolver} instance to use to resolve the cache to use for this operation.
     */
