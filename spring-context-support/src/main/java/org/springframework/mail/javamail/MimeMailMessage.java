...
/**
 * Implementation of the MailMessage interface for a JavaMail MIME message, to let message population code interact with
 * a simple message or a MIME message through a common interface.
 *
 * <p>
 * Uses a MimeMessageHelper underneath. Can either be created with a MimeMessageHelper instance or with a JavaMail
