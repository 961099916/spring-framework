 ...
 *
 * <p>
 * This exception will be thrown either by O/R mapping tools or by custom DAO implementations. Optimistic locking
 * failure is typically <i>not</i> detected by the database itself.
 *
 * @author Rod Johnson
