...
public abstract class DataAccessUtils {
     ...
     * <p>
     * Returns {@code null} if 0 result objects found; throws an exception if more than 1 element found.
     * 
     * @param results
     ...
     * 
     * @param results
     *            the result Collection (can be {@code null} but is not expected to contain {@code null} elements)
     ...
     * 
     * @param results
     *            the result Collection (can be {@code null} and is also expected to contain {@code null} elements)
     * @return the single result object
     * @throws IncorrectResultSizeDataAccessException
     *             if more than one element has been found in the given Collection
     * @throws EmptyResultDataAccessException
     ...
     * <p>
     * Returns {@code null} if 0 result objects found; throws an exception if more than 1 instance found.
     * 
     * @param results
     *            the result Collection (can be {@code null})
     * @return the unique result object, or {@code null} if none
     * @throws IncorrectResultSizeDataAccessException
     *             if more than one result object has been found in the given Collection
     ...
     *             if more than one result object has been found in the given Collection
     * @throws EmptyResultDataAccessException
     *             if no result object at all has been found in the given Collection
     * @see org.springframework.util.CollectionUtils#hasUniqueObject
     */
    ...
    /**
     * Return a unique result object from the given Collection. Throws an exception if 0 or more than 1 result objects
     * found, of if the unique result object is not convertible to the specified required type.
     * 
     * @param results
     *            the result Collection (can be {@code null} but is not expected to contain {@code null} elements)
     * @return the unique result object
    ...
    public static <T> T objectResult(@Nullable Collection<?> results, @Nullable Class<T> requiredType)
        ...
        if (requiredType != null && !requiredType.isInstance(result)) {
            if (String.class == requiredType) {
                ...
                try {
                    result =
                        NumberUtils.convertNumberToTargetClass(((Number)result), (Class<? extends Number>)requiredType);
    ...
    /**
     * Return a unique int result from the given Collection. Throws an exception if 0 or more than 1 result objects
     * found, of if the unique result object is not convertible to an int.
     * 
     * @param results
     *            the result Collection (can be {@code null} but is not expected to contain {@code null} elements)
    ...
    /**
     * Return a unique long result from the given Collection. Throws an exception if 0 or more than 1 result objects
     * found, of if the unique result object is not convertible to a long.
     * 
     * @param results
     *            the result Collection (can be {@code null} but is not expected to contain {@code null} elements)
     ...
     * 
     * @param rawException
     *            an exception that we may wish to translate
     * @param pet
     *            the PersistenceExceptionTranslator to use to perform the translation
     * @return a translated persistence exception if translation is possible, or the raw exception if it is not
     */
