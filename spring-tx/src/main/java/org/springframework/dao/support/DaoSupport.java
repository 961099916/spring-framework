...
public abstract class DaoSupport implements InitializingBean {
     ...
     * <p>
     * Implementors should be marked as {@code final} if concrete subclasses are not supposed to override this template
     * method themselves.
     * 
    ...
    /**
     * Concrete subclasses can override this for custom initialization behavior. Gets called after population of this
     * instance's bean properties.
     * 
     * @throws Exception
