 ...
 *
 * <p>
 * For example, this exception or a subclass might be thrown if a JDBC Connection couldn't be closed after it had been
 * used successfully.
 *
 * <p>
 * Note that data access code might perform resources cleanup in a finally block and therefore log cleanup failure
...
public class CleanupFailureDataAccessException extends NonTransientDataAccessException {
     ...
     *            the detail message
     * @param cause
     *            the root cause from the underlying data access API, such as JDBC
     */
