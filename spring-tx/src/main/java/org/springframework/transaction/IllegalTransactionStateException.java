...
/**
 * Exception thrown when the existence or non-existence of a transaction amounts to an illegal state according to the
 * transaction propagation behavior that applies.
 *
