...
/**
 * Utility methods for triggering specific {@link TransactionSynchronization} callback methods on all currently
...
abstract class TransactionSynchronizationUtils {
    ...
    /**
     * Actually invoke the {@code triggerBeforeCommit} methods of the given Spring TransactionSynchronization objects.
     * 
    ...
    /**
     * Actually invoke the {@code beforeCompletion} methods of the given Spring TransactionSynchronization objects.
     * 
     * @param synchronizations
     *            a List of TransactionSynchronization objects
    ...
    public static Mono<Void> triggerBeforeCompletion(Collection<TransactionSynchronization> synchronizations) {
        return Flux.fromIterable(synchronizations).concatMap(TransactionSynchronization::beforeCompletion)
            .onErrorContinue((t, o) -> logger.error("TransactionSynchronization.beforeCompletion threw exception", t))
            .then();
    }
    ...
    public static Mono<Void> invokeAfterCompletion(Collection<TransactionSynchronization> synchronizations,
        ...
        return Flux.fromIterable(synchronizations).concatMap(it -> it.afterCompletion(completionStatus))
            .onErrorContinue((t, o) -> logger.error("TransactionSynchronization.afterCompletion threw exception", t))
            .then();
    }
