...
public abstract class TransactionContextManager {
    ...
    /**
     * Obtain the current {@link TransactionContext} from the subscriber context or the transactional context holder.
     * Context retrieval fails with NoTransactionException if no context or context holder is registered.
     * 
     ...
     *             if a transaction context is already associated.
    ...
    /**
     * Return a {@link Function} to create or associate a new {@link TransactionContext}. Interaction with transactional
     * resources through {@link TransactionSynchronizationManager} requires a TransactionContext to be registered in the
     * subscriber context.
     * 
     * @return functional context registration.
     */
    ...
    /**
     * Return a {@link Function} to create or associate a new {@link TransactionContextHolder}. Creation and release of
     * transactions within a reactive flow requires a mutable holder that follows a top to down execution scheme.
     * Reactor's subscriber context follows a down to top approach regarding mutation visibility.
     * 
     * @return functional context registration.
     */
