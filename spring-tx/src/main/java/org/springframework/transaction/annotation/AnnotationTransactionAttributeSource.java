 ...
 *
 * <p>
 * This class reads Spring's JDK 1.5+ {@link Transactional} annotation and exposes corresponding transaction attributes
 * to Spring's transaction infrastructure. Also supports JTA 1.2's {@link javax.transaction.Transactional} and EJB3's
 * {@link javax.ejb.TransactionAttribute} annotation (if present). This class may also serve as base class for a custom
 * TransactionAttributeSource, or get customized through {@link TransactionAnnotationParser} strategies.
 *
...
public class AnnotationTransactionAttributeSource extends AbstractFallbackTransactionAttributeSource
     ...
     *            whether to support public methods that carry the {@code Transactional} annotation only (typically for
     *            use with proxy-based AOP), or protected/private methods as well (typically used with AspectJ class
     *            weaving)
     */
