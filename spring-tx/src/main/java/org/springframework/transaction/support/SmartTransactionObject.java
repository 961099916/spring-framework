 ...
 * typically from a another transaction that has participated and marked it as rollback-only.
 *
 * <p>
 * Autodetected by DefaultTransactionStatus, to always return a current rollbackOnly flag even if not resulting from the
...
public interface SmartTransactionObject extends Flushable {
    ...
    /**
     * Return whether the transaction is internally marked as rollback-only. Can, for example, check the JTA
     * UserTransaction.
     * 
