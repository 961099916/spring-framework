 ...
 *
 * <p>
 * Features rollback-only support for participating transactions. Can expire after a certain number of seconds or
 * milliseconds in order to determine a transactional timeout.
 *
...
public abstract class ResourceHolderSupport implements ResourceHolder {
     ...
     * <p>
     * Only really intended to be called after custom rollback steps which keep the original resource in action, e.g. in
     * case of a savepoint.
     * 
     * @since 5.0
    ...
    /**
     * Increase the reference count by one because the holder has been requested (i.e. someone requested the resource
     * held by it).
     */
    ...
    /**
     * Decrease the reference count by one because the holder has been released (i.e. someone released the resource held
     * by it).
     */
