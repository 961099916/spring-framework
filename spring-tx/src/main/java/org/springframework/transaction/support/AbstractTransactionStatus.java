 ...
 *
 * <p>
 * Pre-implements the handling of local rollback-only and completed flags, and delegation to an underlying
 * {@link org.springframework.transaction.SavepointManager}. Also offers the option of a holding a savepoint within the
 * transaction.
 *
 * <p>
 * Does not assume any specific internal transaction handling, such as an underlying transaction object, and no
...
public abstract class AbstractTransactionStatus implements TransactionStatus {
    ...
    /**
     * Determine the rollback-only flag via checking both the local rollback-only flag of this TransactionStatus and the
     * global rollback-only flag of the underlying transaction, if any.
     * 
