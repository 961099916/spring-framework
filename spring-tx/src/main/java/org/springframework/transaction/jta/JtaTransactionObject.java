...
/**
 * JTA transaction object, representing a {@link javax.transaction.UserTransaction}. Used as transaction object by
 * Spring's {@link JtaTransactionManager}.
 *
 * <p>
...
public class JtaTransactionObject implements SmartTransactionObject {
     ...
     *            the JTA UserTransaction for the current transaction (either a shared object or retrieved through a
     *            fresh per-transaction lookup)
     */
