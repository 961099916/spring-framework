...
/**
 * Strategy interface for creating JTA {@link javax.transaction.Transaction} objects based on specified transactional
 * characteristics.
 *
 * <p>
 * The default implementation, {@link SimpleTransactionFactory}, simply wraps a standard JTA
 * {@link javax.transaction.TransactionManager}. This strategy interface allows for more sophisticated implementations
...
public interface TransactionFactory {
     ...
     * 
     * @param name
     *            the transaction name (may be {@code null})
     * @param timeout
     *            the transaction timeout (may be -1 for the default timeout)
     * @return the active Transaction object (never {@code null})
     * @throws NotSupportedException
     *             if the transaction manager does not support a transaction of the specified type
     ...
     * without explicit XA resource enlistment).
     * <p>
     * Typically {@code false}. Checked by {@link org.springframework.jca.endpoint.AbstractMessageEndpointFactory} in
     * order to differentiate between invalid configuration and valid ResourceAdapter-managed transactions.
     * 
