...
/**
 * TransactionAttribute implementation that works out whether a given exception should cause transaction rollback by
 * applying a number of rollback rules, both positive and negative. If no custom rollback rules apply, this attribute
...
public class RuleBasedTransactionAttribute extends DefaultTransactionAttribute implements Serializable {
     ...
     * @param rollbackRules
     *            the list of RollbackRuleAttributes to apply
     * @see #setIsolationLevel
     * @see #setTimeout
     * @see #setReadOnly
     */
    ...
    /**
     * Winning rule is the shallowest rule (that is, the closest in the inheritance hierarchy to the exception). If no
     * rule applies (-1), return false.
     * 
