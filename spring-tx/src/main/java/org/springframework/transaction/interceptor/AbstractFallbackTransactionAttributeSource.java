 ...
 * changing of transaction attributes (which is very unlikely), caching could be made configurable. Caching is desirable
 * because of the cost of evaluating rollback rules.
 *
 * @author Rod Johnson
        ...
        if (cached != null) {
            ...
            if (txAttr == null) {
                ...
                if (logger.isTraceEnabled()) {
                    logger
                        .trace("Adding transactional method '" + methodIdentification + "' with attribute: " + txAttr);
                }
