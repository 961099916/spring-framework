...
/**
 * AOP Alliance MethodInterceptor for declarative transaction management using the common Spring transaction
 * infrastructure ({@link org.springframework.transaction.PlatformTransactionManager}/
 * {@link org.springframework.transaction.ReactiveTransactionManager}).
 *
 * <p>
 * Derives from the {@link TransactionAspectSupport} class which contains the integration with Spring's underlying
 * transaction API. TransactionInterceptor simply calls the relevant superclass methods such as
 * {@link #invokeWithinTransaction} in the correct order.
 *
 * <p>
