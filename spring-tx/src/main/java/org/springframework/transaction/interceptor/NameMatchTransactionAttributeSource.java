...
public class NameMatchTransactionAttributeSource implements TransactionAttributeSource, Serializable {
    ...
    /**
     * Parses the given properties into a name/attribute map. Expects method names as keys and String attributes
     * definitions as values, parsable into TransactionAttribute instances via TransactionAttributeEditor.
     * 
     * @see #setNameMap
     * @see TransactionAttributeEditor
     */
