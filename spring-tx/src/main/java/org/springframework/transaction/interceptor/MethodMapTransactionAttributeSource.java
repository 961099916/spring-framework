...
/**
 * Simple {@link TransactionAttributeSource} implementation that allows attributes to be stored per method in a
 * {@link Map}.
 *
 * @author Rod Johnson
...
public class MethodMapTransactionAttributeSource
    ...
    /**
     * Set a name/attribute map, consisting of "FQCN.method" method names (e.g. "com.mycompany.mycode.MyClass.myMethod")
     * and {@link TransactionAttribute} instances (or Strings to be converted to {@code TransactionAttribute}
     * instances).
     * <p>
     ...
     * 
     * @param methodMap
     *            a Map from method names to {@code TransactionAttribute} instances
     * @see #setMethodMap
     */
    ...
    /**
     * Add an attribute for a transactional method. Method names can end or start with "*" for matching multiple
     * methods.
     * 
     * @param clazz
