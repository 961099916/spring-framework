...
/**
 * Common representation of the current state of a transaction. Serves as base interface for {@link TransactionStatus}
 * as well as {@link ReactiveTransaction}.
 *
...
public interface TransactionExecution {
    ...
    /**
     * Return whether the present transaction is new; otherwise participating in an existing transaction, or potentially
