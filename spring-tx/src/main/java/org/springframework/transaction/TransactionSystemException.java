...
public class TransactionSystemException extends TransactionException {
    ...
    /**
     * Set an application exception that was thrown before this transaction exception, preserving the original exception
     * despite the overriding TransactionSystemException.
     * 
     * @param ex
    ...
    /**
     * Return the exception that was the first to be thrown within the failed transaction: i.e. the application
     * exception, if any, or the TransactionSystemException's own cause.
     * 
