...
public interface ConnectionCallback<T> {
    ...
    /**
     * Gets called by {@code CciTemplate.execute} with an active CCI Connection. Does not need to care about activating
     * or closing the Connection, or handling transactions.
     * <p>
