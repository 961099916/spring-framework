 ...
 *
 * <p>
 * Concrete subclasses must implement the abstract {@code createInputRecord(RecordFactory, Object)} and
 * {@code extractOutputData(Record)} methods, to create an input Record from an object and to convert an output Record
 * into an object, respectively.
 *
...
public abstract class MappingRecordOperation extends EisOperation {
     ...
     * passed-in output Record. This RecordCreator will then be invoked to create a default output Record instance.
     * 
     ...
     * 
     * @param inputObject
     *            the input data, to be converted to a Record by the {@code createInputRecord} method
    ...
    /**
     * Subclasses must implement this method to generate an input Record from an input object passed into the
     * {@code execute} method.
     * 
     * @param inputObject
    ...
    /**
     * Subclasses must implement this method to convert the Record returned by CCI execution into a result object for
    ...
    /**
     * Implementation of RecordCreator that calls the enclosing class's {@code createInputRecord} method.
     */
    ...
    /**
     * Implementation of RecordExtractor that calls the enclosing class's {@code extractOutputData} method.
     */
