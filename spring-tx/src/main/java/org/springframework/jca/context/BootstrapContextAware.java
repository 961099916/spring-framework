...
/**
 * Interface to be implemented by any object that wishes to be notified of the BootstrapContext (typically determined by
 * the {@link ResourceAdapterApplicationContext}) that it runs in.
 *
...
public interface BootstrapContextAware extends Aware {
     ...
     *            the BootstrapContext object to be used by this object
