...
/**
 * {@link org.springframework.context.ApplicationContext} implementation for a JCA ResourceAdapter. Needs to be
 * initialized with the JCA {@link javax.resource.spi.BootstrapContext}, passing it on to Spring-managed beans that
...
public class ResourceAdapterApplicationContext extends GenericApplicationContext {
     ...
     *            the JCA BootstrapContext that the ResourceAdapter has been started with
     */
