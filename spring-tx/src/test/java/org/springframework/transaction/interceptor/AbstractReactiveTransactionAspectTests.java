...
public abstract class AbstractReactiveTransactionAspectTests {
    ...
    /**
     * Check that the when exception thrown by the target can produce the desired behavior with the appropriate
    ...
    /**
     * Subclasses must implement this to create an advised object based on the when target. In the case of AspectJ, the
