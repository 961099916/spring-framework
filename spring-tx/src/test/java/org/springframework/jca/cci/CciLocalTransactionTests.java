...
public class CciLocalTransactionTests {
    ...
    /**
     * Test if a transaction ( begin / commit ) is executed on the LocalTransaction when CciLocalTransactionManager is
     * specified as transaction manager.
     */
    @Test
    ...
    /**
     * Test if a transaction ( begin / rollback ) is executed on the LocalTransaction when CciLocalTransactionManager is
     * specified as transaction manager and a non-checked exception is thrown.
     */
    @Test
