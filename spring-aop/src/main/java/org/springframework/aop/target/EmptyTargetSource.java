...
/**
 * Canonical {@code TargetSource} when there is no target (or just the target class known), and behavior is supplied by
 * interfaces and advisors only.
 *
 * @author Rod Johnson
...
public final class EmptyTargetSource implements TargetSource, Serializable {
     ...
     * <p>
     * This constructor is {@code private} to enforce the Singleton pattern / factory method pattern.
     *
     * @param targetClass
    ...
    /**
     * Returns the canonical instance on deserialization in case of no target class, thus protecting the Singleton
     * pattern.
     */
