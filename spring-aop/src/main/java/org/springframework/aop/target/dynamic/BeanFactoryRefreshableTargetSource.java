 ...
 *
 * <p>
 * Can be subclassed to override {@code requiresRefresh()} to suppress unnecessary refreshes. By default, a refresh will
 * be performed every time the "refreshCheckDelay" has elapsed.
 *
 * @author Rob Harrop
 * @author Rod Johnson
...
public class BeanFactoryRefreshableTargetSource extends AbstractRefreshableTargetSource {
    ...
    /**
     * A template method that subclasses may override to provide a fresh target object for the given bean factory and
     * bean name.
     * <p>
