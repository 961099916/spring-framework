...
/**
 * {@link org.springframework.aop.TargetSource} implementation that caches a local target object, but allows the target
 * to be swapped while the application is running.
 *
 * <p>
