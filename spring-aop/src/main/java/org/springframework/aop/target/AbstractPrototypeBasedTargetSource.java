...
/**
 * Base class for dynamic {@link org.springframework.aop.TargetSource} implementations that create new prototype bean
 * instances to support a pooling or new-instance-per-invocation strategy.
 *
 * <p>
 * Such TargetSources must run in a {@link BeanFactory}, as it needs to call the {@code getBean} method to create a new
 * prototype instance. Therefore, this base class extends {@link AbstractBeanFactoryBasedTargetSource}.
 *
 * @author Rod Johnson
...
public abstract class AbstractPrototypeBasedTargetSource extends AbstractBeanFactoryBasedTargetSource {
    ...
    public void setBeanFactory(BeanFactory beanFactory) throws BeansException {
        ...
        if (!beanFactory.isPrototype(getTargetBeanName())) {
            throw new BeanDefinitionStoreException(
                "Cannot use prototype-based TargetSource against non-prototype bean with name '" + getTargetBeanName()
    ...
    /**
     * Replaces this object with a SingletonTargetSource on serialization. Protected as otherwise it won't be invoked
     * for subclasses. (The {@code writeReplace()} method must be visible to the class being serialized.)
     * <p>
     * With this implementation of this method, there is no need to mark non-serializable fields in this class or
