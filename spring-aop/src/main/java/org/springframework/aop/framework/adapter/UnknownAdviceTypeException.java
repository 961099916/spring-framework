...
public class UnknownAdviceTypeException extends IllegalArgumentException {
    ...
    /**
     * Create a new UnknownAdviceTypeException for the given advice object. Will create a message text that says that
     * the object is neither a subinterface of Advice nor an Advisor.
     * 
     * @param advice
