 ...
 *
 * <p>
 * Subclasses may override the {@link #findCandidateAdvisors()} method to return a custom list of Advisors applying to
 * any object. Subclasses can also override the inherited {@link #shouldSkip} method to exclude certain objects from
 * auto-proxying.
 *
 * <p>
 * Advisors or advices requiring ordering should be annotated with
 * {@link org.springframework.core.annotation.Order @Order} or implement the {@link org.springframework.core.Ordered}
 * interface. This class sorts advisors using the {@link AnnotationAwareOrderComparator}. Advisors that are not
 * annotated with {@code @Order} or don't implement the {@code Ordered} interface will be considered as unordered; they
 * will appear at the end of the advisor chain in an undefined order.
 *
 * @author Rod Johnson
...
public abstract class AbstractAdvisorAutoProxyCreator extends AbstractAutoProxyCreator {
    ...
    /**
     * Extension hook that subclasses can override to register additional Advisors, given the sorted Advisors obtained
     * to date.
     * <p>
    ...
    /**
     * Subclass of BeanFactoryAdvisorRetrievalHelper that delegates to surrounding AbstractAdvisorAutoProxyCreator
     * facilities.
     */
