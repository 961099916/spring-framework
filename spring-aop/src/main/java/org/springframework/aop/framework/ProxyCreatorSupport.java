...
public class ProxyCreatorSupport extends AdvisedSupport {
    ...
    /**
     * Customize the AopProxyFactory, allowing different strategies to be dropped in without changing the core
     * framework.
     * <p>
    ...
    /**
     * Subclasses should call this to get a new AOP proxy. They should <b>not</b> create an AOP proxy with {@code this}
     * as an argument.
     */
