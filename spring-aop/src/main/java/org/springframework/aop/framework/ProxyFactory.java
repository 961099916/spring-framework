...
/**
 * Factory for AOP proxies for programmatic use, rather than via declarative setup in a bean factory. This class
 * provides a simple way of obtaining and configuring AOP proxy instances in custom user code.
 *
 * @author Rod Johnson
...
public class ProxyFactory extends ProxyCreatorSupport {
     ...
     * <p>
     * Convenience method for creating a proxy for a single interceptor, assuming that the interceptor handles all calls
     * itself rather than delegating to a target, like in the case of remoting proxies.
     * 
