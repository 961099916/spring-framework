 ...
 *
 * <p>
 * Manages pre- and post-interceptors (references, rather than interceptor names, as in {@link ProxyFactoryBean}) and
 * provides consistent interface management.
 *
...
public abstract class AbstractSingletonProxyFactoryBean extends ProxyConfig
     ...
     * <p>
     * If not specified (the default), the AOP infrastructure works out which interfaces need proxying by analyzing the
     * target, proxying all the interfaces that the target object implements.
     */
    ...
    /**
     * Set additional interceptors (or advisors) to be applied before the implicit transaction interceptor, e.g. a
     ...
     * 
     * @param target
     *            the target. If this is an implementation of TargetSource it is used as our TargetSource; otherwise it
     *            is wrapped in a SingletonTargetSource.
    ...
    /**
     * A hook for subclasses to post-process the {@link ProxyFactory} before creating the proxy instance with it.
     * 
     * @param proxyFactory
    ...
    /**
     * Create the "main" interceptor for this proxy factory bean. Typically an Advisor, but can also be any type of
     * Advice.
     * <p>
