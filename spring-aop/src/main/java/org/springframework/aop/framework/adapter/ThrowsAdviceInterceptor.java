 ...
 *
 * <p>
 * The signatures on handler methods on the {@code ThrowsAdvice} implementation method argument must be of the form:<br>
 *
...
public class ThrowsAdviceInterceptor implements MethodInterceptor, AfterAdvice {
     ...
     * 
     * @param throwsAdvice
     *            the advice object that defines the exception handler methods (usually a
