 ...
 *
 * <p>
 * In general, specify {@code proxyTargetClass} to enforce a CGLIB proxy, or specify one or more interfaces to use a JDK
 * dynamic proxy.
 *
 * @author Rod Johnson
...
public class DefaultAopProxyFactory implements AopProxyFactory, Serializable {
     ...
     * interface specified (or no proxy interfaces specified at all).
     */
