...
public abstract class ScopedProxyUtils {
    ...
    /**
     * Generate a scoped proxy for the supplied target bean, registering the target bean with an internal name and
     * setting 'targetBeanName' on the scoped proxy.
     * 
     * @param definition
     ...
     *             if the supplied bean name does not refer to the target of a scoped proxy
     * @since 5.1.10
     * @see #getTargetBeanName(String)
    ...
    /**
     * Determine if the {@code beanName} is the name of a bean that references the target bean within a scoped proxy.
     * 
     * @since 4.1.4
     */
