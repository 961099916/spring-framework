 ...
 * BeanDefinitionDecorators} wishing to add an {@link org.aopalliance.intercept.MethodInterceptor interceptor} to the
 * resulting bean.
 *
 * <p>
 * This base class controls the creation of the {@link ProxyFactoryBean} bean definition and wraps the original as an
 * inner-bean definition for the {@code target} property of {@link ProxyFactoryBean}.
 *
 * <p>
 * Chaining is correctly handled, ensuring that only one {@link ProxyFactoryBean} definition is created. If a previous
 * {@link org.springframework.beans.factory.xml.BeanDefinitionDecorator} already created the
 * {@link org.springframework.aop.framework.ProxyFactoryBean} then the interceptor is simply added to the existing
 * definition.
 *
 * <p>
...
public abstract class AbstractInterceptorDrivenBeanDefinitionDecorator implements BeanDefinitionDecorator {
    ...
    /**
     * Subclasses should implement this method to return the {@code BeanDefinition} for the interceptor they wish to
     * apply to the bean being decorated.
     */
