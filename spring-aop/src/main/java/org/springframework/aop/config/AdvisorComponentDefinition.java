...
/**
 * {@link org.springframework.beans.factory.parsing.ComponentDefinition} that bridges the gap between the advisor bean
 * definition configured by the {@code <aop:advisor>} tag and the component definition infrastructure.
 *
 * @author Rob Harrop
