 ...
 * {@code <context:spring-configured/>} tag, mirrored here for compatibility with Spring 2.0's
 * {@code <aop:spring-configured/>} tag (avoiding a direct dependency on the context package).
 *
 * @author Rob Harrop
