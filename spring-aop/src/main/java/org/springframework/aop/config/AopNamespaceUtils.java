 ...
 *
 * <p>
 * Only a single auto-proxy creator should be registered and multiple configuration elements may wish to register
 * different concrete implementations. As such this class delegates to {@link AopConfigUtils} which provides a simple
 * escalation protocol. Callers may request a particular auto-proxy creator and know that creator, <i>or a more capable
 * variant thereof</i>, will be registered as a post-processor.
 *
 * @author Rob Harrop
