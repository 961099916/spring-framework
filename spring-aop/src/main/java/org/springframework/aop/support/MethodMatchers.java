 ...
 *
 * <p>
 * A MethodMatcher may be evaluated statically (based on method and target class) or need further evaluation dynamically
...
public abstract class MethodMatchers {
     ...
     * @return a distinct MethodMatcher that matches all methods that either of the given MethodMatchers matches
     */
     ...
     * @param mm2
     *            the second MethodMatcher
     * @return a distinct MethodMatcher that matches all methods that both of the given MethodMatchers match
     */
     ...
     *            {@code true} if the object on whose behalf we are asking is the subject on one or more introductions;
    ...
    /**
     * MethodMatcher implementation for a union of two given MethodMatchers of which at least one is an
    ...
    /**
     * MethodMatcher implementation for a union of two given MethodMatchers, supporting an associated ClassFilter per
     * MethodMatcher.
     */
    @SuppressWarnings("serial")
    ...
    /**
     * MethodMatcher implementation for a union of two given MethodMatchers of which at least one is an
     * IntroductionAwareMethodMatcher, supporting an associated ClassFilter per MethodMatcher.
     * 
     * @since 5.1
     */
    @SuppressWarnings("serial")
    ...
    /**
     * MethodMatcher implementation for an intersection of two given MethodMatchers of which at least one is an
     * IntroductionAwareMethodMatcher.
     * 
     * @since 5.1
     */
