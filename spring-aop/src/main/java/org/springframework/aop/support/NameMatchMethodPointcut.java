...
public class NameMatchMethodPointcut extends StaticMethodMatcherPointcut implements Serializable {
    ...
    /**
     * Set the method names defining methods to match. Matching will be the union of all these; if any match, the
     * pointcut matches.
     */
    ...
    /**
     * Add another eligible method name, in addition to those already named. Like the set methods, this method is for
     * use when configuring proxies, before a proxy is used.
     * <p>
     * <b>NB:</b> This method does not work after the proxy is in use, as advice chains will be cached.
     * 
     * @param name
