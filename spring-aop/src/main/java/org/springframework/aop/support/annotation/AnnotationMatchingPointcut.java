...
/**
 * Simple Pointcut that looks for a specific Java 5 annotation being present on a {@link #forClassAnnotation class} or
...
public class AnnotationMatchingPointcut implements Pointcut {
     ...
     *            whether to also check the superclasses and interfaces as well as meta-annotations for the annotation
     *            type
     ...
     * 
     * @param classAnnotationType
     *            the annotation type to look for at the class level (can be {@code null})
     * @param methodAnnotationType
     *            the annotation type to look for at the method level (can be {@code null})
     */
    ...
    /**
     * {@link ClassFilter} that delegates to {@link AnnotationUtils#isCandidateClass} for filtering classes whose
