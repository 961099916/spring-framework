...
public class ComposablePointcut implements Pointcut, Serializable {
     ...
     * <p>
     * Note that for a Pointcut union, methods will only match if their original ClassFilter (from the originating
     * Pointcut) matches as well. MethodMatchers and ClassFilters from different Pointcuts will never get interleaved
     * with each other.
     * 
     * @param other
