...
public class DefaultIntroductionAdvisor implements IntroductionAdvisor, ClassFilter, Ordered, Serializable {
     ...
     * 
     * @param advice
     *            the Advice to apply (may implement the {@link org.springframework.aop.IntroductionInfo} interface)
     * @see #addInterface
     */
     ...
     *            the IntroductionInfo that describes the interface to introduce (may be {@code null})
     */
