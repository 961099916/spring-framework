 ...
 *
 * <p>
 * Configure this class using the "pattern" and "patterns" pass-through properties. These are analogous to the pattern
 * and patterns properties of {@link AbstractRegexpMethodPointcut}.
 *
 * <p>
 * Can delegate to any {@link AbstractRegexpMethodPointcut} subclass. By default, {@link JdkRegexpMethodPointcut} will
 * be used. To choose a specific one, override the {@link #createPointcut} method.
 *
 * @author Rod Johnson
