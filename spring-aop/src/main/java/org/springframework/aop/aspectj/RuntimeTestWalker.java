...
/**
 * This class encapsulates some AspectJ internal knowledge that should be pushed back into the AspectJ project in a
 * future release.
 *
 * <p>
 * It relies on implementation specific knowledge in AspectJ to break encapsulation and do something AspectJ was not
 * designed to do: query the types of runtime tests that will be performed. The code here should migrate to
...
class RuntimeTestWalker {
    ...
    /**
     * If the test uses any of the this, target, at_this, at_target, and at_annotation vars, then it tests subtype
     * sensitive vars.
     */
