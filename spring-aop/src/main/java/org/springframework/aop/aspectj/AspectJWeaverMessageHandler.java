...
/**
 * Implementation of AspectJ's {@link IMessageHandler} interface that routes AspectJ weaving messages through the same
 * logging system as the regular Spring messages.
 *
 * <p>
 * Pass the option...
 *
