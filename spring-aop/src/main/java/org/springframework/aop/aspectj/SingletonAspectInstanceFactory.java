...
/**
 * Implementation of {@link AspectInstanceFactory} that is backed by a specified singleton object, returning the same
 * instance for every {@link #getAspectInstance()} call.
 *
 * @author Rod Johnson
...
public class SingletonAspectInstanceFactory implements AspectInstanceFactory, Serializable {
     ...
     * implementing the {@link org.springframework.core.Ordered} interface, or a fallback order.
     * 
    ...
    /**
     * Determine a fallback order for the case that the aspect instance does not express an instance-specific order
     * through implementing the {@link org.springframework.core.Ordered} interface.
     * <p>
