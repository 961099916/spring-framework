...
public class AspectJAroundAdvice extends AbstractAspectJAdvice implements MethodInterceptor, Serializable {
    ...
    /**
     * Return the ProceedingJoinPoint for the current invocation, instantiating it lazily if it hasn't been bound to the
     * thread already.
     * 
     * @param rmi
     *            the current Spring AOP ReflectiveMethodInvocation, which we'll use for attribute binding
