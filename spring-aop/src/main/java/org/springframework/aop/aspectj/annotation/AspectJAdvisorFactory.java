...
public interface AspectJAdvisorFactory {
     ...
     * <p>
     * Will simply return {@code false} if the supposed aspect is invalid (such as an extension of a concrete aspect
     * class). Will return true for some aspects that Spring AOP cannot process, such as those with unsupported
     * instantiation models. Use the {@link #validate} method to handle these cases if necessary.
     * 
     * @param clazz
     ...
     *             if the class is an invalid aspect (which can never be legal)
     * @throws NotAnAtAspectException
     ...
     *            the aspect instance factory (not the aspect instance itself in order to avoid eager instantiation)
     ...
     *            the declaration order within the aspect
     * @param aspectName
     *            the name of the aspect
     * @return {@code null} if the method is not an AspectJ advice method or if it is a pointcut that will be used by
     *         other advice but will not create a Spring advice in its own right
     */
    @Nullable
