...
/**
 * AspectJ-based proxy factory, allowing for programmatic building of proxies which include AspectJ aspects (code style
 * as well Java 5 annotation style).
 *
 * @author Rob Harrop
...
public class AspectJProxyFactory extends ProxyCreatorSupport {
    ...
    /**
     * Add the supplied aspect instance to the chain. The type of the aspect instance supplied must be a singleton
     * aspect. True singleton lifecycle is not honoured when using this method - the caller is responsible for managing
     * the lifecycle of any aspects added in this way.
     * 
    ...
    /**
     * Add all {@link Advisor Advisors} from the supplied {@link MetadataAwareAspectInstanceFactory} to the current
     * chain. Exposes any special purpose {@link Advisor Advisors} if needed.
     * 
    ...
    /**
     * Create a {@link MetadataAwareAspectInstanceFactory} for the supplied aspect type. If the aspect type has no per
     * clause, then a {@link SingletonMetadataAwareAspectInstanceFactory} is returned, otherwise a
    ...
    /**
     * Get the singleton aspect instance for the supplied aspect type. An instance is created if one cannot be found in
     * the instance cache.
     */
