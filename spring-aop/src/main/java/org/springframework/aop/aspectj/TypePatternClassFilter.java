...
public class TypePatternClassFilter implements ClassFilter {
     ...
     * <p>
     * This is the JavaBean constructor; be sure to set the {@link #setTypePattern(String) typePattern} property, else a
     * no doubt fatal {@link IllegalStateException} will be thrown when the {@link #matches(Class)} method is first
     * invoked.
     */
    ...
    /**
     * If a type pattern has been specified in XML, the user cannot write {@code and} as "&&" (though &amp;&amp; will
     * work). We also allow {@code and} between two sub-expressions.
     * <p>
