...
/**
 * Introduction advisor delegating to the given object. Implements AspectJ annotation-style behavior for the
...
public class DeclareParentsAdvisor implements IntroductionAdvisor {
    ...
    /**
     * Private constructor to share common code between impl-based delegate and reference-based delegate (cannot use
     * method such as init() to share common code, due the use of final fields).
     * 
     * @param interfaceType
     *            static field defining the introduction
     * @param typePattern
