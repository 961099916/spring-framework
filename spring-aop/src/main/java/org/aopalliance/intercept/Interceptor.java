 ...
 *
 * <p>
 * This interface is not used directly. Use the sub-interfaces to intercept specific events. For instance, the following
 * class implements some specific interceptors in order to implement a debugger:
 *
 * <pre class=code>
