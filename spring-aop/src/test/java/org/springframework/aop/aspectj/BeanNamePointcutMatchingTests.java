...
public class BeanNamePointcutMatchingTests {
    ...
    private void assertMatch(String beanName, String pcExpression) {
        assertThat(matches(beanName, pcExpression))
            .as("Unexpected mismatch for bean \"" + beanName + "\" for pcExpression \"" + pcExpression + "\"").isTrue();
    }

    private void assertMisMatch(String beanName, String pcExpression) {
        assertThat(matches(beanName, pcExpression))
            .as("Unexpected match for bean \"" + beanName + "\" for pcExpression \"" + pcExpression + "\"").isFalse();
    }
