...
public class AopUtilsTests {
    ...
    /**
     * Test that when we serialize and deserialize various canonical instances of AOP classes, they return the same
     * instance, not a new instance that's subverted the singleton construction limitation.
     */
    @Test
