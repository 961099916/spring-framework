...
/**
 * Integration tests for scoped proxy use in conjunction with aop: namespace. Deemed an integration test because .web
 * mocks and application contexts are required.
 *
 * @author Rob Harrop
