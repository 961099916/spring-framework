...
/**
 * NOTE: This class is a replica of the same class in spring-web so it can be used for tests in spring-messaging.
 *
 * <p>
 ...
 *
 * <p>
 * When testing annotated methods we create test classes such as "TestController" with a diverse range of method
 * signatures representing supported annotations and argument types. It becomes challenging to use naming strategies to
 * keep track of methods and arguments especially in combination with variables for reflection metadata.
 *
 * <p>
 * The idea with {@link ResolvableMethod} is NOT to rely on naming techniques but to use hints to zero in on method
 * parameters. Such hints can be strongly typed and explicit about what is being tested.
 *
 * <h2>1. Declared Return Type</h2>
 *
 * When testing return types it's likely to have many methods with a unique return type, possibly with or without an
 * annotation.
 *
 * <pre>
 ...
 *
 * When testing method arguments it's more likely to have one or a small number of methods with a wide array of argument
...
public class ResolvableMethod {
     ...
     *            the expected type
     * @param generics
     *            optional array of generic types
     */
    ...
    /**
     * Filter on method arguments with annotation. See {@link org.springframework.web.method.MvcAnnotationPredicates}.
     */
    @SafeVarargs
    ...
    public static class Builder<T> {
        ...
        /**
         * Filter on annotated methods. See {@link org.springframework.web.method.MvcAnnotationPredicates}.
         */
        @SafeVarargs
            ...
            addFilter(message, method -> {
                if (annotationTypes.length != 0) {
                    return Arrays.stream(annotationTypes)
                        .noneMatch(annotType -> AnnotatedElementUtils.findMergedAnnotation(method, annotType) != null);
                } else {
        ...
        /**
         * Build a {@code ResolvableMethod} from the provided filters which must resolve to a unique, single method.
         * <p>
         * See additional resolveXxx shortcut methods going directly to {@link Method} or return type parameter.
         *
         * @throws IllegalStateException
         *             for no match or multiple matches
         */
