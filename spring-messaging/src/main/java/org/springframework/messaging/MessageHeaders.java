 ...
 *
 * <p>
 * <b>IMPORTANT</b>: This class is immutable. Any mutating operation such as {@code put(..)}, {@code putAll(..)} and
 * others will throw {@link UnsupportedOperationException}.
 * <p>
 * Subclasses do have access to the raw headers, however, via {@link #getRawHeaders()}.
 *
 * <p>
 * One way to create message headers is to use the {@link org.springframework.messaging.support.MessageBuilder
 * MessageBuilder}:
 * 
 * <pre class="code">
 ...
 * </pre>
 *
 * A second option is to create {@link org.springframework.messaging.support.GenericMessage} passing a payload as
 * {@link Object} and headers as a {@link Map java.util.Map}:
 * 
 * <pre class="code">
 ...
 * </pre>
 *
 * A third option is to use {@link org.springframework.messaging.support.MessageHeaderAccessor} or one of its subclasses
 * to create specific categories of headers.
 *
...
public class MessageHeaders implements Map<String, Object>, Serializable {
    ...
    /**
     * The key for the Message ID. This is an automatically generated UUID and should never be explicitly set in the
     * header map <b>except</b> in the case of Message deserialization where the serialized Message's generated UUID is
     * being restored.
     */
    ...
    /**
     * Construct a {@link MessageHeaders} with the given headers. An {@link #ID} and {@link #TIMESTAMP} headers will
     * also be added, overriding any existing values.
     * 
     * @param headers
     ...
     *            a map with headers to add
     * @param id
     *            the {@link #ID} header value
     * @param timestamp
     *            the {@link #TIMESTAMP} header value
     */
    ...
    /**
     * Copy constructor which allows for ignoring certain entries. Used for serialization without non-serializable
     * entries.
     * 
     * @param original
     *            the MessageHeaders to copy
     * @param keysToIgnore
     *            the keys of the entries to ignore
     */
