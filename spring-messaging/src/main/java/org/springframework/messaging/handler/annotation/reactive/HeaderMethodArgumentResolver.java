...
/**
 * Resolver for {@link Header @Header} arguments. Headers are resolved from either the top-level header map or the
 * nested {@link NativeMessageHeaderAccessor native} header map.
 *
