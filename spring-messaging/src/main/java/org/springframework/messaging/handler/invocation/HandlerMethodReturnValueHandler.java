...
/**
 * Strategy interface to handle the value returned from the invocation of a method handling a {@link Message}.
 *
...
public interface HandlerMethodReturnValueHandler {
     ...
     * @param returnType
     *            the type of the return value. This type must have previously been passed to
     *            {@link #supportsReturnType(org.springframework.core.MethodParameter)} and it must have returned
     *            {@code true}.
     * @param message
