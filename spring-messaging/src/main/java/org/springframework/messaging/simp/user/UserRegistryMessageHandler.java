...
/**
 * {@code MessageHandler} that handles user registry broadcasts from other application servers and periodically
 * broadcasts the content of the local user registry.
 *
 * <p>
...
public class UserRegistryMessageHandler implements MessageHandler, ApplicationListener<BrokerAvailabilityEvent> {
     ...
     *            template for broadcasting local registry information
     * @param broadcastDestination
