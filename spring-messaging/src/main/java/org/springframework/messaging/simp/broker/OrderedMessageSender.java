...
/**
 * Submit messages to an {@link ExecutorSubscribableChannel}, one at a time. The channel must have been configured with
 * {@link #configureOutboundChannel}.
 *
...
class OrderedMessageSender implements MessageChannel {
    ...
    /**
     * Install or remove an {@link ExecutorChannelInterceptor} that invokes a completion task once the message is
     * handled.
     *
     * @param channel
     *            the channel to configure
     * @param preservePublishOrder
     *            whether preserve order is on or off based on which an interceptor is either added or removed.
     */
