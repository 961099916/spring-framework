 ...
 *
 * <p>
 * As of 4.2, this class supports a {@link #setSelectorHeaderName selector} header on subscription messages with Spring
 * EL expressions evaluated against the headers to filter out messages in addition to destination matching.
 *
    ...
    private static class SessionSubscriptionInfo {
        ...
        public Subscription getSubscription(String subscriptionId) {
            for (Map.Entry<String,
                Set<DefaultSubscriptionRegistry.Subscription>> destinationEntry : this.destinationLookup.entrySet()) {
