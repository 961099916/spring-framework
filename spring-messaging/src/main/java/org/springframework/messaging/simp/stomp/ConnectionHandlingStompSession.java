...
/**
 * A {@link StompSession} that implements {@link org.springframework.messaging.tcp.TcpConnectionHandler
 * TcpConnectionHandler} in order to send and receive messages.
 *
 * <p>
 * A ConnectionHandlingStompSession can be used with any TCP or WebSocket library that is adapted to the
 * {@code TcpConnectionHandler} contract.
 *
