...
/**
 * A {@link HandlerMethodReturnValueHandler} for sending to destinations specified in a {@link SendTo} or
 * {@link SendToUser} method-level annotations.
 *
 * <p>
 * The value returned from the method is converted, and turned to a {@link Message} and sent through the provided
 * {@link MessageChannel}. The message is then enriched with the session id of the input message as well as the
 * destination from the annotation(s). If multiple destinations are specified, a copy of the message is sent to each
 * destination.
 *
...
public class SendToMethodReturnValueHandler implements HandlerMethodReturnValueHandler {
     ...
     * {@link SendTo @SendTo} or does not specify any destinations through the annotation's value attribute.
     * <p>
     ...
     * {@link SendToUser @SendToUser} but does not specify any destinations through the annotation's value attribute.
     * <p>
