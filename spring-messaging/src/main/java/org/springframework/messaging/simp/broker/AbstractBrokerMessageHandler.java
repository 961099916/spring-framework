...
public abstract class AbstractBrokerMessageHandler
     ...
     *
     * @param preservePublishOrder
     *            whether to publish in order
     * @since 5.1
     */
     ...
     * alternate between being on and off depending on the concrete sub-class implementation.
     */
    @Override
     ...
     * <p>
     * Note that this is in addition to the {@link #isRunning()} flag, which indicates whether this message handler is
     * running. In other words the message handler must first be running and then the {@code #isBrokerAvailable()} flag
     * may still independently alternate between being on and off depending on the concrete sub-class implementation.
     * <p>
     * Application components may implement
     * {@code org.springframework.context.ApplicationListener&lt;BrokerAvailabilityEvent&gt;} to receive notifications
     * when broker becomes available and unavailable.
     */
     ...
     * {@code preservePublishOrder=true}.
     * 
     * @since 5.1
     */
