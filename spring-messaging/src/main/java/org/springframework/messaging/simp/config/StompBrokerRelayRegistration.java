...
public class StompBrokerRelayRegistration extends AbstractBrokerRegistration {
    ...
    /**
     * Set the interval, in milliseconds, at which the "system" relay session will, in the absence of any other data
     * being sent, send a heartbeat to the STOMP broker. A value of zero will prevent heartbeats from being sent to the
     * broker.
     * <p>
    ...
    /**
     * Set the maximum interval, in milliseconds, at which the "system" relay session expects, in the absence of any
     * other data, to receive a heartbeat from the STOMP broker. A value of zero will configure the relay session to
     * expect not to receive heartbeats from the broker.
     * <p>
     * The default value is 10000.
     */
    ...
    /**
     * Configure whether the {@link StompBrokerRelayMessageHandler} should start automatically when the Spring
    ...
    /**
     * Set a destination to broadcast messages to user destinations that remain unresolved because the user appears not
     * to be connected. In a multi-application server scenario this gives other application servers a chance to try.
     * <p>
    ...
    /**
     * Set a destination to broadcast the content of the local user registry to and to listen for such broadcasts from
     * other servers. In a multi-application server scenarios this allows each server's user registry to be aware of
