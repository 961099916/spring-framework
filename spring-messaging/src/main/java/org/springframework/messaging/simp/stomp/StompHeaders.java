...
public class StompHeaders implements MultiValueMap<String, String>, Serializable {
    ...
    /**
     * Whether heartbeats are enabled. Returns {@code false} if {@link #setHeartbeat} is set to "0,0", and {@code true}
     * otherwise.
     */
    ...
    /**
     * Set the ack header to one of "auto", "client", or "client-individual". Applies to the SUBSCRIBE and MESSAGE
     * frames.
     */
