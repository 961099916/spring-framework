...
public interface StompFrameHandler {
    ...
    /**
     * Invoked before {@link #handleFrame(StompHeaders, Object)} to determine the type of Object the payload should be
     * converted to.
     * 
     * @param headers
     ...
     * @param payload
     *            the payload, or {@code null} if there was no payload
     */
