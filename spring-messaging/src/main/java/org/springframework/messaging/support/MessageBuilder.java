...
/**
 * A builder for creating a {@link GenericMessage} (or {@link ErrorMessage} if the payload is of type
 * {@link Throwable}).
 *
...
public final class MessageBuilder<T> {
     ...
     * <p>
     * If the provided message is an {@link ErrorMessage}, the {@link ErrorMessage#getOriginalMessage() originalMessage}
     * it contains, will be passed on to new instance.
     *
     * @param message
    ...
    /**
     * A shortcut factory method for creating a message with the given payload and {@code MessageHeaders}.
     * <p>
     * <strong>Note:</strong> the given {@code MessageHeaders} instance is used directly in the new message, i.e. it is
     * not copied.
     *
     * @param payload
     *            the payload to use (never {@code null})
     * @param messageHeaders
     *            the headers to use (never {@code null})
    ...
    /**
     * Removes all headers provided via array of 'headerPatterns'. As the name suggests the array may contain simple
     * matching patterns for header names. Supported pattern styles are: "xxx*", "*xxx", "*xxx*" and "xxx*yyy".
     */
