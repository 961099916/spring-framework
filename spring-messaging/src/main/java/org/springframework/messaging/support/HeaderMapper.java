...
/**
 * Generic strategy interface for mapping {@link MessageHeaders} to and from other types of objects. This would
 * typically be used by adapters where the "other type" has a concept of headers or properties (HTTP, JMS, AMQP, etc).
 *
 * @author Mark Fisher
 * @since 4.1
 * @param <T>
