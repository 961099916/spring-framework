...
/**
 * A {@link org.springframework.messaging.support.MessageHeaderInitializer MessageHeaderInitializer} to customize the
 * strategy for ID and TIMESTAMP message header generation.
 *
...
public class IdTimestampMessageHeaderInitializer implements MessageHeaderInitializer {
     ...
     * <p>
     * By default this property is set to {@code null} in which case the default IdGenerator of
    ...
    /**
     * A shortcut for calling {@link #setIdGenerator} with an id generation strategy to disable id generation
     * completely.
     */
    ...
    /**
     * Whether to enable the automatic addition of the {@link org.springframework.messaging.MessageHeaders#TIMESTAMP}
     * header on {@code MessageHeaderAccessor} instances being initialized.
     * <p>
