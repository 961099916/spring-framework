 ...
 * @since 4.0
 * @param <P>
 *            the type of payload for outbound {@link Message Messages}
 */
public interface TcpConnection<P> extends Closeable {
     ...
     * @param message
     *            the message
     * @return a ListenableFuture that can be used to determine when and if the message was successfully sent
     */
