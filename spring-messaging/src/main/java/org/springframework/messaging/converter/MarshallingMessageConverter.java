...
/**
 * Implementation of {@link MessageConverter} that can read and write XML using Spring's {@link Marshaller} and
 ...
 * the {@linkplain #MarshallingMessageConverter(Marshaller) constructor} or {@linkplain #setMarshaller(Marshaller) bean
 * properties}.
 *
...
public class MarshallingMessageConverter extends AbstractMessageConverter {
    ...
    /**
     * Default construct allowing for {@link #setMarshaller(Marshaller)} and/or {@link #setUnmarshaller(Unmarshaller)}
    ...
    /**
     * Constructor with {@link Marshaller}. If the given {@link Marshaller} also implements {@link Unmarshaller}, it is
     * also used for unmarshalling.
     * <p>
     * Note that all {@code Marshaller} implementations in Spring also implement {@code Unmarshaller} so that you can
     * safely use this constructor.
     * 
     * @param marshaller
