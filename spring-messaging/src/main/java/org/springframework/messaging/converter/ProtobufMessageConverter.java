...
/**
 * An {@code MessageConverter} that reads and writes {@link com.google.protobuf.Message com.google.protobuf.Messages}
 ...
 *
 * <p>
 * {@code "application/json"} can be supported with the official {@code "com.google.protobuf:protobuf-java-util"} 3.x,
