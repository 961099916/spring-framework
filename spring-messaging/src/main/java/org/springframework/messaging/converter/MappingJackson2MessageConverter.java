...
public class MappingJackson2MessageConverter extends AbstractMessageConverter {
    ...
    /**
     * Construct a {@code MappingJackson2MessageConverter} supporting the {@code application/json} MIME type with
    ...
    /**
     * Set the {@code ObjectMapper} for this converter. If not set, a default {@link ObjectMapper#ObjectMapper()
     ...
     * 
     * @param contentType
     *            the MIME type from the MessageHeaders, if any
