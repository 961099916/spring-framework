...
/**
 * Resolves arguments of type {@link RSocket} that can be used for making requests to the remote peer.
 *
...
public class RSocketRequesterMethodArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    /**
     * Message header name that is expected to have the {@link RSocket} to initiate new interactions to the remote peer
     * with.
     */
