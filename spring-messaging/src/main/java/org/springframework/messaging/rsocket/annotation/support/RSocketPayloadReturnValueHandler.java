...
/**
 * Extension of {@link AbstractEncoderMethodReturnValueHandler} that {@link #handleEncodedContent handles} encoded
 * content by wrapping data buffers as RSocket payloads and by passing those to the {@link MonoProcessor} from the
...
public class RSocketPayloadReturnValueHandler extends AbstractEncoderMethodReturnValueHandler {
    ...
    /**
     * Message header name that is expected to have a {@link MonoProcessor} which will receive the {@code Flux<Payload>}
