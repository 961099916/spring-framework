...
/**
 * Default {@link MetadataExtractor} implementation that relies on {@link Decoder}s to deserialize the content of
 * metadata entries.
 * <p>
 * By default only {@code "message/x.rsocket.routing.v0""} is extracted and saved under
 * {@link MetadataExtractor#ROUTE_KEY}. Use {@code metadataToExtract} methods to specify other metadata mime types of
 * interest to extract.
 *
