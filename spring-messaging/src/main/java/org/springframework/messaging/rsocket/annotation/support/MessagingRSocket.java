...
/**
 * Responder {@link RSocket} that wraps the payload and metadata of incoming requests as a {@link Message} and then
 * delegates to the configured {@link RSocketMessageHandler} to handle it. The response, if applicable, is obtained from
 * the {@link RSocketPayloadReturnValueHandler#RESPONSE_HEADER "rsocketResponse"} header.
 *
