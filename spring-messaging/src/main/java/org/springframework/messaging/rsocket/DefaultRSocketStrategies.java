...
final class DefaultRSocketStrategies implements RSocketStrategies {
    ...
    private DefaultRSocketStrategies(List<Encoder<?>> encoders, List<Decoder<?>> decoders, RouteMatcher routeMatcher,
        ReactiveAdapterRegistry adapterRegistry, DataBufferFactory bufferFactory, MetadataExtractor metadataExtractor) {
    ...
    static class DefaultRSocketStrategiesBuilder implements RSocketStrategies.Builder {
        ...
        public RSocketStrategies build() {
            ...
            MetadataExtractor extractor =
                (this.metadataExtractor != null ? this.metadataExtractor : new DefaultMetadataExtractor(this.decoders));
