...
/**
 * Extends {@link MessageRequestReplyOperations} and adds operations for sending and receiving messages to and from a
...
public interface DestinationResolvingMessageRequestReplyOperations<D> extends MessageRequestReplyOperations<D> {
     ...
     * {@link org.springframework.messaging.converter.MessageConverter}, wrap it as a message and send it to the
     * resolved destination, receive a reply and convert its body to the specified target class.
     * 
     * @param destinationName
     *            the name of the target destination
     * @param request
     *            the payload for the request message to send
     * @param targetClass
     ...
     * send it to the resolved destination, receive a reply and convert its body to the specified target class.
     * 
     * @param destinationName
     *            the name of the target destination
     * @param request
     ...
     * process, and send the resulting message to the resolved destination, then receive a reply and convert its body to
     ...
     * apply the given post process, and send the resulting message to the resolved destination, then receive a reply
