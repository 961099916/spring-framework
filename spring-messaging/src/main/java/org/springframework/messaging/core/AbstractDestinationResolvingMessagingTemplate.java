...
/**
 * An extension of {@link AbstractMessagingTemplate} that adds operations for sending messages to a resolvable
 * destination name. Supports destination resolving as defined by the following interfaces:
 * <ul>
...
public abstract class AbstractDestinationResolvingMessagingTemplate<D> extends AbstractMessagingTemplate<D>
     ...
     * type {@code <D>}.
     * <p>
     * This field does not have a default setting. If not configured, methods that require resolving a destination name
