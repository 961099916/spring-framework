...
public interface MessageSendingOperations<D> {
     ...
     * {@link org.springframework.messaging.converter.MessageConverter}, wrap it as a message and send it to a default
     * destination.
     * 
     * @param payload
     ...
     * processor, and send the resulting message to a default destination.
     * 
     * @param payload
     *            the Object to use as payload
     * @param postProcessor
