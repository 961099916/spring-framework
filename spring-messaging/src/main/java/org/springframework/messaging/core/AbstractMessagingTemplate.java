...
/**
 * An extension of {@link AbstractMessageReceivingTemplate} that adds support for request-reply style operations as
 * defined by {@link MessageRequestReplyOperations}.
 *
 * @author Mark Fisher
