...
class WebSocketConfigurationTests extends AbstractWebSocketIntegrationTests {
    ...
    void registerWebSocketHandler(WebSocketTestServer server, WebSocketClient webSocketClient, TestInfo testInfo)
        ...
        WebSocketSession session =
            this.webSocketClient.doHandshake(new AbstractWebSocketHandler() {}, getWsBaseUrl() + "/ws").get();
    ...
    void registerWebSocketHandlerWithSockJS(WebSocketTestServer server, WebSocketClient webSocketClient,
        ...
        WebSocketSession session = this.webSocketClient
            .doHandshake(new AbstractWebSocketHandler() {}, getWsBaseUrl() + "/sockjs/websocket").get();
