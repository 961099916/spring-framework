...
/**
 * A basic implementation of {@link org.springframework.web.socket.sockjs.SockJsService} with support for SPI-based
 * transport handling and session management.
 *
 * <p>
 * Based on the {@link TransportHandler} SPI. {@code TransportHandlers} may additionally implement the
 * {@link SockJsSessionFactory} and {@link HandshakeHandler} interfaces.
 *
 * <p>
...
public class TransportHandlingSockJsService extends AbstractSockJsService implements SockJsServiceConfig, Lifecycle {
     ...
     *            application stops
     * @param handlers
     *            one or more {@link TransportHandler} implementations to use
     */
