...
/**
 * Wraps another {@link org.springframework.web.socket.WebSocketSession} instance and delegates to it.
 *
 * <p>
 * Also provides a {@link #getDelegate()} method to return the decorated session as well as a {@link #getLastSession()}
 * method to go through all nested delegates and return the "last" session.
 *
