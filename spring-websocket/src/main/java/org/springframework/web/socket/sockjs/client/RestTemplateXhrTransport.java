...
/**
 * An {@code XhrTransport} implementation that uses a {@link org.springframework.web.client.RestTemplate RestTemplate}.
 *
...
public class RestTemplateXhrTransport extends AbstractXhrTransport {
     ...
     * <p>
     * By default {@link org.springframework.core.task.SimpleAsyncTaskExecutor SimpleAsyncTaskExecutor} is configured
     * which creates a new thread every time the transports connects.
     */
    ...
    /**
     * Splits the body of an HTTP response into SockJS frames and delegates those to an {@link XhrClientSockJsSession}.
     */
