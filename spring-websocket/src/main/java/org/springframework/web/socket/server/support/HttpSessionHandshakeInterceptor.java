...
/**
 * An interceptor to copy information from the HTTP session to the "handshake attributes" map to made available
...
public class HttpSessionHandshakeInterceptor implements HandshakeInterceptor {
    ...
    /**
     * The name of the attribute under which the HTTP session id is exposed when {@link #setCopyHttpSessionId(boolean)
    ...
    /**
     * Whether to copy all attributes from the HTTP session. If set to "true", any explicitly configured attribute names
     * are ignored.
     * <p>
     * By default this is set to either "true" or "false" depending on which constructor was used (default or with
     * attribute names respectively).
     *
     * @param copyAllAttributes
