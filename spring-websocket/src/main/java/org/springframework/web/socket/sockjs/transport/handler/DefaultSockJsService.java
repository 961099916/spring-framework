...
/**
 * A default implementation of {@link org.springframework.web.socket.sockjs.SockJsService} with all default
 * {@link TransportHandler} implementations pre-registered.
 *
...
public class DefaultSockJsService extends TransportHandlingSockJsService implements ServletContextAware {
     ...
     * 
     * @param scheduler
     *            a task scheduler for heart-beat messages and removing timed-out sessions; the provided TaskScheduler
     *            should be declared as a Spring bean to ensure it is initialized at start up and shut down when the
     *            application stops.
     */
    ...
    /**
     * Create a DefaultSockJsService with overridden {@link TransportHandler handler} types replacing the corresponding
     * default handler implementation.
     * 
     * @param scheduler
     *            a task scheduler for heart-beat messages and removing timed-out sessions; the provided TaskScheduler
     *            should be declared as a Spring bean to ensure it gets initialized at start-up and shuts down when the
     *            application stops
     * @param handlerOverrides
