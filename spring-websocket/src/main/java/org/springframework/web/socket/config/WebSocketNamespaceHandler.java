...
/**
 * {@link org.springframework.beans.factory.xml.NamespaceHandler} for Spring WebSocket configuration namespace.
 *
 * @author Brian Clozel
 * @since 4.0
 */
public class WebSocketNamespaceHandler extends NamespaceHandlerSupport {
    ...
    private static boolean isSpringMessagingPresent =
        ClassUtils.isPresent("org.springframework.messaging.Message", WebSocketNamespaceHandler.class.getClassLoader());
