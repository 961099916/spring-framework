 ...
 * {@link org.springframework.web.socket.config.annotation.EnableWebSocket} and {@link WebSocketConfigurer} setup.
 *
...
public class SockJsServiceRegistration {
     ...
     * <p>
     * By default this is set to point to "https://cdn.jsdelivr.net/sockjs/0.3.4/sockjs.min.js". However it can also be
     ...
     * be send over a single HTTP streaming request before it will be closed. After that client will open a new request.
    ...
    /**
     * The SockJS protocol requires a server to respond to the initial "/info" request from clients with a
    ...
    /**
     * Some load balancers don't support WebSocket. This option can be used to disable the WebSocket transport on the
     * server side.
     * <p>
     ...
     * <p>
     * By default {@code Jackson2SockJsMessageCodec} is used requiring the Jackson library to be present on the
     * classpath.
     *
     * @param codec
     *            the codec to use.
