...
/**
 * Indicates a serious failure that occurred in the SockJS implementation as opposed to in user code (e.g. IOException
 * while writing to the response). When this exception is raised, the SockJS session is typically closed.
 *
