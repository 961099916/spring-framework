...
public class ServletWebSocketHandlerRegistry implements WebSocketHandlerRegistry {
    ...
    /**
     * Set the order for the resulting {@link SimpleUrlHandlerMapping} relative to other handler mappings configured in
     * Spring MVC.
     * <p>
    ...
    /**
     * Whether there are any endpoint SockJS registrations without a TaskScheduler. This method should be invoked just
     * before {@link #getHandlerMapping()} to allow for registrations to be made first.
     */
    ...
    /**
     * Provide the TaskScheduler to use for SockJS endpoints for which a task scheduler has not been explicitly
     * registered. This method must be called prior to {@link #getHandlerMapping()}.
     */
