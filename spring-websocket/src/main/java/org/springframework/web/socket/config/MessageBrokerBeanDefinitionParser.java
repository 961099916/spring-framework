...
/**
 * A {@link org.springframework.beans.factory.xml.BeanDefinitionParser} that provides the configuration for the
 * {@code <websocket:message-broker/>} XML namespace element.
 *
 * <p>
 * Registers a Spring MVC {@link org.springframework.web.servlet.HandlerMapping} with order 1 to map HTTP WebSocket
 * handshake requests from STOMP/WebSocket clients.
 *
 * <p>
