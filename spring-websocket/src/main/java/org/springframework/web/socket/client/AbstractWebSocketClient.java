...
public abstract class AbstractWebSocketClient implements WebSocketClient {
     ...
     *            the client-side handler for WebSocket messages
     * @param headers
     *            the HTTP headers to use for the handshake, with unwanted (forbidden) headers filtered out (never
     *            {@code null})
     * @param uri
     *            the target URI for the handshake (never {@code null})
     * @param subProtocols
     *            requested sub-protocols, or an empty list
     * @param extensions
     *            requested WebSocket extensions, or an empty list
     * @param attributes
     *            the attributes to associate with the WebSocketSession, i.e. via
