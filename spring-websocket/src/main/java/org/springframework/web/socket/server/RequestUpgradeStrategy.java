...
public interface RequestUpgradeStrategy {
    ...
    /**
     * Perform runtime specific steps to complete the upgrade. Invoked after successful negotiation of the handshake
     * request.
     * 
     * @param request
     *            the current request
     ...
     *            the selected WebSocket protocol extensions
     * @param user
     *            the user to associate with the WebSocket session
     * @param wsHandler
     *            the handler for WebSocket messages
     * @param attributes
     *            handshake request specific attributes to be set on the WebSocket session via
     *            {@link org.springframework.web.socket.server.HandshakeInterceptor} and thus made available to the
     ...
     *             server error as opposed to a failure to successfully negotiate the requirements of the handshake
     *             request.
     */
