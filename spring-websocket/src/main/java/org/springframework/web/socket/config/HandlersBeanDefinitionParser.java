...
/**
 * Parses the configuration for the {@code <websocket:handlers/>} namespace element. Registers a Spring MVC
 * {@code SimpleUrlHandlerMapping} to map HTTP WebSocket handshake (or SockJS) requests to
...
class HandlersBeanDefinitionParser implements BeanDefinitionParser {
    ...
    public BeanDefinition parse(Element element, ParserContext context) {
        ...
        RuntimeBeanReference sockJsService =
            WebSocketNamespaceUtils.registerSockJsService(element, SOCK_JS_SCHEDULER_NAME, context, source);
