...
public class StandardWebSocketClient extends AbstractWebSocketClient {
    ...
    /**
     * Default constructor that calls {@code ContainerProvider.getWebSocketContainer()} to obtain a (new)
     * {@link WebSocketContainer} instance. Also see constructor accepting existing {@code WebSocketContainer} instance.
     */
     ...
     * <p>
     * For XML configuration, see {@link WebSocketContainerFactoryBean}. For Java configuration, use
     * {@code ContainerProvider.getWebSocketContainer()} to obtain the {@code WebSocketContainer} instance.
     */
     ...
     * {@link ClientEndpointConfig#getUserProperties() userProperties}. Use this property to configure one or more
     * properties to be passed on every handshake.
     */
    ...
    /**
     * Set an {@link AsyncListenableTaskExecutor} to use when opening connections. If this property is set to
     * {@code null}, calls to any of the {@code doHandshake} methods will block until the connection is established.
     * <p>
    ...
    protected ListenableFuture<WebSocketSession> doHandshakeInternal(WebSocketHandler webSocketHandler,
        ...
        final ClientEndpointConfig endpointConfig =
            ClientEndpointConfig.Builder.create().configurator(new StandardWebSocketClientConfigurator(headers))
