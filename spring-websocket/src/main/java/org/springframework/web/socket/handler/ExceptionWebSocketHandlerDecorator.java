...
/**
 * An exception handling {@link WebSocketHandlerDecorator}. Traps all {@link Throwable} instances that escape from the
 * decorated handler and closes the session with {@link CloseStatus#SERVER_ERROR}.
 *
