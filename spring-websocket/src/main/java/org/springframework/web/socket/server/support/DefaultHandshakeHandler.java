...
/**
 * A default {@link org.springframework.web.socket.server.HandshakeHandler} implementation, extending
 * {@link AbstractHandshakeHandler} with Servlet-specific initialization support. See {@link AbstractHandshakeHandler}'s
 * javadoc for details on supported servers etc.
 *
