...
/**
 * A WebSocket connection manager that is given a URI, a {@link javax.websocket.ClientEndpoint}-annotated endpoint,
 * connects to a WebSocket server through the {@link #start()} and {@link #stop()} methods. If
