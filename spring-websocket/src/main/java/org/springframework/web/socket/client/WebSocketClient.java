...
/**
 * Contract for initiating a WebSocket request. As an alternative considering using the declarative style
 * {@link WebSocketConnectionManager} that starts a WebSocket connection to a pre-configured URI when the application
 * starts.
 *
