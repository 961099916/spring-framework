...
public abstract class AbstractWebSocketMessage<T> implements WebSocketMessage<T> {
    ...
    /**
     * Create a new WebSocket message given payload representing the full or partial message content. When the
     * {@code isLast} boolean flag is set to {@code false} the message is sent as partial content and more partial
