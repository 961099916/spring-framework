 ...
 *
 * <p>
 * When used for testing purposes (e.g. load testing) the {@code HttpClient} properties must be set to allow a larger
 * than usual number of connections and threads. For example:
 *
 * <pre class="code">
...
public class JettyXhrTransport extends AbstractXhrTransport implements Lifecycle {
    ...
    /**
     * Jetty client {@link org.eclipse.jetty.client.api.Response.Listener Response Listener} that splits the body of the
     * response into SockJS frames and delegates them to the {@link XhrClientSockJsSession}.
     */
