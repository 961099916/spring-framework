...
public interface WebSocketSession extends Closeable {
     ...
     * {@link org.springframework.web.socket.server.HandshakeInterceptor HandshakeInterceptor}. On the client side the
     * map can be populated via {@link org.springframework.web.socket.client.WebSocketClient WebSocketClient} handshake
     * methods.
     * 
     ...
     * 
     * @return the protocol identifier, or {@code null} if no protocol was specified or negotiated successfully
     */
    @Nullable
     ...
     * 
     * @return the list of extensions, or an empty list if no extension was specified or negotiated successfully
     */
     ...
     * <p>
     * <strong>Note:</strong> The underlying standard WebSocket session (JSR-356) does not allow concurrent sending.
     * Therefore sending must be synchronized. To ensure that, one option is to wrap the {@code WebSocketSession} with
     * the {@link org.springframework.web.socket.handler.ConcurrentWebSocketSessionDecorator
