...
public interface WebSocketMessageBrokerConfigurer {
    ...
    /**
     * Register STOMP endpoints mapping each to a specific URL and (optionally) enabling and configuring SockJS fallback
     * options.
     */
    ...
    /**
     * Configure the {@link org.springframework.messaging.MessageChannel} used for incoming messages from WebSocket
     * clients. By default the channel is backed by a thread pool of size 1. It is recommended to customize thread pool
     * settings for production use.
     */
    default void configureClientInboundChannel(ChannelRegistration registration) {}

    /**
     * Configure the {@link org.springframework.messaging.MessageChannel} used for outbound messages to WebSocket
     * clients. By default the channel is backed by a thread pool of size 1. It is recommended to customize thread pool
     * settings for production use.
     */
     ...
     * support for argument resolution, configure {@code SimpAnnotationMethodMessageHandler} directly.
     * 
     ...
     * support for handling return values, configure {@code SimpAnnotationMethodMessageHandler} directly.
     * 
    ...
    /**
     * Configure the message converters to use when extracting the payload of messages in annotated methods and when
     * sending messages (e.g. through the "broker" SimpMessagingTemplate).
     * <p>
     * The provided list, initially empty, can be used to add message converters while the boolean return value is used
     * to determine if default message should be added as well.
     * 
