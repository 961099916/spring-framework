...
/**
 * Represents a WebSocket extension as defined in the RFC 6455. WebSocket extensions add protocol features to the
 * WebSocket protocol. The extensions used within a session are negotiated during the handshake phase as follows:
 * <ul>
 ...
 *
 * <p>
 * Note that the order of extensions in HTTP headers defines their order of execution, e.g. extensions "foo, bar" will
 * be executed as "bar(foo(message))".
 * </p>
 *
 * @author Brian Clozel
