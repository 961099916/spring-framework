...
/**
 * An XHR transport based on Undertow's {@link io.undertow.client.UndertowClient}. Requires Undertow 1.3 or 1.4,
 * including XNIO, as of Spring Framework 5.0.
 *
 * <p>
 * When used for testing purposes (e.g. load testing) or for specific use cases (like HTTPS configuration), a custom
 * OptionMap should be provided:
 *
 * <pre class="code">
 * OptionMap optionMap = OptionMap.builder().set(Options.WORKER_IO_THREADS, 8).set(Options.TCP_NODELAY, true)
 *     .set(Options.KEEP_ALIVE, true).set(Options.WORKER_NAME, "SockJSClient").getMap();
 *
