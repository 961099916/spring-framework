...
/**
 * Instantiates a target handler through a Spring {@link BeanFactory} and also provides an equivalent destroy method.
 * Mainly for internal use to assist with initializing and destroying handlers with per-connection lifecycle.
 *
