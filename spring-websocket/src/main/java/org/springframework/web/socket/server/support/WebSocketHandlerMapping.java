...
/**
 * An extension of {@link SimpleUrlHandlerMapping} that is also a {@link SmartLifecycle} container and propagates start
 * and stop calls to any handlers that implement {@link Lifecycle}. The handlers are typically expected to be
