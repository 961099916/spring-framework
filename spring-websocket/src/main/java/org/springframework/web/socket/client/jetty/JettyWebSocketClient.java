 ...
 *
 * <p>
 * As of 4.1 this class implements {@link Lifecycle} rather than {@link org.springframework.context.SmartLifecycle}. Use
 * {@link org.springframework.web.socket.client.WebSocketConnectionManager WebSocketConnectionManager} instead to
 * auto-start a WebSocket connection.
 *
...
public class JettyWebSocketClient extends AbstractWebSocketClient implements Lifecycle {
    ...
    public ListenableFuture<WebSocketSession> doHandshakeInternal(WebSocketHandler wsHandler, HttpHeaders headers,
        final URI uri, List<String> protocols, List<WebSocketExtension> extensions, Map<String, Object> attributes) {
    ...
    /**
     * Return the user to make available through {@link WebSocketSession#getPrincipal()}. By default this method returns
     * {@code null}
     */
    @Nullable
