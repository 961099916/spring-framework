...
public final class BinaryMessage extends AbstractWebSocketMessage<ByteBuffer> {
     ...
     * When the {@code isLast} boolean flag is set to {@code false} the message is sent as partial content and more
     * partial messages will be expected until the boolean flag is set to {@code true}.
     * 
     * @param payload
     *            the non-null payload
     * @param isLast
    ...
    /**
     * Create a new binary WebSocket message with the given byte[] payload representing the full or partial message
     * content. When the {@code isLast} boolean flag is set to {@code false} the message is sent as partial content and
     * more partial messages will be expected until the boolean flag is set to {@code true}.
     * 
     * @param payload
     *            a non-null payload; note that this value is not copied so care must be taken not to modify the array.
     * @param isLast
     ...
     *            a non-null payload; note that this value is not copied so care must be taken not to modify the array.
     * @param offset
     *            the offset into the array where the payload starts
     * @param length
     *            the length of the array considered for the payload
     * @param isLast
     *            if the message is the last of a series of partial messages
     */
