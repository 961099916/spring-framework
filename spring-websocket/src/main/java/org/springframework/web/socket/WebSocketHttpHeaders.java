...
/**
 * An {@link org.springframework.http.HttpHeaders} variant that adds support for the HTTP headers defined by the
...
public class WebSocketHttpHeaders extends HttpHeaders {
     ...
     * 
     * @deprecated as of 5.1.16, in favor of calling {@link #WebSocketHttpHeaders(HttpHeaders)} with a read-only wrapper
     *             from {@link HttpHeaders#readOnlyHttpHeaders(HttpHeaders)}
     */
    @Deprecated
