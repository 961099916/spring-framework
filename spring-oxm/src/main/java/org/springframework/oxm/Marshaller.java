 ...
 *
 * <p>
 * Although the {@code marshal} method accepts a {@code java.lang.Object} as its first parameter, most
 * {@code Marshaller} implementations cannot handle arbitrary {@code Object}s. Instead, a object class must be
 * registered with the marshaller, or have a common base class.
 *
...
public interface Marshaller {
     ...
     * @return {@code true} if this marshaller can indeed marshal instances of the supplied class; {@code false}
     *         otherwise
     */
