 ...
 * {@linkplain com.thoughtworks.xstream.XStream#PRIORITY_NORMAL normal} or higher priority, in addition to converters
 * that explicitly handle the domain classes that should be supported. As a result, default XStream converters with
