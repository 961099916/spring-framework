...
/**
 * {@link Source} implementation that uses a {@link Marshaller}.Can be constructed with a {@code Marshaller} and an
 * object to be marshalled.
 *
 * <p>
 * Even though {@code MarshallingSource} extends from {@code SAXSource}, calling the methods of {@code SAXSource} is
 ...
 * result in {@code UnsupportedOperationException}s.
 *
