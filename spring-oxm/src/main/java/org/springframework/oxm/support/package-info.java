 ...
 * MarshallingSource for compatibility with TrAX, MarshallingView for use within Spring Web MVC, and the
 * MarshallingMessageConverter for use within Spring's JMS support.
 */
@NonNullApi @NonNullFields package org.springframework.oxm.support;
