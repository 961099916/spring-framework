...
/**
 * Subinterface of {@link org.springframework.oxm.Unmarshaller} that can use MIME attachments to optimize storage of
 * binary data. Attachments can be added as MTOM, XOP, or SwA.
 *
 * @author Arjen Poutsma
 * @since 3.0
 * @see <a href="https://www.w3.org/TR/2004/WD-soap12-mtom-20040608/">SOAP Message Transmission Optimization
 *      Mechanism</a>
...
public interface MimeUnmarshaller extends Unmarshaller {
    ...
    /**
     * Unmarshals the given provided {@link Source} into an object graph, reading binary attachments from a
     * {@link MimeContainer}.
     * 
     * @param source
