 ...
 *
 * <p>
 * The typical usage will be to set the {@code targetClass} and optionally the {@code bindingName} property on this
 * bean.
 *
...
public class JibxMarshaller extends AbstractMarshaller implements InitializingBean {
    ...
    /**
     * Set the target class for this instance. Setting either this property or the {@link #setTargetPackage(String)
     * targetPackage} property is required.
     * <p>
    ...
    /**
     * Set the target package for this instance. Setting either this property or the {@link #setTargetClass(Class)
     * targetClass} property is required.
     * <p>
    ...
    /**
     * Set the root element name for the DTD declaration written when marshalling. By default, this is {@code null}
    ...
    /**
     * Set the system id for the DTD declaration written when marshalling. By default, this is {@code null}. Only used
     * when the root element also has been set.
     * <p>
    ...
    /**
     * Set the public id for the DTD declaration written when marshalling. By default, this is {@code null}. Only used
     * when the root element also has been set.
     * <p>
    ...
    /**
     * Set the internal subset Id for the DTD declaration written when marshalling. By default, this is {@code null}.
    ...
    /**
     * Convert the given {@code JiBXException} to an appropriate exception from the {@code org.springframework.oxm}
     * hierarchy.
     * <p>
     ...
     * 
     * @param ex
     *            {@code JiBXException} that occurred
     * @param marshalling
