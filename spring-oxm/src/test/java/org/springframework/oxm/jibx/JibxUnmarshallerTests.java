...
/**
 * NOTE: These tests fail under Eclipse/IDEA because JiBX binding does not occur by default. The Gradle build should
 * succeed, however.
 *
...
public class JibxUnmarshallerTests extends AbstractUnmarshallerTests<JibxMarshaller> {
    ...
    public void unmarshalStreamSourceInputStreamUsingNonDefaultEncoding() throws Exception {
        ...
        StreamSource source =
            new StreamSource(new ByteArrayInputStream(INPUT_STRING_WITH_SPECIAL_CHARACTERS.getBytes(encoding)));
