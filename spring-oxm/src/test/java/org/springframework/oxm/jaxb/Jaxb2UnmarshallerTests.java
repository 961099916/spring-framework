...
public class Jaxb2UnmarshallerTests extends AbstractUnmarshallerTests<Jaxb2Marshaller> {
    ...
    public void marshalAttachments() throws Exception {
        ...
        given(
            mimeContainer.getAttachment("<6b76528d-7a9c-4def-8e13-095ab89e9bb7@http://springframework.org/spring-ws>"))
                .willReturn(dataHandler);
        given(
            mimeContainer.getAttachment("<99bd1592-0521-41a2-9688-a8bfb40192fb@http://springframework.org/spring-ws>"))
                .willReturn(dataHandler);
        ...
        String content = "<binaryObject xmlns='http://springframework.org/spring-ws'>" + "<bytes>"
            ...
            + "</dataHandler>" + "<swaDataHandler>696cfb9a-4d2d-402f-bb5c-59fa69e7f0b3@spring-ws.png</swaDataHandler>"
            + "</binaryObject>";
