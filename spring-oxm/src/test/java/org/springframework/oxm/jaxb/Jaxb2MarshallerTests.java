...
public class Jaxb2MarshallerTests extends AbstractMarshallerTests<Jaxb2Marshaller> {
    ...
    public void properties() throws Exception {
        ...
        marshaller.setMarshallerProperties(
            Collections.<String, Object>singletonMap(javax.xml.bind.Marshaller.JAXB_FORMATTED_OUTPUT, Boolean.TRUE));
        marshaller.afterPropertiesSet();
    }
    ...
    private void testSupports() throws Exception {
        ...
        assertThat(marshaller.supports((Type)Flights.class)).as("Jaxb2Marshaller does not support Flights generic type")
            .isTrue();
        ...
        JAXBElement<FlightType> flightTypeJAXBElement =
            new JAXBElement<>(new QName("https://springframework.org", "flight"), FlightType.class, new FlightType());
        ...
        ReflectionUtils.doWithMethods(Primitives.class, new ReflectionUtils.MethodCallback() {
            ...
            public void doWith(Method method) throws IllegalArgumentException, IllegalAccessException {
                ...
                assertThat(marshaller.supports(returnType))
                    .as("Jaxb2Marshaller does not support JAXBElement<" + method.getName().substring(9) + ">").isTrue();
                try {
