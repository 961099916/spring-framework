...
/**
 * Exception thrown if a mapped object could not be retrieved via its identifier. Provides information about the
...
public class ObjectRetrievalFailureException extends DataRetrievalFailureException {
    ...
    /**
     * Create a general ObjectRetrievalFailureException with the given message, without any information on the affected
     * object.
     * 
     * @param msg
     *            the detail message
    ...
    /**
     * Return the persistent class of the object that was not found. If no Class was specified, this method returns
     * null.
     */
    @Nullable
