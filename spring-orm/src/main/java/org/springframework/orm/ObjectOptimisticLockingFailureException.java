...
/**
 * Exception thrown on an optimistic locking violation for a mapped object. Provides information about the persistent
...
public class ObjectOptimisticLockingFailureException extends OptimisticLockingFailureException {
    ...
    /**
     * Create a general ObjectOptimisticLockingFailureException with the given message, without any information on the
     * affected object.
     * 
     * @param msg
     *            the detail message
    ...
    /**
     * Create a new ObjectOptimisticLockingFailureException for the given object, with the default "optimistic locking
     * failed" message.
     * 
    ...
    /**
     * Return the persistent class of the object for which the locking failed. If no Class was specified, this method
     * returns null.
     */
    @Nullable
    ...
    /**
     * Return the name of the persistent class of the object for which the locking failed. Will work for both Class
