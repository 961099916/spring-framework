...
public abstract class SessionFactoryUtils {
     ...
     * {@code DataSourceUtils.CONNECTION_SYNCHRONIZATION_ORDER - 100} to execute Session cleanup before JDBC Connection
     * cleanup, if any.
     * 
    ...
    /**
     * Trigger a flush on the given Hibernate Session, converting regular {@link HibernateException} instances as well
     * as Hibernate 5.2's {@link PersistenceException} wrappers accordingly.
     * 
     * @param session
     *            the Hibernate Session to flush
     * @param synch
     *            whether this flush is triggered by transaction synchronization
     ...
     * 
     * @param session
     *            the Hibernate Session to close (may be {@code null})
     * @see Session#close()
     */
