 ...
 *
 * <p>
 * Auto-configured by {@link LocalSessionFactoryBean#setBeanFactory}, programmatically supported via
 * {@link LocalSessionFactoryBuilder#setBeanContainer}, and manually configurable through a
 ...
 * </pre>
 *
 * Please note that Spring's {@link LocalSessionFactoryBean} is an immediate alternative to
...
public final class SpringBeanContainer implements BeanContainer {
    ...
    private SpringContainedBean<?> createBean(String name, Class<?> beanType, LifecycleOptions lifecycleOptions,
        ...
        try {
            if (lifecycleOptions.useJpaCompliantCreation()) {
                Object bean =
                    this.beanFactory.autowire(beanType, AutowireCapableBeanFactory.AUTOWIRE_CONSTRUCTOR, false);
