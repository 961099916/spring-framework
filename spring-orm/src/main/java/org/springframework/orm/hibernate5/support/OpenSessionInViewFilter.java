...
/**
 * Servlet Filter that binds a Hibernate Session to the thread for the entire processing of the request. Intended for
 ...
 * {@code FlushMode.MANUAL}. It assumes to be used in combination with service layer transactions that care for the
 * flushing: The active transaction manager will temporarily change the flush mode to {@code FlushMode.AUTO} during a
 * read-write transaction, with the flush mode reset to {@code FlushMode.MANUAL} at the end of each transaction.
 *
 * <p>
...
public class OpenSessionInViewFilter extends OncePerRequestFilter {
    ...
    /**
     * Returns "false" so that the filter may re-bind the opened Hibernate {@code Session} to each asynchronously
     * dispatched thread and postpone closing it until the very last asynchronous dispatch.
     */
    @Override
    ...
    /**
     * Returns "false" so that the filter may provide a Hibernate {@code Session} to each error dispatches.
     */
    @Override
