 ...
 * method invocation, if none bound before.
 *
 * <p>
 * This is a simple Hibernate Session scoping interceptor along the lines of {@link OpenSessionInViewInterceptor}, just
 * for use with AOP setup instead of MVC setup. It opens a new {@link Session} with flush mode "MANUAL" since the
