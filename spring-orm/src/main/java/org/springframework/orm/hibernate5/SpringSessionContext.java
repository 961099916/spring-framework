...
/**
 * Implementation of Hibernate 3.1's {@link CurrentSessionContext} interface that delegates to Spring's
 * {@link SessionFactoryUtils} for providing a Spring-managed current {@link Session}.
 *
 * <p>
 * This CurrentSessionContext implementation can also be specified in custom SessionFactory setup through the
 * "hibernate.current_session_context_class" property, with the fully qualified name of this class as value.
 *
...
public class SpringSessionContext implements CurrentSessionContext {
    ...
    public Session currentSession() throws HibernateException {
        ...
        if (TransactionSynchronizationManager.isSynchronizationActive()) {
            ...
            TransactionSynchronizationManager
                .registerSynchronization(new SpringSessionSynchronization(sessionHolder, this.sessionFactory, true));
