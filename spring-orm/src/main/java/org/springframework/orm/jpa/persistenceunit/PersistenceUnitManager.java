 ...
 * {@link javax.persistence.spi.PersistenceUnitInfo} for building a concrete
 * {@link javax.persistence.EntityManagerFactory}.
 *
 * <p>
 * Obtaining a PersistenceUnitInfo instance is an exclusive process. A PersistenceUnitInfo instance is not available for
 * further calls anymore once it has been obtained.
 *
...
public interface PersistenceUnitManager {
     ...
     *             if no PersistenceUnitInfo with the given name is defined
     * @throws IllegalStateException
