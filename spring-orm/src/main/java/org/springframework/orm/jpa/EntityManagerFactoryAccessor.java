...
/**
 * Base class for any class that needs to access a JPA {@link EntityManagerFactory}, usually in order to obtain a JPA
 * {@link EntityManager}. Defines common properties.
 *
...
public abstract class EntityManagerFactoryAccessor implements BeanFactoryAware {
     ...
     * default EntityManagerFactory will be retrieved through finding a single unique bean of type EntityManagerFactory.
     *
     ...
     * @throws IllegalStateException
     *             if this accessor is not configured with an EntityManagerFactory
     * @see javax.persistence.EntityManagerFactory#createEntityManager()
     * @see javax.persistence.EntityManagerFactory#createEntityManager(java.util.Map)
     */
