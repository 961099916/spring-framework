...
/**
 * Spring's base implementation of the JPA {@link javax.persistence.spi.PersistenceUnitInfo} interface, used to
 * bootstrap an {@code EntityManagerFactory} in a container.
 *
 * <p>
 * This implementation is largely a JavaBean, offering mutators for all standard {@code PersistenceUnitInfo} properties.
 *
 * @author Rod Johnson
...
public class MutablePersistenceUnitInfo implements SmartPersistenceUnitInfo {
     ...
     * <p>
     * Note: This refers to annotated {@code package-info.java} files. It does <i>not</i> trigger entity scanning in the
     * specified package; this is rather the job of {@link DefaultPersistenceUnitManager#setPackagesToScan}.
     * 
     * @since 4.1
