 ...
 * {@link org.springframework.orm.jpa.LocalContainerEntityManagerFactoryBean} and {@link PersistenceUnitManager}
 * implementations.
 *
...
public interface SmartPersistenceUnitInfo extends PersistenceUnitInfo {
    ...
    /**
     * Return a list of managed Java packages, to be introspected by the persistence provider. Typically found through
     * scanning but not exposable through {@link #getManagedClassNames()}.
     * 
