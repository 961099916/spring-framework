 ...
 *
 * <p>
 * This interceptor makes JPA EntityManagers available via the current thread, which will be autodetected by transaction
 ...
 *
 * <p>
 * In contrast to {@link OpenEntityManagerInViewFilter}, this interceptor is set up in a Spring application context and
...
public class OpenEntityManagerInViewInterceptor extends EntityManagerFactoryAccessor
    ...
    /**
     * Suffix that gets appended to the EntityManagerFactory toString representation for the "participate in existing
     * entity manager handling" request attribute.
     * 
     ...
     * implementation takes the toString representation of the EntityManagerFactory instance and appends ".FILTERED".
     * 
