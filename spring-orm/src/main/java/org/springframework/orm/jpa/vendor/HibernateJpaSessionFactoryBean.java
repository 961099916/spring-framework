...
/**
 * Simple {@code FactoryBean} that exposes the underlying {@link SessionFactory} behind a Hibernate-backed JPA
 ...
 *
 * <p>
 * And as of JPA 2.1, {@link EntityManagerFactory#unwrap} provides a nice approach as well, in particular within
 * configuration class arrangements:
 *
 * <pre class="code">
 * &#064;Bean
 ...
 * {@code EntityManagerFactory}, you may get conflicts when injecting by type, with both the original factory and your
 * custom {@code SessionFactory} matching {@code EntityManagerFactory}. An explicit qualifier for the original factory
 * (as indicated above) is recommended here.
 *
 * @author Juergen Hoeller
 * @since 3.1
 * @see #setPersistenceUnitName
 * @see #setEntityManagerFactory
 * @deprecated as of Spring Framework 4.3.12 against Hibernate 5.2, in favor of a custom solution based on
 *             {@link EntityManagerFactory#unwrap} with explicit qualifiers and/or primary markers
 */
@Deprecated
