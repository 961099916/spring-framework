...
/**
 * Callback interface for post-processing a JPA PersistenceUnitInfo. Implementations can be registered with a
 * DefaultPersistenceUnitManager or via a LocalContainerEntityManagerFactoryBean.
 *
