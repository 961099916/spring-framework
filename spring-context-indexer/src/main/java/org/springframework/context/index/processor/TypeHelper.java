...
class TypeHelper {
    ...
    /**
     * Return the super class of the specified {@link Element} or null if this {@code element} represents
     * {@link Object}.
     */
    ...
    /**
     * Return the interfaces that are <strong>directly</strong> implemented by the specified {@link Element} or an empty
     * list if this {@code element} does not implement any interface.
     */
