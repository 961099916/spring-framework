...
/**
 * Public API for HTML rendering. Supported as a return value in Spring WebFlux controllers. Comparable to the use of
 * {@code ModelAndView} as a return value in Spring MVC controllers.
 *
 * <p>
 * Controllers typically return a {@link String} view name and rely on the "implicit" model which can also be injected
 * into the controller method. Or controllers may return model attribute(s) and rely on a default view name being
 * selected based on the request path.
 *
 * <p>
 * {@link Rendering} can be used to combine a view name with model attributes, set the HTTP status or headers, and for
 * other more advanced options around redirect scenarios.
 *
...
public interface Rendering {
     ...
     *
     * @param name
     *            the view name to be resolved to a {@link View}
     * @return the builder
     */
    ...
    interface Builder<B extends Builder<B>> {
        ...
        /**
         * Add an attribute to the model using a {@link org.springframework.core.Conventions#getVariableName generated
         * name}.
         * 
        ...
        /**
         * Add all given attributes to the model using {@link org.springframework.core.Conventions#getVariableName
         * generated names}.
         * 
