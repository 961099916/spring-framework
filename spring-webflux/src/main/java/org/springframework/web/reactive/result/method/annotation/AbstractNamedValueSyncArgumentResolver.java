...
/**
 * An extension of {@link AbstractNamedValueArgumentResolver} for named value resolvers that are synchronous and yet
 * non-blocking. Sub-classes implement the synchronous {@link #resolveNamedValue} to which the asynchronous
