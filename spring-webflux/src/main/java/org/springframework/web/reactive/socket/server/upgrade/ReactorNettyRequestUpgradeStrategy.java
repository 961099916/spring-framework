...
public class ReactorNettyRequestUpgradeStrategy implements RequestUpgradeStrategy {
    ...
    /**
     * Create an instance with a pre-configured {@link WebsocketServerSpec.Builder} to use for WebSocket upgrades.
     * 
     * @since 5.2.6
     */
    ...
    /**
     * Build an instance of {@code WebsocketServerSpec} that reflects the current configuration. This can be used to
     * check the configured parameters except for sub-protocols which depend on the {@link WebSocketHandler} that is
     * used for a given upgrade.
     *
     * @since 5.2.6
     */
    ...
    /**
     * Configure the maximum allowable frame payload length. Setting this value to your application's requirement may
     ...
     * {@link io.netty.handler.codec.http.websocketx.WebSocketServerHandshakerFactory WebSocketServerHandshakerFactory}
     * in Netty.
     * <p>
     * By default set to 65536 (64K).
     *
     * @param maxFramePayloadLength
     *            the max length for frames.
     * @since 5.1
     * @deprecated as of 5.2.6 in favor of providing a supplier of {@link WebsocketServerSpec.Builder} wiht a
    ...
    /**
     * Configure whether to let ping frames through to be handled by the {@link WebSocketHandler} given to the upgrade
     * method. By default, Reactor Netty automatically replies with pong frames in response to pings. This is useful in
     * a proxy for allowing ping and pong frames through.
     * <p>
     * By default this is set to {@code false} in which case ping frames are handled automatically by Reactor Netty. If
     * set to {@code true}, ping frames will be passed through to the {@link WebSocketHandler}.
     *
     * @param handlePing
     *            whether to let Ping frames through for handling
     * @since 5.2.4
     * @deprecated as of 5.2.6 in favor of providing a supplier of {@link WebsocketServerSpec.Builder} wiht a
     *             constructor argument.
     */
