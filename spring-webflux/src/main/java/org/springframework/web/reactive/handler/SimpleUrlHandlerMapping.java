...
/**
 * Implementation of the {@link org.springframework.web.reactive.HandlerMapping} interface to map from URLs to request
 * handler beans. Supports both mapping to bean instances and mapping to bean names; the latter is required for
 * non-singleton handlers.
 *
 * <p>
 * The "urlMap" property is suitable for populating the handler map with bean instances. Mappings to bean names can be
 * set via the "mappings" property, in a form accepted by the {@code java.util.Properties} class, as follows:
 *
 * <pre class="code">
...
public class SimpleUrlHandlerMapping extends AbstractUrlHandlerMapping {
     ...
     * 
     * @param urlMap
     *            map with URL paths as keys and handler beans (or handler bean names) as values
     * @since 5.2
     * @see #setUrlMap(Map)
     */
     ...
     *            map with URL paths as keys and handler beans (or handler bean names) as values
     * @param order
     *            the order value for this {@code SimpleUrlHandlerMapping}
     * @since 5.2
     * @see #setUrlMap(Map)
     * @see #setOrder(int)
     */
     ...
     * <p>
     * Useful for specifying entries directly, for example via "urlMap[myKey]". This is particularly useful for adding
     * or overriding entries in child bean definitions.
     */
     ...
     * 
     * @param urlMap
     *            a Map with URL paths as keys and handler beans or bean names as values
