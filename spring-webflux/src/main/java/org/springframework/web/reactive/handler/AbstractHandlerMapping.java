...
public abstract class AbstractHandlerMapping extends ApplicationObjectSupport
     ...
     * <li>{@link PathPatternParser#setCaseSensitive(boolean)} -- the case sensitive slash option, including its default
     * value.
     * </ul>
     * <p>
     ...
     * <ul>
     * <li>{@link #getPathPatternParser()} -- the underlying pattern parser
     * <li>{@link PathPatternParser#setMatchOptionalTrailingSeparator(boolean)} -- the trailing slash option, including
     * its default value.
     * </ul>
     */
    ...
    /**
     * Return the {@link PathPatternParser} instance that is used for {@link #setCorsConfigurations(Map) CORS
     * configuration checks}. Sub-classes can also use this pattern parser for their own request mapping purposes.
     */
     ...
     * with handler-level CORS configuration if any.
     * 
    ...
    /**
     * Look up a handler for the given request, returning an empty {@code Mono} if no specific one is found. This method
     * is called by {@link #getHandler}.
     * <p>
     ...
     * headers from the "Access-Control-Request-Headers" header.
     * 
     * @param exchange
     *            current exchange
