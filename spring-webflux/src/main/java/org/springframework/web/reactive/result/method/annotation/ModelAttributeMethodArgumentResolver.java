 ...
 *
 * <p>
 * Model attributes are sourced from the model, or created using a default constructor and then added to the model. Once
 * created the attribute is populated via data binding to the request (form data, query params). Validation also may be
 * applied if the argument is annotated with {@code @javax.validation.Valid} or Spring's own
 * {@code @org.springframework.validation.annotation.Validated}.
 *
 * <p>
 * When this handler is created with {@code useDefaultResolution=true} any non-simple type argument and return value is
...
public class ModelAttributeMethodArgumentResolver extends HandlerMethodArgumentResolverSupport {
    ...
    /**
     * Determine if binding should be disabled for the supplied {@link MethodParameter}, based on the
     * {@link ModelAttribute#binding} annotation attribute.
     * 
     * @since 5.2.15
     */
