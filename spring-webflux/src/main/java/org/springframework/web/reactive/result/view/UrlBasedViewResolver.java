...
/**
 * A {@link ViewResolver} that allows direct resolution of symbolic view names to URLs without explicit mapping
 * definitions. This is useful if symbolic names match the names of view resources in a straightforward manner (i.e. the
 * symbolic name is the unique part of the resource's filename), without the need for a dedicated mapping to be defined
 * for each view.
 *
 * <p>
 * Supports {@link AbstractUrlBasedView} subclasses like
 * {@link org.springframework.web.reactive.result.view.freemarker.FreeMarkerView}. The view class for all views
...
public class UrlBasedViewResolver extends ViewResolverSupport
    ...
    /**
     * Return the required type of view for this resolver. This implementation returns {@link AbstractUrlBasedView}.
     * 
    ...
    /**
     * Set the view names (or name patterns) that can be handled by this {@link ViewResolver}. View names can contain
     * simple wildcards such that 'my*', '*Report' and '*Repo*' will all match the view name 'myReport'.
     *
     * @see #canHandle
     */
    ...
    /**
     * URL based {@link RedirectView} provider which can be used to provide, for example, redirect views with a custom
     * default status code.
     */
     ...
     * <p>
     * To be used for the initialization of newly created {@link View} instances, applying lifecycle callbacks and
     * providing access to the containing environment.
     *
     * @see #setViewClass
     * @see #createView
    ...
    /**
     * Indicates whether or not this {@link ViewResolver} can handle the supplied view name. If not, an empty result is
     * returned. The default implementation checks against the configured {@link #setViewNames view names}.
     * 
     * @param viewName
     ...
     * <p>
     * Spring lifecycle methods as defined by the bean container do not have to be called here: They will be
     * automatically applied afterwards, provided that an {@link #setApplicationContext ApplicationContext} is
     * available.
     * 
     * @param viewName
