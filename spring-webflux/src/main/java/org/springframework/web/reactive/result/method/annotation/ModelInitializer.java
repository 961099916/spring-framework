...
/**
 * Package-private class to assist {@link RequestMappingHandlerAdapter} with default model initialization through
...
class ModelInitializer {
    ...
    /**
     * Initialize the {@link org.springframework.ui.Model Model} based on a (type-level) {@code @SessionAttributes}
     * annotation and {@code @ModelAttribute} methods.
     *
     * @param handlerMethod
    ...
    private Mono<Void> invokeModelAttributeMethods(BindingContext bindingContext,
        ...
        return Mono
            .zip(resultList,
                objectArray -> Arrays.stream(objectArray)
