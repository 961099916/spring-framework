...
/**
 * Simple container of information related to the handshake request that started the {@link WebSocketSession} session.
 *
...
public class HandshakeInfo {
     ...
     * @param principal
     *            the principal for the session
     * @param protocol
     *            the negotiated sub-protocol (may be {@code null})
     */
    ...
    /**
     * Constructor targetting server-side use with extra information about the handshake, the remote address, and a
     * pre-existing log prefix for correlation.
     * 
     * @param uri
     *            the endpoint URL
     * @param headers
     ...
     *            the negotiated sub-protocol (may be {@code null})
     * @param remoteAddress
     *            the remote address where the handshake came from
     * @param attributes
     *            initial attributes to use for the WebSocket session
     * @param logPrefix
     *            log prefix used during the handshake for correlating log messages, if any.
     * @since 5.1
     */
    public HandshakeInfo(URI uri, HttpHeaders headers, Mono<Principal> principal, @Nullable String protocol,
