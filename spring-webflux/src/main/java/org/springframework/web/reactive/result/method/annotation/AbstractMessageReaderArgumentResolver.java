 ...
 *
 * <p>
 * Applies validation if the method argument is annotated with {@code @javax.validation.Valid} or
...
public abstract class AbstractMessageReaderArgumentResolver extends HandlerMethodArgumentResolverSupport {
     ...
     *            readers to convert from the request body
     ...
     * 
     * @param bodyParameter
     *            the {@link MethodParameter} to read
     * @param isBodyRequired
     *            true if the body is required
     * @param bindingContext
     *            the binding context to use
     * @param exchange
     ...
     * 
     * @param bodyParam
     *            represents the element type for the body
     * @param actualParam
     *            the actual method argument type; possibly different from {@code bodyParam}, e.g. for an
     *            {@code HttpEntity} argument
     * @param isBodyRequired
     *            true if the body is required
     * @param bindingContext
     *            the binding context to use
    ...
    /**
     * Check if the given MethodParameter requires validation and if so return a (possibly empty) Object[] with
     * validation hints. A return value of {@code null} indicates that validation is not required.
     */
    @Nullable
