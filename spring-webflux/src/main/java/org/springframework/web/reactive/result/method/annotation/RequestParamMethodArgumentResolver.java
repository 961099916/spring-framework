...
/**
 * Resolver for method arguments annotated with @{@link RequestParam} from URI query string parameters.
 *
 * <p>
 * This resolver can also be created in default resolution mode in which simple types (int, long, etc.) not annotated
 * with @{@link RequestParam} are also treated as request parameters with the parameter name derived from the argument
 * name.
 *
 * <p>
 ...
 * {@link Converter} has been registered. Or if a request parameter name is not specified the
