...
class InitBinderBindingContext extends BindingContext {
    ...
    /**
     * Provide the context required to apply {@link #saveModel()} after the controller method has been invoked.
     */
    ...
    /**
     * Save model attributes in the session based on a type-level declarations in an {@code @SessionAttributes}
     * annotation.
     */
