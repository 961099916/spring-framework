...
public abstract class ExchangeFunctions {
    ...
    /**
     * Create an {@code ExchangeFunction} with the given {@code ClientHttpConnector}. This is the same as calling
     * {@link #create(ClientHttpConnector, ExchangeStrategies)} and passing {@link ExchangeStrategies#withDefaults()}.
     * 
     * @param connector
     *            the connector to use for connecting to servers
    ...
    /**
     * Create an {@code ExchangeFunction} with the given {@code ClientHttpConnector} and {@code ExchangeStrategies}.
     * 
     * @param connector
     *            the connector to use for connecting to servers
     * @param strategies
     *            the {@code ExchangeStrategies} to use
     * @return the created {@code ExchangeFunction}
     */
    ...
    private static class DefaultExchangeFunction implements ExchangeFunction {
        ...
        public Mono<ClientResponse> exchange(ClientRequest clientRequest) {
            ...
            return this.connector
                ...
                .doOnCancel(() -> logger.debug(logPrefix + "Cancel signal (to close connection)")).map(httpResponse -> {
