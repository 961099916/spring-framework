...
/**
 * A {@code ViewResolver} for resolving {@link FreeMarkerView} instances, i.e. FreeMarker templates and custom
 * subclasses of it.
 *
 * <p>
 * The view class for all views generated by this resolver can be specified via the "viewClass" property. See
 * {@link UrlBasedViewResolver} for details.
 *
...
public class FreeMarkerViewResolver extends UrlBasedViewResolver {
     ...
     * 
     * @param suffix
     *            the suffix to prepend view names with
     * @param prefix
