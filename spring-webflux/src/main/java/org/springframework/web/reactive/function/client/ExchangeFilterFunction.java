 ...
 * <p>
 * The filter is executed when a {@code Subscriber} subscribes to the {@code Publisher} returned by the
 * {@code WebClient}.
 *
...
public interface ExchangeFilterFunction {
     ...
     * <p>
     * The given {@linkplain ExchangeFunction} represents the next entity in the chain, to be invoked via
     * {@linkplain ExchangeFunction#exchange(ClientRequest) invoked} in order to proceed with the exchange, or not
     * invoked to shortcut the chain.
     *
     * @param request
     *            the current request
     * @param next
     *            the next exchange function in the chain
     ...
     *
     * @param afterFilter
     *            the filter to apply after this filter
    ...
    /**
     * Apply this filter to the given {@linkplain ExchangeFunction}, resulting in a filtered exchange function.
     *
     * @param exchange
     *            the exchange function to filter
