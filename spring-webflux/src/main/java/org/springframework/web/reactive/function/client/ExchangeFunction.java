 ...
 *
 * Mono&lt;String&gt; result = exchangeFunction.exchange(request).then(response -> response.bodyToMono(String.class));
 * </pre>
 *
...
public interface ExchangeFunction {
    ...
    /**
     * Filters this exchange function with the given {@code ExchangeFilterFunction}, resulting in a filtered
     * {@code ExchangeFunction}.
     * 
     * @param filter
     *            the filter to apply to this exchange
