...
/**
 * A logical conjunction (' && ') request condition that matches a request against a set of header expressions with
 * syntax defined in {@link RequestMapping#headers()}.
 *
 * <p>
 * Expressions passed to the constructor with header names 'Accept' or 'Content-Type' are ignored. See
 * {@link ConsumesRequestCondition} and {@link ProducesRequestCondition} for those.
 *
...
public final class HeadersRequestCondition extends AbstractRequestCondition<HeadersRequestCondition> {
    ...
    /**
     * Create a new instance from the given header expressions. Expressions with header names 'Accept' or 'Content-Type'
     * are ignored. See {@link ConsumesRequestCondition} and {@link ProducesRequestCondition} for those.
     * 
     * @param headers
     *            media type expressions with syntax defined in {@link RequestMapping#headers()}; if 0, the condition
    ...
    /**
     * Compare to another condition based on header expressions. A condition is considered to be a more specific match,
     * if it has:
     * <ol>
     ...
     * each instance contains the matching header expression only or is otherwise empty.
     */
    @Override
