...
public abstract class RequestPredicates {
    ...
    /**
     * Return a {@code RequestPredicate} that matches if the request's query parameter of the given name has the given
     * value.
     * 
     * @param name
     *            the name of the query parameter to test against
     * @param value
     *            the value of the query parameter to test against
    ...
    /**
     * Return a {@code RequestPredicate} that tests the request's query parameter of the given name against the given
     * predicate.
     * 
     * @param name
     *            the name of the query parameter to test against
