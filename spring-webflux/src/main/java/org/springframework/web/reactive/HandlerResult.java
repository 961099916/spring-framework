...
public class HandlerResult {
     ...
     * @param returnValue
     *            the return value from the handler possibly {@code null}
     * @param returnType
    ...
    /**
     * Return the type of the value returned from the handler -- e.g. the return type declared on a controller method's
     * signature. Also see {@link #getReturnTypeSource()} to obtain the underlying {@link MethodParameter} for the
     * return type.
     */
    ...
    /**
     * Return the model used for request handling. This is a shortcut for {@code getBindingContext().getModel()}.
     */
     ...
     * Especially for an async return value errors may occur after the invocation of the handler.
     * 
     * @param function
     *            the error handler
