...
public interface EntityResponse<T> extends ServerResponse {
     ...
     *
     * @param producer
     *            the producer that represents the body of the response
     * @param elementClass
     ...
     *            the producer that represents the body of the response
     * @param typeReference
     *            the type of elements contained in the producer
     * @return the created builder
     * @since 5.2
     */
     ...
     *
     * @param publisher
     *            the publisher that represents the body of the response
     * @param elementClass
     *            the class of elements contained in the publisher
     * @param <T>
