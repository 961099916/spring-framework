...
final class DefaultWebClientBuilder implements WebClient.Builder {
    ...
    public DefaultWebClientBuilder(DefaultWebClientBuilder other) {
        ...
        this.strategiesConfigurers =
            (other.strategiesConfigurers != null ? new ArrayList<>(other.strategiesConfigurers) : null);
    ...
    public WebClient build() {
        ...
        ExchangeFunction filteredExchange = (this.filters != null ? this.filters.stream()
            .reduce(ExchangeFilterFunction::andThen).map(filter -> filter.apply(exchange)).orElse(exchange) : exchange);
    ...
    private UriBuilderFactory initUriBuilderFactory() {
        ...
        DefaultUriBuilderFactory factory =
            (this.baseUrl != null ? new DefaultUriBuilderFactory(this.baseUrl) : new DefaultUriBuilderFactory());
