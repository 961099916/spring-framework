 ...
 *
 * <p>
 * To create an instance, see the static methods {@link #withDefaults()}, {@link #builder()}, and {@link #empty()}.
 *
 * @author Brian Clozel
...
public interface ExchangeStrategies {
    ...
    /**
     * Return an {@code ExchangeStrategies} instance with default configuration provided by
    ...
    /**
     * Return a builder pre-configured with default configuration to start. This is the same as {@link #withDefaults()}
    ...
    /**
     * Return a builder to create a new {@link ExchangeStrategies} instance replicated from the current instance.
     *
     * @since 5.1.12
     */
    ...
    interface Builder {
         ...
         * 
         * @param consumer
         *            the consumer to customize the codecs
         * @return this builder
         */
