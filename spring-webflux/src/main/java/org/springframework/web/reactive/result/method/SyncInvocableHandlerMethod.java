...
/**
 * Extension of {@link HandlerMethod} that invokes the underlying method via {@link InvocableHandlerMethod} but uses
 * sync argument resolvers only and thus can return directly a {@link HandlerResult} with no async wrappers.
 *
