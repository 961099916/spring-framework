...
/**
 * Represents a typed server-side HTTP response, as returned by a {@linkplain HandlerFunction handler function} or
...
public interface ServerResponse {
    ...
    /**
     * Create a new builder with a {@linkplain HttpStatus#CREATED 201 Created} status and a location header set to the
     * given URI.
     *
     * @param location
     *            the location URI
    ...
    /**
     * Create a builder with a {@linkplain HttpStatus#SEE_OTHER 303 See Other} status and a location header set to the
     * given URI.
     *
     * @param location
     *            the location URI
    ...
    /**
     * Create a builder with a {@linkplain HttpStatus#TEMPORARY_REDIRECT 307 Temporary Redirect} status and a location
    ...
    /**
     * Create a builder with a {@linkplain HttpStatus#PERMANENT_REDIRECT 308 Permanent Redirect} status and a location
     * header set to the given URI.
     *
     * @param location
     *            the location URI
    ...
    /**
     * Create a builder with an {@linkplain HttpStatus#UNPROCESSABLE_ENTITY 422 Unprocessable Entity} status.
     *
     * @return the created builder
     */
     ...
     *
     * @param exchange
     *            the web exchange to write to
     * @param context
     *            the context to use when writing
    ...
    interface HeadersBuilder<B extends HeadersBuilder<B>> {
        ...
        /**
         * Manipulate this response's headers with the given consumer. The headers provided to the consumer are "live",
         * so that the consumer can be used to {@linkplain HttpHeaders#set(String, String) overwrite} existing header
        ...
        /**
         * Manipulate this response's cookies with the given consumer. The cookies provided to the consumer are "live",
         * so that the consumer can be used to {@linkplain MultiValueMap#set(Object, Object) overwrite} existing
         * cookies, {@linkplain MultiValueMap#remove(Object) remove} cookies, or use any of the other
         * {@link MultiValueMap} methods.
         * 
         * @param cookiesConsumer
         *            a function that consumes the cookies
         * @return this builder
         */
        ...
        /**
         * Set the caching directives for the resource, as specified by the HTTP 1.1 {@code Cache-Control} header.
         * <p>
        ...
        /**
         * Configure one or more request header names (e.g. "Accept-Language") to add to the "Vary" response header to
         * inform clients that the response is subject to content negotiation and variances based on the value of the
         * given request headers. The configured request header names are added only if not already present in the
         ...
         * 
         * @param voidPublisher
         *            the publisher to indicate when the response should be committed
         */
         ...
         * 
         * @param writeFunction
         *            the function used to write to the {@link ServerWebExchange}
         */
    ...
    interface BodyBuilder extends HeadersBuilder<BodyBuilder> {
        ...
        /**
         * Add a serialization hint like {@link Jackson2CodecSupport#JSON_VIEW_HINT} to customize how the body will be
         * serialized.
         * 
         * @param key
         *            the hint key
         ...
         * 
         * @param hintsConsumer
         *            a function that consumes the hints
         * @return this builder
         * @since 5.1.6
         */
        ...
        /**
         * Set the body of the response to the given {@code Object} and return it. This is a shortcut for using a
         * {@link #body(BodyInserter)} with a {@linkplain BodyInserters#fromValue value inserter}.
         * 
         * @param body
         ...
         * 
         * @param publisher
         *            the {@code Publisher} to write to the response
         * @param elementClass
         ...
         * 
         * @param publisher
         *            the {@code Publisher} to use to write the response
         ...
         * 
         * @param producer
         *            the producer to write to the response
         * @param elementTypeRef
         *            the type of elements produced
         * @return the built response
         * @since 5.2
         ...
         * 
         * @param inserter
         *            the {@code BodyInserter} that writes to the response
         * @return the built response
         */
        Mono<ServerResponse> body(BodyInserter<?, ? super ServerHttpResponse> inserter);

        /**
         * Set the response body to the given {@code Object} and return it. As of 5.2 this method delegates to
         * {@link #bodyValue(Object)}.
         * 
        ...
        /**
         * Render the template with the given {@code name} using the given {@code modelAttributes}. The model attributes
         * are mapped under a {@linkplain org.springframework.core.Conventions#getVariableName generated name}.
         * <p>
         * <em>Note: Empty {@link Collection Collections} are not added to the model when using this method because we
         * cannot correctly determine the true convention name.</em>
         * 
         * @param name
