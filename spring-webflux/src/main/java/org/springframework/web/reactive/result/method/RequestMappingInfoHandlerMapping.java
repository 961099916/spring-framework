...
/**
 * Abstract base class for classes for which {@link RequestMappingInfo} defines the mapping between a request and a
 * handler method.
 *
...
public abstract class RequestMappingInfoHandlerMapping extends AbstractHandlerMethodMapping<RequestMappingInfo> {
    ...
    /**
     * Check if the given RequestMappingInfo matches the current request and return a (potentially new) instance with
     * conditions that match the current request -- for example with a subset of URL patterns.
     * 
     ...
     *             for matches by URL but not by HTTP method
     * @throws UnsupportedMediaTypeStatusException
     *             if there are matches by URL and HTTP method but not by consumable media types
     * @throws NotAcceptableStatusException
     *             if there are matches by URL and HTTP method but not by producible media types
     * @throws ServerWebInputException
     *             if there are matches by URL and HTTP method but not by query parameter conditions
     */
    @Override
    ...
    private static class PartialMatchHelper {
        ...
        /**
         * Return declared "producible" types but only among those that also match the "methods" and "consumes"
         * conditions.
         */
        ...
        /**
         * Return declared "params" conditions but only among those that also match the "methods", "consumes", and
         * "params" conditions.
         */
        ...
        private static class PartialMatch {
             ...
             * 
             * @param info
             *            the RequestMappingInfo that matches the URL path
             * @param exchange
