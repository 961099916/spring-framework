...
public class ReactorNettyWebSocketClient implements WebSocketClient {
    ...
    /**
     * Configure whether to let ping frames through to be handled by the {@link WebSocketHandler} given to the execute
        ...
        return getHttpClient().headers(nettyHeaders -> setNettyHeaders(requestHeaders, nettyHeaders))
            ...
            .handle((inbound, outbound) -> {
                ...
                WebSocketSession session =
                    new ReactorNettyWebSocketSession(inbound, outbound, info, factory, getMaxFramePayloadLength());
