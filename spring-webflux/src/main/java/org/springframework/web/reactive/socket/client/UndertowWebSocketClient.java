...
public class UndertowWebSocketClient implements WebSocketClient {
    ...
    /**
     * Alternate constructor providing additional control over the {@link ConnectionBuilder} for each WebSocket
     * connection.
     * 
     * @param worker
     *            the Xnio worker to use to create {@code ConnectionBuilder}'s
     * @param builderConsumer
     *            a consumer to configure {@code ConnectionBuilder}'s
     */
     ...
     *            the ByteBufferPool to use to create {@code ConnectionBuilder}'s
     * @param builderConsumer
     *            a consumer to configure {@code ConnectionBuilder}'s
     * @since 5.0.8
     */
    ...
    /**
     * Return the {@link io.undertow.connector.ByteBufferPool} currently used for newly created WebSocket sessions by
     * this client.
     *
     ...
     * {@link io.undertow.websockets.client.WebSocketClient#connectionBuilder}.
     * <p>
     * By default an indirect {@link io.undertow.server.DefaultByteBufferPool} with a buffer size of 8192 is used.
     *
     * @since 5.0.8
     ...
     * <p>
     * The default implementation creates a builder with the configured {@link #getXnioWorker() XnioWorker} and
     * {@link #getByteBufferPool() ByteBufferPool} and then passes it to the {@link #getConnectionBuilderConsumer()
     * consumer} provided at construction time.
     */
    protected ConnectionBuilder createConnectionBuilder(URI url) {
        ConnectionBuilder builder =
            io.undertow.websockets.client.WebSocketClient.connectionBuilder(getXnioWorker(), getByteBufferPool(), url);
