...
/**
 * Resolves arguments of type {@link Map} annotated with {@link MatrixVariable @MatrixVariable} where the annotation
 * does not specify a name. In other words the purpose of this resolver is to provide access to multiple matrix
 * variables, either all or associated with a specific path variable.
 *
 * <p>
 * When a name is specified, an argument of type Map is considered to be a single attribute with a Map value, and is
 * resolved by {@link MatrixVariableMethodArgumentResolver} instead.
 *
