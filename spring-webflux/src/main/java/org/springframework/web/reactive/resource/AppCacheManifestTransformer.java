 ...
 *
 * <p>
 * All files with an ".appcache" file extension (or the extension given to the constructor) will be transformed by this
 * class. The hash is computed using the content of the appcache manifest so that changes in the manifest should
 * invalidate the browser cache. This should also work with changes in referenced resources whose links are also
 * versioned.
 *
