...
/**
 * A {@link ResourceTransformer} implementation that modifies links in a CSS file to match the public URL paths that
 * should be exposed to clients (e.g. with an MD5 content-based hash inserted in the URL).
 *
 * <p>
 * The implementation looks for links in CSS {@code @import} statements and also inside CSS {@code url()} functions. All
 * links are then passed through the {@link ResourceResolverChain} and resolved relative to the location of the
 * containing CSS file. If successfully resolved, the link is modified, otherwise the original link is preserved.
 *
...
public class CssLinkResourceTransformer extends ResourceTransformerSupport {
    ...
    protected abstract static class AbstractLinkParser implements LinkParser {
        ...
        /**
         * Invoked after a keyword match, after whitespace has been removed, and when the next char is neither a single
         * nor double quote.
         */
