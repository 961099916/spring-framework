...
/**
 * Supports the invocation of {@link org.springframework.web.bind.annotation.RequestMapping @RequestMapping} handler
 * methods.
 *
...
public class RequestMappingHandlerAdapter implements HandlerAdapter, ApplicationContextAware, InitializingBean {
    ...
    /**
     * A {@link ConfigurableApplicationContext} is expected for resolving expressions in method argument default values
     * as well as for detecting {@code @ControllerAdvice} beans.
     */
    @Override
