 ...
 *
 * <p>
 * An instance of this class is immutable. Instances are typically created through the mutable {@link Builder}: either
 * through {@link #builder()} to set up default strategies, or {@link #empty()} to start from scratch.
 *
...
public interface HandlerStrategies {
    ...
    interface Builder {
         ...
         *            the locale context resolver to add
         * @return this builder
         */
