...
/**
 * Abstract base class for resolving method arguments from a named value. Request parameters, request headers, and path
 * variables are examples of named values. Each may have a name, a required flag, and a default value.
 *
 * <p>
 ...
 *
 * <p>
 * A default value string can contain ${...} placeholders and Spring Expression Language #{...} expressions. For this to
 * work a {@link ConfigurableBeanFactory} must be supplied to the class constructor.
 *
...
public abstract class AbstractNamedValueArgumentResolver extends HandlerMethodArgumentResolverSupport {
     ...
     * 
     * @param factory
     *            a bean factory to use for resolving {@code ${...}} placeholder and {@code #{...}} SpEL expressions in
     *            default values, or {@code null} if default values are not expected to contain expressions
     * @param registry
    ...
    public Mono<Object> resolveArgument(MethodParameter parameter, BindingContext bindingContext,
        ...
        if (resolvedName == null) {
            return Mono.error(
                new IllegalArgumentException("Specified name must not resolve to null: [" + namedValueInfo.name + "]"));
        }
     ...
     * @param parameter
     *            the method parameter to resolve to an argument value (pre-nested in case of a
    ...
    /**
     * Invoked when a named value is required, but {@link #resolveName(String, MethodParameter, ServerWebExchange)}
