...
public class InvocableHandlerMethod extends HandlerMethod {
    ...
    /**
     * Configure a reactive adapter registry. This is needed for cases where the response is fully handled within the
     * controller in combination with an async void return value.
     * <p>
     ...
     * @param providedArgs
     *            optional list of argument values to match by type
