...
public class ResourceWebHandler implements WebHandler, InitializingBean {
    ...
    /**
     * Return the {@code List} of {@code Resource} paths to use as sources for serving static resources.
     * <p>
    ...
    /**
     * Return the {@link org.springframework.http.CacheControl} instance to build the Cache-Control HTTP response
     * header.
     */
    @Nullable
     ...
     * <li>Paths that represent a {@link ResourceUtils#isUrl valid URL} or would represent one after the leading slash
     * is removed.
     * </ul>
     * <p>
