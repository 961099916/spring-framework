...
public interface RequestedContentTypeResolver {
    ...
    /**
     * A singleton list with {@link MediaType#ALL} that is returned from {@link #resolveMediaTypes} when no specific
    ...
    /**
     * Resolve the given request to a list of requested media types. The returned list is ordered by specificity first
     * and by quality parameter second.
     * 
     * @param exchange
