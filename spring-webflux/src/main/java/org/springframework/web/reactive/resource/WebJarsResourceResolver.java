...
/**
 * A {@code ResourceResolver} that delegates to the chain to locate a resource and then attempts to find a matching
 * versioned resource contained in a WebJar JAR file.
 *
 * <p>
 * This allows WebJars.org users to write version agnostic paths in their templates, like
 * {@code <script src="/jquery/jquery.min.js"/>}. This path will be resolved to the unique version
 * {@code <script src="/jquery/1.2.0/jquery.min.js"/>}, which is a better fit for HTTP caching and version management in
 * applications.
 *
 * <p>
 ...
 *
 * <p>
 * This resolver requires the {@code org.webjars:webjars-locator-core} library on the classpath and is automatically
...
public class WebJarsResourceResolver extends AbstractResourceResolver {
    ...
    /**
     * Create a {@code WebJarsResourceResolver} with a custom {@code WebJarAssetLocator} instance, e.g. with a custom
     * index.
     */
