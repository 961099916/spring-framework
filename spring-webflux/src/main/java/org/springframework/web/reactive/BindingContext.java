...
/**
 * Context to assist with binding request data onto Objects and provide access to a shared {@link Model} with
 * controller-specific attributes.
 *
 * <p>
 * Provides methods to create a {@link WebExchangeDataBinder} for a specific target, command Object to apply data
 * binding and validation to, or without a target Object for simple type conversion from request values.
 *
 * <p>
...
public class BindingContext {
     ...
     * 
     * @param initializer
     *            the binding initializer to apply (may be {@code null})
     */
    ...
    /**
     * Create a {@link WebExchangeDataBinder} to apply data binding and validation with on the target, command object.
     * 
     * @param exchange
     ...
     *             if {@code @InitBinder} method invocation fails
     */
    ...
    /**
     * Create a {@link WebExchangeDataBinder} without a target object for type conversion of request values to simple
     * types.
     * 
     * @param exchange
     *            the current exchange
