...
/**
 * Context holder for request-specific state, like the {@link MessageSource} to use, current locale, binding errors,
 * etc. Provides easy access to localized messages and Errors instances.
 *
 * <p>
 * Suitable for exposition to views, and usage within FreeMarker templates and tag libraries.
 *
 * <p>
 * Can be instantiated manually or automatically exposed to views as a model attribute via AbstractView's
...
public class RequestContext {
    ...
    /**
     * Return the {@link RequestDataValueProcessor} instance to apply to in form tag libraries and to redirect URLs.
     */
    @Nullable
    ...
    /**
     * Return the context path of the current web application. This is useful for building links to other resources
     ...
     * @return a URL that points back to the current web application with an absolute path also URL-encoded accordingly
     */
    ...
    /**
     * Return the request path of the request. This is useful as HTML form action target, also in combination with the
    ...
    /**
     * Return the query string of the current request. This is useful for building an HTML form action target in
     * combination with the original request path.
     */
