...
public class WebSocketMessage {
     ...
     * {@link WebSocketSession#bufferFactory()} to create the payload and then invoke this constructor.
     */
    ...
    /**
     * A variant of {@link #getPayloadAsText(Charset)} that uses {@code UTF-8} for decoding the raw content to text.
     */
    ...
    /**
     * A shortcut for decoding the raw content of the message to text with the given character encoding. This is useful
     * for text WebSocket messages, or otherwise when the payload is expected to contain text.
     * 
     * @param charset
