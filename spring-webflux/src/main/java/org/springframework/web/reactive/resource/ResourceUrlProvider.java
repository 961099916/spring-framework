 ...
 *
 * <p>
 * This class is aware of Spring WebFlux handler mappings used to serve static resources and uses the
...
public class ResourceUrlProvider implements ApplicationListener<ContextRefreshedEvent>, ApplicationContextAware {
    ...
    /**
     * Return a read-only view of the resource handler mappings either manually configured or auto-detected from Spring
     * configuration.
     */
     ...
     * <p>
     * The URI string is expected to be a path and if it contains a query or fragment those will be preserved in the
     * resulting public resource URL.
     *
     * @param uriString
     *            the URI string to transform
     * @param exchange
