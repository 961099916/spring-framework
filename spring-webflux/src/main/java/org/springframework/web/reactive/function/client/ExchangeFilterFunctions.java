...
/**
 * Static factory methods providing access to built-in implementations of {@link ExchangeFilterFunction} for basic
...
public abstract class ExchangeFilterFunctions {
     ...
     * 
     * @deprecated as of Spring 5.1 in favor of using {@link HttpHeaders#setBasicAuth(String, String)} while building
     *             the request.
     */
    @Deprecated
    ...
    /**
     * Return a filter that generates an error signal when the given {@link HttpStatus} predicate matches.
     * 
     * @param statusPredicate
     *            the predicate to check the HTTP status with
     ...
     * {@link HttpHeaders#setBasicAuth(String)} and {@link HttpHeaders#encodeBasicAuth(String, String, Charset)}.
     * 
     * @param username
     *            the username
     * @param password
    ...
    public static ExchangeFilterFunction basicAuthentication(String username, String password) {
        ...
        return (request, next) -> next
            .exchange(ClientRequest.from(request).headers(headers -> headers.setBasicAuth(encodedCredentials)).build());
    }

    /**
     * Variant of {@link #basicAuthentication(String, String)} that looks up the {@link Credentials Credentials} in a
    ...
    public static final class Credentials {
        ...
        /**
         * Return a {@literal Consumer} that stores the given username and password as a request attribute of type
         * {@code Credentials} that is in turn used by {@link ExchangeFilterFunctions#basicAuthentication()}.
         * 
         * @param username
         *            the username
         * @param password
