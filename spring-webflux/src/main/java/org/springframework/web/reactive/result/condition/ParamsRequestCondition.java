...
/**
 * A logical conjunction (' && ') request condition that matches a request against a set parameter expressions with
 * syntax defined in {@link RequestMapping#params()}.
 *
...
public final class ParamsRequestCondition extends AbstractRequestCondition<ParamsRequestCondition> {
     ...
     * 
     * @param params
     *            expressions with syntax defined in {@link RequestMapping#params()}; if 0, the condition will match to
     *            every request.
     */
    ...
    /**
     * Compare to another condition based on parameter expressions. A condition is considered to be a more specific
     * match, if it has:
     * <ol>
     ...
     * each instance contains the matching parameter expressions only or is otherwise empty.
     */
    @Override
