 ...
 * {@link org.springframework.web.server.ResponseStatusException} (inherited from the base class) as well as exceptions
 * annotated with {@link ResponseStatus @ResponseStatus} by determining the HTTP status for them and updating the status
