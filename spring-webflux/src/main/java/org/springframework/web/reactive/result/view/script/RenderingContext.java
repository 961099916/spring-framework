...
/**
 * Context passed to {@link ScriptTemplateView} render function in order to make the application context, the locale,
 * the template loader and the url available on scripting side.
 *
...
public class RenderingContext {
     ...
     * @param locale
     *            the locale of the rendered template
     * @param templateLoader
     *            a function that takes a template path as input and returns the template content as a String
     * @param url
     *            the URL of the rendered template
     */
