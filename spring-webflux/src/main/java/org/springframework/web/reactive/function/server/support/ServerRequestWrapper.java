...
/**
 * Implementation of the {@link ServerRequest} interface that can be subclassed to adapt the request in a
 * {@link org.springframework.web.reactive.function.server.HandlerFilterFunction handler filter function}. All methods
...
public class ServerRequestWrapper implements ServerRequest {
     ...
     * {@link org.springframework.web.reactive.function.server.HandlerFilterFunction handler filter function}. All
     * methods default to calling through to the wrapped headers.
     */
