...
/**
 * {@code @RequestMapping} integration tests focusing on serialization and deserialization of the request and response
 * body.
 *
...
public class RequestMappingMessageConversionIntegrationTests extends AbstractRequestMappingIntegrationTests {
    ...
    public void personResponseBodyWithMonoResponseEntityXml(HttpServer httpServer) throws Exception {
        ...
        assertThat(actual).isEqualTo(
            ("<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>" + "<person><name>Robert</name></person>"));
    }
    ...
    public void personTransformWithRxJava2Single(HttpServer httpServer) throws Exception {
        ...
        assertThat(
            performPost("/person-transform/rxjava2-single", JSON, new Person("Robert"), JSON, Person.class).getBody())
                .isEqualTo(new Person("ROBERT"));
    }
    ...
    public void personTransformWithRxJava2Maybe(HttpServer httpServer) throws Exception {
        ...
        assertThat(
            performPost("/person-transform/rxjava2-maybe", JSON, new Person("Robert"), JSON, Person.class).getBody())
                .isEqualTo(new Person("ROBERT"));
    }
    ...
    private static class PersonTransformationController {
        ...
        public CompletableFuture<Person>
            transformCompletableFuture(@RequestBody CompletableFuture<Person> personFuture) {
        ...
        public io.reactivex.Single<Person>
            transformRxJava2Single(@RequestBody io.reactivex.Single<Person> personFuture) {
            return personFuture.map(person -> new Person(person.getName().toUpperCase()));
        }
        ...
        public io.reactivex.Observable<Person>
            transformObservable(@RequestBody io.reactivex.Observable<Person> persons) {
            return persons.map(person -> new Person(person.getName().toUpperCase()));
        }
    ...
    private static class PersonCreateController {
        ...
        @PostMapping("/rxjava2-observable")
        public io.reactivex.Completable
            createWithRxJava2Observable(@RequestBody io.reactivex.Observable<Person> observable) {
