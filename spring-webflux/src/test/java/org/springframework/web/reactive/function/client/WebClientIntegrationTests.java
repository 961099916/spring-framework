...
class WebClientIntegrationTests {
    ...
    private void startServer(ClientHttpConnector connector) {
        ...
        this.webClient =
            WebClient.builder().clientConnector(connector).baseUrl(this.server.url("/").toString()).build();
    }
    ...
    void retrieveJson(ClientHttpConnector connector) {
        ...
        Mono<Pojo> result =
            this.webClient.get().uri("/pojo").accept(MediaType.APPLICATION_JSON).retrieve().bodyToMono(Pojo.class);
    ...
    void retrieveJsonWithParameterizedTypeReference(ClientHttpConnector connector) {
        ...
        StepVerifier.create(result)
            .assertNext(c -> assertThat(c.getContainerValue()).isEqualTo(new Pojo("foofoo", "barbar"))).expectComplete()
            .verify(Duration.ofSeconds(3));
    ...
    void retrieveJsonAsResponseEntity(ClientHttpConnector connector) {
        ...
        Mono<ResponseEntity<String>> result =
            this.webClient.get().uri("/json").accept(MediaType.APPLICATION_JSON).retrieve().toEntity(String.class);
    ...
    void retrieveJsonAsBodilessEntity(ClientHttpConnector connector) {
        ...
        Mono<ResponseEntity<Void>> result =
            this.webClient.get().uri("/json").accept(MediaType.APPLICATION_JSON).retrieve().toBodilessEntity();
    ...
    void retrieveJsonArray(ClientHttpConnector connector) {
        ...
        Flux<Pojo> result =
            this.webClient.get().uri("/pojos").accept(MediaType.APPLICATION_JSON).retrieve().bodyToFlux(Pojo.class);
    ...
    void retrieveJsonArrayAsResponseEntity(ClientHttpConnector connector) {
        ...
        Mono<ResponseEntity<List<Pojo>>> result =
            this.webClient.get().uri("/json").accept(MediaType.APPLICATION_JSON).retrieve().toEntityList(Pojo.class);
    ...
    void retrieveJsonArrayAsBodilessEntityShouldReleasesConnection() {
        ...
        this.server = new MockWebServer();
        WebClient webClient =
            WebClient.builder().clientConnector(new ReactorClientHttpConnector(HttpClient.create(connectionProvider)))
        ...
        for (int i = 1; i <= 2; i++) {
            ...
            Mono<ResponseEntity<Void>> result =
                webClient.get().uri("/json").accept(MediaType.APPLICATION_JSON).retrieve().toBodilessEntity();
    ...
    void retrieveJsonAsSerializedText(ClientHttpConnector connector) {
        ...
        Mono<String> result =
            this.webClient.get().uri("/json").accept(MediaType.APPLICATION_JSON).retrieve().bodyToMono(String.class);
    ...
    void retrieve500(ClientHttpConnector connector) {
        ...
        prepareResponse(
            response -> response.setResponseCode(500).setHeader("Content-Type", "text/plain").setBody(errorMessage));
    ...
    void retrieve500AsEntity(ClientHttpConnector connector) {
        ...
        Mono<ResponseEntity<String>> result =
            this.webClient.get().uri("/").accept(MediaType.APPLICATION_JSON).retrieve().toEntity(String.class);
    ...
    void retrieve500AsEntityList(ClientHttpConnector connector) {
        ...
        Mono<ResponseEntity<List<String>>> result =
            this.webClient.get().uri("/").accept(MediaType.APPLICATION_JSON).retrieve().toEntityList(String.class);
    ...
    void retrieve500AsBodilessEntity(ClientHttpConnector connector) {
        ...
        Mono<ResponseEntity<Void>> result =
            this.webClient.get().uri("/").accept(MediaType.APPLICATION_JSON).retrieve().toBodilessEntity();
    ...
    void postLargeTextFile(ClientHttpConnector connector) throws Exception {
        ...
        Mono<Void> result =
            this.webClient.post().uri("/").body(body, DataBuffer.class).retrieve().bodyToMono(Void.class);
    ...
    void statusHandlerWithErrorBodyTransformation(ClientHttpConnector connector) {
        ...
        Mono<String> result = this.webClient.get().uri("/json").retrieve()
    ...
    void statusHandlerSuppressedErrorSignalWithEntity(ClientHttpConnector connector) {
        ...
        Mono<ResponseEntity<String>> result = this.webClient.get().uri("/").accept(MediaType.APPLICATION_JSON)
            .retrieve().onStatus(HttpStatus::is5xxServerError, response -> Mono.empty())// use normal response
    ...
    void exchangeForEmptyBodyAsVoidEntity(ClientHttpConnector connector) {
        ...
        Mono<ResponseEntity<Void>> result =
            this.webClient.get().uri("/noContent").exchange().flatMap(response -> response.toEntity(Void.class));
