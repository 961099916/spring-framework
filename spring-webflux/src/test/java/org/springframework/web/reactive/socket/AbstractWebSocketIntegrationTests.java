...
/**
 * Base class for WebSocket integration tests. Sub-classes must implement {@link #getWebConfigClass()} to return Spring
 * config class with (server-side) handler mappings to {@code WebSocketHandler}'s.
 *
...
abstract class AbstractWebSocketIntegrationTests {
    ...
    private HttpHandler createHttpHandler() {
        ApplicationContext context =
            new AnnotationConfigApplicationContext(DispatcherConfig.class, this.serverConfigClass, getWebConfigClass());
