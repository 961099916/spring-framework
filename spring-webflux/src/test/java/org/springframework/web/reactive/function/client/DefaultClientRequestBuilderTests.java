...
public class DefaultClientRequestBuilderTests {
    ...
    public void bodyClass() {
        ...
        ClientRequest result =
            ClientRequest.create(POST, URI.create("https://example.com")).body(publisher, String.class).build();
    ...
    public void bodyParameterizedTypeReference() {
        ...
        ClientRequest result =
            ClientRequest.create(POST, URI.create("https://example.com")).body(publisher, typeReference).build();
