...
class RenderingResponseIntegrationTests extends AbstractRouterFunctionIntegrationTests {
    ...
    protected RouterFunction<?> routerFunction() {
        ...
        RouterFunction<RenderingResponse> filteredRoute = route(GET("/filter"), handler::render).filter(
            ofResponseProcessor(response -> RenderingResponse.from(response).modelAttribute("qux", "quux").build()));
