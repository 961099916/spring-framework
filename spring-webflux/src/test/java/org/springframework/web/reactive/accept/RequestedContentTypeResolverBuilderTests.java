...
public class RequestedContentTypeResolverBuilderTests {
    ...
    public void defaultSettings() throws Exception {
        ...
        MockServerWebExchange exchange =
            MockServerWebExchange.from(MockServerHttpRequest.get("/flower").accept(MediaType.IMAGE_GIF));
    ...
    public void parameterResolverWithCustomParamName() throws Exception {
        ...
        List<MediaType> mediaTypes =
            resolver.resolveMediaTypes(MockServerWebExchange.from(MockServerHttpRequest.get("/flower?s=json")));
