...
/**
 * Test the effect of exceptions at different stages of request processing by checking the error signals on the
...
public class DispatcherHandlerErrorTests {
    ...
    public void requestBodyError() {
        ServerWebExchange exchange =
            MockServerWebExchange.from(MockServerHttpRequest.post("/request-body").body(Mono.error(EXCEPTION)));
