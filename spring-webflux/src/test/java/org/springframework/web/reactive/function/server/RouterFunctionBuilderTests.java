...
public class RouterFunctionBuilderTests {
    ...
    public void route() {
        ...
        Mono<Integer> responseMono =
            route.route(getRequest).flatMap(handlerFunction -> handlerFunction.handle(getRequest))
    ...
    public void resources() {
        ...
        Mono<Integer> responseMono =
            route.route(resourceRequest).flatMap(handlerFunction -> handlerFunction.handle(resourceRequest))
                .map(ServerResponse::statusCode).map(HttpStatus::value);
    ...
    public void filters() {
        ...
        Mono<Integer> barResponseMono =
            route.route(barRequest).flatMap(handlerFunction -> handlerFunction.handle(barRequest))
                .map(ServerResponse::statusCode).map(HttpStatus::value);
